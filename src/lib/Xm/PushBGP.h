...
#  define PBG_FillOnArm(w) (((XmPushButtonGadget)(w))->pushbutton.cache->fill_on_arm)
#  define PBG_ArmColor(w) (((XmPushButtonGadget)(w))->pushbutton.cache->arm_color)
#  define PBG_FillGc(w) (((XmPushButtonGadget)(w))->pushbutton.cache->fill_gc)
#  define PBG_BackgroundGc(w) (((XmPushButtonGadget)(w))->pushbutton.cache->background_gc)
#  define PBG_Timer(w) (((XmPushButtonGadget)(w))->pushbutton.cache->timer)
#  define PBG_ArmPixmap(w) (((XmPushButtonGadget)(w))->pushbutton.cache->arm_pixmap)
#  define PBG_UnarmPixmap(w) (((XmPushButtonGadget)(w))->pushbutton.cache->unarm_pixmap)
#  define PBG_MultiClick(w) (((XmPushButtonGadget)(w))->pushbutton.cache->multiClick)
...
#  define PBG_ActivateCallback(w) (((XmPushButtonGadget)(w))->pushbutton.activate_callback)
#  define PBG_ArmCallback(w) (((XmPushButtonGadget)(w))->pushbutton.arm_callback)
#  define PBG_DisarmCallback(w) (((XmPushButtonGadget)(w))->pushbutton.disarm_callback)
#  define PBG_Armed(w) (((XmPushButtonGadget)(w))->pushbutton.armed)
#  define PBG_ClickCount(w) (((XmPushButtonGadget)(w))->pushbutton.click_count)
#  define PBG_Compatible(w) (((XmPushButtonGadget)(w))->pushbutton.compatible)
#  define PBG_ShowAsDefault(w) (((XmPushButtonGadget)(w))->pushbutton.show_as_default)
/******************************/
/* Convenience Macros         */
/******************************/
#  define PBG_Cache(w) (((XmPushButtonGadget)(w))->pushbutton.cache)
