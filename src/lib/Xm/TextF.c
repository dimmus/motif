...
static void MakeCopy(Widget w, int n, XtArgVal *value);
static void WcsMakeCopy(Widget w, int n, XtArgVal *value);
static void FreeContextData(Widget w, XtPointer clientData, XtPointer callData);
static TextFDestData GetTextFDestData(Widget w);
static _XmHighlightRec *FindHighlight(XmTextFieldWidget w, XmTextPosition position);
static void InsertHighlight(XmTextFieldWidget w, XmTextPosition position, XmHighlightMode mode);
...
static void HandleTimer(XtPointer closure, XtIntervalId *id);
static void ChangeBlinkBehavior(XmTextFieldWidget tf, Boolean turn_on);
static void GetRect(XmTextFieldWidget tf, XRectangle *rect);
static void SetFullGC(XmTextFieldWidget tf, GC gc);
static void SetMarginGC(XmTextFieldWidget tf, GC gc);
static void SetNormGC(XmTextFieldWidget tf, GC gc, Boolean change_stipple, Boolean stipple);
static void SetShadowGC(XmTextFieldWidget tf, GC gc);
static void SetInvGC(XmTextFieldWidget tf, GC gc);
static void DrawText(XmTextFieldWidget tf, GC gc, int x, int y, char *string, int length);
static int FindPixelLength(XmTextFieldWidget tf, char *string, int length);
...
static void VerifyBounds(XmTextFieldWidget tf, XmTextPosition *from, XmTextPosition *to);
static XmTextPosition GetPosFromX(XmTextFieldWidget tf, Position x);
static Boolean SetDestination(Widget w, XmTextPosition position, Boolean disown, Time set_time);
static Boolean VerifyLeave(XmTextFieldWidget tf, XEvent *event);
...
static void CheckDisjointSelection(Widget w, XmTextPosition position, Time sel_time);
static Boolean NeedsPendingDelete(XmTextFieldWidget tf);
static Boolean NeedsPendingDeleteDisjoint(XmTextFieldWidget tf);
static void InsertChar(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DeletePrevChar(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DeleteNextChar(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DeletePrevWord(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DeleteNextWord(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DeleteToEndOfLine(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DeleteToStartOfLine(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ProcessCancel(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void Activate(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void SetAnchorBalancing(XmTextFieldWidget tf, XmTextPosition position);
...
static void CompleteNavigation(
    XmTextFieldWidget tf, XEvent *event, XmTextPosition position, Time time, Boolean extend);
...
static void ProcessSelectParams(Widget w,
                                ...
                                XmTextPosition *right,
                                XmTextPosition *position);
static void KeySelection(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void TextFocusIn(Widget w, XEvent *event, char **params, Cardinal *num_params);
...
static void ExtendScanSelection(XmTextFieldWidget tf, XEvent *event);
static void SetScanSelection(XmTextFieldWidget tf, XEvent *event);
static void StartPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void MoveDestination(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ExtendPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ExtendEnd(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DoExtendedSelection(Widget w, Time time);
static void DoSecondaryExtend(Widget w, Time ev_time);
...
static void ProcessBDragRelease(Widget w, XEvent *event, String *params, Cardinal *num_params);
static Boolean InSelection(Widget w, XEvent *event);
static void ProcessBSelect(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ProcessBSelectEvent(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ExtendSecondary(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void Stuff(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void SecondaryNotify(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ProcessCopy(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ProcessLink(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ProcessMove(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void DeleteSelection(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ClearSelection(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void PageRight(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void PageLeft(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void CopyPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void CutPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void LinkPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void SetAnchor(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ToggleOverstrike(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void ToggleAddMode(Widget w, XEvent *event, char **params, Cardinal *num_params);
...
static void VoidAction(Widget w, XEvent *event, char **params, Cardinal *num_params);
...
static void PasteClipboard(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void TraverseDown(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void TraverseUp(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void TraverseHome(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void TraverseNextTabGroup(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void TraversePrevTabGroup(Widget w, XEvent *event, char **params, Cardinal *num_params);
static void TextEnter(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TextLeave(Widget w, XEvent *event, String *params, Cardinal *num_params);
...
static void MakeIBeamOffArea(XmTextFieldWidget tf, Dimension width, Dimension height);
static Pixmap FindPixmap(
    Screen *screen, char *image_name, Pixel foreground, Pixel background, int depth);
static void MakeIBeamStencil(XmTextFieldWidget tf, int line_width);
static void MakeAddModeCursor(XmTextFieldWidget tf, int line_width);
static void MakeCursors(XmTextFieldWidget tf);
static void DragProcCallback(Widget w, XtPointer client, XtPointer call);
...
static void TextFieldExpose(Widget w, XEvent *event, Region region);
static Boolean SetValues(
    Widget old, Widget request, Widget new_w, ArgList args, Cardinal *num_args);
static Boolean TextFieldGetBaselines(Widget w, Dimension **baselines, int *line_count);
static Boolean TextFieldGetDisplayRect(Widget w, XRectangle *display_rect);
static void TextFieldMarginsProc(Widget w, XmBaselineMargins *margins_rec);
...
static Boolean TextFieldRemove(Widget w, XEvent *event);
static void TextFieldReplace(
    Widget w, XmTextPosition from_pos, XmTextPosition to_pos, char *value, int is_wc);
static void CursorPosVisDefault(Widget widget, int offset, XrmValue *value);
...
static void PreeditSetCursorPosition(XmTextFieldWidget tf, XmTextPosition position);
static void TextFieldResetIC(Widget w);
static void doSetHighlight(Widget w,
                           XmTextPosition left,
                           XmTextPosition right,
                           XmHighlightMode mode);
...
static XtResource resources[] = {
    ...
    {"pri.vate",
     ...
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(struct _XmTextFieldRec, text.check_set_render_table),
     XmRImmediate,
     (XtPointer)False},
    {XmNfontList,
     XmCFontList,
...
externaldef(xmtextfieldwidgetclass)
 ...
 *
 *********************************************************************/
static void CursorPosVisDefault(Widget widget,
                                int offset, /* unused */
                                XrmValue *value)
{
 ...
 */
int _XmTextFieldCountCharacters(XmTextFieldWidget tf, char *ptr, int n_bytes)
{
  char *bptr;
  int count = 0;
  int char_size = 0;
 ...
 */
int _XmTextFieldCountBytes(XmTextFieldWidget tf, wchar_t *wc_value, int num_chars)
{
  wchar_t *wc_ptr;
...
static void FreeContextData(Widget w, /* unused */
...
static TextFDestData GetTextFDestData(Widget w)
{
  ...
  if (XFindContext(display, (Window)screen, loc_context, (char **)&dest_data)) {
    ...
    dest_data = (TextFDestData)XtCalloc((unsigned)sizeof(TextFDestDataRec), (unsigned)1);
    XtAddCallback(
        xm_display, XmNdestroyCallback, (XtCallbackProc)FreeContextData, (XtPointer)ctx_data);
    XSaveContext(XtDisplay(w), (Window)screen, loc_context, (XPointer)dest_data);
  }
  return dest_data;
}

void _XmTextFToggleCursorGC(Widget widget)
{
  ...
  if (!XtIsSensitive((Widget)tf)) {
    ...
    if (tf->text.overstrike) {
      if (tf->text.stipple_tile == XmUNSPECIFIED_PIXMAP)
        return;
                            ...
                            Position *y)
{
  ...
  *y += tf->primitive.highlight_thickness + tf->primitive.shadow_thickness + tf->text.margin_top +
        TextF_FontAscent(tf);
...
static void PaintCursor(XmTextFieldWidget tf)
{
  Position x, y;
  XmTextPosition position;
  if (!TextF_CursorPositionVisible(tf))
    return;
   ...
   */
  {
    ...
    if ((tf->text.cursor_on >= 0) && tf->text.blink_on) {
      if ((int)(x + tf->text.cursor_width) >
          (int)(tf->core.width - tf->primitive.shadow_thickness -
      ...
      if (cursor_width > 0 && cursor_height > 0) {
        ...
        _XmTextFToggleCursorGC((Widget)tf);
        XFillRectangle(
            XtDisplay(tf), XtWindow(tf), tf->text.image_gc, x, y, cursor_width, cursor_height);
      }
    }
    else {
      Position src_x = 0;
...
void _XmTextFieldDrawInsertionPoint(XmTextFieldWidget tf, Boolean turn_on)
{
  if (turn_on == True) {
    tf->text.cursor_on += 1;
...
static void BlinkInsertionPoint(XmTextFieldWidget tf)
{
  if ((tf->text.cursor_on >= 0) && (tf->text.blink_on == CurrentCursorState(tf)) &&
...
static void HandleTimer(XtPointer closure, XtIntervalId *id)
{
  ...
  if (TextF_BlinkRate(tf) != 0)
    tf->text.timer_id = XtAppAddTimeOut(XtWidgetToApplicationContext((Widget)tf),
                                        ...
                                        HandleTimer,
                                        (XtPointer)closure);
  if (tf->text.has_focus && XtIsSensitive((Widget)tf))
...
static void GetRect(XmTextFieldWidget tf, XRectangle *rect)
{
  ...
  Dimension margin_top = tf->text.margin_top + tf->primitive.shadow_thickness +
                         tf->primitive.highlight_thickness;
  Dimension margin_bottom = tf->text.margin_bottom + tf->primitive.shadow_thickness +
                            tf->primitive.highlight_thickness;
...
static void SetFullGC(XmTextFieldWidget tf, GC gc)
{
  ...
  ClipRect.width = tf->core.width -
                   (2 * (tf->primitive.shadow_thickness + tf->primitive.highlight_thickness));
...
static void DrawText(XmTextFieldWidget tf, GC gc, int x, int y, char *string, int length)
{
  if (TextF_UseFontSet(tf)) {
    if (tf->text.max_char_size != 1)
      ...
      XmbDrawString(
          XtDisplay(tf), XtWindow(tf), (XFontSet)TextF_Font(tf), gc, x, y, string, length);
#if USE_XFT
  }
    ...
    if (tf->text.max_char_size != 1) { /* was passed a wchar_t*  */
      ...
      if (num_bytes >= 0)
        _XmXftDrawString2(
            XtDisplay(tf), XtWindow(tf), gc, TextF_XftFont(tf), 1, x, y, tmp, num_bytes);
      XmStackFree(tmp, stack_cache);
    }
    else /* one byte chars */
      _XmXftDrawString2(
          XtDisplay(tf), XtWindow(tf), gc, TextF_XftFont(tf), 1, x, y, string, length);
#endif
  }
...
static int FindPixelLength(XmTextFieldWidget tf, char *string, int length)
{
  if (TextF_UseFontSet(tf)) {
    if (tf->text.max_char_size != 1)
      return (XwcTextEscapement((XFontSet)TextF_Font(tf), (wchar_t *)string, length));
    else /* one byte chars */
                            ...
                            int *x)
{
  ...
  if (tf->text.max_char_size != 1) {
    *x += FindPixelLength(
        tf, (char *)(TextF_WcValue(tf) + prev_seg_start), (int)(seg_start - prev_seg_start));
    x_seg_len = FindPixelLength(
        tf, (char *)(TextF_WcValue(tf) + seg_start), (int)seg_end - (int)seg_start);
  }
  else {
  ...
  if (stipple) {
    ...
    if (tf->text.max_char_size != 1) {
      DrawText(tf,
               ...
               *x + 1,
               y + 1,
               (char *)(TextF_WcValue(tf) + seg_start),
  ...
  if (tf->text.max_char_size != 1)
    *x += FindPixelLength(
        tf, (char *)(TextF_WcValue(tf) + seg_start), (int)(next_seg - (int)seg_start));
  else
  ...
  for (i = 0; i + 1 < tf->text.highlight.number; i++) {
    ...
    if (l[i].position <= start && start < l[i + 1].position && l[i].position < end) {
      if (end > l[i + 1].position) {
        ...
        DrawTextSegment(
            tf, l[i].mode, l[i].position, start, end, l[i + 1].position, stipple, y, &x);
        start = end;
      }
    }
    else { /* start not within current record */
      if (tf->text.max_char_size != 1)
        x += FindPixelLength(tf,
                             (char *)(TextF_WcValue(tf) + l[i].position),
                             (int)(l[i + 1].position - l[i].position));
      else
        x += FindPixelLength(
            tf, TextF_Value(tf) + l[i].position, (int)(l[i + 1].position - l[i].position));
    }
  } /* end for loop */
  /* complete the drawing of the text to the end of the line */
  if (l[i].position < end) {
    DrawTextSegment(
        tf, l[i].mode, l[i].position, start, end, tf->text.string_length, stipple, y, &x);
  }
  else {
    if (tf->text.max_char_size != 1)
      x += FindPixelLength(tf,
      ...
      x += FindPixelLength(
          tf, TextF_Value(tf) + l[i].position, tf->text.string_length - (int)l[i].position);
  }
  if (x < (Position)(rect.x + rect.width)) {
    SetInvGC(tf, tf->text.gc);
    XFillRectangle(
        XtDisplay(tf), XtWindow(tf), tf->text.gc, x, rect.y, rect.x + rect.width - x, rect.height);
  }
  tf->text.refresh_ibeam_off = True;
  _XmTextFieldDrawInsertionPoint(tf, True);
}
...
static void ComputeSize(XmTextFieldWidget tf, Dimension *width, Dimension *height)
{
  ...
  if (TextF_ResizeWidth(tf) && TextF_Columns(tf) < tf->text.string_length) {
    ...
    *width = tmp + (2 * (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                         tf->primitive.highlight_thickness));
  }
  else {
...
static Boolean AdjustText(XmTextFieldWidget tf, XmTextPosition position, Boolean flag)
{
  ...
  Dimension temp;
  if (tf->text.max_char_size != 1) {
    left_edge = FindPixelLength(tf, (char *)TextF_WcValue(tf), (int)position) +
  ...
  if (flag)
    RedisplayText(tf, position, tf->text.string_length);
  return False;
}
...
static void AdjustSize(XmTextFieldWidget tf)
{
  ...
  Dimension margin_width = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                           tf->primitive.highlight_thickness;
  if (tf->text.max_char_size != 1) {
    left_edge = FindPixelLength(tf, (char *)TextF_WcValue(tf), tf->text.string_length) +
                margin_width;
  }
  else {
  ...
  if (TextF_ModifyVerifyCallbackWcs(tf) && vcb.doit) {
    if (do_free) { /* there is a char* modify verify callback; the data we
      ...
      if (tf->text.max_char_size == 1)
        ...
        (void)memcpy(
            (void *)wcs_newblock.wcsptr, (void *)*insert, *insert_length * sizeof(wchar_t));
      }
      if (wcs_newblock.length < 0) { /* bad value; don't pass anything */
        wcs_newblock.wcsptr[0] = 0L;
        wcs_newblock.length = 0;
 ...
 */
void _XmTextFieldSetCursorPosition(XmTextFieldWidget tf,
                                   XEvent *event,
                                   XmTextPosition position,
                                   Boolean adjust_flag,
                                   Boolean call_cb)
                              ...
                              PassDisown passDisown)
{
  ...
  if (position == hl_list[i].position)
    ...
    InvertImageGC(tf);
  if (adjust_flag)
    (void)AdjustText(tf, position, flag);
  tf->text.refresh_ibeam_off = True;
  _XmTextFieldDrawInsertionPoint(tf, True);
 ...
 */
Boolean _XmTextFieldReplaceText(XmTextFieldWidget tf,
                                XEvent *event,
                                XmTextPosition replace_prev,
                                XmTextPosition replace_next,
                                char *insert,
                                ...
                                Boolean move_cursor)
{
  ...
  if (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right)
    doSetHighlight(
        (Widget)tf, tf->text.prim_pos_left, tf->text.prim_pos_right, XmHIGHLIGHT_NORMAL);
  _XmTextFieldDrawInsertionPoint(tf, False);
  ...
  if (tf->text.max_char_size == 1) {
     ...
     */
    if (insert_length != 0) {
      for (src = insert, dst = TextF_Value(tf) + replace_prev, i = insert_length; i > 0;
           ++src, ++dst, --i)
        *dst = *src;
    }
  }
  ...
  if (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right)
    doSetHighlight(
        (Widget)tf, tf->text.prim_pos_left, tf->text.prim_pos_right, XmHIGHLIGHT_SELECTED);
  ...
  if (move_cursor) {
    ...
    if (event != NULL) {
      ...
      (void)SetDestination(
          (Widget)tf, cursorPos, False, XtLastTimestampProcessed(XtDisplay((Widget)tf)));
    }
 ...
 * the new settings.
 */
void _XmTextFieldDeselectSelection(Widget w, Boolean disown, Time sel_time)
{
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  if (w != NULL && disown) {
    if (!sel_time)
      sel_time = _XmValidTimestamp(w);
    /*
  ...
  if (tf != NULL) {
    ...
    tf->text.prim_pos_left = tf->text.prim_pos_right = tf->text.prim_anchor = TextF_CursorPosition(
        tf);
...
static XmTextPosition GetPosFromX(XmTextFieldWidget tf, Position x)
{
  ...
  for (position = 0; temp_x + next_char_width / 2 < (int)x && position < tf->text.string_length;
       position++)
  {
    ...
    if (tf->text.string_length > position + 1) {
      if (tf->text.max_char_size != 1) {
        ...
        next_char_width = FindPixelLength(tf, TextF_Value(tf) + position + 1, 1);
      }
    }
  } /* for */
  return position;
...
Boolean _XmTextFieldSetDestination(Widget w, XmTextPosition position, Time set_time)
{
  Boolean result;
                                          ...
                                          XmTextPosition pos2)
{
  ...
  if (tf->text.max_char_size == 1) { /* data is char* and one-byte per char */
    if (isspace((unsigned char)TextF_Value(tf)[pos1]) ||
        isspace((unsigned char)TextF_Value(tf)[pos2]))
      return True;
  }
  else {
...
static void FindNextWord(XmTextFieldWidget tf, XmTextPosition *left, XmTextPosition *right)
{
  ...
  if (tf->text.max_char_size == 1) {
    if (isspace((unsigned char)TextF_Value(tf)[end])) {
      for (end = TextF_CursorPosition(tf); end < tf->text.string_length; end++) {
        if (!isspace((unsigned char)TextF_Value(tf)[end])) {
          break;
        }
      }
...
static void CheckDisjointSelection(Widget w, XmTextPosition position, Time sel_time)
{
  ...
  if (tf->text.add_mode ||
      (tf->text.has_primary && left != right && position >= left && position <= right))
...
static Boolean NeedsPendingDelete(XmTextFieldWidget tf)
{
  return (tf->text.add_mode ?
              (TextF_PendingDelete(tf) && tf->text.has_primary &&
               tf->text.prim_pos_left != tf->text.prim_pos_right &&
               tf->text.prim_pos_left <= TextF_CursorPosition(tf) &&
               tf->text.prim_pos_right >= TextF_CursorPosition(tf)) :
              (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right));
}

static Boolean NeedsPendingDeleteDisjoint(XmTextFieldWidget tf)
{
  return (TextF_PendingDelete(tf) && tf->text.has_primary &&
          tf->text.prim_pos_left != tf->text.prim_pos_right &&
          tf->text.prim_pos_left <= TextF_CursorPosition(tf) &&
          tf->text.prim_pos_right >= TextF_CursorPosition(tf));
}

static Boolean PrintableString(XmTextFieldWidget tf,
                               char *str,
                               int n,
                               Boolean use_wchar) /* sometimes unused */
{
  ...
  if (tf->text.max_char_size == 1) {
    ...
    if (use_wchar) {
      ...
      int i, csize;
      wchar_t wc;
      for (i = 0, csize = mblen(str, tf->text.max_char_size); i < n;
...
static void InsertChar(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
  ...
  insert_length = XmImMbLookupString(
      w, (XKeyEvent *)event, insert_string, TEXT_MAX_INSERT_SIZE, (KeySym *)NULL, &status_return);
  ...
  for (i = 0; i < insert_length; i++)
    if (insert_string[i] == 0)
      insert_length = 0; /* toss out input string */
  if (insert_length > 0) {
    ...
    if (NeedsPendingDeleteDisjoint(tf)) {
      if (!tf->text.has_primary ||
          (cursorPos = tf->text.prim_pos_left) == (nextPos = tf->text.prim_pos_right))
      {
    ...
    if (tf->text.max_char_size == 1) {
      if (tf->text.overstrike)
        nextPos += insert_length;
      if (nextPos > tf->text.string_length)
        nextPos = tf->text.string_length;
      replace_res = _XmTextFieldReplaceText(
          tf, (XEvent *)event, cursorPos, nextPos, insert_string, insert_length, True);
    }
    else {
    ...
    if (replace_res) {
      if (pending_delete) {
        _XmTextFieldStartSelection(
            tf, TextF_CursorPosition(tf), TextF_CursorPosition(tf), event->xkey.time);
        tf->text.pending_off = False;
      }
...
{
  XmTextPosition left = tf->text.prim_pos_left, right = tf->text.prim_pos_right;
  if ((tf->text.add_mode && tf->text.has_primary && position >= left && position <= right) ||
      extend)
    tf->text.pending_off = FALSE;
  else
    tf->text.pending_off = TRUE;
                           ...
                           XmTextPosition position)
{
  ...
  if (*num_params > 0) {
    ...
    if (_XmConvertActionParamToRepTypeId(
            (Widget)w, XmRID_TEXTFIELD_EXTEND_MOVEMENT_ACTION_PARAMS, params[0], False, &value) ==
        True)
    {
      extend = True;
    }
                         ...
                         Boolean redisplay)
{
  ...
  if (redisplay) {
    if (old_prim_left > tf->text.prim_pos_left) {
      ...
      display_left = (old_prim_right > tf->text.prim_pos_right) ? tf->text.prim_pos_right :
                                                                  old_prim_right;
    if (old_prim_right < tf->text.prim_pos_right) {
      ...
      display_right = (old_prim_left < tf->text.prim_pos_left) ? tf->text.prim_pos_left :
                                                                 old_prim_left;
 ...
 */
void _XmTextFieldStartSelection(XmTextFieldWidget tf,
                                XmTextPosition left,
                                XmTextPosition right,
                                Time sel_time)
{
  ...
  {
    if (!sel_time)
      sel_time = _XmValidTimestamp((Widget)tf);
    ...
    if (XmePrimarySource((Widget)tf, sel_time)) {
      ...
      tf->text.prim_pos_left = tf->text.prim_pos_right = tf->text.prim_anchor =
          TextF_CursorPosition(tf);
      /*
                                    ...
                                    XmTextPosition *position)
{
  ...
  *position = TextF_CursorPosition(tf);
  ...
  if (*num_params > 0) {
    ...
    if (_XmConvertActionParamToRepTypeId(
            (Widget)w, XmRID_TEXTFIELD_DIRECTION_ACTION_PARAMS, params[0], False, &direction) ==
        True)
    {
      if (direction == _RIGHT) {
        if (*position >= tf->text.string_length)
...
static void ProcessSelectParams(
    Widget w, XEvent *event, XmTextPosition *left, XmTextPosition *right, XmTextPosition *position)
{
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  *position = TextF_CursorPosition(tf);
  if (!tf->text.has_primary || tf->text.prim_pos_left == tf->text.prim_pos_right) {
...
static void TextFocusOut(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
  ...
  if (event->xfocus.send_event && tf->text.has_focus) {
    ...
    tf->text.blink_on = True;
    _XmTextFieldDrawInsertionPoint(tf, True);
    if (((XmTextFieldWidgetClass)XtClass(tf))->primitive_class.border_unhighlight) {
      (*((XmTextFieldWidgetClass)XtClass(tf))->primitive_class.border_unhighlight)((Widget)tf);
    }
    XmImUnsetFocus(w);
  }
...
static void DoExtendedSelection(Widget w, Time time)
{
  ...
  if (!tf->text.has_primary || left == right) {
    ...
    bal_point = (float)(((float)(tf->text.orig_right - tf->text.orig_left) / 2.0) +
...
static void DoSecondaryExtend(Widget w, Time ev_time)
{
  ...
  if (position < tf->text.sec_anchor) {
    ...
    if (tf->text.sec_pos_left >= 0)
      AdjustText(tf, tf->text.sec_pos_left, True);
  }
...
{
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  Dimension margin_size = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                          tf->primitive.highlight_thickness;
  ...
  if ((event->xmotion.x > (int)margin_size) &&
      ...
      (event->xmotion.y < (int)(top_margin + TextF_FontAscent(tf) + TextF_FontDescent(tf))))
  {
    if (tf->text.select_id) {
      XtRemoveTimeOut(tf->text.select_id);
      tf->text.select_id = 0;
    ...
    if (tf->text.sec_pos_left <= prim_right && tf->text.sec_pos_left >= prim_left) {
      ...
      if (tf->text.sec_pos_left <= prim_left && tf->text.sec_pos_right >= prim_right) {
        ...
        TextFieldSetHighlight(
            tf, tf->text.sec_pos_left, tf->text.sec_pos_right, XmHIGHLIGHT_NORMAL);
      }
    }
  }
}
    ...
    Widget w, XmTextPosition left, XmTextPosition right, Boolean disown, Time sel_time)
{
  ...
  TextFieldSetHighlight((XmTextFieldWidget)w,
                        tf->text.sec_pos_left,
...
static void ProcessBDragEvent(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
...
static Boolean InSelection(Widget w, XEvent *event)
{
  ...
  return (tf->text.has_primary && left != right &&
          ((position > left && position < right) ||
           (position == left && GetXYFromPos(tf, left, &left_x, &dummy) &&
            event->xbutton.x > left_x) ||
           (position == right && GetXYFromPos(tf, right, &right_x, &dummy) &&
    ...
    switch (event->type) {
      ...
      case ButtonRelease:
        if (tf->text.drag_id) {
          ...
          if (*tf->text.transfer_action->num_params) {
            XtCallActionProc(
                w, tf->text.transfer_action->params[0], tf->text.transfer_action->event, NULL, 0);
          }
        }
        XtCallActionProc(w, params[0], event, NULL, 0);
        break;
      case MotionNotify:
        if (tf->text.drag_id) {
          ...
          if (ABS_DELTA(press->xbutton.x_root, event->xmotion.x_root) > tf->text.threshold ||
...
static void ProcessBSelectEvent(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XtEnum drag_on_btn1 = XmOFF;
  XmDisplay dpy;
  dpy = (XmDisplay)XmGetXmDisplay(XtDisplay(w));
...
void _XmTextFieldHandleSecondaryFinished(Widget w, XEvent *event)
{
  ...
  if (_XmTextFieldReplaceText(
          tf, event, left, right, NULL, 0, False /* don't adjust cursor position */))
  {
    XmTextPosition cursorPos;
  ...
  if (num_spaces > 0) {
    ...
    if (tf->text.max_char_size == 1) {
      ...
      rep_result = _XmTextFieldReplaceText(
          tf, (XEvent *)event, left, right, spaces, num_spaces, False);
      ...
      rep_result = _XmTextFieldReplaceText(
          tf, (XEvent *)event, left, right, (char *)wc_spaces, num_spaces, False);
...
static void PageRight(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
  ...
  if ((int)(length - ((int)(tf->core.width - (2 * margin_width)) - tf->text.h_offset)) >
...
static void PageLeft(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
  ...
  int value;
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  int margin_width = (int)TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                     tf->primitive.highlight_thickness;
  TextFieldResetIC(w);
  _XmTextFieldDrawInsertionPoint(tf, False);
  if (*num_params > 0) {
...
Boolean XmTextFieldPasteLink(Widget w)
{
  Boolean status;
  _XmWidgetToAppContext(w);
  _XmAppLock(app);
...
static Boolean LoadFontMetrics(XmTextFieldWidget tf)
{
  ...
  do {
    ...
    if (next_entry && (tmp_font = XmFontListEntryGetFont(next_entry, &type_return))) {
  ...
  if (!is_wchar) {
    ...
    for (i = 0; i < str_len;) {
      if (tf->text.max_char_size == 1) {
        ...
        if (TextF_UseXft(tf)) {
          ...
          printable = (num_conv >= 0 && PrintableString(tf, curr_str, num_conv, True));
        }
        else
#endif
        {
          num_conv = mbtowc(&tmp, curr_str, tf->text.max_char_size);
          printable = (num_conv >= 0 && PrintableString(tf, (char *)&tmp, 1, True));
        }
        if (printable) {
    ...
    *temp_str = '\0';
    ...
    if (tf->text.max_char_size == 1) {
      ...
      tf->text.string_length = mbstowcs(
          TextF_WcValue(tf), start_temp, tf->text.string_length + 30);
      if (tf->text.string_length < 0)
        tf->text.string_length = 0;
      TextF_Value(tf) = NULL;
    }
    ...
    *wcs_temp_str = (wchar_t)0L;      /* terminate with a wchar_t NULL */
    ...
    if (tf->text.max_char_size == 1) { /* Need to store data as char* */
      ...
      TextF_WcValue(tf) = (wchar_t *)memcpy(XtMalloc((unsigned)tf->text.size_allocd),
                                            (void *)wcs_start_temp,
...
static void InitializeTextStruct(XmTextFieldWidget tf)
{
  ...
  tf->text.orig_left = tf->text.orig_right = tf->text.prim_pos_left = tf->text.prim_pos_right =
      tf->text.prim_anchor = TextF_CursorPosition(tf);
...
static void LoadGCs(XmTextFieldWidget tf, Pixel background, Pixel foreground)
{
  ...
  tf->text.save_gc = XtAllocateGC(
      (Widget)tf, tf->core.depth, valueMask, &values, dynamicMask, unusedMask);
  /*
...
static void MakeIBeamOffArea(XmTextFieldWidget tf, Dimension width, Dimension height)
{
   ...
   * be painted */
  tf->text.ibeam_off = XCreatePixmap(
      dpy, RootWindowOfScreen(screen), width, height, tf->core.depth);
  tf->text.refresh_ibeam_off = True;
}
...
static void MakeIBeamStencil(XmTextFieldWidget tf, int line_width)
{
  ...
  if (tf->text.cursor == XmUNSPECIFIED_PIXMAP) {
    ...
    tf->text.cursor = XCreatePixmap(
        dpy, XtWindow(tf), tf->text.cursor_width, tf->text.cursor_height, 1);
    ...
    (void)_XmCachePixmap(tf->text.cursor,
                         XtScreen(tf),
                         pixmap_name,
                         1,
                         0,
...
static void MakeAddModeCursor(XmTextFieldWidget tf, int line_width)
{
  ...
  if (tf->text.add_mode_cursor == XmUNSPECIFIED_PIXMAP) {
    ...
    XGCValues values;
    Display *dpy = XtDisplay(tf);
    tf->text.add_mode_cursor = XCreatePixmap(
        dpy, XtWindow(tf), tf->text.cursor_width, tf->text.cursor_height, 1);
    values.function = GXcopy;
    ...
    XCopyArea(dpy,
              ...
              0,
              0);
    valueMask = (GCForeground | GCBackground | GCTile | GCFillStyle | GCFunction |
                 GCTileStipXOrigin);
...
static void MakeCursors(XmTextFieldWidget tf)
{
  ...
  if (tf->text.cursor == XmUNSPECIFIED_PIXMAP ||
      tf->text.add_mode_cursor == XmUNSPECIFIED_PIXMAP ||
      tf->text.ibeam_off == XmUNSPECIFIED_PIXMAP || oldheight != tf->text.cursor_height ||
      oldwidth != tf->text.cursor_width)
  {
    ...
    MakeIBeamOffArea(
        tf, MAX(tf->text.cursor_height >> 1, tf->text.cursor_height), tf->text.cursor_height);
...
static void Resize(Widget w)
{
  ...
  tf->text.h_offset = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                      tf->primitive.highlight_thickness;
#else
  new_width = tf->core.width - (2 * (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                                     tf->primitive.highlight_thickness));
  offset = tf->text.h_offset - (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                                tf->primitive.highlight_thickness);
  if (tf->text.max_char_size != 1)
                                      ...
                                      XtWidgetGeometry *desired)
{
  ...
  ComputeSize((XmTextFieldWidget)widget, &desired->width, &desired->height);
...
static void TextFieldExpose(Widget w, XEvent *event, Region region)
{
  ...
  if (XtIsRealized((Widget)tf)) {
    ...
    if (tf->primitive.highlighted) {
      if (((XmTextFieldWidgetClass)XtClass(tf))->primitive_class.border_highlight) {
        (*((XmTextFieldWidgetClass)XtClass(tf))->primitive_class.border_highlight)((Widget)tf);
      }
    }
    else {
      if (((XmTextFieldWidgetClass)XtClass(tf))->primitive_class.border_unhighlight) {
    ...
    Widget old, Widget request, Widget new_w, ArgList args, Cardinal *num_args)
{
  ...
  if (TextF_CursorPosition(new_tf) != TextF_CursorPosition(old_tf)) {
    ...
    (void)SetDestination(
        new_w, TextF_CursorPosition(new_tf), False, XtLastTimestampProcessed(XtDisplay(new_w)));
    cursor_pos_set = True;
  }
  else {
    int ix;
  ...
  if (!XtIsSensitive(new_w) && new_tf->text.has_destination) {
    (void)SetDestination(
        new_w, TextF_CursorPosition(new_tf), True, XtLastTimestampProcessed(XtDisplay(new_w)));
  }
  ...
  if (diff_values) { /* old value != new value */
    ...
    if (TextF_ModifyVerifyCallback(new_tf) || TextF_ModifyVerifyCallbackWcs(new_tf)) {
      ...
      if (new_tf->text.max_char_size == 1) {
        ...
        mod_ver_ret = ModifyVerify(new_tf,
                                   NULL,
                                   &fromPos,
                                   &toPos,
                                   &temp,
        ...
        mod_ver_ret = ModifyVerify(
            new_tf, NULL, &fromPos, &toPos, &temp, &ret_val, &newInsert, &free_insert);
        if (old_s != temp)
          XtFree(old_s);
      }
      if (free_insert)
      ...
      if (!mod_ver_ret) {
        if (new_tf->text.verify_bell)
          XBell(XtDisplay(new_w), 0);
        if (new_tf->text.max_char_size == 1) {
          TextF_Value(new_tf) = (char *)memcpy(
              XtRealloc(TextF_Value(new_tf), (unsigned)old_tf->text.size_allocd),
          ...
          TextF_WcValue(new_tf) = (wchar_t *)memcpy(
              XtRealloc((char *)TextF_WcValue(new_tf), (unsigned)old_tf->text.size_allocd),
    ...
    if (do_it) {
      ...
      if (new_tf->text.max_char_size == 1)
        ...
        XtFree((char *)TextF_WcValue(old_tf));
      doSetHighlight(
          new_w, new_tf->text.prim_pos_left, new_tf->text.prim_pos_right, XmHIGHLIGHT_NORMAL);
      ...
      if (!cursor_pos_set || new_position > old_tf->text.string_length) {
        ...
        if (new_tf->text.has_destination)
          (void)SetDestination(new_w,
                               TextF_CursorPosition(new_tf),
                               False,
  ...
  new_size = TextF_MarginWidth(new_tf) != TextF_MarginWidth(old_tf) ||
             ...
             TextF_FontList(new_tf) != TextF_FontList(old_tf) ||
             new_tf->primitive.highlight_thickness != old_tf->primitive.highlight_thickness ||
             new_tf->primitive.shadow_thickness != old_tf->primitive.shadow_thickness;
  ...
  if (XtIsSensitive((Widget)new_tf) != XtIsSensitive((Widget)old_tf)) {
    ...
    if (new_tf->text.string_length > 0)
      redisplay = True;
  }
  ...
  if (!redisplay)
    redisplay = new_tf->text.redisplay;
  ...
  if (new_tf->core.width == 0)
    new_tf->core.width = old_tf->core.width;
  if (new_tf->core.height == 0)
    new_tf->core.height = old_tf->core.height;
...
{
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  Position margin_width = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness +
                          tf->primitive.highlight_thickness;
  Position margin_top = tf->text.margin_top + tf->primitive.shadow_thickness +
                        tf->primitive.highlight_thickness;
  Position margin_bottom = tf->text.margin_bottom + tf->primitive.shadow_thickness +
                           tf->primitive.highlight_thickness;
 ...
 */
static Boolean _XmTextFieldReplaceTextForPreedit(XmTextFieldWidget tf,
                                                 XmTextPosition replace_prev,
                                                 XmTextPosition replace_next,
                                                 char *insert,
                                                 int insert_length,
 ...
 */
static XmHighlightMode _XimFeedbackToXmHighlightMode(XIMFeedback fb)
{
  switch (fb) {
    case XIMReverse:
 ...
 */
static void PreeditSetRendition(Widget w, XIMPreeditDrawCallbackStruct *data)
{
...
static int PreeditStart(XIC xic, XPointer client_data, XPointer call_data)
{
  ...
  if (NeedsPendingDeleteDisjoint(tf)) {
    ...
    pending_delete = True;
    tf->text.prim_anchor = TextF_CursorPosition(tf);
    replace_res = _XmTextFieldReplaceText(tf, NULL, cursorPos, nextPos, NULL, 0, True);
    if (replace_res) {
      if (pending_delete)
      ...
      CheckDisjointSelection(
          w, TextF_CursorPosition(tf), XtLastTimestampProcessed(XtDisplay((Widget)tf)));
...
static void PreeditDone(XIC xic, XPointer client_data, XPointer call_data)
{
  ...
  if (tf->text.overstrike) {
    if (need_verify) {
      ...
      _XmTextFieldDrawInsertionPoint(tf, False);
      (void)_XmTextFieldReplaceTextForPreedit(tf,
                                              PreStart(tf),
                                              PreStart(tf),
                                              (char *)tf->text.onthespot->over_str,
                                              tf->text.onthespot->over_maxlen,
...
static void PreeditDraw(XIC xic, XPointer client_data, XIMPreeditDrawCallbackStruct *call_data)
{
  ...
  if (call_data->text) {
    if ((call_data->text->encoding_is_wchar && !call_data->text->string.wide_char) ||
        (!call_data->text->encoding_is_wchar && !call_data->text->string.multi_byte))
    {
  ...
  if (tf->text.overstrike) {
    ...
    if (tf->text.onthespot->over_maxlen < tmp_end - PreStart(tf)) {
      ...
      endPos = startPos + call_data->chg_length;
    rest_len = (XmTextPosition)(PreEnd(tf) - PreStart(tf) - call_data->chg_first -
...
int XmTextFieldGetSubstringWcs(
    Widget widget, XmTextPosition start, int num_chars, int buf_size, wchar_t *buffer)
{
  XmTextFieldWidget tf = (XmTextFieldWidget)widget;
  int ret_value = XmCOPY_SUCCEEDED;
  int num_wcs = 0;
  ...
  if (num_chars > 0) {
    if (tf->text.max_char_size == 1) {
      ...
      memcpy(
          (void *)buffer, (void *)&TextF_WcValue(tf)[start], (size_t)num_chars * sizeof(wchar_t));
    }
    buffer[num_chars] = '\0';
  }
  else if (num_chars == 0) {
...
void XmTextFieldSetString(Widget w, char *value)
{
  ...
  if (tf->text.max_char_size == 1)
    ...
    for (length = 0, tmp_ptr = value, ret_val = mblen(tmp_ptr, MB_CUR_MAX); ret_val > 0;
  ...
  if (TextF_ModifyVerifyCallback(tf) || TextF_ModifyVerifyCallbackWcs(tf)) {
    ...
    if (tf->text.max_char_size == 1) {
      ...
      if (!ModifyVerify(
              tf, NULL, &fromPos, &toPos, (char **)&wbuf, &length, &newInsert, &free_insert))
      {
        if (tf->text.verify_bell)
          XBell(XtDisplay(w), 0);
        if (free_insert)
    ...
    Widget w, XmTextPosition from_pos, XmTextPosition to_pos, char *value, int is_wc)
{
  ...
  if (tf->text.has_primary) {
    if ((tf->text.prim_pos_left > from_pos && tf->text.prim_pos_left < to_pos) ||
        (tf->text.prim_pos_right > from_pos && tf->text.prim_pos_right < to_pos) ||
        (tf->text.prim_pos_left <= from_pos && tf->text.prim_pos_right >= to_pos))
    {
  ...
  if (is_wc) {
    ...
    if (tf->text.max_char_size != 1) {
      ...
      rep_result = _XmTextFieldReplaceText(
          tf, NULL, from_pos, to_pos, (char *)value, length, False);
      XtFree(value);
    }
  }
  else {
...
void XmTextFieldReplaceWcs(Widget w,
...
void XmTextFieldSetAddMode(Widget w, Boolean state)
{
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  _XmWidgetToAppContext(w);
  _XmAppLock(app);
...
Boolean XmTextFieldCopyLink(Widget w, Time clip_time)
{
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  Boolean ret_val;
  _XmWidgetToAppContext(w);
...
XmTextPosition XmTextFieldXYToPos(Widget w, Position x, Position y)
{
  XmTextFieldWidget tf = (XmTextFieldWidget)w;
  XmTextPosition ret_val;
  _XmWidgetToAppContext(w);
...
void XmTextFieldSetHighlight(Widget w,
                             XmTextPosition left,
                             XmTextPosition right,
                             XmHighlightMode mode)
{
...
int XmTextFieldGetBaseline(Widget w)
{
  ...
  _XmWidgetToAppContext(w);
  _XmAppLock(app);
  margin_top = tf->text.margin_top + tf->primitive.shadow_thickness +
               tf->primitive.highlight_thickness;
...
Widget XmVaCreateTextField(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmTextFieldWidgetClass, parent, False, var, count);
  va_end(var);
  return w;
}
...
Widget XmVaCreateManagedTextField(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmTextFieldWidgetClass, parent, True, var, count);
  va_end(var);
  return w;
}
