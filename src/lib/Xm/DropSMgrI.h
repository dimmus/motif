...
extern void _XmDSMUpdate(XmDropSiteManagerObject dsm, XtPointer clientData, XtPointer callData);
extern int _XmDSMGetTreeFromDSM(XmDropSiteManagerObject dsm, Widget shell, XtPointer dataPtr);
...
#define GetDSType(ds) ((((XmDSStatus)(ds))->type) ? XmDROP_SITE_COMPOSITE : XmDROP_SITE_SIMPLE)
...
#define GetDSActivity(ds) \
  ((((XmDSStatus)(ds))->activity) ? XmDROP_SITE_ACTIVE : XmDROP_SITE_INACTIVE)
#define GetDSImportTargetsID(ds) (((XmDSLocalNoneLeaf)(ds))->info.import_targets_ID)
#define GetDSOperations(ds) (((XmDSLocalNoneLeaf)(ds))->info.operations)
#define GetDSRegion(ds) (((XmDSLocalNoneLeaf)(ds))->info.region)
#define GetDSParent(ds) ((GetDSShell(ds)) ? NULL : (((XmDSLocalNoneLeaf)(ds))->info.parent))
#define GetDSUpdateLevel(ds) \
  ((GetDSShell(ds)) ? ((long)(((XmDSLocalNoneNode)(ds))->info.parent)) : -1)
#define GetDSDragProc(ds) \
  ((GetDSRemote(ds)) ? (XtCallbackProc)NULL : \
                       ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.drag_proc) : \
                                          (((XmDSLocalNoneLeaf)(ds))->info.drag_proc)))
#define GetDSDropProc(ds) \
  ((GetDSRemote(ds)) ? (XtCallbackProc)NULL : \
                       ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.drop_proc) : \
                                          (((XmDSLocalNoneLeaf)(ds))->info.drop_proc)))
#define GetDSClientData(ds) \
  ((GetDSRemote(ds)) ? NULL : \
                       ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.client_data) : \
                                          (((XmDSLocalNoneLeaf)(ds))->info.client_data)))
#define GetDSWidget(ds) \
  ((GetDSRemote(ds)) ? (Widget)NULL : \
                       ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.widget) : \
                                          (((XmDSLocalNoneLeaf)(ds))->info.widget)))
#define GetDSNumChildren(ds) ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.num_children) : 0)
#define GetDSMaxChildren(ds) ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.max_children) : 0)
#define GetDSChildren(ds) \
  ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.children) : (XtPointer *)NULL)
#define GetDSChild(ds, position) \
  ((GetDSType(ds)) ? (((XmDSLocalNoneNode)(ds))->info.children[position]) : NULL)
#define GetDSLocalAnimationPart(ds) \
  ((GetDSType(ds)) ? ((GetDSAnimationStyle(ds) == XmDRAG_UNDER_PIXMAP) ? \
...
#define GetDSRemoteAnimationPart(ds) \
  ((GetDSType(ds)) ? &(((XmDSRemoteNoneNode)(ds))->animation_data) : \
                     &(((XmDSRemoteNoneLeaf)(ds))->animation_data))
#define SetDSRemote(ds, newRemote) (((XmDSStatus)(ds))->remote) = (unsigned int)(newRemote)
#define SetDSLeaf(ds, newLeaf) (((XmDSStatus)(ds))->leaf) = (unsigned int)(newLeaf)
#define SetDSShell(ds, newShell) (((XmDSStatus)(ds))->shell) = (unsigned int)(newShell)
#define SetDSAnimationStyle(ds, newAnimationStyle) \
  (((XmDSStatus)(ds))->animation_style) = (unsigned int)(newAnimationStyle)
#define SetDSType(ds, newType) \
  (((XmDSStatus)(ds))->type) = (((newType) == XmDROP_SITE_COMPOSITE) ? 1 : 0)
#define SetDSRegistered(ds, newRegistered) \
  (((XmDSStatus)(ds))->registered) = (unsigned int)(newRegistered)
#define SetDSInternal(ds, newInternal) (((XmDSStatus)(ds))->internal) = (unsigned int)(newInternal)
...
#define SetDSActivity(ds, newActivity) \
  (((XmDSStatus)(ds))->activity) = (((newActivity) == XmDROP_SITE_ACTIVE) ? 1 : 0)
#define SetDSImportTargetsID(ds, newImportTargetsID) \
  (((XmDSLocalNoneLeaf)(ds))->info.import_targets_ID) = (unsigned short)(newImportTargetsID)
#define SetDSOperations(ds, newOperations) \
  (((XmDSLocalNoneLeaf)(ds))->info.operations) = (unsigned char)(newOperations)
#define SetDSRegion(ds, newRegion) (((XmDSLocalNoneLeaf)(ds))->info.region) = (XmRegion)(newRegion)
#define SetDSParent(ds, newParent) \
  ((GetDSShell(ds)) ? NULL : ((((XmDSLocalNoneLeaf)(ds))->info.parent) = (XtPointer)(newParent)))
#define SetDSUpdateLevel(ds, newUpdateLevel) \
  ((GetDSShell(ds)) ? ((((XmDSLocalNoneNode)(ds))->info.parent) = (XtPointer)(newUpdateLevel)) : 0)
#define SetDSDragProc(ds, newDragProc) \
  ((GetDSRemote(ds)) ? \
       (XtCallbackProc)NULL : \
       ((GetDSType(ds)) ? \
            ((((XmDSLocalNoneNode)(ds))->info.drag_proc) = (XtCallbackProc)(newDragProc)) : \
            ((((XmDSLocalNoneLeaf)(ds))->info.drag_proc) = (XtCallbackProc)(newDragProc))))
#define SetDSDropProc(ds, newDropProc) \
  ((GetDSRemote(ds)) ? \
       (XtCallbackProc)NULL : \
       ((GetDSType(ds)) ? \
            ((((XmDSLocalNoneNode)(ds))->info.drop_proc) = (XtCallbackProc)(newDropProc)) : \
            ((((XmDSLocalNoneLeaf)(ds))->info.drop_proc) = (XtCallbackProc)(newDropProc))))
#define SetDSClientData(ds, clientData) \
  ((GetDSRemote(ds)) ? \
       NULL : \
       ((GetDSType(ds)) ? \
            ((((XmDSLocalNoneNode)(ds))->info.client_data) = (XtPointer)(clientData)) : \
            ((((XmDSLocalNoneLeaf)(ds))->info.client_data) = (XtPointer)(clientData))))
#define SetDSWidget(ds, newWidget) \
  ((GetDSRemote(ds)) ? \
       (Widget)NULL : \
       ((GetDSType(ds)) ? (((((XmDSLocalNoneNode)(ds))->info.widget) = (Widget)(newWidget))) : \
                          (((((XmDSLocalNoneLeaf)(ds))->info.widget) = (Widget)(newWidget)))))
#define SetDSNumChildren(ds, newNumChildren) \
  ((GetDSType(ds)) ? \
       ((((XmDSLocalNoneNode)(ds))->info.num_children) = (unsigned short)(newNumChildren)) : \
       0)
#define SetDSMaxChildren(ds, newMaxChildren) \
  ((GetDSType(ds)) ? \
       ((((XmDSLocalNoneNode)(ds))->info.max_children) = (unsigned short)(newMaxChildren)) : \
       0)
#define SetDSChildren(ds, newChildren) \
  ((GetDSType(ds)) ? ((((XmDSLocalNoneNode)(ds))->info.children) = (XtPointer *)(newChildren)) : \
                     (XtPointer *)NULL)
/********    Private Function Declarations    ********/
extern void _XmDSIAddChild(XmDSInfo parentInfo, XmDSInfo childInfo, Cardinal childPosition);
...
extern void _XmDSIReplaceChild(XmDSInfo oldChildInfo, XmDSInfo newChildInfo);
extern void _XmDSISwapChildren(XmDSInfo parentInfo, Cardinal position1, Cardinal position2);
extern void _XmDSIDestroy(XmDSInfo info, Boolean substructures);
extern Dimension _XmDSIGetBorderWidth(XmDSInfo info);
/********    End Private Function Declarations    ********/
