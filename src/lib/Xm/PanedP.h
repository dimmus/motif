...
#  define XmPanedC_allow_resize(w) \
    (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.allow_resize)
#  define XmPanedC_show_sash(w) (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.show_sash)
#  define XmPanedC_skip_adjust(w) \
    (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.skip_adjust)
#  define XmPanedC_position(w) (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.position)
#  define XmPanedC_preferred_size(w) \
    (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.preferred_size)
#  define XmPanedC_resize_to_pref(w) \
    (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.resize_to_pref)
...
#  define XmPanedC_wp_off_size(w) \
    (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.wp_off_size)
...
#  define XmPanedC_prefs_inited(w) \
    (((XmPanedConstraintsRec *)(w)->core.constraints)->paned.prefs_inited)
...
#  define IsLastPane(pw, childP) \
    ((XmPaned_managed_children((pw)) + XmPaned_num_panes((pw)) - 1) == childP)
