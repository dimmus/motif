...
#include <Xm/TransltnsP.h>
    ...
    static void
    HeightDefault(Widget widget, int offset, XrmValue *value);
static void GetSeparatorGC(XmTearOffButtonWidget tob);
...
static XtResource resources[] = {
    {XmNseparatorType,
     ...
     XmRImmediate,
     (XtPointer)XmSHADOW_ETCHED_OUT_DASH},
    {XmNmargin,
     XmCMargin,
...
externaldef(xmtearoffbuttonclassrec) XmTearOffButtonClassRec xmTearOffButtonClassRec = {
    {
        /* core_class record */
 ...
 *********************************************************************/
/*ARGSUSED*/
static void HeightDefault(Widget widget,
                          int offset, /* unused */
                          XrmValue *value)
{
...
static void ClassInitialize(void)
{
  xmTearOffButtonClassRec.tearoffbutton_class.translations = (String)XtParseTranslationTable(
                       ...
                       Cardinal *num_args) /* unused */
{
  ...
  _XmProcessLock();
  trans =
      (XtTranslations)((XmTearOffButtonClassRec *)XtClass(nw))->tearoffbutton_class.translations;
  _XmProcessUnlock();
  XtOverrideTranslations(nw, trans);
  if (!XmRepTypeValidValue(
          XmRID_SEPARATOR_TYPE, new_w->tear_off_button.separator_type, (Widget)new_w))
  {
...
static void Redisplay(Widget wid, XEvent *event, Region region)
{
  ...
  if (XtIsRealized((Widget)tob)) {
    XtExposeProc expose;
    XmeDrawSeparator(XtDisplay(tob),
                     XtWindow(tob),
...
{
  XtReleaseGC(wid, ((XmTearOffButtonWidget)wid)->tear_off_button.separator_GC);
}
                         ...
                         Cardinal *num_args) /* unused */
{
  ...
  if ((new_w->core.background_pixel != current->core.background_pixel) ||
      (new_w->tear_off_button.separator_type != current->tear_off_button.separator_type) ||
 ...
 ************************************************************************/
/*ARGSUSED*/
static void BActivate(Widget wid,
                      XEvent *event,
                      String *param,       /* unused */
                      Cardinal *num_param) /* unused */
{
 ...
 ************************************************************************/
/*ARGSUSED*/
static void KActivate(Widget wid,
                      XEvent *event,
                      String *param,       /* unused */
                      Cardinal *num_param) /* unused */
{
