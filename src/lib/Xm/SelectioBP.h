...
#  define SB_StringDirection(w) \
    (XmDirectionToStringDirection(((XmSelectionBoxWidget)(w))->manager.string_direction))
#  define SB_AddingSelWidgets(w) (((XmSelectionBoxWidget)w)->selection_box.adding_sel_widgets)
#  define SB_TextAccelerators(w) (((XmSelectionBoxWidget)w)->selection_box.text_accelerators)
#  define SB_ListItemCount(w) (((XmSelectionBoxWidget)w)->selection_box.list_item_count)
...
#  define SB_TextColumns(w) (((XmSelectionBoxWidget)w)->selection_box.text_columns)
#  define SB_MinimizeButtons(w) (((XmSelectionBoxWidget)w)->selection_box.minimize_buttons)
