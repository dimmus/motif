...
#define XmIconButton_double_click_callback(w) \
  (((XmIconButtonWidget)(w))->icon.double_click_callback)
...
#endif
void _XmPrimitiveEnter(Widget wid, XEvent *event, String *params, Cardinal *num_params);
void _XmPrimitiveLeave(Widget wid, XEvent *event, String *params, Cardinal *num_params);
