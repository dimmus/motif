...
#define FILL_SPACE(iw) ((iw)->primitive.highlight_thickness + (iw)->primitive.shadow_thickness)
...
static XtResource resources[] = {{XmNlabel,
                                  XmCLabel,
                                  XmRString,
                                  sizeof(String),
                                  XtOffsetOf(XmIconButtonRec, icon.label),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNlabelString,
                                  XmCLabelString,
                                 ...
                                 {XmNpixmap,
                                  ...
                                  sizeof(Pixmap),
                                  XtOffsetOf(XmIconButtonRec, icon.pixmap),
                                  XmRImmediate,
                                 ...
                                 {"pri.vate",
                                  ...
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmIconButtonRec, icon.check_set_render_table),
                                  XmRImmediate,
                                  (XtPointer)False},
                                 {XmNfontList,
                                  XmCFontList,
                                  XmRFontList,
                                  sizeof(XmFontList),
                                  XtOffsetOf(XmIconButtonRec, icon.font_list),
                                  XmRCallProc,
                                 ...
                                 {XmNalignment,
                                  ...
                                  XtOffsetOf(XmIconButtonRec, icon.alignment),
                                  XmRImmediate,
                                 ...
                                 {XmNstringDirection,
                                  ...
                                  XmRStringDirection,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmIconButtonRec, icon.string_direction),
                                  XmRImmediate,
                                  (XtPointer)XmDEFAULT_DIRECTION},
                                 {XmNiconPlacement,
                                  XmCIconPlacement,
                                  XmRXmIconPlacement,
                                  sizeof(XmIconPlacement),
                                  XtOffsetOf(XmIconButtonRec, icon.icon_placement),
                                  XmRImmediate,
                                  (XtPointer)XmIconTop},
                                 {XmNrecomputeSize,
                                  XmCBoolean,
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmIconButtonRec, icon.recompute),
                                  XmRImmediate,
                                  (XtPointer)True},
                                 {XmNarmColor,
                                  XmCArmColor,
                                  XmRPixel,
                                  sizeof(Pixel),
                                  XtOffsetOf(XmIconButtonRec, icon.arm_color),
                                  XmRCallProc,
                                 ...
                                 {XmNset,
                                  ...
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmIconButtonRec, icon.set),
                                  XmRImmediate,
                                  (XtPointer)False},
                                 {XmNverticalMargin,
                                  XmCSpace,
                                 ...
                                 {XmNactivateCallback,
                                  ...
                                  XtOffsetOf(XmIconButtonRec, icon.activate_callback),
                                  XmRPointer,
                                  (XtPointer)NULL},
                                 {XmNdoubleClickCallback,
                                  ...
                                  XmRCallback,
                                  sizeof(XtCallbackList),
                                  XtOffsetOf(XmIconButtonRec, icon.double_click_callback),
                                  XmRPointer,
                                  (XtPointer)NULL},
                                 {XmNpixmapWidth,
                                  XmCDimension,
                                  XmRDimension,
                                  sizeof(Dimension),
                                  XtOffsetOf(XmIconButtonRec, icon.pix_width),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNpixmapHeight,
                                  XmCDimension,
                                  XmRDimension,
                                  sizeof(Dimension),
                                  XtOffsetOf(XmIconButtonRec, icon.pix_height),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNpixmapDepth,
                                  XmCDimension,
                                  XmRDimension,
                                  sizeof(Dimension),
                                  XtOffsetOf(XmIconButtonRec, icon.pix_depth),
                                  XmRImmediate,
                                  (XtPointer)0}};
...
static void Initialize(Widget req, Widget set, ArgList args, Cardinal *num_args)
{
  ...
  if (ValidPixmap(XmIconButton_pixmap(iw))) {
    ...
    if ((0 != XmIconButton_pix_width(iw)) && (0 != XmIconButton_pix_height(iw)) &&
  ...
  if (resetPixmapValues) {
    ...
    AddPixCache(XtDisplay(set),
                XmIconButton_pixmap(iw),
  ...
  if (XmPrim_layout_direction(iw) != XmDEFAULT_DIRECTION) {
    if (XmIconButton_string_direction(iw) == XmDEFAULT_DIRECTION)
      XmIconButton_string_direction(iw) = XmDirectionToStringDirection(
  ...
  if (!XmRepTypeValidValue(XmRID_STRING_DIRECTION, XmIconButton_string_direction(iw), (Widget)iw))
  {
    XmIconButton_string_direction(iw) = XmSTRING_DIRECTION_L_TO_R;
    XmPrim_layout_direction(iw) = XmStringDirectionToDirection(XmIconButton_string_direction(iw));
  }
  if (XmIconButton_font_list(iw) == NULL) {
    XmIconButton_font_list(iw) = XmeGetDefaultRenderTable((Widget)iw, XmBUTTON_FONTLIST);
  }
 ...
 */
/* ARGSUSED */
static void SetValuesAlmost(Widget old,
                            Widget set,
    ...
    Widget current, Widget request, Widget set, ArgList args, Cardinal *num_args)
{
  ...
  if (pixmapGeoChanged) {
    /* here's what we enforce: all must be non-zero */
    if (!((0 != XmIconButton_pix_width(set_iw)) && (0 != XmIconButton_pix_height(set_iw)) &&
  ...
  if (XmIconButton_font_list(old_iw) != XmIconButton_font_list(set_iw)) {
    ...
    if (XmIconButton_font_list(set_iw) == NULL) {
      XmIconButton_font_list(set_iw) = XmeGetDefaultRenderTable(set, XmBUTTON_FONTLIST);
    }
    ...
    if (reinit_ls) {
      if (XmIconButton_label_string(set_iw) == NULL) {
        if (XmIconButton_label(set_iw) == NULL) {
          ...
          if ((XmIconButton_label_string(set_iw) = CreateXmString(
                   set, XmIconButton_label(set_iw))) == NULL)
          {
            XmIconButton_label_string(set_iw) = CreateXmString(set, XtName(set));
            XmIconButton_label_from_name(set_iw) = True;
          }
...
static void Destroy(Widget w)
{
  ...
  if (XmIconButton_font_list(iw) != NULL)
    XmFontListFree(XmIconButton_font_list(iw));
  DestroyGCs(w);
 ...
 */
/*ARGSUSED*/
static void ToggleState(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XmIconButtonWidget iw = (XmIconButtonWidget)w;
  Arg args[1];
 ...
 */
/*ARGSUSED*/
static void DoubleNotify(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XmIconButtonWidget iw = (XmIconButtonWidget)w;
...
static void ArmAndActivate(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  XmIconButton_unset_timer(iw) = XtAppAddTimeOut(
      XtWidgetToApplicationContext(w), (unsigned long)DELAY, Deactivate, (XtPointer)w);
 ...
 */
/* ARGSUSED */
static void Deactivate(XtPointer data, XtIntervalId *timer)
{
  Arg args[1];
 ...
 *	Returns:       none.
 */
static void GetDesiredSize(Widget w, Dimension *width, Dimension *height)
{
  XmIconButtonWidget iw = (XmIconButtonWidget)w;
  Dimension total_width, total_height;
  XmStringExtent(
      XmIconButton_font_list(iw), XmIconButton_label_string(iw), &total_width, &total_height);
  if ((XmIconButton_icon_placement(iw) != XmIconNone) && ValidPixmap(XmIconButton_pixmap(iw))) {
    ...
    {
      if (!CheckPixCache(
              XtDisplay(w), XmIconButton_pixmap(iw), &local_width, &local_height, &depth))
      {
 ...
 *	Returns:       none.
 */
static void RequestNewSize(Widget w, Dimension width, Dimension height)
{
...
static void CalcLocations(Widget w)
{
    ...
    switch (XmIconButton_icon_placement(iw)) {
      ...
      case XmIconBottom: /* Centered at the bottom */
        XmIconButton_pix_y(iw) = ((Position)height -
                                  ((Position)V_SPACE(iw) + (Position)extra_y_space +
  ...
  if (XmIconButton_icon_placement(iw) != XmIconOnly) {
     ...
     */
    XmStringExtent(
        XmIconButton_font_list(iw), XmIconButton_label_string(iw), &text_width, &text_height);
    ...
    switch (XmIconButton_icon_placement(iw)) {
      ...
      case XmIconRight: /* Aligned to left of Icon. */
        if (have_pixmap) {
          XmIconButton_text_x(iw) = H_SPACE(iw);
          if ((tmp = XmIconButton_pix_x(iw) - XmIconButton_text_x(iw)) < 0)
            tmp = 0;
          XmIconButton_max_text_width(iw) = tmp;
        }
        break;
 ...
 *	Returns:       none.
 */
static void DrawTextAndImage(Widget w, GC text_gc, GC icon_gc, GC icon_stippled_gc)
{
  XmIconButtonWidget iw = (XmIconButtonWidget)w;
  if (XmIconButton_icon_placement(iw) != XmIconNone && ValidPixmap(XmIconButton_pixmap(iw))) {
    if (XmIconButton_pix_depth(iw) == 1) {
      XCopyPlane(XtDisplay(w),
                 ...
                 XmIconButton_pix_width(iw),
                 XmIconButton_pix_height(iw),
                 XmIconButton_pix_x(iw),
                 XmIconButton_pix_y(iw),
                 1L);
    }
    else {
  ...
  if (XmIconButton_icon_placement(iw) != XmIconOnly) {
    ...
    if ((int)clip.x < (int)H_SPACE(iw))
      clip.x = H_SPACE(iw);
    if ((int)clip.y < (int)V_SPACE(iw))
      clip.y = V_SPACE(iw);
    ...
    if (clip.width != 0 && clip.height != 0) {
      ...
      if (!XtIsSensitive(w)) {
        XmStringDraw(XtDisplay(w),
                     XtWindow(w),
                     XmIconButton_font_list(iw),
                     XmIconButton_label_string(iw),
                     XmIconButton_shadow_gc(iw),
                     XmIconButton_text_x(iw) + 1,
                     XmIconButton_text_y(iw) + 1,
                     XmIconButton_max_text_width(iw),
                     XmIconButton_alignment(iw),
                     XmPrim_layout_direction(iw),
                     NULL);
      }
      XmStringDraw(XtDisplay(w),
 ...
 */
static XmString CreateXmString(Widget w, String str)
{
 ...
 */
Widget XmCreateIconButton(Widget parent, String name, ArgList args, Cardinal num_args)
{
