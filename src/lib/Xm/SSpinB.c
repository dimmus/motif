...
static Widget GetCallbackWidget(Widget widget);
...
externaldef(xmspinboxclassrec) XmSimpleSpinBoxClassRec xmSimpleSpinBoxClassRec = {
    ...
    },
    {
        ...
        (Cardinal)sizeof(XmSimpleSpinBoxConstraintRec), /* constraint_size */
    ...
    {
        (XmGetCallbackWidgetProc)GetCallbackWidget, /* get_callback_widget */
        (XtPointer)NULL,                            /* extension */
    },
...
externaldef(xmsimplespinboxwidgetclass)
    WidgetClass xmSimpleSpinBoxWidgetClass = (WidgetClass)&xmSimpleSpinBoxClassRec;
...
#define SSB_SIMPLE_SPIN_BOX_PART(w) (&((XmSimpleSpinBoxWidget)(w))->simpleSpinBox)
                       ...
                       Cardinal *n_user_args) /* unused */
{
  ...
  nargs++;
  ssb_p->text_field = XtCreateManagedWidget(
      widget_name, xmTextFieldWidgetClass, (Widget)new, args, nargs);
  ...
  XtVaGetValues(
      ssb_p->text_field, XmNeditable, &ssb_p->editable, XmNcolumns, &ssb_p->columns, NULL);
  XtFree(widget_name);
}
...
static void SyntheticGetValue(Widget widget, int offset, XtArgVal *value)
{
  ...
  switch (offset) {
    ...
    case Offset(wrap):
      ...
      break;
    default:
      fprintf(stderr, "SimpleSpinBox ERROR:  Invalid synthetic resource offset  %d\n", offset);
  }
}
 ...
 ************************************************************************/
Widget XmCreateSimpleSpinBox(Widget parent, String name, ArgList arglist, Cardinal argcount)
{
...
Widget XmVaCreateSimpleSpinBox(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmSimpleSpinBoxWidgetClass, parent, False, var, count);
  va_end(var);
  return w;
}
...
Widget XmVaCreateManagedSimpleSpinBox(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmSimpleSpinBoxWidgetClass, parent, True, var, count);
  va_end(var);
  return w;
}
 ...
 ************************************************************************/
void XmSimpleSpinBoxAddItem(Widget ssb_w, XmString item, int pos)
{
 ...
 ************************************************************************/
void XmSimpleSpinBoxDeletePos(Widget ssb_w, int pos)
{
  XmSimpleSpinBoxPart *ssb_p = SSB_SIMPLE_SPIN_BOX_PART(ssb_w);
  XmSpinBoxConstraint textf_c;
  int i, skipped;
 ...
 *	or label.
 ************************************************************************/
void XmSimpleSpinBoxSetItem(Widget ssb_w, XmString item)
{
  XmSimpleSpinBoxPart *ssb_p = SSB_SIMPLE_SPIN_BOX_PART(ssb_w);
  XmSpinBoxConstraint textf_c;
  int pos;
