...
#define LINEHEIGHTS(lw, lines) ((lines) * ((lw)->list.MaxItemHeight + (lw)->list.spacing))
...
static XtGeometryResult QueryProc(Widget wid, XtWidgetGeometry *request, XtWidgetGeometry *ret);
...
static XmImportOperator CvtToInternalPos(Widget wid, int offset, XtArgVal *value);
...
static int DeleteInternalElements(XmListWidget lw, XmString string, int position, int count);
static int DeleteInternalElementPositions(XmListWidget lw,
                                          int *position_list,
                                          int position_count,
                                          int oldItemCount);
static int ReplaceInternalElement(XmListWidget lw, int position, Boolean selectable);
...
static void VerifyMotion(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void SelectElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdSelectElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void UnSelectElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdUnSelectElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ExSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ExUnSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void CtrlBtnSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void CtrlSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void CtrlUnSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdShiftSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdShiftUnSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdCtrlSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdCtrlUnSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdActivate(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdCancel(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdToggleAddMode(Widget wid, XEvent *event, String *params, Cardinal *num_params);
...
static void ClickElement(XmListWidget lw, XEvent *event, Boolean default_action);
static void ListFocusIn(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ListFocusOut(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void BrowseScroll(XtPointer closure, XtIntervalId *id);
static void ListLeave(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ListEnter(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void MakeItemVisible(XmListWidget lw, int item);
static void PrevElement(XmListWidget lw, XEvent *event, String *params, Cardinal *num_params);
static void NextElement(XmListWidget lw, XEvent *event, String *params, Cardinal *num_params);
static void NormalNextElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ShiftNextElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void CtrlNextElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ExtendAddNextElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void NormalPrevElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ShiftPrevElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void CtrlPrevElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ExtendAddPrevElement(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdPrevPage(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdNextPage(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdLeftChar(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdLeftPage(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void BeginLine(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdRightChar(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void KbdRightPage(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void EndLine(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void TopItem(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void EndItem(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ExtendTopItem(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ExtendEndItem(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ListItemVisible(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ListCopyToClipboard(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void DragDropFinished(Widget w, XtPointer closure, XtPointer call_data);
static void ListProcessDrag(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void DragStart(XtPointer closure, XtIntervalId *id);
static void ListProcessBtn1(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ListProcessBtn2(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ListQuickNavigate(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static wchar_t FirstChar(XmString string);
static Boolean CompareCharAndItem(XmListWidget lw, wchar_t input_char, int pos);
...
static void APIAddItems(XmListWidget lw, XmString *items, int item_count, int pos, Boolean select);
...
static void APIReplaceItemsPos(
    Widget w, XmString *new_items, int item_count, int position, Boolean select);
static void APISelect(XmListWidget lw, int item_pos, Boolean notify);
static void APIDeletePositions(XmListWidget lw, int *positions, int count, Boolean track_kbd);
static void SetSelectionParams(XmListWidget lw);
static void GetPreeditPosition(XmListWidget lw, XPoint *xmim_point);
static void ScrollBarDisplayPolicyDefault(Widget widget, int offset, XrmValue *value);
static void ListScrollUp(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ListScrollDown(Widget wid, XEvent *event, String *params, Cardinal *num_params);
 ...
 * 									*
 ************************************************************************/
static XtResource resources[] = {{XmNlistSpacing,
                                  XmCListSpacing,
                                 ...
                                 {"pri.vate",
                                  ...
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmListRec, list.MouseMoved),
                                  XmRImmediate,
                                  (XtPointer)False},
                                 {XmNfontList,
                                  XmCFontList,
                                  XmRFontList,
                                  sizeof(XmFontList),
                                  XtOffsetOf(XmListRec, list.font),
                                  XmRCallProc,
                                 ...
                                 {XmNstringDirection,
                                  ...
                                  XtOffsetOf(XmListRec, list.StrDir),
                                  XmRImmediate,
                                 ...
                                 {XmNitems,
                                  ...
                                  XtOffsetOf(XmListRec, list.items),
                                  XmRStringTable,
                                  NULL},
                                 {XmNitemCount,
                                  XmCItemCount,
                                  XmRInt,
                                  sizeof(int),
                                  XtOffsetOf(XmListRec, list.itemCount),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNselectedItems,
                                  XmCSelectedItems,
                                  XmRXmStringTable,
                                  sizeof(XmStringTable),
                                  XtOffsetOf(XmListRec, list.selectedItems),
                                  XmRStringTable,
                                  NULL},
                                 {XmNselectedItemCount,
                                  ...
                                  XmRInt,
                                  sizeof(int),
                                  XtOffsetOf(XmListRec, list.selectedItemCount),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNselectedPositions,
                                  ...
                                  XmRPointer,
                                  sizeof(XtPointer),
                                  XtOffsetOf(XmListRec, list.selectedPositions),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNselectedPositionCount,
                                  ...
                                  XmRInt,
                                  sizeof(int),
                                  XtOffsetOf(XmListRec, list.selectedPositionCount),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNvisibleItemCount,
                                  XmCVisibleItemCount,
                                  XmRInt,
                                  sizeof(int),
                                  XtOffsetOf(XmListRec, list.visibleItemCount),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNtopItemPosition,
                                  XmCTopItemPosition,
                                 ...
                                 {XmNselectionPolicy,
                                  ...
                                  XtOffsetOf(XmListRec, list.SelectionPolicy),
                                  XmRImmediate,
                                 ...
                                 {XmNselectionMode,
                                  ...
                                  XmRSelectionMode,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmListRec, list.SelectionMode),
                                  XmRImmediate,
                                  (XtPointer)XmNORMAL_MODE},
                                 {XmNlistSizePolicy,
                                  XmCListSizePolicy,
                                  XmRListSizePolicy,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmListRec, list.SizePolicy),
                                  XmRImmediate,
                                 ...
                                 {XmNscrollBarDisplayPolicy,
                                  ...
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmListRec, list.ScrollBarDisplayPolicy),
                                  XmRCallProc,
                                  (XtPointer)ScrollBarDisplayPolicyDefault},
                                 {XmNautomaticSelection,
                                  XmCAutomaticSelection,
                                  XmRAutomaticSelection,
                                  sizeof(XtEnum),
                                  XtOffsetOf(XmListRec, list.AutoSelect),
                                  XmRImmediate,
                                 ...
                                 {XmNdoubleClickInterval,
                                  ...
                                  XmRInt,
                                  sizeof(int),
                                  XtOffsetOf(XmListRec, list.ClickInterval),
                                  XmRImmediate,
                                  (XtPointer)(-1)},
                                 {XmNsingleSelectionCallback,
                                  ...
                                  XtOffsetOf(XmListRec, list.SingleCallback),
                                  XmRCallback,
                                  (XtPointer)NULL},
                                 {XmNmultipleSelectionCallback,
                                  ...
                                  XmRCallback,
                                  sizeof(XtCallbackList),
                                  XtOffsetOf(XmListRec, list.MultipleCallback),
                                  XmRCallback,
                                  (XtPointer)NULL},
                                 {XmNextendedSelectionCallback,
                                  ...
                                  XmRCallback,
                                  sizeof(XtCallbackList),
                                  XtOffsetOf(XmListRec, list.ExtendCallback),
                                  XmRCallback,
                                  (XtPointer)NULL},
                                 {XmNbrowseSelectionCallback,
                                  ...
                                  XmRCallback,
                                  sizeof(XtCallbackList),
                                  XtOffsetOf(XmListRec, list.BrowseCallback),
                                  XmRCallback,
                                  (XtPointer)NULL},
                                 {XmNdefaultActionCallback,
                                  ...
                                  XmRCallback,
                                  sizeof(XtCallbackList),
                                  XtOffsetOf(XmListRec, list.DefaultCallback),
                                  XmRCallback,
                                  (XtPointer)NULL},
                                 {XmNdestinationCallback,
                                  ...
                                  XmRCallback,
                                  sizeof(XtCallbackList),
                                  XtOffsetOf(XmListRec, list.DestinationCallback),
                                  XmRCallback,
                                  (XtPointer)NULL},
                                 {XmNhorizontalScrollBar,
                                  ...
                                  XmRWidget,
                                  sizeof(Widget),
                                  XtOffsetOf(XmListRec, list.hScrollBar),
                                  XmRImmediate,
                                  NULL},
                                 {XmNverticalScrollBar,
                                  ...
                                  XmRWidget,
                                  sizeof(Widget),
                                  XtOffsetOf(XmListRec, list.vScrollBar),
                                  XmRImmediate,
                                  NULL},
                                 {XmNnavigationType,
                                  XmCNavigationType,
                                  XmRNavigationType,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmListRec, primitive.navigation_type),
                                  XmRImmediate,
                                 ...
                                 {XmNprimaryOwnership,
                                  ...
                                  XmRPrimaryOwnership,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmListRec, list.PrimaryOwnership),
                                  XmRImmediate,
                                  (XtPointer)XmOWN_NEVER},
                                 {XmNmatchBehavior,
                                  XmCMatchBehavior,
                                  XmRMatchBehavior,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmListRec, list.matchBehavior),
                                  XmRImmediate,
                                  (XtPointer)XmQUICK_NAVIGATE},
                                 {XmNselectColor,
                                  XmCSelectColor,
                                  XmRSelectColor,
                                  sizeof(Pixel),
...
static void NullRoutine(Widget wid) /* unused */
{
  /*EMPTY*/
}
                       ...
                       Cardinal *num_args) /* unused */
{
  ...
  lw->list.BaseX = ((Position)lw->list.margin_width + lw->list.HighlightThickness +
                    lw->primitive.shadow_thickness);
  lw->list.BaseY = ((Position)lw->list.margin_height + lw->list.HighlightThickness +
                    lw->primitive.shadow_thickness);
  lw->list.InternalList = NULL;
  if (!XmRepTypeValidValue(XmRID_SELECTION_POLICY, lw->list.SelectionPolicy, (Widget)lw))
    lw->list.SelectionPolicy = XmBROWSE_SELECT;
  if (!XmRepTypeValidValue(XmRID_LIST_SIZE_POLICY, lw->list.SizePolicy, (Widget)lw))
    lw->list.SizePolicy = XmVARIABLE;
  if (!XmRepTypeValidValue(
          XmRID_SCROLL_BAR_DISPLAY_POLICY, lw->list.ScrollBarDisplayPolicy, (Widget)lw))
    lw->list.ScrollBarDisplayPolicy = XmAS_NEEDED;
  if (!XmRepTypeValidValue(XmRID_PRIMARY_OWNERSHIP, lw->list.PrimaryOwnership, (Widget)lw))
    lw->list.PrimaryOwnership = XmOWN_NEVER;
  if (!XmRepTypeValidValue(XmRID_MATCH_BEHAVIOR, lw->list.matchBehavior, (Widget)lw))
  ...
  if (!XmRepTypeValidValue(XmRID_STRING_DIRECTION, lw->list.StrDir, (Widget)lw))
  ...
  else if (!XmRepTypeValidValue(XmRID_SELECTION_MODE, lw->list.SelectionMode, (Widget)lw))
    lw->list.SelectionMode = XmADD_MODE;
  /* Deal with selectColor */
  lw->list.scratchRend = XmRenditionCreate(NULL, XmS, NULL, 0);
  if (lw->list.selectColor == XmDEFAULT_SELECT_COLOR) {
    _XmSelectColorDefault((Widget)lw, XtOffsetOf(XmListRec, list.selectColor), &val);
  ...
  if (lw->list.matchBehavior == XmQUICK_NAVIGATE) {
    ...
    XmImVaSetValues((Widget)lw, XmNspotLocation, &xmim_point, XmNfontList, lw->list.font, NULL);
  }
  /*
   ...
   */
  scrollFrameTrait = (XmScrollFrameTrait)XmeTraitGet((XtPointer)XtClass(lw->core.parent),
                                                     XmQTscrollFrame);
   ...
   * but ScrolledWindow is no longer required, ScrollFrame is. */
  {
    ...
    lw->list.vScrollBar = (XmScrollBarWidget)XmCreateScrollBar(
        (Widget)lw->list.Mom, "VertScrollBar", vSBArgs, i);
  ...
  if (lw->list.SizePolicy != XmVARIABLE) {
      ...
      lw->list.hExtent = lw->list.hmax - lw->list.hOrigin;
    {
      ...
      lw->list.hScrollBar = (XmScrollBarWidget)XmCreateScrollBar(
          (Widget)lw->list.Mom, "HorScrollBar", hSBArgs, j);
...
static int ComputeVizCount(XmListWidget lw)
{
  ...
  int borders = 2 * (lw->primitive.shadow_thickness + lw->list.HighlightThickness +
...
#if USE_XFT
    XmRenderTableGetDefaultFontExtents(lw->list.font, &lineheight, NULL, NULL);
    if (lineheight == 0)
      lineheight = 1;
#else
    ...
    Widget old, Widget request, Widget new_w, ArgList args, Cardinal *num_args)
{
  ...
  if (!XmRepTypeValidValue(XmRID_PRIMARY_OWNERSHIP, newlw->list.PrimaryOwnership, (Widget)newlw))
    newlw->list.PrimaryOwnership = oldlw->list.PrimaryOwnership;
  if (!XmRepTypeValidValue(XmRID_MATCH_BEHAVIOR, newlw->list.matchBehavior, (Widget)newlw))
  ...
  if (!XmRepTypeValidValue(XmRID_LIST_SIZE_POLICY, newlw->list.SizePolicy, (Widget)newlw))
    newlw->list.SizePolicy = oldlw->list.SizePolicy;
  if (!XmRepTypeValidValue(
          XmRID_SCROLL_BAR_DISPLAY_POLICY, newlw->list.ScrollBarDisplayPolicy, (Widget)newlw))
   ...
   *
   ****************/
  if (newlw->list.StrDir != oldlw->list.StrDir)
    redraw = TRUE;
  ...
  if (newlw->list.selectColor != oldlw->list.selectColor) {
    if (newlw->list.selectColor == XmDEFAULT_SELECT_COLOR) {
      _XmSelectColorDefault((Widget)newlw, XtOffsetOf(struct _XmListRec, list.selectColor), &val);
  ...
  if (new_size || new_size_viz) {
    ...
    newlw->list.BaseX = (Position)newlw->list.margin_width + newlw->list.HighlightThickness +
                        newlw->primitive.shadow_thickness;
    newlw->list.BaseY = (Position)newlw->list.margin_height + newlw->list.HighlightThickness +
                        newlw->primitive.shadow_thickness;
  ...
  if (newlw->list.matchBehavior == XmQUICK_NAVIGATE) {
    ...
    if (newlw->list.font != oldlw->list.font || oldlw->list.matchBehavior != XmQUICK_NAVIGATE)
      XmImVaSetValues(
          (Widget)newlw, XmNspotLocation, &xmim_point, XmNfontList, newlw->list.font, NULL);
    else
                                          ...
                                          XrmValue *value)
{
  ...
  if (XmIsScrolledWindow(XtParent(widget)) && XmIsFileSelectionBox(XtParent(XtParent(widget)))) {
    XtEnum path_mode;
    XtVaGetValues(XtParent(XtParent(widget)), XmNpathMode, &path_mode, NULL);
...
{
  /* Don't allow underflow */
  int borders = 2 * ((int)lw->list.margin_width + lw->list.HighlightThickness +
                     lw->primitive.shadow_thickness);
  if ((int)lw->core.width <= borders)
    return 1;
  else
...
static void DrawItem(Widget w, int position)
{
  ...
  if (!XtIsRealized((Widget)lw))
    return;
  if ((position >= lw->list.itemCount) || (position < lw->list.top_position) ||
...
static void DrawItems(XmListWidget lw, int top, int bot, Boolean all)
{
  ...
  for (pos = top; pos < bot; pos++) {
    ...
    if (!all &&
        (lw->list.InternalList[pos]->selected == lw->list.InternalList[pos]->LastTimeDrawn))
      break;
    ...
    XFillRectangle(
        XtDisplay(lw),
        XtWindow(lw),
        ((lw->list.InternalList[pos]->selected) ? lw->list.NormalGC : lw->list.InverseGC),
        lw->list.BaseX,
        y - 1,
        width + 1,
...
#if USE_XFT
    _XmRendXftFG(lw->list.scratchRend) = _XmXftGetXftColor(XtDisplay(lw),
                                                           _XmRendFG(lw->list.scratchRend));
#endif
    if (!XtIsSensitive((Widget)lw)) {
...
static void DrawHighlight(XmListWidget lw, int position, Boolean on)
{
   ...
   *
   ****************/
  if ((position < lw->list.top_position) || (lw->list.items == NULL) ||
      (lw->list.itemCount == 0) ||
      (position >= (lw->list.top_position + lw->list.visibleItemCount)))
  {
    y = lw->list.BaseY - ht;
                           ...
                           Boolean reset_max_height)
{
  ...
  wideborder = 2 * (lw->primitive.shadow_thickness + lw->list.HighlightThickness +
  ...
  *height = visheight + (2 * (lw->primitive.shadow_thickness + lw->list.HighlightThickness +
                              lw->list.margin_height));
  if (lw->list.itemCount == 0)
...
static void MakeGC(XmListWidget lw)
{
  ...
  lw->list.InsensitiveGC = XtAllocateGC(
      (Widget)lw, lw->core.depth, valueMask, &values, modifyMask, 0);
}
...
static void MakeHighlightGC(XmListWidget lw, Boolean AddMode)
{
  ...
  if (lw->list.HighlightGC != NULL)
    XtReleaseGC((Widget)lw, lw->list.HighlightGC);
  modifyMask = (GCLineStyle | GCLineWidth | GCDashList | GCClipXOrigin | GCClipYOrigin |
                GCClipMask);
  lw->list.HighlightGC = XtAllocateGC(
      (Widget)lw, lw->core.depth, valueMask, &values, modifyMask, 0);
}
...
static Boolean SetVerticalScrollbar(XmListWidget lw)
{
  ...
  if (lw->list.items && lw->list.itemCount) {
    ...
    nav_data.page_increment.y = ((lw->list.visibleItemCount > 1) ? lw->list.visibleItemCount - 1 :
                                                                   1);
...
static Boolean SetHorizontalScrollbar(XmListWidget lw)
{
  ...
  if ((!lw->list.Mom) || (!lw->list.hScrollBar) || (lw->list.FromSetSB))
    return False;
  lw->list.FromSetSB = TRUE;
  listwidth = lw->core.width - 2 * (int)(lw->list.margin_width + lw->list.HighlightThickness +
                                         lw->primitive.shadow_thickness);
  was_managed = XtIsManaged((Widget)lw->list.vScrollBar);
  if (lw->list.ScrollBarDisplayPolicy == XmAS_NEEDED) {
    /* CR 9663: Hide scrollbars in empty lists. */
    if ((lw->list.MaxWidth <= (Dimension)listwidth) || (lw->list.itemCount == 0)) {
      lw->list.BaseX = ((int)lw->list.margin_width + lw->list.HighlightThickness +
                        lw->primitive.shadow_thickness);
      lw->list.XOrigin = 0;
      XtUnmanageChild((Widget)lw->list.hScrollBar);
    }
...
static void UpdateSelectedList(XmListWidget lw, Boolean rebuild)
{
  ...
  if ((lw->list.selectedItemCount > 0) && (lw->list.PrimaryOwnership != XmOWN_NEVER)) {
    ...
    if (/* 1. */ (lw->list.PrimaryOwnership == XmOWN_ALWAYS) ||
        ...
        /* 3. */
        (lw->list.PrimaryOwnership == XmOWN_POSSIBLE_MULTIPLE &&
...
static int WhichItem(XmListWidget w, Position EventY)
{
  ...
  if (!lw->list.items)
    return -1;
  if (y <= (Position)(lw->list.BaseY - lw->list.HighlightThickness)) { /* END OSF Fix CR 5081 */
...
static void HandleNewItem(XmListWidget lw, int item, int olditem)
{
  ...
  switch (lw->list.SelectionPolicy) {
    ...
    case XmEXTENDED_SELECT:
      ...
      while (lw->list.LastHLItem != item && lw->list.StartItem >= 0 && lw->list.EndItem >= 0 &&
             lw->list.StartItem < lw->list.itemCount && lw->list.EndItem < lw->list.itemCount)
      {
...
static void VerifyMotion(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
   ...
   *
   ****************/
  if ((event->xmotion.x < (int)lw->core.width) && (event->xmotion.x > (int)lw->core.x) &&
      (event->xmotion.y < (int)lw->core.height) && (event->xmotion.y > (int)lw->core.y))
  {
    if (lw->list.DragID) {
      XtRemoveTimeOut(lw->list.DragID);
      lw->list.DragID = 0;
    ...
    if (LayoutIsRtoLP(lw)) {
      if (((event->xmotion.y >= (int)lw->core.height) && (lw->list.LeaveDir & TOPLEAVE)) ||
          ((event->xmotion.y <= (int)lw->core.y) && (lw->list.LeaveDir & BOTTOMLEAVE)) ||
          ((event->xmotion.x <= (int)lw->core.x) && (lw->list.LeaveDir & LEFTLEAVE)) ||
          ((event->xmotion.x >= (int)lw->core.width) && (lw->list.LeaveDir & RIGHTLEAVE)))
      {
        if (lw->list.DragID) {
          XtRemoveTimeOut(lw->list.DragID);
          lw->list.DragID = 0;
      ...
      if (((event->xmotion.y >= (int)lw->core.height) && (lw->list.LeaveDir & TOPLEAVE)) ||
          ((event->xmotion.y <= (int)lw->core.y) && (lw->list.LeaveDir & BOTTOMLEAVE)) ||
          ((event->xmotion.x <= (int)lw->core.x) && (lw->list.LeaveDir & RIGHTLEAVE)) ||
          ((event->xmotion.x >= (int)lw->core.width) && (lw->list.LeaveDir & LEFTLEAVE)))
      {
        if (lw->list.DragID) {
          XtRemoveTimeOut(lw->list.DragID);
          lw->list.DragID = 0;
  ...
  if ((item == lw->list.LastHLItem) || (item >= lw->list.itemCount) ||
      (item < lw->list.top_position) ||
...
static void SelectElement(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if ((item >= (lw->list.top_position + lw->list.visibleItemCount)) ||
      (item < lw->list.top_position) || (item >= lw->list.itemCount))
    return;
  ...
  if (!(lw->list.KbdSelection) && /* No more doubleclick from space... */
      (lw->list.DownTime != 0) && (lw->list.DownCount > 0) &&
  ...
  if (((lw->list.SelectionPolicy == XmSINGLE_SELECT) ||
      ...
      ((!lw->list.AppendInProgress) ||
       ((lw->list.SelectionMode == XmNORMAL_MODE) && (lw->list.KbdSelection) &&
        (lw->list.SelectionPolicy == XmMULTIPLE_SELECT))))
  {
    for (i = 0; i < lw->list.itemCount; i++) {
      lw->list.InternalList[i]->last_selected = lw->list.InternalList[i]->selected;
...
static void KbdToggleAddMode(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  XmListWidget lw = (XmListWidget)wid;
  if (lw->list.SelectionPolicy == XmEXTENDED_SELECT) {
    XmListSetAddMode((Widget)lw, !(lw->list.SelectionMode == XmADD_MODE));
    ClickElement(lw, event, FALSE);
  }
  lw->list.Event = 0;
}
...
static void KbdDeSelectAll(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (((lw->list.SelectionPolicy == XmSINGLE_SELECT) ||
    ...
    return;
  if ((lw->list.SelectionPolicy == XmEXTENDED_SELECT) &&
      (lw->list.SelectionMode == XmNORMAL_MODE) && (_XmGetFocusPolicy((Widget)lw) == XmEXPLICIT))
  ...
  if (lw->list.CurrentKbdItem == lw->list.top_position) {
    if (lw->list.visibleItemCount <= 1) /* on top */
      ...
      xmim_point->y = lw->list.BaseY + 2 * lw->list.MaxItemHeight + lw->list.spacing;
           ...
           lw->list.CurrentKbdItem >= lw->list.top_position + lw->list.visibleItemCount)
  {
    /* on top */
    xmim_point->y = lw->list.BaseY + lw->list.MaxItemHeight;
  }
    ...
    xmim_point->y = (lw->list.BaseY +
                     LINEHEIGHTS(lw, (lw->list.CurrentKbdItem - lw->list.top_position)) -
...
{
  XmListWidget lw = (XmListWidget)wid;
  if (lw->primitive.traversal_on && (_XmGetFocusPolicy((Widget)lw) == XmEXPLICIT) &&
...
static void BrowseScroll(XtPointer closure, XtIntervalId *id)
{
  ...
  if (lw->list.LeaveDir & LEFTLEAVE) {
    if ((lw->list.hOrigin <= 0) || !(lw->list.hScrollBar)) {
      ...
      if (lw->list.Traversing)
        DrawHighlight(lw, lw->list.CurrentKbdItem, FALSE);
      XtVaGetValues((Widget)lw->list.hScrollBar, XmNincrement, &inc, NULL);
      lw->list.hOrigin -= inc;
                      ...
                      Cardinal *num_params) /* unused */
{
  ...
  if (lw->list.vScrollBar)
    XtVaGetValues((Widget)lw->list.vScrollBar, XmNinitialDelay, &interval, NULL);
  lw->list.DragID = XtAppAddTimeOut(XtWidgetToApplicationContext((Widget)lw),
                                    (unsigned long)interval,
                                    BrowseScroll,
                                    (XtPointer)lw);
...
static void KbdLeftPage(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (LayoutIsRtoLP(lw)) {
    pos = lw->list.hOrigin + (lw->core.width - CHAR_WIDTH_GUESS -
                              2 * (int)(lw->list.margin_width + lw->list.HighlightThickness +
                                        lw->primitive.shadow_thickness));
    if ((lw->list.hExtent + pos) > lw->list.hmax)
      pos = lw->list.hmax - lw->list.hExtent;
  }
...
static void DragDropFinished(Widget w, /* unused */
                             XtPointer closure,
                            ...
                            Cardinal *num_params) /* unused */
{
  ...
  if (event->xbutton.state & ~((Button1Mask >> 1) << event->xbutton.button) &
  ...
  if ((item < 0) || (item >= lw->list.itemCount))
    return;
  location_data = 0;
  lw->list.drag_conv = ListDragConv = (XmListDragConvertStruct *)XtMalloc(
 ...
 */
static void DragStart(XtPointer closure, XtIntervalId *id) /* unused */
{
  XmListWidget lw = (XmListWidget)closure;
  lw->list.drag_start_timer = 0;
  lw->list.drag_abort_action = NULL;
...
static void ListProcessBtn1(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  switch (btn1_transfer) {
    ...
    case XmBUTTON2_TRANSFER:
      ...
      if (!lw->list.drag_start_timer &&
          ((event->xany.type != ButtonPress) || ((item = WhichItem(lw, event->xbutton.y)) < 0) ||
           (item >= lw->list.itemCount) || !OnSelectedList(lw, lw->list.items[item], item)))
      {
        XtCallActionProc(wid, params[0], event, params, *num_params);
      }
      else {
        switch (event->xany.type) {
          case ButtonPress:
            ...
            if ((!lw->list.drag_start_timer) &&
                !(event->xbutton.state & ~((Button1Mask >> 1) << event->xbutton.button) &
                  (Button1Mask | Button2Mask | Button3Mask | Button4Mask | Button5Mask)))
            {
              ...
              XtCallActionProc(
                  wid, lw->list.drag_abort_action, &lw->list.drag_event, params, *num_params);
              XtCallActionProc(wid, params[0], event, params, *num_params);
              lw->list.drag_abort_action = NULL;
            }
            break;
...
static void ListQuickNavigate(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  input_length = XmImMbLookupString(
      wid, (XKeyEvent *)event, input_string, LIST_MAX_INPUT_SIZE, (KeySym *)NULL, &status_return);
...
static wchar_t FirstChar(XmString string)
{
  ...
  if (string != NULL) {
    ...
    while ((result == 0) &&
           ((type = XmeStringGetComponent(&stack_context, TRUE, FALSE, &len, &val)) !=
 ...
 *									   *
 ***************************************************************************/
static void ListConvert(Widget w, XtPointer client_data, XmConvertCallbackStruct *cs)
{
  enum {
  ...
  static char *atom_names[] = {XmS_MOTIF_COMPOUND_STRING,
                               XmSCOMPOUND_TEXT,
                               XmSTEXT,
                               XmSTARGETS,
                               XmS_MOTIF_DROP,
           ...
           (cs->target == atoms[XmA_MOTIF_CLIPBOARD_TARGETS]))
  {
    ...
    cs->status = XmCONVERT_DONE;
           ...
           cs->target == atoms[XmA_MOTIF_COMPOUND_STRING] || cs->target == XA_STRING ||
           cs->target == C_ENCODING || cs->target == atoms[XmATEXT] ||
           cs->target == atoms[XmAUTF8_STRING])
  {
    ...
    if (cs->selection == atoms[XmA_MOTIF_DROP]) {
      ...
      for (i = 1; i < itemcount; i++) {
        concat = XmStringConcatAndFree(concat, XmStringCopy(sep));
        concat = XmStringConcatAndFree(concat, XmStringCopy(items[pos[i] - 1]));
      }
    }
    if (cs->target == atoms[XmACOMPOUND_TEXT] || cs->target == C_ENCODING ||
        cs->target == XA_STRING || cs->target == atoms[XmATEXT])
    {
      if (concat != NULL)
      ...
      if (cs->target == XA_STRING) {
        ...
        ret_status = XmbTextListToTextProperty(
            XtDisplay(w), (char **)&value, 1, (XICCEncodingStyle)XStringStyle, &tmp_prop);
        XtFree((char *)value);
...
static void ListPreDestProc(Widget w,
...
static void APIAddItems(XmListWidget lw, XmString *items, int item_count, int pos, Boolean select)
{
  ...
  if ((lw->list.Traversing) && (intern_pos <= lw->list.CurrentKbdItem) && !bot)
    DrawHighlight(lw, lw->list.CurrentKbdItem, FALSE);
  selectable = (select && (lw->list.SelectionPolicy != XmSINGLE_SELECT) &&
                (lw->list.SelectionPolicy != XmBROWSE_SELECT));
 ...
 *									*
 ************************************************************************/
void XmListReplaceItemsUnselected(Widget w,
                                  XmString *old_items,
                                  int item_count,
                                  XmString *new_items)
{
...
void XmListReplacePositions(Widget w, int *position_list, XmString *item_list, int item_count)
{
  ...
  if ((position_list == NULL) || (item_list == NULL) || (lw->list.items == NULL) ||
      (item_count == 0))
  {
    _XmAppUnlock(app);
    return;
...
static void APISelect(XmListWidget lw, int item_pos, Boolean notify)
{
  ...
  if (lw->list.SelectionPolicy == XmEXTENDED_SELECT)
    lw->list.SelectionType = XmINITIAL;
  lw->list.InternalList[item_pos]->selected = ((lw->list.SelectionPolicy != XmMULTIPLE_SELECT) ||
 ...
 *									*
 ************************************************************************/
void XmListSelectPos(Widget w, int pos, Boolean notify)
{
  XmListWidget lw = (XmListWidget)w;
  _XmWidgetToAppContext(w);
  _XmAppLock(app);
...
void XmListSetAddMode(Widget w, Boolean add_mode)
{
   ...
   *
   ****************/
  if ((add_mode) && (lw->list.itemCount != 0) && (lw->list.SelectionPolicy == XmEXTENDED_SELECT) &&
...
void ListScrollUp(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  XmListWidget lw = (XmListWidget)wid;
  int value;
  int slider_size;
  ...
  if (lw->list.vScrollBar) {
    ...
    XmScrollBarGetValues(
        ((Widget)(lw->list.vScrollBar)), &value, &slider_size, &increment, &page_increment);
    new_value = value - increment;
    if (new_value < lw->list.vScrollBar->scrollBar.minimum)
      new_value = lw->list.vScrollBar->scrollBar.minimum;
    XmScrollBarSetValues(
        ((Widget)(lw->list.vScrollBar)), new_value, slider_size, increment, page_increment, True);
  }
}

void ListScrollDown(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  XmListWidget lw = (XmListWidget)wid;
  int value;
  int slider_size;
...
Boolean XmListGetSelectedPos(Widget w, int **pos_list, int *pos_count)
{
  ...
  *pos_count = 0;
  _XmAppLock(app);
  if (lw->list.items == NULL || lw->list.itemCount <= 0 || lw->list.selectedPositions == NULL ||
      lw->list.selectedPositionCount <= 0)
  {
    _XmAppUnlock(app);
    return FALSE;
...
Widget XmVaCreateList(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmListWidgetClass, parent, False, var, count);
  va_end(var);
  return w;
}
...
Widget XmVaCreateManagedList(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmListWidgetClass, parent, True, var, count);
  va_end(var);
  return w;
}
