...
enum { XmCONVERT_DEFAULT = 0, XmCONVERT_MORE, XmCONVERT_MERGE, XmCONVERT_REFUSE, XmCONVERT_DONE };
...
void XmTransferValue(XtPointer, Atom, XtCallbackProc, XtPointer, Time);
