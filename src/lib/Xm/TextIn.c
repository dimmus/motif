...
static void RingBell(Widget w, XEvent *event, String *params, Cardinal *num_params);
...
static void StuffFromBuffer(XmTextWidget tw, XEvent *event, int buffer);
static void UnKill(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RemoveCurrentSelection(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill);
static void DeleteCurrentSelection(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void KillCurrentSelection(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void CheckDisjointSelection(Widget w, XmTextPosition position, Time sel_time);
static void SelfInsert(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void InsertString(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessVerticalParams(Widget w, XEvent *event, String *params, Cardinal *num_params);
...
static XmTextPosition SelectOutLine(XmTextWidget tw,
                                    ...
                                    int count);
static void KeySelection(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void SetAnchorBalancing(XmTextWidget tw, XmTextPosition position);
...
static void SimpleMovement(Widget w,
                           ...
                           XmTextScanType type,
                           Boolean include);
static void MoveForwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveBackwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveForwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveBackwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveForwardParagraph(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveBackwardParagraph(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveToLineStart(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveToLineEnd(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void _MoveNextLine(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean pendingoff);
static void MoveNextLine(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void _MovePreviousLine(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean pendingoff);
static void MovePreviousLine(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveNextPage(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MovePreviousPage(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MovePageLeft(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MovePageRight(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MovePageUp(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MovePageDown(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveBeginningOfFile(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveEndOfFile(Widget w, XEvent *event, String *params, Cardinal *num_params);
...
static void ScrollCursorVertically(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void AddNewLine(Widget w, XEvent *event, Boolean move_cursor);
static void InsertNewLine(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void InsertNewLineAndBackup(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void InsertNewLineAndIndent(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RedrawDisplay(Widget w, XEvent *event, String *params, Cardinal *num_params);
...
static void ToggleAddMode(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void SetCursorPosition(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RemoveBackwardChar(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill);
static void DeleteBackwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void KillBackwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RemoveForwardWord(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill);
static void DeleteForwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void KillForwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RemoveBackwardWord(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill);
static void DeleteBackwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void KillBackwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RemoveForwardChar(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill);
static void KillForwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void DeleteForwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RemoveToEndOfLine(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill);
static void RemoveToStartOfLine(
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill);
static void DeleteToStartOfLine(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void KillToStartOfLine(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void DeleteToEndOfLine(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void KillToEndOfLine(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void RestorePrimaryHighlight(InputData data,
                                    XmTextPosition prim_left,
                                    XmTextPosition prim_right);
static void SetSelectionHint(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void a_Selection(
    XmTextWidget tw, Position x, Position y, Time sel_time, int set_empty_selection);
static void SetAnchor(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void DoSelection(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void SetScanType(Widget w, InputData data, XEvent *event);
static void StartPrimary(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void StartSecondary(Widget w, XEvent *event, String *params, Cardinal *num_params);
...
static Boolean dragged(SelectionHint selectionHint, XEvent *event, int threshold);
static void DoExtendedSelection(Widget w, Time ev_time);
...
static void StartExtendSelection(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ExtendSelection(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ExtendSecondary(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ExtendEnd(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void DoGrabFocus(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void MoveDestination(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void Stuff(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void SecondaryNotify(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void VoidAction(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ExtendSecondaryEnd(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void SelectAll(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void DeselectAll(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ClearSelection(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessBDragRelease(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessCopy(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessLink(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessMove(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void CopyPrimary(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void CutPrimary(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void LinkPrimary(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void CutClipboard(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void CopyClipboard(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void PasteClipboard(Widget w, XEvent *event, String *params, Cardinal *num_params);
static Boolean VerifyLeave(Widget w, XEvent *event);
static void TextLeave(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TextFocusIn(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TextFocusOut(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TraverseDown(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TraverseUp(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TraverseHome(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TraverseNextTabGroup(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void TraversePrevTabGroup(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessCancel(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessReturn(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessTab(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessUp(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessDown(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessShiftUp(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessShiftDown(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessLeft(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessRight(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessShiftLeft(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessShiftRight(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void ProcessHome(Widget w, XEvent *event, String *params, Cardinal *num_params);
static void Invalidate(XmTextWidget tw, XmTextPosition position, XmTextPosition topos, long delta);
static void InputGetValues(Widget wid, ArgList args, Cardinal num_args);
static void InputSetValues(
    Widget oldw, Widget reqw, Widget new_w, ArgList args, Cardinal *num_args);
static void InputDestroy(Widget w);
static XtPointer InputBaseProc(Widget widget, XtPointer client_data);
static void DragProcCallback(Widget w, XtPointer client, XtPointer call);
static void RegisterDropSite(Widget w);
static XmTextPosition XtoPosInLine(XmTextWidget tw, Position x, LineNum line);
static XmTextPosition YtoPosInLine(XmTextWidget tw, Position y, LineNum line);
...
static TextDestData GetTextDestData(Widget tw)
{
  ...
  if (XFindContext(display, (Window)screen, loc_context, (char **)&dest_data)) {
    ...
    XtAddCallback(xm_display,
                  XmNdestroyCallback,
                  (XtCallbackProc)_XmTextFreeContextData,
                  (XtPointer)ctx_data);
    XSaveContext(display, (Window)screen, loc_context, (char *)dest_data);
  }
  return dest_data;
}

Boolean _XmTextNeedsPendingDeleteDis(XmTextWidget tw,
                                     XmTextPosition *left,
                                     XmTextPosition *right,
                                     int check_add_mode)
{
  ...
  else if (check_add_mode && !tw->text.add_mode)
    return (*left != *right);
  else
    return (data->pendingdelete && *left != *right && *left <= tw->text.cursor_position &&
...
Boolean _XmTextHasDestination(Widget w)
{
  XmTextWidget tw = (XmTextWidget)w;
  InputData data = tw->text.input->data;
...
Boolean _XmTextSetDestinationSelection(Widget w,
                                       XmTextPosition position,
                                       Boolean disown,
                                       Time set_time)
{
                            ...
                            XmTextPosition *cursorPos)
{
  ...
  if (_XmTextModifyVerify(tw, event, &from, &to, cursorPos, &block, &newblock, &freeBlock)) {
    if ((*tw->text.source->Replace)(tw, NULL, &from, &to, &newblock, False) != EditDone) {
      _XmTextEnableRedisplay(tw);
      ...
      _XmTextEnableRedisplay(tw);
      _XmTextSetDestinationSelection((Widget)tw, tw->text.cursor_position, False, event_time);
    }
    if (freeBlock && newblock.ptr)
      XtFree(newblock.ptr);
  }
...
static void StuffFromBuffer(XmTextWidget tw, XEvent *event, int buffer)
{
  ...
  block.format = XmFMT_8_BIT;
  if (_XmTextModifyVerify(
          tw, event, &from_pos, &to_pos, &cursorPos, &block, &newblock, &freeBlock))
  {
    if ((*tw->text.source->Replace)(tw, NULL, &from_pos, &to_pos, &newblock, False) != EditDone) {
      RingBell((Widget)tw, NULL, NULL, NULL);
    }
    else {
    ...
    if (left < right) {
      ...
      if (DeleteOrKill(tw, event, left, right, kill, &newCursorPos)) {
        if (cursorPos > left && cursorPos <= right) {
          ...
          _XmTextSetDestinationSelection(w, tw->text.cursor_position, False, event_time);
        }
        _XmTextValueChanged(tw, event);
      }
      else
        (*tw->text.source->SetSelection)(tw->text.source, left, right, event_time);
    }
  }
}
...
static void CheckDisjointSelection(Widget w, XmTextPosition position, Time sel_time)
{
  ...
  InputData data = tw->text.input->data;
  left = right = position;
  if (tw->text.add_mode || ((*tw->text.source->GetSelection)(tw->text.source, &left, &right) &&
...
static Boolean PrintableString(XmTextWidget tw, char *str, int n)
{
  ...
  if (tw->text.char_size == 1) {
    ...
    int i, csize;
    wchar_t wc;
    for (i = 0, csize = mblen(str, tw->text.char_size); i < n;
...
static void SelfInsert(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  n = XmImMbLookupString(
      w, (XKeyEvent *)event, str, TEXT_MAX_INSERT_SIZE, (KeySym *)NULL, &status_return);
  ...
  for (i = 0; i < n; i++)
    if (str[i] == 0)
      n = 0; /* just toss out the entire input string */
  if (n > 0) {
    EraseInsertionPoint(tw);
    str[n] = '\0';
    ...
    if (_XmTextNeedsPendingDeleteDis(tw, &left, &right, FALSE)) {
      ...
      lastPos = (*(tw->text.source->Scan))(
          tw->text.source, beginPos, XmSELECT_LINE, XmsdRight, 1, TRUE);
    ...
    block.format = XmFMT_8_BIT;
    if (_XmTextModifyVerify(
            tw, event, &beginPos, &nextPos, &cursorPos, &block, &newblock, &freeBlock))
    {
      if (pending_delete)
        (*tw->text.source->SetSelection)(tw->text.source, cursorPos, cursorPos, event_time);
      if ((*tw->text.source->Replace)(tw, NULL, &beginPos, &nextPos, &newblock, False) != EditDone)
      {
...
static void InsertString(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  for (i = 0; i < *num_params; i++) {
    ...
    block.format = XmFMT_8_BIT;
    if (_XmTextModifyVerify(
            tw, event, &beginPos, &nextPos, &newCursorPos, &block, &newblock, &freeBlock))
    {
      if (pending_delete) {
        (*tw->text.source->SetSelection)(tw->text.source, cursorPos, cursorPos, event_time);
                                    ...
                                    XmTextPosition *position)
{
  ...
  *position = (*tw->text.source->Scan)(
      tw->text.source, tw->text.cursor_position, XmSELECT_POSITION, XmsdRight, 1, False);
  if (!(*tw->text.source->GetSelection)(tw->text.source, left, right) || *left == *right) {
                                    ...
                                    int count)
{
  ...
  if (line < tw->text.total_lines)
    ...
    return (*source->Scan)(
        source, tw->text.line_table[line].start_pos, XmSELECT_ALL, XmsdRight, 1, TRUE);
  }
}
...
static void KeySelection(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (data->extendDir == XmsdRight) {
    ...
    if (data->stype == XmSELECT_OUT_LINE) {
      ...
      right = cursorPos = (*tw->text.source->Scan)(
          tw->text.source, position, data->stype, cursorDir, 1, FALSE);
    }
    left = data->anchor;
  }
  else {
    ...
    if (data->stype == XmSELECT_OUT_LINE) {
      ...
      left = cursorPos = (*tw->text.source->Scan)(
          tw->text.source, position, data->stype, cursorDir, 1, FALSE);
    }
    right = data->anchor;
  }
  ...
  _XmTextSetCursorPosition(w, cursorPos);
  _XmTextSetDestinationSelection(w, tw->text.cursor_position, False, event_time);
  if (tw->text.auto_show_cursor_position && cursorPos == tw->text.bottom_position)
                                ...
                                Boolean extend)
{
  ...
  has_selection = ((*tw->text.source->GetSelection)(tw->text.source, &left, &right) &&
                   left != right);
  if (!tw->text.add_mode) {
    if (extend) {
      ...
      if (has_selection) {
        (*tw->text.source->SetSelection)(tw->text.source, old_position, old_position, time);
        data->anchor = old_position;
      }
    }
  }
...
static void CompleteNavigation(XmTextWidget tw, XmTextPosition position, Time time, Boolean extend)
{
  XmTextPosition left, right;
  InputData data = tw->text.input->data;
  if ((tw->text.add_mode && (*tw->text.source->GetSelection)(tw->text.source, &left, &right) &&
                           ...
                           Boolean include)
{
  ...
  if (*num_params > 0) {
    ...
    if (_XmConvertActionParamToRepTypeId(
            (Widget)w, XmRID_TEXT_EXTEND_MOVEMENT_ACTION_PARAMS, params[0], False, &value) == True)
    {
      extend = True;
    }
  }
...
static void MoveForwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XmTextWidget tw = (XmTextWidget)w;
  EraseInsertionPoint(tw);
  SimpleMovement(w, event, params, num_params, XmsdRight, XmSELECT_POSITION, TRUE);
  DisplayInsertionPoint(tw);
}
...
static void MoveBackwardChar(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XmTextWidget tw = (XmTextWidget)w;
  EraseInsertionPoint(tw);
  SimpleMovement(w, event, params, num_params, XmsdLeft, XmSELECT_POSITION, TRUE);
  DisplayInsertionPoint(tw);
}
...
static void MoveForwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  /* Add if We only want to select to the end of the word w/o spaces
     ...
     */
  position = (*tw->text.source->Scan)(
      tw->text.source, cursorPos, XmSELECT_WORD, XmsdRight, 1, TRUE);
...
static void MoveBackwardWord(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  position = (*tw->text.source->Scan)(
      tw->text.source, cursorPos, XmSELECT_WORD, XmsdLeft, 1, FALSE);
  if (position == cursorPos) {
    position = (*tw->text.source->Scan)(
        tw->text.source, position, XmSELECT_WORD, XmsdLeft, 1, TRUE);
    position = (*tw->text.source->Scan)(
        tw->text.source, position, XmSELECT_WORD, XmsdLeft, 1, FALSE);
  }
  SetNavigationAnchor(tw, cursorPos, position, event_time, extend);
  CompleteNavigation(tw, position, event_time, extend);
  DisplayInsertionPoint(tw);
...
static void MoveForwardParagraph(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (tw->text.edit_mode == XmSINGLE_LINE_EDIT)
    return;
  EraseInsertionPoint(tw);
  SimpleMovement(w, event, params, num_params, XmsdRight, XmSELECT_PARAGRAPH, FALSE);
  DisplayInsertionPoint(tw);
}
...
static void MoveBackwardParagraph(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (tw->text.edit_mode == XmSINGLE_LINE_EDIT)
    return;
  EraseInsertionPoint(tw);
  SimpleMovement(w, event, params, num_params, XmsdLeft, XmSELECT_PARAGRAPH, FALSE);
  DisplayInsertionPoint(tw);
}
...
static void MoveToLineEnd(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (line == NOLINE) {
    ...
    if (position == PASTENDPOS)
      position = (*tw->text.source->Scan)(
          tw->text.source, position, XmSELECT_ALL, XmsdRight, 1, TRUE);
    else
      position = (*tw->text.source->Scan)(
          tw->text.source, position, XmSELECT_POSITION, XmsdLeft, 1, TRUE);
    SetNavigationAnchor(tw, cursorPos, position, event_time, extend);
    CompleteNavigation(tw, position, event_time, extend);
  }
  DisplayInsertionPoint(tw);
    ...
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean pendingoff)
{
  ...
  if (start == PASTENDPOS) {
    newPos = (*tw->text.source->Scan)(
        tw->text.source, currentPos, XmSELECT_ALL, XmsdRight, 1, TRUE);
    ...
    next = (*tw->text.source->Scan)(tw->text.source, newPos, XmSELECT_LINE, XmsdRight, 1, FALSE);
    SetNavigationAnchor(tw, currentPos, newPos, event_time, extend);
    CompleteNavigation(tw, newPos, event_time, extend);
  ...
  if (line != NOLINE) {
    ...
    if (start2 != start && start != PASTENDPOS) {
      newPos = (*tw->text.source->Scan)(
          tw->text.source, start, XmSELECT_LINE, XmsdRight, 1, FALSE);
      SetNavigationAnchor(tw, currentPos, newPos, event_time, extend);
      CompleteNavigation(tw, newPos, event_time, extend);
    }
  }
    ...
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean pendingoff)
{
  ...
  if (line == NOLINE) {
    ...
    if (line == 0) {
      ...
      if (line == 0) {
        newPos = (*tw->text.source->Scan)(
            tw->text.source, currentPos, XmSELECT_ALL, XmsdLeft, 1, TRUE);
        changed = True;
        goto done;
      }
      if (line == NOLINE)
    ...
    if (line != NOLINE) {
      ...
      if (start2 != start) {
        newPos = (*tw->text.source->Scan)(
            tw->text.source, origstart, XmSELECT_POSITION, XmsdLeft, 1, TRUE);
      }
    }
  }
done:
...
static void ScrollCursorVertically(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (*num_params == 0) {
    ...
    if (pos == tw->text.line[tw->text.number_lines].start)
      ...
      for (desired_line = 0; desired_line < tw->text.number_lines - 1; desired_line++)
        if (tw->text.line[desired_line + 1].start > pos)
          break;
  }
  else {
  ...
  if (tw->text.cursor_position == tw->text.line[tw->text.number_lines].start)
    ...
    for (cur_line = 0; cur_line < tw->text.number_lines; cur_line++)
      if (tw->text.line[cur_line + 1].start > tw->text.cursor_position)
        break;
...
static void InsertNewLineAndIndent(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  _XmTextDisableRedisplay(tw, TRUE);
  pos = tw->text.cursor_position;
  left = (*tw->text.source->Scan)(tw->text.source, pos, XmSELECT_LINE, XmsdLeft, 1, FALSE);
  if (left !=
      (*tw->text.source->Scan)(tw->text.source, left, XmSELECT_WHITESPACE, XmsdRight, 1, FALSE))
  {
    AddNewLine(w, event, True);
  }
  else {
    right = (*tw->text.source->Scan)(
        tw->text.source, left, XmSELECT_WHITESPACE, XmsdRight, 1, TRUE);
    if (right > pos)
      right = pos;
    AddNewLine(w, event, True);
    cursorPos = from_pos = to_pos = tw->text.cursor_position;
    while (left < right) {
      left = (*tw->text.source->ReadSource)(tw->text.source, left, right, &block);
      if (_XmTextModifyVerify(
              tw, event, &from_pos, &to_pos, &newCursorPos, &block, &newblock, &freeBlock))
      {
        if ((*tw->text.source->Replace)(tw, NULL, &from_pos, &to_pos, &newblock, False) !=
            EditDone)
        {
          RingBell(w, event, params, num_params);
          if (freeBlock && newblock.ptr)
...
static void ToggleAddMode(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  DisplayInsertionPoint(tw);
  if (tw->text.add_mode &&
      (!(*tw->text.source->GetSelection)(data->widget->text.source, &left, &right) ||
       left == right))
  {
...
static void SetCursorPosition(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  _XmTextResetIC(w);
  if (event)
    _XmTextSetCursorPosition(w,
                             (*tw->text.output->XYToPos)(tw, event->xbutton.x, event->xbutton.y));
}
    ...
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill)
{
  ...
  if (_XmTextNeedsPendingDeleteDis(tw, &left, &right, TRUE)) {
    ...
    cursorPos = (*tw->text.source->Scan)(
        tw->text.source, nextPos, XmSELECT_POSITION, XmsdLeft, 1, TRUE);
    ...
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill)
{
  ...
  if (_XmTextNeedsPendingDeleteDis(tw, &left, &right, TRUE)) {
    ...
    right = (*tw->text.source->Scan)(tw->text.source, left, XmSELECT_WORD, XmsdRight, 1, TRUE);
    if (left < right) {
      if (DeleteOrKill(tw, event, left, right, kill, &newCursorPos)) {
        _XmTextSetCursorPosition(w, newCursorPos);
        CheckDisjointSelection(w, tw->text.cursor_position, event_time);
    ...
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill)
{
  ...
  if (_XmTextNeedsPendingDeleteDis(tw, &left, &right, TRUE)) {
    ...
    _XmTextDisableRedisplay(tw, TRUE);
    right = tw->text.cursor_position;
    left = (*tw->text.source->Scan)(tw->text.source, right, XmSELECT_WORD, XmsdLeft, 1, FALSE);
    if (left == right) {
      left = (*tw->text.source->Scan)(tw->text.source, left, XmSELECT_WORD, XmsdLeft, 1, TRUE);
      left = (*tw->text.source->Scan)(tw->text.source, left, XmSELECT_WORD, XmsdLeft, 1, FALSE);
    }
    if (left < right) {
      if (DeleteOrKill(tw, event, left, right, kill, &newCursorPos)) {
        _XmTextSetCursorPosition(w, newCursorPos);
    ...
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill)
{
  ...
  if (_XmTextNeedsPendingDeleteDis(tw, &left, &right, TRUE)) {
    ...
    nextPos = (*tw->text.source->Scan)(
        tw->text.source, cursorPos, XmSELECT_POSITION, XmsdRight, 1, TRUE);
    if (DeleteOrKill(tw, event, cursorPos, nextPos, kill, &newCursorPos)) {
      _XmTextSetCursorPosition(w, newCursorPos);
      CheckDisjointSelection(w, tw->text.cursor_position, event_time);
      _XmTextValueChanged(tw, event);
    ...
    Widget w, XEvent *event, String *params, Cardinal *num_params, Boolean kill)
{
  ...
  if (_XmTextNeedsPendingDeleteDis(tw, &left, &right, TRUE)) {
    ...
    if (line == NOLINE)
      ...
      if (right == PASTENDPOS)
        right = (*tw->text.source->Scan)(tw->text.source, right, XmSELECT_ALL, XmsdRight, 1, TRUE);
      else
        right = (*tw->text.source->Scan)(
            tw->text.source, right, XmSELECT_POSITION, XmsdLeft, 1, TRUE);
    }
    if (left < right) {
      if (DeleteOrKill(tw, event, left, right, kill, &newCursorPos)) {
        _XmTextSetCursorPosition(w, newCursorPos);
                                    ...
                                    XmTextPosition prim_right)
{
  if (data->sel2Right >= prim_left && data->sel2Right <= prim_right) {
    ...
    if (data->sel2Left >= prim_left) {
      _XmTextSetHighlight((Widget)data->widget, prim_left, data->sel2Left, XmHIGHLIGHT_SELECTED);
      _XmTextSetHighlight(
          (Widget)data->widget, data->sel2Left, data->sel2Right, XmHIGHLIGHT_NORMAL);
      _XmTextSetHighlight((Widget)data->widget, data->sel2Right, prim_right, XmHIGHLIGHT_SELECTED);
      /* right side of secondary selection is inside primary selection */
    }
    else {
      _XmTextSetHighlight((Widget)data->widget, prim_left, data->sel2Right, XmHIGHLIGHT_SELECTED);
      _XmTextSetHighlight((Widget)data->widget, data->sel2Left, prim_left, XmHIGHLIGHT_NORMAL);
    }
  }
  else {
    /* left side of secondary selection is inside primary selection */
    if (data->sel2Left <= prim_right && data->sel2Left >= prim_left) {
      _XmTextSetHighlight((Widget)data->widget, data->sel2Left, prim_right, XmHIGHLIGHT_SELECTED);
      _XmTextSetHighlight((Widget)data->widget, prim_right, data->sel2Right, XmHIGHLIGHT_NORMAL);
    }
    else {
      /* secondary selection encompasses the primary selection */
      if (data->sel2Left <= prim_left && data->sel2Right >= prim_right) {
        _XmTextSetHighlight((Widget)data->widget, data->sel2Left, prim_left, XmHIGHLIGHT_NORMAL);
        _XmTextSetHighlight((Widget)data->widget, prim_left, prim_right, XmHIGHLIGHT_SELECTED);
        _XmTextSetHighlight((Widget)data->widget, prim_right, data->sel2Right, XmHIGHLIGHT_NORMAL);
...
Boolean _XmTextSetSel2(XmTextWidget tw,
                       XmTextPosition left,
                       ...
                       Time set_time)        /*   LoseSelection, so don't call  */
{
  ...
  if (data->hasSel2) {
     ...
     */
    if ((*data->widget->text.source->GetSelection)(
            data->widget->text.source, &prim_left, &prim_right))
  ...
  if (!set_time)
    set_time = _XmValidTimestamp((Widget)tw);
  if (left <= right) {
    if (!data->hasSel2) {
      ...
      result = TRUE;
    if (result) {
      _XmTextSetHighlight((Widget)data->widget, left, right, XmHIGHLIGHT_SECONDARY_SELECTED);
      data->sel2Left = left;
...
Boolean _XmTextGetSel2(XmTextWidget tw, XmTextPosition *left, XmTextPosition *right)
{
  InputData data = tw->text.input->data;
    ...
    XmTextWidget tw, Position x, Position y, Time sel_time, int set_empty_selection)
{
  ...
  if (data->stype == XmSELECT_OUT_LINE) {
    ...
    newLeft = (*tw->text.source->Scan)(tw->text.source, position, data->stype, XmsdLeft, 1, FALSE);
    newRight = (*tw->text.source->Scan)(
        tw->text.source, position, data->stype, XmsdRight, 1, data->stype == XmSELECT_LINE);
  }
  if (data->stype == XmSELECT_WORD && (int)tw->text.char_size > 1) {
    if (position ==
        (*tw->text.source->Scan)(tw->text.source, newLeft, data->stype, XmsdRight, 1, FALSE))
      newLeft = position;
  }
  if (set_empty_selection || newLeft != newRight)
    (*tw->text.source->SetSelection)(tw->text.source, newLeft, newRight, sel_time);
  tw->text.pendingoff = FALSE;
  ...
  _XmTextSetDestinationSelection((Widget)tw, tw->text.cursor_position, False, sel_time);
...
static void SetAnchor(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if ((*tw->text.source->GetSelection)(tw->text.source, &left, &right)) {
    (*tw->text.source->SetSelection)(tw->text.source, data->anchor, data->anchor, event_time);
  }
}
...
static void DoSelection(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XmTextWidget tw = (XmTextWidget)w;
  if (event)
    a_Selection(tw, event->xbutton.x, event->xbutton.y, event->xbutton.time, True);
}
...
static void StartPrimary(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  EraseInsertionPoint(tw);
  if (event)
    data->anchor = (*tw->text.output->XYToPos)(tw, event->xbutton.x, event->xbutton.y);
  else
    data->anchor = tw->text.cursor_position;
  SetSelectionHint(w, event, params, num_params);
  SetScanType(w, data, event);
  if (data->stype != XmSELECT_POSITION ||
      ((*tw->text.source->GetSelection)(tw->text.source, &left, &right) && left != right))
...
static void StartSecondary(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  Time event_time = event ? event->xbutton.time : XtLastTimestampProcessed(XtDisplay(w));
  if (!event_time)
    event_time = _XmValidTimestamp(w);
  data->sel_start = True;
  ...
  data->cancel = False;
  status = XtGrabKeyboard(w, False, GrabModeAsync, GrabModeAsync, CurrentTime);
...
static Boolean InSelection(Widget w, XEvent *event)
{
  ...
  Position x, y;
  if (event) {
    position = (*tw->text.output->XYToPos)(tw, event->xbutton.x, event->xbutton.y);
    x = event->xbutton.x;
  }
  else {
  ...
  return ((*tw->text.source->GetSelection)(tw->text.source, &left, &right) && (right != left) &&
          ((position > left && position < right) ||
           (position == left && (*tw->text.output->PosToXY)(tw, left, &left_x, &left_y) &&
            x > left_x) ||
           (position == right && (*tw->text.output->PosToXY)(tw, right, &right_x, &right_y) &&
            x < right_x)));
}
      ...
      case ButtonPress:
             ...
             event_time - data->lasttime < XtGetMultiClickTime(XtDisplay(w))))
        {
          ...
          if (data->transfer_action == NULL) {
            data->transfer_action = (_XmTextActionRec *)XtMalloc(sizeof(_XmTextActionRec));
            data->transfer_action->event = (XEvent *)XtMalloc(sizeof(XEvent));
          }
          memcpy((void *)data->transfer_action->event, (void *)event, sizeof(XEvent));
      ...
      case ButtonRelease:
        if (data->drag_id) {
          ...
          if (*data->transfer_action->num_params) {
            XtCallActionProc(
                w, data->transfer_action->params[0], data->transfer_action->event, NULL, 0);
          }
        }
        XtCallActionProc(w, params[0], event, NULL, 0);
        break;
...
static void DoExtendedSelection(Widget w, Time ev_time)
{
  ...
  if (!((*tw->text.source->GetSelection)(tw->text.source, &left, &right)) || left == right) {
    ...
    bal_point = (float)(((float)(data->origRight - data->origLeft) / 2.0) + (float)data->origLeft);
  ...
  {
    data->extendDir = (data->extendDir == XmsdRight) ? XmsdLeft : XmsdRight;
    left = data->origLeft;
  ...
  if (data->extendDir == XmsdRight) {
    ...
    if (data->stype == XmSELECT_OUT_LINE) {
      ...
      left = cursorPos = (*tw->text.source->Scan)(
          tw->text.source, position, data->stype, XmsdLeft, 1, FALSE);
    }
    if (data->stype == XmSELECT_WORD && (int)tw->text.char_size > 1) {
      if (position ==
          (*tw->text.source->Scan)(tw->text.source, left, data->stype, XmsdRight, 1, FALSE))
...
static void DoSecondaryExtend(Widget w, Time ev_time)
{
  ...
  if ((data->Sel2ExtendDir == XmsdRight && position < data->Sel2OrigLeft) ||
      (data->Sel2ExtendDir == XmsdLeft && position > data->Sel2OrigRight))
  {
    data->Sel2ExtendDir = (data->Sel2ExtendDir == XmsdRight) ? XmsdLeft : XmsdRight;
    left = data->Sel2OrigLeft;
    right = data->Sel2OrigRight;
  }
  if (data->Sel2ExtendDir == XmsdRight)
    right = (*tw->text.source->Scan)(
        tw->text.source, position, XmSELECT_POSITION, XmsdRight, 1, FALSE);
  else
    left = (*tw->text.source->Scan)(
        tw->text.source, position, XmSELECT_POSITION, XmsdLeft, 1, FALSE);
...
static void BrowseScroll(XtPointer closure, XtIntervalId *id)
{
  ...
  if (tw->text.output->data->vbar)
    XtVaGetValues((Widget)tw->text.output->data->vbar, XmNrepeatDelay, &interval, NULL);
  XSync(XtDisplay(w), False);
  data->select_id = XtAppAddTimeOut(
      XtWidgetToApplicationContext(w), (unsigned long)interval, BrowseScroll, (XtPointer)w);
}
...
static Boolean CheckTimerScrolling(Widget w, XEvent *event)
{
  ...
  if ((event->xmotion.x > (int)o_data->leftmargin) &&
      ...
      (event->xmotion.y < (int)(o_data->topmargin + (o_data->lineheight * o_data->number_lines))))
  {
    if (data->select_id) {
      XtRemoveTimeOut(data->select_id);
      data->select_id = 0;
    ...
    if (XmDirectionMatch(XmPrim_layout_direction(tw), XmTOP_TO_BOTTOM_RIGHT_TO_LEFT)) {
      ...
      if (event->xmotion.y <= (int)o_data->topmargin)
        data->select_pos_y = (Position)(o_data->topmargin -
                                        (o_data->font_ascent + o_data->font_descent + 1));
      /* to the below of the text */
      else if (event->xmotion.y >= (int)(tw->core.height - o_data->bottommargin))
        data->select_pos_y = (Position)((tw->core.height - o_data->bottommargin) +
                                        (o_data->font_ascent + o_data->font_descent + 1));
      /* right the text */
      if (event->xmotion.x >= (int)(tw->core.width - o_data->rightmargin)) {
        data->select_pos_x = (int)((tw->core.width - o_data->rightmargin) + o_data->linewidth);
        if (tw->text.top_line == 0)
          data->select_pos_x = tw->core.width;
        /* left the text */
      }
      else if (event->xmotion.x <= (int)((tw->core.width - o_data->rightmargin) -
                                         (o_data->linewidth * (o_data->number_lines + 1))))
        data->select_pos_y = (tw->core.width - o_data->rightmargin) -
                             (o_data->linewidth * (o_data->number_lines + 1));
      /* ask the vertical scroller its delay */
      if (o_data->hbar)
        XtVaGetValues(o_data->hbar, XmNinitialDelay, &interval, NULL);
    }
    else {
      /* to the left of the text */
      if (event->xmotion.x <= (int)o_data->leftmargin)
        data->select_pos_x = (Position)(o_data->leftmargin - (o_data->averagecharwidth + 1));
      /* to the right of the text */
      else if (event->xmotion.x >= (int)(tw->core.width - o_data->rightmargin))
        data->select_pos_x = (Position)((tw->core.width - o_data->rightmargin) +
      ...
      if (event->xmotion.y <= (int)o_data->topmargin) {
        ...
        /* below the text */
               ...
               (int)(o_data->topmargin + (o_data->lineheight * o_data->number_lines)))
        data->select_pos_y = o_data->topmargin + (o_data->lineheight * (o_data->number_lines + 1));
      /* ask the vertical scroller its delay */
      if (o_data->vbar)
        XtVaGetValues(o_data->vbar, XmNinitialDelay, &interval, NULL);
    }
    if (!data->select_id)
      data->select_id = XtAppAddTimeOut(
          XtWidgetToApplicationContext(w), interval, BrowseScroll, (XtPointer)w);
    return True;
  }
  return False;
}
...
static void ExtendSelection(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (data->selectionHint.x || data->selectionHint.y) {
    ...
    a_Selection(tw, data->selectionHint.x, data->selectionHint.y, event_time, False);
    data->selectionHint.x = data->selectionHint.y = 0;
    data->extending = True;
  }
...
static void ExtendSecondary(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (data->Sel2Hint.x || data->Sel2Hint.y) {
    ...
    hintposition = (*tw->text.output->XYToPos)(tw, data->Sel2Hint.x, data->Sel2Hint.y);
    if (position < hintposition) {
      data->Sel2Extending = _XmTextSetSel2(tw, position, hintposition, event_time);
      data->Sel2OrigLeft = hintposition; /**/
      data->Sel2OrigRight = hintposition;
      data->Sel2ExtendDir = XmsdLeft;
    }
    else {
      data->Sel2Extending = _XmTextSetSel2(tw, hintposition, position, event_time);
      data->Sel2OrigLeft = hintposition;
      data->Sel2OrigRight = hintposition; /**/
...
static void DoGrabFocus(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (event) {
    if (XmDirectionMatch(XmPrim_layout_direction(tw), XmTOP_TO_BOTTOM_RIGHT_TO_LEFT)) {
      ...
      else if (event->xbutton.y >= (int)(tw->core.height - o_data->bottommargin))
        event->xbutton.y = (Position)((tw->core.height - o_data->bottommargin) - 1);
      /* above the text */
      ...
      /* below the text */
               ...
               (int)(o_data->topmargin + (o_data->lineheight * o_data->number_lines)))
        event->xbutton.y = (o_data->topmargin + (o_data->lineheight * o_data->number_lines)) - 1;
    }
  }
  /* CR 9058: "No-op" calls to traversal may generate focus events. */
  if ((_XmGetFocusPolicy(w) == XmEXPLICIT) && (XmGetFocusWidget(w) != w))
    (void)XmProcessTraversal(w, XmTRAVERSE_CURRENT);
...
static void MoveDestination(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  Time event_time = event ? event->xbutton.time : XtLastTimestampProcessed(XtDisplay((Widget)tw));
  _XmTextResetIC(w);
  EraseInsertionPoint(tw);
  if (event)
    new_pos = (*tw->text.output->XYToPos)(tw, event->xbutton.x, event->xbutton.y);
  else
    new_pos = tw->text.cursor_position;
  if ((*tw->text.source->GetSelection)(tw->text.source, &left, &right) && (right != left))
...
static void Stuff(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (data->selectionLink)
    XmePrimarySink(w, XmLINK, (XtPointer)point, event_time);
  else if (data->selectionMove)
    XmePrimarySink(w, XmMOVE, (XtPointer)point, event_time);
  else
    XmePrimarySink(w, XmCOPY, (XtPointer)point, event_time);
}

void _XmTextHandleSecondaryFinished(Widget w, XEvent *event)
{
  XmTextWidget tw = (XmTextWidget)w;
  ...
  if (dest_data->has_destination) {
    ...
    else if (dest_data->position > data->sel2Left && dest_data->position < data->sel2Right) {
      data->sel2Left -= dest_data->replace_length;
      data->sel2Right += adjustment - dest_data->replace_length;
    }
  }
  ...
  if (dest_data->position <= data->sel2Left)
    left += adjustment;
  if (_XmTextModifyVerify(tw, NULL, &left, &right, &cursorPos, &block, &newblock, &freeBlock)) {
    if ((*tw->text.source->Replace)(tw, NULL, &left, &right, &newblock, False) != EditDone) {
      ...
      if (dest_data->has_destination && dest_data->position > right) {
        ...
        _XmTextSetDestinationSelection(
            (Widget)dest_tw, dest_tw->text.cursor_position, False, time);
      }
...
static void SecondaryNotify(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (data->selectionMove == TRUE && data->has_destination &&
      tw->text.dest_position >= data->sel2Left && tw->text.dest_position <= data->sel2Right)
  {
  ...
  dest_tw = tw;
  if (!dest_tw->text.input->data->has_destination && dest_tw->text.source->data->numwidgets > 1) {
    int i;
    ...
    if (i == tw->text.source->data->numwidgets)
      dest_tw = tw;
  }
  ...
  if ((*dest_tw->text.source->GetSelection)(dest_tw->text.source, &left, &right) && left != right)
  {
  ...
  _XmTextSetHighlight((Widget)data->widget, data->sel2Left, data->sel2Right, XmHIGHLIGHT_NORMAL);
  /*
  ...
  if (!event_time)
    event_time = _XmValidTimestamp(w);
  if (data->selectionLink)
    XmeSecondaryTransfer(w, XmeGetEncodingAtom(w), XmLINK, event_time);
  else if (data->selectionMove)
    XmeSecondaryTransfer(w, XmeGetEncodingAtom(w), XmMOVE, event_time);
  else
...
static void ExtendSecondaryEnd(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if ((data->Sel2Extending || dragged(data->Sel2Hint, event, data->threshold)) && !data->cancel) {
...
static void SelectAll(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XmTextWidget tw = (XmTextWidget)w;
  InputData data = tw->text.input->data;
  XmTextPosition last_position = (*tw->text.source->Scan)(
      tw->text.source, 0, XmSELECT_ALL, XmsdRight, 1, TRUE);
  Time event_time = event ? event->xkey.time : XtLastTimestampProcessed(XtDisplay((Widget)tw));
  EraseInsertionPoint(tw);
  data->stype = XmSELECT_ALL;
  (*tw->text.source->SetSelection)(tw->text.source, 0, last_position, event_time);
...
static void ClearSelection(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (!(*tw->text.source->GetSelection)(tw->text.source, &left, &right)) {
    ...
    char *select_string = _XmStringSourceGetString(tw, left, right, False);
    XmTextBlockRec block, newblock;
    int num_spaces = right - left;
    int i;
    for (i = 0; i < num_spaces; i++) {
      if (select_string[i] != '\012')
        select_string[i] = ' ';
    }
    block.ptr = select_string;
    block.length = num_spaces;
    block.format = XmFMT_8_BIT;
    if (_XmTextModifyVerify(tw, event, &left, &right, NULL, &block, &newblock, &freeBlock)) {
      if ((*tw->text.source->Replace)(tw, NULL, &left, &right, &newblock, False) != EditDone) {
        RingBell(w, event, params, num_params);
      }
      else {
...
static void CutClipboard(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (!event_time)
    event_time = _XmValidTimestamp(w);
  EraseInsertionPoint(tw);
  if (_XmStringSourceGetEditable(GetSrc(w)) && (*source->GetSelection)(source, &left, &right) &&
      right != left)
...
static void TextFocusOut(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (event && event->xfocus.send_event && _XmGetFocusPolicy(w) == XmEXPLICIT &&
      !tw->text.traversed)
  {
    (void)VerifyLeave(w, event);
  }
  else if (tw->text.traversed)
...
static void ProcessCancel(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (_XmStringSourceHasSelection(tw->text.source) && data->extending) {
    ...
    _XmTextSetDestinationSelection((Widget)tw, tw->text.cursor_position, False, event_time);
    /* reset origLeft and origRight */
    (*tw->text.source->SetSelection)(tw->text.source, data->origLeft, data->origRight, event_time);
  }
  if (!data->cancel)
    (void)_XmParentProcess(XtParent(tw), (XmParentProcessData)&p_event);
  if (data->select_id) {
...
externaldef(nonvisible) XtPointer _XmdefaultTextActionsTable = (XtPointer)ZdefaultTextActionsTable;
...
static void InputGetValues(Widget wid, ArgList args, Cardinal num_args)
{
  ...
  XtGetSubvalues(
      (XtPointer)tw->text.input->data, input_resources, XtNumber(input_resources), args, num_args);
}
    ...
    Widget oldw, Widget reqw, Widget new_w, ArgList args, Cardinal *num_args)
{
  ...
  XtSetSubvalues((XtPointer)data, input_resources, XtNumber(input_resources), args, *num_args);
  /*
...
{
  XmTextWidget tw = (XmTextWidget)w;
  Atom MOTIF_DESTINATION = XInternAtom(XtDisplay(tw), XmS_MOTIF_DESTINATION, False);
  Widget dest = XmGetDestination(XtDisplay(w));
  if (dest == w)
    _XmSetDestination(XtDisplay(w), NULL);
  if (tw->core.window == XGetSelectionOwner(XtDisplay(tw), MOTIF_DESTINATION))
    XtDisownSelection(w, MOTIF_DESTINATION, XtLastTimestampProcessed(XtDisplay(w)));
  if (tw->core.window == XGetSelectionOwner(XtDisplay(tw), XA_PRIMARY))
    XtDisownSelection(w, XA_PRIMARY, XtLastTimestampProcessed(XtDisplay(w)));
  if (tw->core.window == XGetSelectionOwner(XtDisplay(tw), XA_SECONDARY))
    XtDisownSelection(w, XA_SECONDARY, XtLastTimestampProcessed(XtDisplay(w)));
...
void _XmTextInputGetSecResData(XmSecondaryResourceData *secResDataRtn)
{
  XmSecondaryResourceData secResData;
  secResData = XtNew(XmSecondaryResourceDataRec);
  _XmTransformSubResources(input_resources,
...
static void DragProcCallback(Widget w, XtPointer client, XtPointer call)
{
  ...
  static char *atom_names[] = {XmSCOMPOUND_TEXT,
                               XmSTEXT,
#ifdef XM_UTF8
                               XmSUTF8_STRING
#endif
...
#ifdef XM_UTF8
      if (XmTargetsAreCompatible(XtDisplay(drag_cont), exp_targets, num_exp_targets, targets, 5))
#else
...
void _XmTextInputCreate(Widget wid, ArgList args, Cardinal num_args)
{
  XmTextWidget tw = (XmTextWidget)wid;
  Input input;
  InputData data;
...
static XmTextPosition XtoPosInLine(XmTextWidget tw, Position x, LineNum line)
{
  ...
  Position x1 = 0, y1 = 0;
  XmTextPosition pos;
  pos = (*tw->text.output->XYToPos)(tw, x, line * data->lineheight + data->topmargin);
...
static XmTextPosition YtoPosInLine(XmTextWidget tw, Position y, LineNum line)
{
  ...
  pos = (*tw->text.output->XYToPos)(
      tw, tw->text.inner_widget->core.width - (line * data->linewidth) - data->rightmargin, y);
  (*tw->text.output->PosToXY)(tw, pos, &x1, &y1);
  if (pos > 0 && y1 > y)
    return pos - 1;
  else
