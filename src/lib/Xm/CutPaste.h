...
typedef void (*XmCutPasteProc)(Widget w, long *data_id, long *private_id, int *reason);
typedef void (*VoidProc)(Widget w, int *data_id, int *private_id, int *reason);
/********    Public Function Declarations    ********/
extern int XmClipboardBeginCopy(Display *display,
                                Window window,
                                XmString label,
                                Widget widget,
                                VoidProc callback,
                                long *itemid);
extern int XmClipboardStartCopy(Display *display,
                                Window window,
                                XmString label,
                                Time timestamp,
                                Widget widget,
...
extern int XmClipboardWithdrawFormat(Display *display, Window window, long data);
...
extern int XmClipboardUnlock(Display *display, Window window, Boolean all_levels);
...
extern int XmClipboardRetrieve(Display *display,
                               ...
                               long *private_id);
extern int XmClipboardInquireCount(Display *display,
                                   Window window,
                                   int *count,
                                   unsigned long *maxlength);
extern int XmClipboardInquireFormat(Display *display,
                                    Window window,
                                    int n,
                                    XtPointer buffer,
