...
extern void XmListAddItemsUnselected(Widget w, XmString *items, int item_count, int pos);
...
extern void XmListDeletePositions(Widget w, int *position_list, int position_count);
...
extern void XmListReplaceItemsUnselected(Widget w,
                                         XmString *old_items,
                                         int item_count,
                                         XmString *new_items);
extern void XmListReplaceItemsPosUnselected(Widget w,
                                            XmString *new_items,
                                            int item_count,
                                            int position);
extern void XmListReplacePositions(Widget w,
                                   int *position_list,
                                   XmString *item_list,
                                   int item_count);
...
extern int XmListGetKbdItemPos(Widget w);
extern Boolean XmListSetKbdItemPos(Widget w, int pos);
extern int XmListYToPos(Widget w, Position y);
...
extern void XmListUpdateSelectedList(Widget w);
