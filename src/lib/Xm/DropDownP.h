...
#define XmDropDown_popup_offset(w) (((XmDropDownWidget)(w))->combo.popup_offset)
#define XmDropDown_verify(w) (((XmDropDownWidget)(w))->combo.verify)
#define XmDropDown_editable(w) (((XmDropDownWidget)(w))->combo.editable)
#define XmDropDown_show_label(w) (((XmDropDownWidget)(w))->combo.show_label)
#define XmDropDown_customized_combo_box(w) (((XmDropDownWidget)(w))->combo.customized_combo_box)
#define XmDropDown_use_text_field(w) (((XmDropDownWidget)(w))->combo.use_text_field)
#define XmDropDown_popup_shell(w) (((XmDropDownWidget)(w))->combo.popup_shell)
#define XmDropDown_popup_cursor(w) (((XmDropDownWidget)(w))->combo.popup_cursor)
#define XmDropDown_translations(w) (((XmDropDownWidget)(w))->combo.translations)
#define XmDropDown_verify_text_callback(w) (((XmDropDownWidget)(w))->combo.verify_text_callback)
#define XmDropDown_verify_text_failed_callback(w) \
  (((XmDropDownWidget)(w))->combo.verify_text_failed_callback)
#define XmDropDown_update_text_callback(w) (((XmDropDownWidget)(w))->combo.update_text_callback)
#define XmDropDown_update_shell_callback(w) (((XmDropDownWidget)(w))->combo.update_shell_callback)
#define XmDropDown_visible_items(w) (((XmDropDownWidget)(w))->combo.visible_items)
#define XmDropDown_new_visual_style(w) (((XmDropDownWidget)(w))->combo.new_visual_style)
...
#define XmDropDown_activateOnFill(w) (((XmDropDownWidget)(w))->combo.activateOnFill)
#define XmDropDown_doActivate(w) (((XmDropDownWidget)(w))->combo.doActivate)
#define XmDropDown_inValueChanged(w) (((XmDropDownWidget)(w))->combo.inValueChanged)
...
typedef Boolean (*XmDropDownTextListMapProc)(Widget w,    /* combo box */
                                             Widget text, /* text */
                                             Widget list  /* list */
);
