...
extern void _XmTextSetHighlight(Widget, XmTextPosition, XmTextPosition, XmHighlightMode);
extern void _XmTextShowPosition(Widget, XmTextPosition);
extern void _XmTextSetEditable(Widget widget, Boolean editable);
extern void _XmTextResetIC(Widget widget);
extern Boolean _XmTextNeedsPendingDeleteDis(XmTextWidget tw,
                                            XmTextPosition *left,
                                            XmTextPosition *right,
                                            int check_add_mode);
extern void _XmTextReplace(
    Widget widget, XmTextPosition frompos, XmTextPosition topos, char *value, Boolean is_wchar);
extern void _XmTextValidate(XmTextPosition *start, XmTextPosition *end, int maxsize);
extern XmTextPosition _XmTextSetPreeditPosition(Widget w, XmTextPosition cursor_position);
