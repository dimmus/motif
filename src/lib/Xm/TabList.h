...
#define XmTAB_ALL_FLAGS \
  (XmTAB_LABEL_STRING | XmTAB_LABEL_PIXMAP | XmTAB_PIXMAP_PLACEMENT | XmTAB_BACKGROUND | \
   XmTAB_FOREGROUND | XmTAB_VALUE_MODE | XmTAB_LABEL_ALIGNMENT | XmTAB_STRING_DIRECTION | \
