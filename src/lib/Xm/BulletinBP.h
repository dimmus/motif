...
/* Access macros */
#  define BB_CancelButton(w) (((XmBulletinBoardWidget)w)->bulletin_board.cancel_button)
#  define BB_DynamicCancelButton(w) \
    (((XmBulletinBoardWidget)w)->bulletin_board.dynamic_cancel_button)
#  define BB_DefaultButton(w) (((XmBulletinBoardWidget)w)->bulletin_board.default_button)
#  define BB_DynamicDefaultButton(w) \
    (((XmBulletinBoardWidget)w)->bulletin_board.dynamic_default_button)
#  define BB_MarginHeight(w) (((XmBulletinBoardWidget)w)->bulletin_board.margin_height)
#  define BB_MarginWidth(w) (((XmBulletinBoardWidget)w)->bulletin_board.margin_width)
#  define BB_ButtonFontList(w) (((XmBulletinBoardWidget)w)->bulletin_board.button_font_list)
#  define BB_LabelFontList(w) (((XmBulletinBoardWidget)w)->bulletin_board.label_font_list)
#  define BB_TextFontList(w) (((XmBulletinBoardWidget)w)->bulletin_board.text_font_list)
#  define BB_StringDirection(w) \
    (XmDirectionToStringDirection(((XmBulletinBoardWidget)w)->manager.string_direction))
#  define BB_ResizePolicy(w) (((XmBulletinBoardWidget)w)->bulletin_board.resize_policy)
#  define BB_InSetValues(w) (((XmBulletinBoardWidget)w)->bulletin_board.in_set_values)
#  define BB_InitialFocus(w) (((XmBulletinBoardWidget)w)->bulletin_board.initial_focus)
#  ifdef __cplusplus
