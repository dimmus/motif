...
static void GetDetailHeader(Widget wid, int offset, XtArgVal *value);
static void GetDetailHeaderCount(Widget wid, int offset, XtArgVal *value);
static void GetOutlineColumnWidth(Widget wid, int offset, XtArgVal *value);
...
static void GetSize(Widget wid, Dimension *pwidth, Dimension *pheight);
static XtGeometryResult QueryGeometry(Widget wid,
                                      XtWidgetGeometry *intended,
                                      XtWidgetGeometry *desired);
static XtGeometryResult GeometryManager(Widget instigator,
                                        XtWidgetGeometry *desired,
                                        XtWidgetGeometry *allowed);
static void ChangeManaged(Widget wid);
static void ChangeManagedOutlineDetail(Widget wid);
static void ChangeManagedSpatial(Widget wid);
static Boolean RequestSpatialGrowth(Widget wid, Widget cwid);
static void ConstraintInitialize(Widget rcwid, Widget ncwid, ArgList args, Cardinal *num_args);
static void ConstraintDestroy(Widget cwid);
static Boolean ConstraintSetValues(
    Widget ccwid, Widget rcwid, Widget ncwid, ArgList args, Cardinal *num_args);
static Widget ObjectAtPoint(Widget wid, Position x, Position y);
static Boolean TestFitItem(Widget wid, Widget cwid, Position x, Position y);
static Boolean PlaceItem(Widget wid, Widget cwid, unsigned char fit_type);
static Boolean RemoveItem(Widget wid, Widget cwid);
static void GetSpatialSize(Widget wid, Dimension *pwidth, Dimension *pheight);
static void GetSpatialSizeCellAdjustment(Widget wid,
                                         int *width_in_cells,
                                         int *height_in_cells,
                                         ContainerCwidCellInfo cwid_info,
                                         int cwid_info_count);
static void PlaceItemNone(Widget wid, Widget cwid, unsigned char fit_type);
static void PlaceItemGridCells(Widget wid, Widget cwid, unsigned char fit_type);
static int GetCellFromCoord(Widget wid, Position x, Position y);
static XPoint *GetCoordFromCell(Widget wid, int cell_idx, XPoint *point);
static void PlaceItemReset(Widget wid);
static void PlaceCwid(Widget cwid, Position x, Position y);
static XPoint *SnapCwid(Widget cwid, Position x, Position y, XPoint *point);
static void HideCwid(Widget cwid);
static void ContainerNoop(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerHandleBtn1Down(Widget wid,
                                    XEvent *event,
                                    String *params,
                                    Cardinal *num_params);
static void ContainerHandleBtn1Motion(Widget wid,
                                      XEvent *event,
                                      String *params,
                                      Cardinal *num_params);
static void ContainerHandleBtn1Up(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerHandleBtn2Down(Widget wid,
                                    XEvent *event,
                                    String *params,
                                    Cardinal *num_params);
static void ContainerHandleBtn2Motion(Widget wid,
                                      XEvent *event,
                                      String *params,
                                      Cardinal *num_params);
static void ContainerHandleBtn2Up(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerBeginSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerButtonMotion(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerEndSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerBeginToggle(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerEndToggle(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerBeginExtend(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerEndExtend(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerStartTransfer(Widget wid,
                                   XEvent *event,
                                   String *params,
                                   Cardinal *num_params);
static void ContainerEndTransfer(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerPrimaryCopy(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerPrimaryLink(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerPrimaryMove(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerCancel(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerExtend(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerMoveCursor(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerExtendCursor(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerToggleMode(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerSelectAll(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerDeselectAll(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerActivate(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void ContainerExpandOrCollapse(Widget wid,
                                      XEvent *event,
                                      String *params,
                                      Cardinal *num_params);
static void ContainerConvertProc(Widget wid, XtPointer closure, XmConvertCallbackStruct *cs);
static void ContainerDestinationProc(Widget wid,
                                     XtPointer closure,
                                     XmDestinationCallbackStruct *cs);
static void ContainerDestPrehookProc(Widget wid,
                                     XtPointer closure,
                                     XmDestinationCallbackStruct *cs);
static void ContGetValues(Widget wid, XmContainerData contData);
static unsigned char GetVisualEmphasis(Widget cwid);
static void SetVisualEmphasis(Widget cwid, unsigned char emphasis);
static unsigned char GetViewType(Widget cwid);
static void SetViewType(Widget cwid, unsigned char viewtype);
static Dimension GetIconWidth(Widget cwid);
static Cardinal GetDefaultDetailCount(Widget wid);
static XmTabList SetDynamicTabList(Widget wid);
static XmTabList GetDumbTabList(int tab_size, Cardinal asked_num_tab);
static Dimension GetDynFirstColWidth(Widget wid);
static void ResizeIconWidths(Widget wid);
static void Layout(Widget wid);
static void RequestOutlineDetail(Widget wid, XtWidgetGeometry *geo_desired);
static void LayoutOutlineDetail(Widget wid);
static void LayoutSpatial(Widget wid, Boolean growth_req_allowed, CwidNode stop_node);
static void SetCellSizes(Widget wid);
static void SetLargeCellSizes(Widget wid);
static void SetSmallCellSizes(Widget wid);
static void SizeOutlineButton(Widget wid);
static void UpdateGCs(Widget wid);
static void CreateIconHeader(Widget wid);
static Widget GetRealIconHeader(Widget wid);
...
static Boolean NodeIsActive(CwidNode node);
static CwidNode GetNextUpLevelNode(CwidNode start_item);
static void StartSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static Boolean ProcessButtonMotion(Widget wid,
                                   XEvent *event,
                                   String *params,
                                   Cardinal *num_params);
static Boolean SelectAllCwids(Widget wid);
static Boolean DeselectAllCwids(Widget wid);
static Boolean MarkCwid(Widget cwid, Boolean visual_only);
static Boolean UnmarkCwidVisual(Widget cwid);
static void SetMarkedCwids(Widget wid);
static Boolean ResetMarkedCwids(Widget wid);
static Boolean MarkCwidsInRange(Widget wid, Widget cwid1, Widget cwid2, Boolean visual_only);
static Boolean MarkCwidsInMarquee(Widget wid, Boolean find_anchor, Boolean visual_only);
static Boolean InMarquee(Widget cwid);
static void RecalcMarquee(Widget wid, Widget cwid, Position x, Position y);
static void DrawMarquee(Widget wid);
static void KBSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void SetLocationCursor(Widget cwid);
static void CalcNextLocationCursor(Widget wid, String direction);
static Widget RedirectTraversal(Widget old_focus,
                                Widget new_focus,
                                unsigned int focus_policy,
                                XmTraversalDirection direction,
                                unsigned int pass);
static CwidNode GetLastTraversableChild(CwidNode node);
static CwidNode GetPrevTraversableSibling(CwidNode node);
static CwidNode GetPrevTraversableUplevel(CwidNode node);
static CwidNode GetNextTraversableChild(CwidNode node);
static CwidNode GetNextTraversableSibling(CwidNode node);
static CwidNode GetNextTraversableUplevel(CwidNode node);
static CwidNode GetNextTraversable(CwidNode node);
static Widget GetLastTraversalWidget(XmContainerWidget cw, Widget child, Boolean wrap);
static Widget GetFirstTraversalWidget(XmContainerWidget cw, Widget child, Boolean wrap);
static Widget GetNextTraversalWidget(XmContainerWidget cw, Widget child, Boolean wrap);
static Widget GetPrevTraversalWidget(XmContainerWidget cw, Widget child, Boolean wrap);
static void MakeOutlineButton(Widget cwid);
static void ChangeOutlineButtons(Widget wid);
static void ExpandCwid(Widget cwid);
static void CollapseCwid(Widget cwid);
static void CallActionCB(Widget cwid, XEvent *event);
static void CallSelectCB(Widget wid, XEvent *event, unsigned char auto_selection_type);
static WidgetList GetSelectedCwids(Widget wid);
static void GetSelectedItems(Widget wid, int offset, XtArgVal *value);
static int CompareInts(XmConst void *p1, XmConst void *p2);
static int Isqrt(int n);
static void GainPrimary(Widget wid, Time timestamp);
static void ConvertRefuse(Widget wid, XtPointer closure, XmConvertCallbackStruct *cs);
static void DragStart(XtPointer data, XtIntervalId *id);
static void OutlineButtonCallback(Widget pbwid, XtPointer client_data, XtPointer call_data);
static void OutlineButtonAction(Widget cwid, unsigned char new_state, XEvent *event);
static void MoveItemCallback(Widget wid, XtPointer client_data, XtPointer call_data);
static void DropDoneCallback(Widget wid, XtPointer client_data, XtPointer call_data);
static void FreeLocationData(Widget wid, XtEnum op, XmTransferDoneCallbackStruct *);
static Boolean SetupDrag(Widget wid, XEvent *event, String *params, Cardinal *num_params);
...
static void EnterHandler(Widget wid,
                         XtPointer closure,
                         XEvent *event,
                         Boolean *continue_to_dispatch);
static void LeaveHandler(Widget wid,
                         XtPointer closure,
                         XEvent *event,
                         Boolean *continue_to_dispatch);
static void ScrollProc(XtPointer closure, XtIntervalId *id);
...
static XtResource resources[] = {
    ...
    {XmNcollapsedStatePixmap,
     ...
     XmRCallProc,
     (XtPointer)DefaultCollapsedPixmap},
    {XmNconvertCallback,
     XmCCallback,
     XmRCallback,
    ...
    {XmNoutlineButtonPolicy,
     ...
     XmROutlineButtonPolicy,
     sizeof(unsigned char),
     XtOffsetOf(XmContainerRec, container.ob_policy),
     XmRImmediate,
     (XtPointer)XmOUTLINE_BUTTON_PRESENT},
    ...
    {XmNprimaryOwnership,
     ...
     XmRImmediate,
     (XtPointer)XmOWN_POSSIBLE_MULTIPLE},
    {"pri.vate",
     "Pri.vate",
     XmRBoolean,
     sizeof(Boolean),
    ...
    {XmNselectColor,
     ...
     XmRImmediate,
     (XtPointer)XmREVERSED_GROUND_COLORS},
    {XmNselectedObjects,
     XmCSelectedObjects,
     XmRWidgetList,
     sizeof(WidgetList),
...
externaldef(xmcontainerwidgetclass)
 ...
 * GetDetailHeader
 ************************************************************************/
static void GetDetailHeader(Widget wid,
                            int offset, /* unused */
                            XtArgVal *value)
{
 ...
 * GetDetailHeaderCount
 ************************************************************************/
static void GetDetailHeaderCount(Widget wid,
                                 int offset, /* unused */
                                 XtArgVal *value)
{
  Widget icon_header;
  ...
  /* If there is an icon_header, fetch the information out of it */
  if ((icon_header = GetRealIconHeader(wid)) != NULL) {
    XtVaGetValues(icon_header, XmNdetailCount, &detail_header_count, NULL);
 ...
 * GetOutlineColumnWidth
 ************************************************************************/
static void GetOutlineColumnWidth(Widget wid,
                                  int offset, /* unused */
                                  XtArgVal *value)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
...
static void ClassPartInitialize(WidgetClass wc)
{
  ...
  if (wc != xmContainerWidgetClass) {
    ...
    if (this_class->container_class.test_fit_item == XmInheritSpatialTestFitProc)
      this_class->container_class.test_fit_item = super->container_class.test_fit_item;
    if (this_class->container_class.place_item == XmInheritSpatialPlacementProc)
      this_class->container_class.place_item = super->container_class.place_item;
    if (this_class->container_class.remove_item == XmInheritSpatialRemoveProc)
      this_class->container_class.remove_item = super->container_class.remove_item;
    if (this_class->container_class.get_spatial_size == XmInheritSpatialGetSize)
      this_class->container_class.get_spatial_size = super->container_class.get_spatial_size;
  }
                       ...
                       Cardinal *num_args) /* unused */
{
   ...
   */
  if (!XmRepTypeValidValue(XmRID_AUTOMATIC_SELECTION, ncw->container.automatic, nw))
    ncw->container.automatic = XmAUTO_SELECT;
  if (!XmRepTypeValidValue(XmRID_ENTRY_VIEW_TYPE, ncw->container.entry_viewtype, nw))
    ncw->container.entry_viewtype = XmANY_ICON;
  if (!XmRepTypeValidValue(XmRID_SPATIAL_INCLUDE_MODEL, ncw->container.include_model, nw))
    ncw->container.include_model = XmAPPEND;
  if (!XmRepTypeValidValue(XmRID_LAYOUT_TYPE, ncw->container.layout_type, nw))
    ncw->container.layout_type = XmSPATIAL;
  if (!XmRepTypeValidValue(XmRID_LINE_STYLE, ncw->container.outline_sep_style, nw))
    ncw->container.outline_sep_style = XmSINGLE;
  if (!XmRepTypeValidValue(XmRID_OUTLINE_BUTTON_POLICY, ncw->container.ob_policy, nw))
    ncw->container.ob_policy = XmOUTLINE_BUTTON_PRESENT;
  if (!XmRepTypeValidValue(XmRID_SPATIAL_STYLE, ncw->container.spatial_style, nw))
    ncw->container.spatial_style = XmGRID;
  if (!XmRepTypeValidValue(XmRID_PRIMARY_OWNERSHIP, ncw->container.primary_ownership, nw))
    ncw->container.primary_ownership = XmOWN_POSSIBLE_MULTIPLE;
  if (!XmRepTypeValidValue(XmRID_SPATIAL_RESIZE_MODEL, ncw->container.resize_model, nw))
    ncw->container.resize_model = XmGROW_MINOR;
  if (!XmRepTypeValidValue(XmRID_SELECTION_POLICY, ncw->container.selection_policy, nw))
    ncw->container.selection_policy = XmEXTENDED_SELECT;
  if (!XmRepTypeValidValue(XmRID_SELECTION_TECHNIQUE, ncw->container.selection_technique, nw))
    ncw->container.selection_technique = XmTOUCH_OVER;
  if (!XmRepTypeValidValue(XmRID_SPATIAL_SNAP_MODEL, ncw->container.snap_model, nw))
  ...
  ncw->container.kaddmode = (CtrPolicyIsMULTIPLE(ncw) || CtrPolicyIsSINGLE(ncw));
  ...
  if (ncw->container.render_table == NULL) {
    ...
    ncw->container.render_table = XmFontListCopy(ncw->container.render_table);
  /*
  ...
  if (ncw->container.detail_tablist != NULL)
    ncw->container.detail_tablist = XmTabListCopy(ncw->container.detail_tablist, 0, 0);
  /*
  ...
  else if (ncw->container.select_color == XmHIGHLIGHT_COLOR) {
  ...
  if (ncw->container.detail_heading_count > 0) {
    ...
    ncw->container.saved_detail_heading_count = ncw->container.detail_heading_count;
  ...
  XtSetArg(wargs[n], XmNimportTargets, targets);
  n++;
  XtSetArg(wargs[n], XmNnumImportTargets, 1);
  n++;
   ...
   * Set Cell sizes.
   */
  ncw->container.large_cell_dim_fixed = ((ncw->container.large_cell_height > 0) &&
                                         (ncw->container.large_cell_width > 0));
  ncw->container.small_cell_dim_fixed = ((ncw->container.small_cell_height > 0) &&
                                         (ncw->container.small_cell_width > 0));
  SetCellSizes(nw);
  /*
   * init auto scroll related data
   */
  scrollFrameTrait = (XmScrollFrameTrait)XmeTraitGet((XtPointer)XtClass(XtParent(nw)),
                                                     XmQTscrollFrame);
  if (scrollFrameTrait && (scrollFrameTrait->getInfo(XtParent(nw), NULL, NULL, NULL))) {
...
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  XmScrollFrameTrait scrollFrameTrait = (XmScrollFrameTrait)XmeTraitGet(
      (XtPointer)XtClass(XtParent(wid)), XmQTscrollFrame);
...
static void Resize(Widget wid)
{
   ...
   */
  if (CtrLayoutIsOUTLINE_DETAIL(cw) && (!CtrLayoutIsDETAIL(cw)) && (!LayoutIsRtoLM(cw)))
    return;
  /*
   * One-dimensional Right-to_Left layouts are oblivious to
   * height changes; so, just return if the width hasn't changed.
   */
  if (CtrLayoutIsOUTLINE_DETAIL(cw) && (cw->core.width == cw->container.prev_width))
    return;
  /*
...
static void Redisplay(Widget wid, XEvent *event, Region region)
{
  ...
  if (cw->container.marquee_drawn) {
    ...
    XSetForeground(XtDisplay(wid), cw->container.normalGC, cw->core.background_pixel);
    ...
    XSetForeground(XtDisplay(wid), cw->container.normalGC, cw->manager.foreground);
  }
  /*
                         ...
                         Cardinal *num_args) /* unused */
{
  ...
  if (ncw->container.automatic != ccw->container.automatic) {
    if (!XmRepTypeValidValue(XmRID_AUTOMATIC_SELECTION, ncw->container.automatic, nw))
      ncw->container.automatic = ccw->container.automatic;
  }
  if (ncw->container.entry_viewtype != ccw->container.entry_viewtype) {
    if (!XmRepTypeValidValue(XmRID_ENTRY_VIEW_TYPE, ncw->container.entry_viewtype, nw))
      ncw->container.entry_viewtype = ccw->container.entry_viewtype;
  }
  if (ncw->container.include_model != ccw->container.include_model) {
    if (!XmRepTypeValidValue(XmRID_SPATIAL_INCLUDE_MODEL, ncw->container.include_model, nw))
      ncw->container.include_model = ccw->container.include_model;
  }
  ...
  if (ncw->container.primary_ownership != ccw->container.primary_ownership) {
    if (!XmRepTypeValidValue(XmRID_PRIMARY_OWNERSHIP, ncw->container.primary_ownership, nw))
      ncw->container.primary_ownership = ccw->container.primary_ownership;
  }
  if (ncw->container.resize_model != ccw->container.resize_model) {
    if (!XmRepTypeValidValue(XmRID_SPATIAL_RESIZE_MODEL, ncw->container.resize_model, nw))
      ncw->container.resize_model = ccw->container.resize_model;
  }
  if (ncw->container.selection_policy != ccw->container.selection_policy) {
    if (!XmRepTypeValidValue(XmRID_SELECTION_POLICY, ncw->container.selection_policy, nw))
      ncw->container.selection_policy = ccw->container.selection_policy;
  }
  if (ncw->container.selection_technique != ccw->container.selection_technique) {
    if (!XmRepTypeValidValue(XmRID_SELECTION_TECHNIQUE, ncw->container.selection_technique, nw))
      ncw->container.selection_technique = ccw->container.selection_technique;
  }
      ...
      (ncw->container.entry_viewtype != XmANY_ICON))
  {
    ...
    if (CtrLayoutIsSPATIAL(ncw) && !CtrLayoutIsSPATIAL(ccw)) {
      ...
      while (node) {
        ...
        XmeConfigureObject(cwid, cwid->core.x, cwid->core.y, desired.width, desired.height, 0);
        /*
  ...
  {
    if ((ncw->container.large_cell_width != ccw->container.large_cell_width) &&
        (ncw->container.large_cell_width == 0))
      ncw->container.large_cell_dim_fixed = False;
    if ((ncw->container.large_cell_height != ccw->container.large_cell_height) &&
        (ncw->container.large_cell_height == 0))
      ncw->container.large_cell_dim_fixed = False;
    SetCellSizes(nw);
    if ((ncw->container.real_large_cellw != ccw->container.real_large_cellw) ||
        (ncw->container.real_large_cellh != ccw->container.real_large_cellh))
    {
      ncw->container.current_width_in_cells = 0;
      ncw->container.current_height_in_cells = 0;
      spatial_need_layout = True;
  ...
  if (CtrLayoutIsSPATIAL(ncw) && !CtrSpatialStyleIsNONE(ncw) && CtrViewIsSMALL_ICON(ncw)) {
    if ((ncw->container.small_cell_width != ccw->container.small_cell_width) &&
        (ncw->container.small_cell_width == 0))
      ncw->container.small_cell_dim_fixed = False;
    if ((ncw->container.small_cell_height != ccw->container.small_cell_height) &&
        (ncw->container.small_cell_height == 0))
      ncw->container.small_cell_dim_fixed = False;
    SetCellSizes(nw);
    if ((ncw->container.real_small_cellw != ccw->container.real_small_cellw) ||
        (ncw->container.real_small_cellh != ccw->container.real_small_cellh))
    {
      ncw->container.current_width_in_cells = 0;
      ncw->container.current_height_in_cells = 0;
      spatial_need_layout = True;
  ...
  if ((ncw->container.collapsed_state_pixmap != ccw->container.collapsed_state_pixmap) ||
      (ncw->container.expanded_state_pixmap != ccw->container.expanded_state_pixmap))
  {
   ...
   */
  if ((ncw->container.detail_order != ccw->container.detail_order) ||
      (ncw->container.detail_order_count != ccw->container.detail_order_count))
  {
    detail_need_layout = True;
    if (ccw->container.detail_order_count && ccw->container.detail_order) {
   ...
   * have changed.
   */
  if (CtrLayoutIsSPATIAL(ncw) && ((ncw->container.layout_type != ccw->container.layout_type) ||
                                  (ncw->container.spatial_style != ccw->container.spatial_style)))
  {
    if (((XmContainerWidgetClass)XtClass(ncw))->container_class.place_item)
      (*((XmContainerWidgetClass)XtClass(ncw))->container_class.place_item)(nw, NULL, ANY_FIT);
    need_expose = True;
  }
  /*
   * Set selected items, if necessary.
   */
  if ((ncw->container.selected_item_count != ccw->container.selected_item_count) ||
      (ncw->container.selected_items != ccw->container.selected_items))
  {
    int save_item_count;
    save_item_count = ncw->container.selected_item_count;
    ncw->container.selected_item_count = ccw->container.selected_item_count;
...
#define BOTH_VALID (COUNT_VALID | HEADING_VALID)
    ...
    if ((INVALID_COUNT != ncw->container.detail_heading_count) &&
        (ncw->container.detail_heading_count != ncw->container.saved_detail_heading_count))
    ...
    if (NONE_CHANGED != whichChanged) {
        ...
        if (HEADING_CHANGED & whichChanged) {
          ...
          if (INVALID_COUNT == ncw->container.detail_heading_count) {
            if (ncw->container.icon_header) {
              XtVaGetValues(GetRealIconHeader(nw),
                            XmNdetailCount,
      ...
      if (BOTH_VALID == (BOTH_VALID & whichValid)) {
        ...
        if (ccw->container.icon_header == NULL)
           ...
           ** heading count.
           */
          UpdateIconHeader(nw, (HEADING_CHANGED & whichChanged) ? False : True);
        }
        if (CtrLayoutIsDETAIL(ncw)) {
...
#undef HEADING_VALID
  ...
  if (CtrLayoutIsDETAIL(ncw) && !CtrLayoutIsDETAIL(ccw) && (ncw->container.icon_header != NULL)) {
    detail_need_layout = True;
    XtManageChild(ncw->container.icon_header);
  }
  if (!CtrLayoutIsDETAIL(ncw) && CtrLayoutIsDETAIL(ccw) && (ncw->container.icon_header)) {
    outline_need_layout = True;
    XtUnmanageChild(ncw->container.icon_header);
  ...
  {
    if ((CtrLayoutIsDETAIL(ncw)) && (ncw->container.icon_header) &&
        (XtParent(ncw->container.icon_header) != nw))
    {
      ...
      XtVaSetValues(ncw->container.icon_header,
                    ...
                    XmNbackground,
                    ncw->core.background_pixel,
                    XmNbackgroundPixmap,
                    ncw->core.background_pixmap,
                    XmNforeground,
                    ncw->manager.foreground,
                    NULL);
      XmeConfigureObject(ncw->container.icon_header, /* the DA */
                         ncw->container.icon_header->core.x,
                         ncw->container.icon_header->core.y,
                         real_icon_header->core.width + 2 * ncw->container.margin_w,
                         real_icon_header->core.height + ncw->container.margin_h,
  ...
  if (ncw->container.selection_policy != ccw->container.selection_policy)
    ncw->container.kaddmode = (CtrPolicyIsMULTIPLE(ncw) || CtrPolicyIsSINGLE(ncw));
  if (ncw->container.selection_technique != ccw->container.selection_technique)
    ncw->container.marquee_mode = (CtrTechIsTOUCH_ONLY(ncw) ? False : True);
  /** perform some logic */
  spatial_need_layout |= container_need_layout;
  outline_need_layout |= container_need_layout;
  detail_need_layout |= outline_need_layout;
  if (CtrLayoutIsSPATIAL(ncw) && !CtrSpatialStyleIsNONE(ncw) && !spatial_need_layout &&
      (ncw->container.snap_model != ccw->container.snap_model))
  {
    node = GetFirstNode(ncw);
    while (node) {
      (void)SnapCwid(
          node->widget_ptr, node->widget_ptr->core.x, node->widget_ptr->core.y, &snap_point);
       ...
       (CtrLayoutIsSPATIAL(ncw) && spatial_need_layout)))
  {
    ...
    clipWindowTrait = (XmClipWindowTrait)XmeTraitGet((XtPointer)XtClass(swparent),
                                                     _XmQTclipWindow);
    if (clipWindowTrait != NULL)
      swparent = XtParent(swparent);
    scrollFrameTrait = (XmScrollFrameTrait)XmeTraitGet((XtPointer)XtClass(swparent),
                                                       XmQTscrollFrame);
        ...
        scrollFrameTrait->updateOrigGeom != NULL)
    {
      ...
      scrollFrameTrait->updateOrigGeom(swparent, (Widget)ncw, &preferred);
    }
    need_expose = True;
  }
  ncw->container.self = False;
...
static void GetSize(Widget wid, Dimension *pwidth, Dimension *pheight)
{
   ...
   */
  {
    if (((XmContainerWidgetClass)XtClass(wid))->container_class.get_spatial_size) {
      (*((XmContainerWidgetClass)XtClass(wid))->container_class.get_spatial_size)(
          wid, pwidth, pheight);
      ...
      ((XtParent(cwid) == wid) || (XtIsManaged(XtParent(cwid)))))
  {
    ...
    cw->container.ideal_width = MAX(cw->container.ideal_width, cwid->core.x + desired.width);
  ...
  while (node) {
    ...
    /*
         ...
         */
    save_x = cwid->core.x;
    cwid->core.x = cw->container.margin_w + c->depth * cw->container.outline_indent +
  ...
  if (!(*pwidth))
    *pwidth = cw->container.ideal_width;
  if (!(*pheight))
    *pheight = cw->container.ideal_height;
}

/************************************************************************
 * GeometryManager (Composite Method)
 ************************************************************************/
static XtGeometryResult GeometryManager(Widget cwid,
                                        XtWidgetGeometry *desired,
                                        XtWidgetGeometry *allowed) /* unused */
{
  ...
  (*((XmContainerWidgetClass)XtClass(wid))->container_class.remove_item)(wid, cwid);
  /*
  ...
  (*((XmContainerWidgetClass)XtClass(wid))->container_class.place_item)(wid, cwid, EXACT_FIT);
  ...
  save_include_model = cw->container.include_model;
  cw->container.include_model = XmCLOSEST;
  (*((XmContainerWidgetClass)XtClass(wid))->container_class.place_item)(wid, cwid, FORCE);
  cw->container.include_model = save_include_model;
  return (XtGeometryNo);
}
...
static void ChangeManagedSpatial(Widget wid)
{
   ...
   */
  {
    if (((XmContainerWidgetClass)XtClass(wid))->container_class.get_spatial_size) {
      ...
      if (geo_desired.width < 1)
        geo_desired.width = cw->core.width;
      if (geo_desired.height < 1)
        geo_desired.height = cw->core.height;
...
static Boolean RequestSpatialGrowth(Widget wid, Widget cwid)
{
  ...
  if (CtrSpatialStyleIsNONE(cw)) {
    if (grow_width_allowed) {
      new_width = cwid->core.x + cwid->core.width + cw->container.margin_w;
      if (new_width > cw->core.width)
        width_increase = new_width - cw->core.width;
    }
    if (grow_height_allowed) {
      new_height = cwid->core.y + cwid->core.height + cw->container.margin_h;
    ...
    if (grow_width_allowed) {
      ...
      if (CtrIncludeIsCLOSEST(cw) && (c->user_x > (cw->core.width - cw->container.margin_w))) {
        width_in_cells = (c->user_x - (cw->core.width - cw->container.margin_w)) / cell_width;
        if (c->user_x - (cw->core.width - cw->container.margin_w) % cell_width)
          width_in_cells++;
    ...
    if (grow_height_allowed) {
      ...
      if (CtrIncludeIsCLOSEST(cw) && (c->user_y > (cw->core.height - cw->container.margin_h))) {
        height_in_cells = (c->user_y - (cw->core.height - cw->container.margin_h)) / cell_height;
        if (c->user_y - (cw->core.height - cw->container.margin_h) % cell_height)
          height_in_cells++;
 ...
 ************************************************************************/
static void ConstraintInitialize(Widget rcwid, /* unused */
                                 Widget ncwid,
                                 ArgList args,       /* unused */
                                 Cardinal *num_args) /* unused */
{
                                   ...
                                   Cardinal *num_args) /* unused */
{
   ...
   */
  if (CtrLayoutIsOUTLINE_DETAIL(cw) &&
      ((nc->entry_parent != cc->entry_parent) || (nc->position_index != cc->position_index) ||
       (nc->outline_state != cc->outline_state)))
    need_layout = True;
  /*
   ...
   */
  if (((ncwid->core.x != ccwid->core.x) || (ncwid->core.y != ccwid->core.y)) &&
      CtrLayoutIsSPATIAL(cw) &&
      (((XmContainerWidgetClass)XtClass((Widget)cw))->container_class.remove_item) &&
      (((XmContainerWidgetClass)XtClass((Widget)cw))->container_class.place_item))
  {
    unsigned char save_include_model;
    unsigned char save_snap_model;
    (*((XmContainerWidgetClass)XtClass((Widget)cw))->container_class.remove_item)((Widget)cw,
                                                                                  ncwid);
    save_include_model = cw->container.include_model;
    cw->container.include_model = XmCLOSEST;
  ...
  if (need_layout) {
    if (CtrLayoutIsOUTLINE_DETAIL(cw)) {
      ...
      GetSize((Widget)cw, &cw->container.ideal_width, &cw->container.ideal_height);
...
static Boolean TestFitItem(Widget wid, Widget cwid, Position x, Position y)
{
  ...
  else if (x < (Position)cw->container.margin_w)
    return (False);
  if (CtrSpatialStyleIsGRID(cw) || CtrSpatialStyleIsCELLS(cw)) {
...
static void GetSpatialSize(Widget wid, Dimension *pwidth, Dimension *pheight)
{
   ...
   */
  if (CtrSpatialStyleIsCELLS(cw))
    cwid_info = (ContainerCwidCellInfo)XtCalloc(cw->composite.num_children,
  ...
  while (node) {
     ...
     */
    {
      trial_width = MAX(trial_width, node->widget_ptr->core.x + node->widget_ptr->core.width);
      trial_height = MAX(trial_height, node->widget_ptr->core.y + node->widget_ptr->core.height);
    }
    else if (CtrIncludeIsCLOSEST(cw)) {
      c = GetContainerConstraint(node->widget_ptr);
      trial_width = MAX(trial_width, c->user_x + node->widget_ptr->core.width);
      trial_height = MAX(trial_height, c->user_y + node->widget_ptr->core.height);
    }
     ...
     */
    {
      ...
      cwid_height_in_cells = (node->widget_ptr)->core.height / cell_height;
      if ((node->widget_ptr)->core.height % cell_height)
        cwid_height_in_cells++;
      min_height_in_cells = MAX(min_height_in_cells, cwid_height_in_cells);
      cell_count += cwid_width_in_cells * cwid_height_in_cells;
      cwid_info[cwid_info_count].cwid_width_in_cells = cwid_width_in_cells;
      cwid_info[cwid_info_count].cwid_height_in_cells = cwid_height_in_cells;
      cwid_info_count++;
    }
    node = GetNextNode(node);
  }
  ...
  if (CtrSpatialStyleIsNONE(cw)) {
     ...
     */
    {
      ...
      if (cwid_info != NULL) {
        GetSpatialSizeCellAdjustment(
            wid, &width_in_cells, &height_in_cells, cwid_info, cwid_info_count);
     ...
     */
    width = width_in_cells * cell_width + 2 * cw->container.margin_w;
    height = height_in_cells * cell_height + 2 * cw->container.margin_h;
    if (CtrIncludeIsCLOSEST(cw))
    /*
 ...
 ************************************************************************/
static void PlaceItemNone(Widget wid, Widget cwid, unsigned char fit_type) /* unused */
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  XmContainerConstraint c = GetContainerConstraint(cwid);
   ...
   */
  if (((cwid->core.x + cwid->core.width) <= (cw->core.width - cw->container.margin_w)) &&
      ((cwid->core.y + cwid->core.height) <= (cw->core.height - cw->container.margin_h)))
    c->cell_idx = 1;
}
...
static void PlaceItemGridCells(Widget wid, Widget cwid, unsigned char fit_type)
{
  ...
  if (CtrIncludeIsCLOSEST(cw)) {
    ...
    if (trial_cell >= cw->container.cell_count) {
      ...
      trial_cell = GetCellFromCoord(
          wid,
          MIN(c->user_x,
              (Position)(cw->container.current_width_in_cells *
                             (CtrViewIsSMALL_ICON(cw) ? cw->container.real_small_cellw :
                                                        cw->container.real_large_cellw) -
                         1)),
          MIN(c->user_y,
              (Position)(cw->container.current_height_in_cells *
                             (CtrViewIsSMALL_ICON(cw) ? cw->container.real_small_cellh :
  ...
  if (CtrSpatialStyleIsCELLS(cw)) {
    ...
    XUnionRectWithRegion(&cwidrect, cw->container.cells_region, cw->container.cells_region);
  }
...
static int GetCellFromCoord(Widget wid, Position x, Position y)
{
  ...
  int cell_width, cell_height;
  int row, col;
  cell_width = (CtrViewIsSMALL_ICON(cw)) ? cw->container.real_small_cellw :
                                           cw->container.real_large_cellw;
  cell_height = (CtrViewIsSMALL_ICON(cw)) ? cw->container.real_small_cellh :
                                            cw->container.real_large_cellh;
  /*
...
static void PlaceItemReset(Widget wid)
{
      ...
      (((XmContainerWidgetClass)XtClass(wid))->container_class.remove_item))
  {
    ...
    while (node) {
      if (CtrItemIsPlaced(node->widget_ptr))
        (*((XmContainerWidgetClass)XtClass(wid))->container_class.remove_item)(wid,
                                                                               node->widget_ptr);
      node = GetNextNode(node);
    }
    XtFree((char *)cw->container.cells);
  ...
  if (cw->core.width > cell_width + 2 * cw->container.margin_w)
    width_in_cells = (cw->core.width - 2 * cw->container.margin_w) / cell_width;
  else
    width_in_cells = 1;
  if (cw->core.height > cell_height + 2 * cw->container.margin_h)
    height_in_cells = (cw->core.height - 2 * cw->container.margin_h) / cell_height;
  else
    height_in_cells = 1;
  ...
  if (CtrSpatialStyleIsGRID(cw))
    return;
  XSubtractRegion(
      cw->container.cells_region, cw->container.cells_region, cw->container.cells_region);
}
...
static void PlaceCwid(Widget cwid, Position x, Position y)
{
   ...
   */
  if (LayoutIsRtoLM(cw)) {
    if ((cwid->core.width + (Position)cw->container.margin_w) >= cw->core.width)
      cwid->core.x = MIN(cwid->core.x,
                         cw->core.width - cwid->core.width - (Position)cw->container.margin_w);
  }
  else
...
static XPoint *SnapCwid(Widget cwid, Position x, Position y, XPoint *point)
{
  ...
  if (CtrSnapModelIsNONE(cw)) {
    point->x = MIN(x, target_cell_coord.x + (width_in_cells * cell_width) - 1);
    point->y = MIN(y, target_cell_coord.y + (height_in_cells * cell_height) - 1);
    return (point);
  }
  if (CtrSpatialStyleIsGRID(cw)) {
  ...
  if (CtrViewIsSMALL_ICON(cw)) {
    if (height_in_cells != 0)
      point->y += ((height_in_cells * cell_height) - cwid->core.height) / 2;
    if (LayoutIsRtoLM(cw))
      point->x += ((width_in_cells * cell_width) - cwid->core.width);
  }
  else {
    if (width_in_cells != 0)
      point->x += ((width_in_cells * cell_width) - cwid->core.width) / 2;
    if (height_in_cells != 0)
      point->y += (height_in_cells * cell_height) - cwid->core.height;
  }
  return (point);
}
...
static void HideCwid(Widget cwid)
{
  ...
  if (cwid == NULL)
    return;
  c = GetContainerConstraint(cwid);
  XmeConfigureObject(cwid,
                     (Position)(0 - ((Widget)cwid)->core.width),
                     (Position)(0 - ((Widget)cwid)->core.height),
                     ((Widget)cwid)->core.width,
                     ((Widget)cwid)->core.height,
                     0);
  if (!CtrICON(cwid))
    return;
  /*
 ...
 ************************************************************************/
static void ContainerStartTransfer(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  Widget cwid;
  int transfer_action;
  ...
  if (CtrLayoutIsOUTLINE_DETAIL(wid)) {
    ...
    if ((cwid) && CtrOUTLINE_BUTTON(cwid)) {
      XtCallActionProc(wid, "ManagerGadgetDrag", event, params, *num_params);
      return;
    }
  }
  /*
  ...
  if (cw->container.transfer_action == NULL) {
    cw->container.transfer_action = (ContainerXfrAction)XtCalloc(1,
                                                                 sizeof(XmContainerXfrActionRec));
    cw->container.transfer_action->event = (XEvent *)XtCalloc(1, sizeof(XEvent));
  }
  cw->container.transfer_action->wid = (Widget)cw;
  memcpy((void *)cw->container.transfer_action->event, (void *)event, sizeof(XEvent));
  ...
  if (cw->container.transfer_timer_id != 0)
    XtRemoveTimeOut(cw->container.transfer_timer_id);
  cw->container.transfer_timer_id = XtAppAddTimeOut(XtWidgetToApplicationContext((Widget)cw),
 ...
 ************************************************************************/
static void ContainerEndTransfer(Widget wid,
                                 XEvent *event,        /* unused */
                                 ...
                                 Cardinal *num_params) /* unused */
{
  ...
  if (cw->container.transfer_action->operation == XmLINK)
    ContainerPrimaryLink(wid, cw->container.transfer_action->event, NULL, 0);
  else if (cw->container.transfer_action->operation == XmMOVE)
    ContainerPrimaryMove(wid, cw->container.transfer_action->event, NULL, 0);
  else
    ContainerPrimaryCopy(wid, cw->container.transfer_action->event, NULL, 0);
 ...
 ************************************************************************/
static void ContainerPrimaryCopy(Widget wid,
                                 XEvent *event,
                                 String *params,       /* unused */
                                 Cardinal *num_params) /* unused */
{
  ...
  XmePrimarySink(wid, XmCOPY, (XtPointer)loc_data, event->xbutton.time);
}

/************************************************************************
 * ContainerPrimaryLink (Action Proc)
 ************************************************************************/
static void ContainerPrimaryLink(Widget wid,
                                 XEvent *event,
                                 String *params,       /* unused */
                                 Cardinal *num_params) /* unused */
{
  ...
  loc_data->x = event->xbutton.x;
  loc_data->y = event->xbutton.y;
  XmePrimarySink(wid, XmLINK, (XtPointer)loc_data, event->xbutton.time);
}

/************************************************************************
 * ContainerPrimaryMove (Action Proc)
 ************************************************************************/
static void ContainerPrimaryMove(Widget wid,
                                 XEvent *event,
                                 String *params,       /* unused */
                                 Cardinal *num_params) /* unused */
{
  ...
  loc_data->x = event->xbutton.x;
  loc_data->y = event->xbutton.y;
  XmePrimarySink(wid, XmMOVE, (XtPointer)loc_data, event->xbutton.time);
}
 ...
 ************************************************************************/
static void ContainerNoop(Widget wid,           /* unused */
                          XEvent *event,        /* unused */
                          String *params,       /* unused */
                          Cardinal *num_params) /* unused */
{
                                    ...
                                    Cardinal *num_params)
{
  ...
  if (dpy->display.enable_btn1_transfer && cwid != (Widget)NULL && !CtrOUTLINE_BUTTON(cwid)) {
                                      ...
                                      Cardinal *num_params)
{
  ...
  if (dpy->display.enable_btn1_transfer != XmOFF && (!cw->container.selecting)) {
    int dx, dy;
    ...
    if (ABS(dx) >= MOTION_THRESHOLD || ABS(dy) >= MOTION_THRESHOLD) {
      ...
      DragStart((XtPointer)cw, &cw->container.transfer_timer_id);
    }
    else {
      return;
    }
                                      ...
                                      Cardinal *num_params)
{
  ...
  if (dpy->display.enable_btn1_transfer != XmBUTTON2_ADJUST && (!cw->container.selecting)) {
    int dx, dy;
    dx = event->xmotion.x - cw->container.anchor_point.x;
    dy = event->xmotion.y - cw->container.anchor_point.y;
    if (ABS(dx) >= MOTION_THRESHOLD || ABS(dy) >= MOTION_THRESHOLD) {
...
{
  XmDisplay dpy = (XmDisplay)XmGetXmDisplay(XtDisplay(wid));
  if ((dpy->display.enable_btn1_transfer == XmBUTTON2_ADJUST) || (!num_params) ||
      (*num_params < 1))
...
static void ContainerButtonMotion(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (cw->container.ob_pressed) {
    XtCallActionProc(wid, "ManagerGadgetButtonMotion", event, params, *num_params);
    return;
  }
...
static void ContainerEndSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (cw->container.ob_pressed) {
    XtCallActionProc(wid, "ManagerGadgetActivate", event, params, *num_params);
  ...
  if (cw->container.anchor_cwid) {
    if (!cw->container.kaddmode) {
      ...
      /* Only move the focus if the old focus child is no
           ...
           widget */
      if (current_focus != (Widget)NULL && XtParent(current_focus) == wid) {
        XmContainerConstraint c = GetContainerConstraint(current_focus);
    ...
    if (CtrPolicyIsBROWSE(cw))
      cw->container.no_auto_sel_changes |= MarkCwid(cw->container.anchor_cwid, False);
    else
...
static void ContainerBeginToggle(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (CtrLayoutIsOUTLINE_DETAIL(wid)) {
    cwid = (Widget)_XmInputForGadget(wid, event->xbutton.x, event->xbutton.y);
    if ((cwid) && CtrOUTLINE_BUTTON(cwid)) {
      XtCallActionProc(wid, "ManagerGadgetTraverseCurrent", event, params, *num_params);
      cw->container.ob_pressed = True;
      return;
    }
  }
 ...
 ************************************************************************/
static void ContainerBeginExtend(Widget wid,
                                 XEvent *event,
                                 String *params,       /* unused */
                                 Cardinal *num_params) /* unused */
{
  ...
  Widget current_cwid;
  if (CtrLayoutIsOUTLINE_DETAIL(wid)) {
    current_cwid = (Widget)_XmInputForGadget(wid, event->xbutton.x, event->xbutton.y);
  ...
  (void)MarkCwidsInRange(wid, cw->container.anchor_cwid, current_cwid, (Boolean)True);
  if (CtrIsAUTO_SELECT(cw))
 ...
 ************************************************************************/
static void ContainerEndExtend(Widget wid,
                               XEvent *event,
                               String *params,       /* unused */
                               Cardinal *num_params) /* unused */
{
 ...
 ************************************************************************/
static void ContainerCancel(Widget wid,
                            XEvent *event,
                            String *params,       /* unused */
                            Cardinal *num_params) /* unused */
{
  ...
  if (cw->container.ob_pressed) {
    XtCallActionProc(wid, "ManagerParentCancel", event, params, *num_params);
    cw->container.ob_pressed = False;
    return;
  }
  cw->container.toggle_pressed = False;
  ...
  if (CtrPolicyIsBROWSE(cw)) {
    if (cw->container.anchor_cwid) {
      selection_changes = UnmarkCwidVisual(cw->container.anchor_cwid);
      if (CtrIsAUTO_SELECT(cw) && selection_changes) {
        GainPrimary(wid, event->xbutton.time);
...
static void ContainerSelect(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (CtrLayoutIsOUTLINE_DETAIL(wid) && focus_cwid && (focus_cwid != wid) &&
      CtrOUTLINE_BUTTON(focus_cwid))
  {
    XtCallActionProc(wid, "ManagerGadgetSelect", event, params, *num_params);
    return;
  }
 ...
 ************************************************************************/
static void ContainerExtend(Widget wid,
                            XEvent *event,
                            String *params,       /* unused */
                            Cardinal *num_params) /* unused */
{
  ...
  cw->container.no_auto_sel_changes |= MarkCwidsInRange(
      wid, cw->container.anchor_cwid, focus_cwid, (Boolean)False);
  GainPrimary(wid, event->xbutton.time);
  if (CtrIsAUTO_SELECT(cw)) {
    CallSelectCB(wid, event, XmAUTO_BEGIN);
    CallSelectCB(wid, event, XmAUTO_NO_CHANGE);
 ...
 ************************************************************************/
static void ContainerToggleMode(Widget wid,
                                XEvent *event,        /* unused */
                                String *params,       /* unused */
                                Cardinal *num_params) /* unused */
{
 ...
 ************************************************************************/
static void ContainerDeselectAll(Widget wid,
                                 XEvent *event,
                                 String *params,       /* unused */
                                 Cardinal *num_params) /* unused */
{
...
static void ContainerActivate(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (CtrLayoutIsOUTLINE_DETAIL(wid) && CtrOUTLINE_BUTTON(focus_cwid)) {
    XtCallActionProc(wid, "ManagerParentActivate", event, params, *num_params);
    return;
  }
                                      ...
                                      Cardinal *num_params)
{
  ...
  if (!num_params || *num_params != 1 || !params)
    return;
  if (((focus_cwid = XmGetFocusWidget(wid)) == NULL) || (wid != XtParent(focus_cwid)) ||
      (CtrLayoutIsSPATIAL(cw)) || (CtrOUTLINE_BUTTON(focus_cwid)))
    return;
  ...
  if ((state_to == _COLLAPSE) || (state_to == _LEFT && (!LayoutIsRtoLM(cw))) ||
...
static void ContainerConvertProc(Widget wid, XtPointer closure, XmConvertCallbackStruct *cs)
{
  ...
  if ((cs->target == atoms[XmA_TARGETS]) || (cs->target == atoms[XmA_MOTIF_EXPORT_TARGETS]) ||
  ...
  else if ((cs->target == XA_PIXMAP) || (cs->target == atoms[XmA_MOTIF_COMPOUND_STRING]) ||
           (cs->target == atoms[XmAUTF8_STRING]) || (cs->target == atoms[XmA_COMPOUND_TEXT]))
  {
  ...
  if (cs->target == XA_PIXMAP) {
    ...
    int n, i;
    Pixmap item_pm;
    Pixmap *return_pm = (Pixmap *)XtCalloc(item_count, sizeof(Pixmap));
           ...
           (cs->target == atoms[XmA_COMPOUND_TEXT]))
  {
    ...
    n = 0;
    XtSetArg(wargs[n], XmNlabelString, &item_xmstr);
    n++;
    for (i = 0; i < item_count; i++) {
      ...
      XtGetValues(items[i], wargs, n);
      if (i > 0)
        return_xmstr = XmStringConcatAndFree(return_xmstr, XmStringSeparatorCreate());
    ...
    if (cs->target == atoms[XmA_MOTIF_COMPOUND_STRING]) {
      ...
      length = XmCvtXmStringToByteStream(return_xmstr, (unsigned char **)&(value));
    }
                                     ...
                                     XmDestinationCallbackStruct *cs)
{
  ...
  XmTransferValue(cs->transfer_id,
                  ...
                  (XtPointer)&cw->container.dropspot,
                  cs->time);
}
 ...
 ************************************************/
static void FreeLocationData(Widget wid,       /* unused */
    ...
    if (CtrLayoutIsDETAIL(cw)) {
      if (cw->container.detail_order_count) {
        ...
        if (contData->valueMask & ContDetailOrder) {
          contData->detail_order_count = MAX(GetDefaultDetailCount(wid),
...
static unsigned char GetVisualEmphasis(Widget cwid)
{
  ...
  if ((cItemTrait = (XmContainerItemTrait)XmeTraitGet((XtPointer)XtClass(cwid),
                                                      XmQTcontainerItem)) == NULL)
...
static Cardinal GetDefaultDetailCount(Widget wid)
{
  ...
  if ((cwid = GetRealIconHeader(wid)) && (XtIsManaged(cwid)) &&
      ((XtParent(cwid) == wid) || (XtIsManaged(XtParent(cwid)))))
  {
    cItemTrait = (XmContainerItemTrait)XmeTraitGet((XtPointer)XtClass(cwid), XmQTcontainerItem);
...
static XmTabList SetDynamicTabList(Widget wid)
{
  ...
  if (cw->core.width == 0)
    return (NULL);
  tab_size = cw->core.width - (cw->container.margin_w * 2) - cw->container.real_first_col_width;
  detail_order_count = (cw->container.detail_order_count) ? cw->container.detail_order_count :
                                                            GetDefaultDetailCount(wid);
  if (tab_size <= 0)
    return (NULL);
...
static Dimension GetDynFirstColWidth(Widget wid)
{
  ...
  while (node) {
    ...
    c = GetContainerConstraint(cwid);
    cwid_fcw += cw->container.ob_width + c->depth * cw->container.outline_indent;
...
static void ResizeIconWidths(Widget wid)
{
  ...
  if (cw->core.width == cw->container.ideal_width)
    ...
    if (CtrIsDynamic(cw, TABLIST))
      max_x = MAX(cw->container.margin_w + cw->container.real_first_col_width,
      ...
      while (node) {
        ...
        cwid->core.x = cw->container.margin_w + c->depth * cw->container.outline_indent +
                       ((CtrOB_PRESENT(cw)) ? cw->container.ob_width : 0);
        if (LayoutIsRtoLM(cw))
          cwid->core.x = (Position)cw->core.width - (Position)cwid->core.width - cwid->core.x;
        XtQueryGeometry(cwid, NULL, &desired);
        max_x = MAX(max_x, cwid->core.x + desired.width);
        node = GetNextNode(node);
      }
...
static void LayoutOutlineDetail(Widget wid)
{
  ...
  if (cw->container.outline_seg_count != n_outline_segs) {
    if (cw->container.outline_segs)
      XtFree((char *)cw->container.outline_segs);
    cw->container.outline_segs = (XSegment *)XtCalloc(n_outline_segs, sizeof(XSegment));
    cw->container.outline_seg_count = n_outline_segs;
  }
  point_at_depth = (XPoint *)XtCalloc((cw->container.max_depth + 1), sizeof(XPoint));
  ...
  if (CtrLayoutIsDETAIL(cw) && cw->container.icon_header) {
     ...
     */
    Widget real_icon_header = GetRealIconHeader(wid), header_parent = XtParent(real_icon_header);
    /* only if it is managed */
    if (XtIsManaged(real_icon_header) && ((header_parent == wid) || (XtIsManaged(header_parent))))
    {
      if (header_parent != wid) {
        ...
        XmeConfigureObject(header_parent,
                           ...
                           real_icon_header->core.width + 2 * cw->container.margin_w,
                           real_icon_header->core.height + cw->container.margin_h,
                           cw->core.border_width);
      }
      else {
  ...
  while (node) {
    ...
    c = GetContainerConstraint(cwid);
    if (LayoutIsRtoLM(cw))
      x = cw->core.width - cw->container.margin_w - c->depth * cw->container.outline_indent;
    else
      x = cw->container.margin_w + c->depth * cw->container.outline_indent;
    ...
    if ((node->child_ptr) && CtrOB_PRESENT(cw)) {
      ...
      if ((!LayoutIsRtoLM(cw) &&
           ((x + cw->container.ob_width) >
            (cw->container.margin_w + cw->container.real_first_col_width))) ||
          (LayoutIsRtoLM(cw) && (x < (Position)(cw->core.width - cw->container.margin_w -
                                                cw->container.real_first_col_width))))
        HideCwid(c->related_cwid);
      else
        XmeConfigureObject(
            c->related_cwid, x, ob_y, cw->container.ob_width, cw->container.ob_height, 0);
    }
    else if (c->related_cwid) {
    ...
    if (LayoutIsRtoLM(cw))
      x = MAX(x,
              (Position)(cw->core.width - cw->container.margin_w -
                         cw->container.real_first_col_width + 1));
    else
      x = MIN(x, (Position)(cw->container.margin_w + cw->container.real_first_col_width - 1));
    /*
    ...
    if (c->entry_parent) {
      ...
      if (CtrOB_PRESENT(cw)) {
         ...
         */
        cw->container.outline_segs[seg_idx].x1 = MIN(
            (point_at_depth[pc->depth].x + cw->container.ob_width / 2),
         ...
         */
        cw->container.outline_segs[seg_idx].x1 = MIN(
            (point_at_depth[pc->depth].x + GetIconWidth(c->entry_parent) / 2),
            (point_at_depth[pc->depth].x + point_at_depth[c->depth].x) / 2);
      }
      cw->container.outline_segs[seg_idx].y1 = point_at_depth[pc->depth].y;
      cw->container.outline_segs[seg_idx].x2 = cw->container.outline_segs[seg_idx].x1;
      cw->container.outline_segs[seg_idx].y2 = y + cwid->core.height / 2;
      cw->container.outline_segs[seg_idx + 1].x1 = cw->container.outline_segs[seg_idx].x2;
      cw->container.outline_segs[seg_idx + 1].y1 = cw->container.outline_segs[seg_idx].y2;
      cw->container.outline_segs[seg_idx + 1].x2 = cw->container.margin_w +
                                                   cw->container.outline_indent * c->depth;
      if (CtrOB_PRESENT(cw) && (!c->related_cwid))
        cw->container.outline_segs[seg_idx + 1].x2 += cw->container.ob_width;
      cw->container.outline_segs[seg_idx + 1].y2 = cw->container.outline_segs[seg_idx].y2;
      seg_idx += 2;
    }
    if (LayoutIsRtoLM(cw))
  ...
  for (i = 0; i < cw->container.outline_seg_count; i++) {
    int max_x = (int)cw->container.real_first_col_width + (int)cw->container.margin_w;
    /* we don't want the lines to be drawn after the first
           column width, so we clip here the x positions of the
           segments */
    cw->container.outline_segs[i].x1 = MIN(max_x, cw->container.outline_segs[i].x1);
    cw->container.outline_segs[i].x2 = MIN(max_x, cw->container.outline_segs[i].x2);
  }
  if (LayoutIsRtoLM(cw)) {
    int adjust;
    adjust = (int)cw->core.width - (int)cw->container.ideal_width;
    for (i = 0; i < cw->container.outline_seg_count; i++) {
      cw->container.outline_segs[i].x1 = MAX(
          0, cw->container.ideal_width - cw->container.outline_segs[i].x1 + adjust);
      cw->container.outline_segs[i].x2 = MAX(
          0, cw->container.ideal_width - cw->container.outline_segs[i].x2 + adjust);
    }
  }
}
...
static void LayoutSpatial(Widget wid, Boolean growth_req_allowed, CwidNode stop_node)
{
   ...
   */
  {
    ...
    width_in_cells = (cw->core.width - 2 * cw->container.margin_w) / cell_width;
    height_in_cells = (cw->core.height - 2 * cw->container.margin_h) / cell_height;
    if (((width_in_cells != cw->container.current_width_in_cells) && (CtrIsHORIZONTAL(wid))) ||
        ((height_in_cells != cw->container.current_height_in_cells) && (CtrIsVERTICAL(wid))))
      (*((XmContainerWidgetClass)XtClass(wid))->container_class.place_item)(wid, NULL, ANY_FIT);
    else
    /*
  ...
  while (node) {
    ...
    if (CtrItemIsPlaced(cwid))
      ...
      /* Not placed */
      (*((XmContainerWidgetClass)XtClass(wid))->container_class.place_item)(
          wid, cwid, (growth_req_allowed ? EXACT_FIT : ANY_FIT));
...
static void SetSmallCellSizes(Widget wid)
{
  ...
  if (cw->container.first_node) {
    node = cw->container.first_node;
    if (CtrDynamicSmallCellHeight(cw))
      cw->container.real_small_cellh = cw->container.first_node->widget_ptr->core.height;
    if (CtrDynamicSmallCellWidth(cw))
      cw->container.real_small_cellw = cw->container.first_node->widget_ptr->core.width;
    while (node) {
      if (CtrSpatialStyleIsGRID(cw))
      /*
      ...
      {
        if (CtrDynamicSmallCellHeight(cw))
          cw->container.real_small_cellh = MAX(cw->container.real_small_cellh,
                                               node->widget_ptr->core.height);
        if (CtrDynamicSmallCellWidth(cw))
          cw->container.real_small_cellw = MAX(cw->container.real_small_cellw,
                                               node->widget_ptr->core.width);
      }
      else {
        /*
         ...
         */
        if (CtrDynamicSmallCellHeight(cw))
          cw->container.real_small_cellh = MIN(cw->container.real_small_cellh,
                                               node->widget_ptr->core.height);
        if (CtrDynamicSmallCellWidth(cw))
          cw->container.real_small_cellw = MIN(cw->container.real_small_cellw,
                                               node->widget_ptr->core.width);
      }
      node = GetNextNode(node);
    }
    ...
    if (CtrDynamicSmallCellHeight(cw))
      cw->container.real_small_cellh = MAX(10, (int)(.02 * HeightOfScreen(XtScreen((Widget)cw))));
    if (CtrDynamicSmallCellWidth(cw))
      cw->container.real_small_cellw = MAX(10, (int)(.02 * WidthOfScreen(XtScreen((Widget)cw))));
  }
}
...
static void SetLargeCellSizes(Widget wid)
{
  ...
  if (cw->container.first_node) {
    ...
    node = cw->container.first_node;
    if (CtrDynamicLargeCellHeight(cw))
      cw->container.real_large_cellh = cw->container.first_node->widget_ptr->core.height;
    if (CtrDynamicLargeCellWidth(cw))
      cw->container.real_large_cellw = cw->container.first_node->widget_ptr->core.width;
    while (node) {
      if (CtrSpatialStyleIsGRID(cw))
      /*
       * GRID: cell should be size of largest cwid.
      ...
      {
        if (CtrDynamicLargeCellHeight(cw))
          cw->container.real_large_cellh = MAX(cw->container.real_large_cellh,
                                               node->widget_ptr->core.height);
        if (CtrDynamicLargeCellWidth(cw))
          cw->container.real_large_cellw = MAX(cw->container.real_large_cellw,
                                               node->widget_ptr->core.width);
      }
      else {
        /*
         ...
         */
        if (CtrDynamicLargeCellHeight(cw))
          cw->container.real_large_cellh = MIN(cw->container.real_large_cellh,
                                               node->widget_ptr->core.height);
        if (CtrDynamicLargeCellWidth(cw))
          cw->container.real_large_cellw = MIN(cw->container.real_large_cellw,
                                               node->widget_ptr->core.width);
      }
      node = GetNextNode(node);
    }
    ...
    if (CtrDynamicLargeCellHeight(cw))
      cw->container.real_large_cellh = MAX(20, (int)(.04 * HeightOfScreen(XtScreen((Widget)cw))));
    if (CtrDynamicLargeCellWidth(cw))
      cw->container.real_large_cellw = MAX(20, (int)(.04 * WidthOfScreen(XtScreen((Widget)cw))));
  }
}
...
static void SizeOutlineButton(Widget wid)
{
   ...
   */
  n = 0;
  XtSetArg(wargs[n], XmNlabelType, XmPIXMAP);
  n++;
  XtSetArg(wargs[n], XmNlabelPixmap, cw->container.expanded_state_pixmap);
  n++;
  ...
  if (cw->container.size_ob)
    ...
    cw->container.size_ob = XtCreateWidget(OBNAME, xmPushButtonGadgetClass, (Widget)cw, wargs, n);
  ...
  XtSetArg(wargs[n], XmNlabelType, XmPIXMAP);
  n++;
  XtSetArg(wargs[n], XmNlabelPixmap, cw->container.collapsed_state_pixmap);
  n++;
  XtSetValues(cw->container.size_ob, wargs, n);
  cw->container.self = False;
  XtVaGetValues(cw->container.size_ob, XmNwidth, &width, XmNheight, &height, NULL);
...
static void UpdateGCs(Widget wid)
{
  ...
  cw->container.normalGC = XtAllocateGC(
      wid, 0, valueMask, &values, GCClipMask | GCForeground, unusedMask);
  valueMask = GCForeground | GCSubwindowMode | GCFunction;
  values.foreground = cw->core.background_pixel ^ cw->manager.foreground;
  values.subwindow_mode = IncludeInferiors;
  values.function = GXxor;
  cw->container.marqueeGC = XtAllocateGC(wid, 0, valueMask, &values, GCClipMask, 0);
}
                                         ...
                                         int cwid_info_count)
{
  ...
  cell_occupied = (Boolean *)XtCalloc((width_in_cells * height_in_cells), sizeof(Boolean));
  i = 0;
  all_cwids_fit = True;
   ...
   */
  {
    ...
    while ((start_col < width_in_cells) && (!cwid_placed)) {
      ...
      while ((start_row < height_in_cells) && (!cwid_placed)) {
        ...
        this_spot_fits = True;
        col = start_col;
        while ((col < start_col + cwid_info[i].cwid_width_in_cells) && (this_spot_fits)) {
          row = start_row;
          while ((row < start_row + cwid_info[i].cwid_height_in_cells) && (this_spot_fits))
          /*
           ...
           */
          {
            this_spot_fits = ((col < width_in_cells) && (row < height_in_cells) &&
        ...
        if (this_spot_fits) /* Mark everything as occupied */
          for (col = start_col; col < start_col + cwid_info[i].cwid_width_in_cells; col++)
            for (row = start_row; row < start_row + cwid_info[i].cwid_height_in_cells; row++)
...
#define CWINDOW_PARENT 2
   ...
   */
  {
    ...
    if (NO_PARENT == inScrolledWindow) {
      XmClipWindowTrait clipWindowTrait = (XmClipWindowTrait)XmeTraitGet(
          (XtPointer)XtClass(XtParent(wid)), _XmQTclipWindow);
      if (NULL != clipWindowTrait)
        inScrolledWindow = CWINDOW_PARENT;
    }
  }
  if (NO_PARENT != inScrolledWindow) {
    Widget sWindow = (SWINDOW_PARENT == inScrolledWindow) ? XtParent(wid) :
                                                            XtParent(XtParent(wid));
    scrollp = XmAUTOMATIC;
    /* use an intermediate DA so that we can have margins */
    n = 0;
    XtSetArg(sargs[n], XmNscrolledWindowChildType, XmSCROLL_HOR);
    n++;
    XtSetArg(sargs[n], XmNmarginHeight, cw->container.margin_h);
    n++;
    XtSetArg(sargs[n], XmNmarginWidth, cw->container.margin_w);
    n++;
    XtSetArg(sargs[n], XmNforeground, cw->manager.foreground);
    n++;
    XtSetArg(sargs[n], XmNbackground, cw->core.background_pixel);
    n++;
    XtSetArg(sargs[n], XmNbackgroundPixmap, cw->core.background_pixmap);
    n++;
    XtSetArg(sargs[n], XmNborderWidth, cw->core.border_width);
    n++;
    XtSetArg(sargs[n], XmNborderColor, cw->core.border_pixel);
    n++;
    XtSetArg(sargs[n], XmNborderPixmap, cw->core.border_pixmap);
    n++;
    XtSetArg(sargs[n], XmNtraversalOn, False);
    n++;
   ...
   */
  n = 0;
  XtSetArg(sargs[n], XmNcontainerID, wid);
  n++;
  XtSetArg(sargs[n], XmNshadowThickness, 0);
  n++;
  XtSetArg(sargs[n], XmNtraversalOn, False);
  n++;
  /* not really necessary */
  XtSetArg(sargs[n], XmNlargeIconPixmap, XmUNSPECIFIED_PIXMAP);
  n++;
  XtSetArg(sargs[n], XmNsmallIconPixmap, XmUNSPECIFIED_PIXMAP);
  n++;
  assert(cw->container.detail_heading_count > 0);
  XtSetArg(sargs[n], XmNlabelString, cw->container.detail_heading[0]);
  n++;
  if (cw->container.detail_heading_count > 1) {
    XtSetArg(sargs[n], XmNdetail, &(cw->container.detail_heading[1]));
    n++;
  }
  XtSetArg(sargs[n], XmNdetailCount, cw->container.detail_heading_count - 1);
  n++;
  cw->container.icon_header = XmCreateIconHeader(header_parent, HEADERNAME, sargs, n);
  if (scrollp == XmAUTOMATIC) {
    ...
    XmeConfigureObject(header_parent,
                       header_parent->core.x,
                       header_parent->core.y,
                       cw->container.icon_header->core.width + 2 * cw->container.margin_w,
                       cw->container.icon_header->core.height + cw->container.margin_h,
...
static Widget GetRealIconHeader(Widget wid)
{
  ...
  if (XtParent(cw->container.icon_header) != wid)
    /* we are in the SW auto case where a DA was created as
           ...
           icon_header. */
    return ((CompositeWidget)(cw->container.icon_header))->composite.children[0];
  else
...
static void UpdateIconHeader(Widget wid, Boolean count_only)
{
  ...
  n = 0;
  if (!count_only) {
    XtSetArg(wargs[n], XmNlabelString, cw->container.detail_heading[0]);
    n++;
    if (cw->container.detail_heading_count > 1) {
  ...
  XtSetArg(wargs[n], XmNdetailCount, cw->container.detail_heading_count - 1);
  n++;
 ...
 ************************************************************************/
static CwidNode GetNextNode(CwidNode start_node)
{
  XmContainerWidget cw;
  CwidNode node;
  if (!start_node)
 ...
 ************************************************************************/
static CwidNode GetNextUpLevelNode(CwidNode start_node)
{
  CwidNode node;
  node = start_node;
  while (node) {
 ...
 ************************************************************************/
static void StartSelect(Widget wid,
                        XEvent *event,
                        String *params,       /* unused */
                        Cardinal *num_params) /* unused */
{
  ...
  if (CtrPolicyIsSINGLE(cw)) {
    ...
    if (current_cwid && current_cwid == cw->container.anchor_cwid &&
        c->selection_visual == XmSELECTED && cw->container.selection_state == XmSELECTED)
    {
  ...
  if (CtrPolicyIsBROWSE(cw)) {
    if (current_cwid != cw->container.anchor_cwid) {
      ...
      cw->container.anchor_cwid = current_cwid;
      if (cw->container.anchor_cwid) {
        cw->container.no_auto_sel_changes |= MarkCwid(cw->container.anchor_cwid, True);
        SetLocationCursor(cw->container.anchor_cwid);
      }
    }
    if (CtrIsAUTO_SELECT(cw))
  ...
  if (CtrIsAUTO_SELECT(cw))
    CallSelectCB(wid, event, XmAUTO_BEGIN);
  if ((CtrTechIsMARQUEE_ES(cw) || CtrTechIsMARQUEE_EB(cw)) && (!CtrLayoutIsDETAIL(cw))) {
    XSetClipMask(XtDisplay(wid), cw->container.marqueeGC, None);
    RecalcMarquee(wid, cw->container.anchor_cwid, event->xbutton.x, event->xbutton.y);
    DrawMarquee(wid);
    cw->container.marquee_drawn = True;
  }
}

static Boolean SetupDrag(Widget wid,
                         XEvent *event,
                         String *params,       /* unused */
                         Cardinal *num_params) /* unused */
{
                                   ...
                                   Cardinal *num_params) /* unused */
{
  ...
  if ((current_cwid) && CtrOUTLINE_BUTTON(current_cwid))
    current_cwid = NULL;
  if (CtrPolicyIsBROWSE(cw)) {
    if ((cw->container.extend_pressed) || (cw->container.toggle_pressed))
      return (False);
    if (current_cwid == cw->container.anchor_cwid)
      return (False);
    if (cw->container.anchor_cwid) {
      cw->container.selection_state = XmNOT_SELECTED;
      selection_changes = MarkCwid(cw->container.anchor_cwid, False);
      cw->container.selection_state = XmSELECTED;
    }
    if (current_cwid)
  ...
  if (CtrLayoutIsDETAIL(cw) || (CtrLayoutIsOUTLINE_DETAIL(cw) && !cw->container.marquee_mode))
    return (MarkCwidsInRange(wid, cw->container.anchor_cwid, current_cwid, (Boolean)True));
...
static Widget ObjectAtPoint(Widget wid, Position x, Position y)
{
  ...
  while (node) {
    ...
    if (CtrLayoutIsOUTLINE_DETAIL(cw) && c->related_cwid != (Widget)NULL) {
      Widget outline_button = c->related_cwid;
      pointInTrait = (XmPointInTrait)XmeTraitGet((XtPointer)XtClass(outline_button), XmQTpointIn);
      if (pointInTrait) {
        if (pointInTrait->pointIn(outline_button, x, y))
          return outline_button;
      }
      else if ((XtX(outline_button) <= x) &&
               (XtX(outline_button) + XtWidth(outline_button) >= x) &&
               (XtY(outline_button) <= y) && (XtY(outline_button) + XtHeight(outline_button) >= y))
        return (outline_button);
    }
    pointInTrait = (XmPointInTrait)XmeTraitGet((XtPointer)XtClass(node->widget_ptr), XmQTpointIn);
    ...
    else if ((g->rectangle.x <= x) && (x <= g->rectangle.x + g->rectangle.width) &&
             (g->rectangle.y <= y) && (y <= g->rectangle.y + g->rectangle.height))
      return (node->widget_ptr);
    if ((g->rectangle.y + g->rectangle.height > cw->core.height) && CtrLayoutIsOUTLINE_DETAIL(cw))
      return (NULL);
    if ((g->rectangle.x <= x) && (x <= g->rectangle.x + g->rectangle.width))
...
static Boolean MarkCwidsInRange(Widget wid, Widget cwid1, Widget cwid2, Boolean visual_only)
{
  ...
  while (node) {
    ...
    if (marking_started && (!marking_ended))
      selection_changes |= MarkCwid(node->widget_ptr, visual_only);
    else
      selection_changes |= UnmarkCwidVisual(node->widget_ptr);
    if (cwid1_found && cwid2_found && marking_started)
      marking_ended = True;
...
static Boolean InMarquee(Widget cwid)
{
  ...
  Dimension width, height;
  XtVaGetValues(cwid, XmNx, &cwid_x, XmNy, &cwid_y, XmNwidth, &width, XmNheight, &height, NULL);
  cwid_xw = cwid_x + (Position)width;
  cwid_yh = cwid_y + (Position)height;
  return ((cwid_x >= cw->container.marquee_start.x) && (cwid_y >= cw->container.marquee_start.y) &&
          (cwid_xw <= cw->container.marquee_end.x) && (cwid_yh <= cw->container.marquee_end.y));
}
  ...
  switch (cw->container.selection_technique) {
    case XmMARQUEE_EXTEND_BOTH:
      if ((cw->container.started_in_anchor) && (cwid)) {
        ...
        if (anchor_y > 0)
          anchor_y--, height++;
        XtVaGetValues(
            cwid, XmNx, &cwid_x, XmNy, &cwid_y, XmNwidth, &width, XmNheight, &height, NULL);
        /* CR9113: adjust marquee to encompass child */
        if (cwid_x > 0)
          cwid_x--, width++;
        if (cwid_y > 0)
        ...
        cwid_xw = cwid_x + (Position)width;
        cwid_yh = cwid_y + (Position)height;
        cw->container.marquee_start.x = MIN(anchor_x, cwid_x);
        cw->container.marquee_start.y = MIN(anchor_y, cwid_y);
        cw->container.marquee_end.x = MAX(anchor_xw, cwid_xw);
        cw->container.marquee_end.y = MAX(anchor_yh, cwid_yh);
        break;
      }
    ...
    case XmMARQUEE_EXTEND_START:
      ...
      if (cwid) {
        ...
        cwid_yh = cwid_y + (Position)height;
        if (x <= cwid_xw) {
          cw->container.marquee_start.x = MIN(x, cwid_x);
          cw->container.marquee_end.x = cwid_xw;
        }
        else {
          cw->container.marquee_start.x = cwid_x;
          cw->container.marquee_end.x = MAX(x, cwid_xw);
        }
        if (y <= cwid_yh) {
          cw->container.marquee_start.y = MIN(y, cwid_y);
          cw->container.marquee_end.y = cwid_yh;
        }
        else {
          cw->container.marquee_start.y = cwid_y;
          cw->container.marquee_end.y = MAX(y, cwid_yh);
        }
        break;
      }
    case XmMARQUEE:
    case XmTOUCH_OVER:
      ...
      cw->container.marquee_start.y = MIN(y, cw->container.anchor_point.y);
      cw->container.marquee_end.x = MAX(x, cw->container.anchor_point.x);
      cw->container.marquee_end.y = MAX(y, cw->container.anchor_point.y);
      break;
    default:
      return;
  }
...
static void DrawMarquee(Widget wid)
{
  ...
  if (!XtIsRealized(wid))
    return;
  width = (Dimension)(cw->container.marquee_end.x - cw->container.marquee_start.x);
  height = (Dimension)(cw->container.marquee_end.y - cw->container.marquee_start.y);
 ...
 ************************************************************************/
static void KBSelect(Widget wid,
                     XEvent *event,
                     String *params,       /* unused */
                     Cardinal *num_params) /* unused */
{
  ...
  if ((!cw->container.extending_mode || CtrPolicyIsSINGLE(cw)) &&
      ((cw->container.selected_item_count > 1) || (c->selection_state != XmSELECTED)))
    cw->container.no_auto_sel_changes |= DeselectAllCwids(wid);
  if (cw->container.extending_mode) {
    if (c->selection_state == XmSELECTED)
      cw->container.selection_state = XmNOT_SELECTED;
...
static void CalcNextLocationCursor(Widget wid, String direction)
{
  ...
  if (_XmConvertActionParamToRepTypeId(
          (Widget)cw, XmRID_CONTAINER_CURSOR_ACTION_PARAMS, direction, False, &move_to) == False)
  {
  ...
  if (CtrLayoutIsSPATIAL(cw)) {
    if (move_to == _LEFT)
      ...
      XmProcessTraversal(cw->container.last_node->widget_ptr, XmTRAVERSE_CURRENT);
  }
    ...
    if (move_to == _LEFT)
      ...
      w = GetLastTraversalWidget(cw, cw->container.first_node->widget_ptr, False);
      if (w)
                                ...
                                unsigned int pass)
{
  ...
  Boolean wrap;
  if ((old_focus == NULL) || (focus_policy != XmEXPLICIT) ||
      (direction != XmTRAVERSE_PREV && direction != XmTRAVERSE_NEXT &&
       direction != XmTRAVERSE_LEFT && direction != XmTRAVERSE_RIGHT &&
       direction != XmTRAVERSE_UP && direction != XmTRAVERSE_DOWN && direction != XmTRAVERSE_HOME))
    return new_focus;
  if (((cw = (XmContainerWidget)XtParent(old_focus)) == NULL) || (!XmIsContainer(cw)) ||
      (CtrLayoutIsSPATIAL(cw)) || (CtrOUTLINE_BUTTON(old_focus)))
    return new_focus;
  ...
  for (i = 0; i < cw->composite.num_children; i++) {
    ...
    if (CtrOUTLINE_BUTTON(cwid)) {
      ...
      if (c->outline_state == XmEXPANDED)
        ...
        pm = cw->container.collapsed_state_pixmap;
      n = 0;
      XtSetArg(wargs[n], XmNlabelPixmap, pm);
      n++;
      cw->container.self = True;
...
static void ExpandCwid(Widget cwid)
{
  ...
  if (c->related_cwid == NULL)
    return;
  cw->container.self = True;
  XtVaSetValues(c->related_cwid, XmNlabelPixmap, cw->container.expanded_state_pixmap, NULL);
  cw->container.self = False;
...
static void CollapseCwid(Widget cwid)
{
  ...
  if (c->related_cwid == NULL)
    return;
  cw->container.self = True;
  XtVaSetValues(c->related_cwid, XmNlabelPixmap, cw->container.collapsed_state_pixmap, NULL);
  cw->container.self = False;
...
static void CallActionCB(Widget cwid, XEvent *event)
{
  ...
  if (!(XtHasCallbacks((Widget)cw, XmNdefaultActionCallback) == XtCallbackHasSome))
    return;
  if (!XtIsSensitive(cwid))
    return;
...
static void CallSelectCB(Widget wid, XEvent *event, unsigned char auto_selection_type)
{
  ...
  switch (cw->container.selection_policy) {
    ...
    case XmBROWSE_SELECT:
      ...
      if (cw->container.anchor_cwid) {
        cbs.selected_items = (WidgetList)XtMalloc(sizeof(Widget));
        cbs.selected_items[0] = cw->container.anchor_cwid;
        cbs.selected_item_count = 1;
      }
      break;
 ...
 ************************************************************************/
static void GetSelectedItems(Widget wid,
                             int offset, /* unused */
                             XtArgVal *value)
{
  WidgetList selected_items;
 ...
 ************************************************************************/
static void ConvertRefuse(Widget wid,        /* unused */
                          XtPointer closure, /* unused */
 ...
 ************************************************************************/
static void DragStart(XtPointer data, XtIntervalId *id) /* unused */
{
  ...
  if (GetViewType(cw->container.druggee) == XmSMALL_ICON) {
    XtSetArg(wargs[n], XmNsmallIconPixmap, &pixmap);
    n++;
    XtSetArg(wargs[n], XmNsmallIconMask, &mask);
    n++;
  }
  else {
    XtSetArg(wargs[n], XmNlargeIconPixmap, &pixmap);
    n++;
    XtSetArg(wargs[n], XmNlargeIconMask, &mask);
    n++;
  }
  ...
  if (XFindContext(XtDisplay(cw), None, dragIconInfoContext, (XPointer *)&dragIconInfo) ==
          XCNOENT ||
      dragIconInfo == (DragIconInfo)NULL)
  {
    Pixmap cross;
    ...
    XSaveContext(XtDisplay(cw), None, dragIconInfoContext, (char *)dragIconInfo);
    ...
    XSetLineAttributes(XtDisplay(cw), tempgc, 2, LineSolid, CapButt, JoinMiter);
    ...
    XSetLineAttributes(XtDisplay(cw), tempgc, 6, LineSolid, CapButt, JoinMiter);
    ...
    n = 0;
    XtSetArg(args[n], XmNpixmap, cross);
    n++;
    XtSetArg(args[n], XmNmask, cross_m);
    n++;
    XtSetArg(args[n], XmNheight, farpoint);
    n++;
    XtSetArg(args[n], XmNwidth, farpoint);
    n++;
    dragIconInfo->state = XmCreateDragIcon(diParent, "stateIcon", args, n);
  }
  n = 0;
  XtSetArg(wargs[n], XmNforeground, &fg);
  n++;
  XtSetArg(wargs[n], XmNbackground, &bg);
  n++;
  ...
  if (pixmap != XmUNSPECIFIED_PIXMAP) {
    ...
    XtSetArg(wargs[n], XmNoffsetX, offsetx);
    n++;
    XtSetArg(wargs[n], XmNoffsetY, offsety);
    n++;
    XtSetValues(dragIconInfo->state, wargs, n);
    /* now create or fix up the source icon */
    XmeGetPixmapData(XtScreen(cw), pixmap, NULL, &rd, NULL, NULL, NULL, NULL, &rw, &rh);
    n = 0;
    XtSetArg(wargs[n], XmNpixmap, pixmap);
    n++;
    XtSetArg(wargs[n], XmNmask, mask);
    n++;
    XtSetArg(wargs[n], XmNheight, rh);
    n++;
    XtSetArg(wargs[n], XmNwidth, rw);
    n++;
    XtSetArg(wargs[n], XmNdepth, rd);
    n++;
    ...
    n++;
    XtSetArg(wargs[n], XmNstateCursorIcon, dragIconInfo->state);
    n++;
  }
  XtSetArg(wargs[n], XmNdragOperations, cw->container.transfer_action->operation);
  n++;
  if (vis_state == XmSELECTED)
    loc_data = NULL;
  else
    loc_data = (XtPointer)cw->container.druggee;
  XtSetArg(wargs[n], XmNcursorBackground, bg);
  n++;
  XtSetArg(wargs[n], XmNcursorForeground, fg);
  n++;
  dc = XmeDragSource((Widget)cw, loc_data, cw->container.transfer_action->event, wargs, n);
  if (dc)
 ...
 ************************************************************************/
static void OutlineButtonCallback(Widget pbwid, /* unused */
...
static void OutlineButtonAction(Widget cwid, unsigned char new_state, XEvent *event)
{
  ...
  if ((cbs.new_outline_state != XmCOLLAPSED) && (cbs.new_outline_state != XmEXPANDED))
...
static void MoveItemCallback(Widget wid, XtPointer client_data, XtPointer call_data)
{
  ...
  XmDestinationCallbackStruct *ds = _XmTransferGetDestinationCBStruct(cs->transfer_id);
  ...
  dropspot->x -= offset->x;
  dropspot->y -= offset->y;
  if (((XmContainerWidgetClass)XtClass(wid))->container_class.test_fit_item) {
    XmSpatialTestFitProc test_item;
    Boolean status;
    test_item = (XmSpatialTestFitProc)((XmContainerWidgetClass)XtClass(wid))
  ...
  if (((XmContainerWidgetClass)XtClass(wid))->container_class.remove_item)
    (*((XmContainerWidgetClass)XtClass(wid))->container_class.remove_item)(wid, cwid);
  /* Clear old placement */
  XClearArea(XtDisplay(wid),
             XtWindow(wid),
 ...
 ************************************************************************/
static void DropDoneCallback(Widget wid, /* unused */
                             XtPointer client_data,
                         ...
                         Boolean *continue_to_dispatch)
{
  ...
  cw->container.scroll_proc_id = XtAppAddTimeOut(
      XtWidgetToApplicationContext(wid), (unsigned long)interval, ScrollProc, (XtPointer)cw);
}
...
static void ScrollProc(XtPointer closure, XtIntervalId *id)
{
  ...
  scrollFrameTrait = (XmScrollFrameTrait)XmeTraitGet((XtPointer)XtClass(sf), XmQTscrollFrame);
  if (!(scrollFrameTrait && (scrollFrameTrait->getInfo(sf, NULL, &nav, &num_nav_list))))
    return; /* this should never happen */
  for (i = 0; i < num_nav_list; i++, nav++) {
    navigatorTrait = (XmNavigatorTrait)XmeTraitGet((XtPointer)XtClass(*nav), XmQTnavigator);
    /* get the current position */
    nav_data.valueMask = NavValue | NavIncrement | NavMinimum | NavMaximum | NavSliderSize;
 ...
 ************************************************************************/
Boolean XmContainerCut(Widget wid, Time timestamp)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  Boolean status;
 ...
 ************************************************************************/
Boolean XmContainerCopy(Widget wid, Time timestamp)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  Boolean status;
  _XmWidgetToAppContext(wid);
 ...
 ************************************************************************/
Boolean XmContainerPaste(Widget wid)
{
 ...
 ************************************************************************/
Boolean XmContainerCopyLink(Widget wid, Time timestamp)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  Boolean status;
  _XmWidgetToAppContext(wid);
 ...
 ************************************************************************/
Boolean XmContainerPasteLink(Widget wid)
{
 ...
 ************************************************************************/
int XmContainerGetItemChildren(Widget wid, Widget item, WidgetList *item_children)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  XmContainerConstraint c;
  CwidNode node;
 ...
 ************************************************************************/
void XmContainerRelayout(Widget wid)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  _XmWidgetToAppContext(wid);
  if (!XtIsRealized(wid))
 ...
 ************************************************************************/
void XmContainerReorder(Widget wid, WidgetList cwid_list, int cwid_count)
{
  XmContainerWidget cw = (XmContainerWidget)wid;
  XmContainerConstraint c;
  Widget pcwid;
...
Widget XmVaCreateContainer(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmContainerWidgetClass, parent, False, var, count);
  va_end(var);
  return w;
}
...
Widget XmVaCreateManagedContainer(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmContainerWidgetClass, parent, True, var, count);
  va_end(var);
  return w;
}
