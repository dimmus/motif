...
static Boolean Search(XmI18ListWidget ilist,
                      XmString xms,
                      int start_row,
                      int start_column,
                      int *found_row,
...
static XtResource resources[] = {{XmNnumColumns,
                                  XmCNumColumns,
                                  XmRShort,
                                  sizeof(short),
                                  XtOffsetOf(XmI18ListRec, ilist.num_columns),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNnumRows,
                                  XmCNumRows,
                                  XmRShort,
                                  sizeof(short),
                                  XtOffsetOf(XmI18ListRec, ilist.num_rows),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNselectedColumn,
                                  XmCSelectedColumn,
                                  XmRShort,
                                  sizeof(short),
                                  XtOffsetOf(XmI18ListRec, ilist.selected_header),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNcolumnTitles,
                                  XmCColumnTitles,
                                  XmRXmStringTable,
                                  sizeof(XmString *),
                                  XtOffsetOf(XmI18ListRec, ilist.column_titles),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNentryData,
                                  XmCEntryData,
                                  XmRPointer,
                                  sizeof(XtPointer),
                                  XtOffsetOf(XmI18ListRec, ilist.row_data),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNfirstColumnPixmaps,
                                  ...
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmI18ListRec, ilist.first_col_pixmaps),
                                  XmRImmediate,
                                  (XtPointer)False},
                                 {"pri.vate",
                                  "Pri.vate",
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmI18ListRec, ilist.check_set_render_table),
                                  XmRImmediate,
                                  (XtPointer)False},
                                 {XmNfontList,
                                  XmCFontList,
                                  XmRFontList,
                                  sizeof(XmFontList),
                                  XtOffsetOf(XmI18ListRec, ilist.font_list),
                                  XmRCallProc,
                                 ...
                                 {XmNverticalScrollBar,
                                  ...
                                  XmRWidget,
                                  sizeof(Widget),
                                  XtOffsetOf(XmI18ListRec, ilist.v_bar),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNhorizontalScrollBar,
                                  ...
                                  XmRWidget,
                                  sizeof(Widget),
                                  XtOffsetOf(XmI18ListRec, ilist.h_bar),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNfirstRow,
                                  XmCFirstLocation,
                                  XmRShort,
                                  sizeof(short),
                                  XtOffsetOf(XmI18ListRec, ilist.first_row),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNfirstColumn,
                                  XmCFirstLocation,
                                  XmRShort,
                                  sizeof(short),
                                  XtOffsetOf(XmI18ListRec, ilist.first_col),
                                  XmRImmediate,
                                  (XtPointer)0},
                                 {XmNdoubleClickCallback,
                                  ...
                                  XtOffsetOf(XmI18ListRec, ilist.double_click),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNsortFunctions,
                                  XmCFunction,
                                  XmRFunction,
                                  sizeof(Xm18SortFunction **),
                                  XtOffsetOf(XmI18ListRec, ilist.sort_functions),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNselectionPolicy,
                                  XmCSelectionPolicy,
                                  ...
                                  XtOffsetOf(XmI18ListRec, ilist.selection_policy),
                                  XmRImmediate,
                                 ...
                                 {XmNsingleSelectionCallback,
                                  ...
                                  XmRCallback,
                                  sizeof(XtCallbackList),
                                  XtOffsetOf(XmI18ListRec, ilist.single_select),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNalignment,
                                  XmCAlignment,
                                  XmRAlignment,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmI18ListRec, ilist.alignment),
                                  XmRImmediate,
                                 ...
                                 {XmNstringDirection,
                                  ...
                                  XmRStringDirection,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmI18ListRec, ilist.string_direction),
                                  XmRImmediate,
                                 ...
                                 {XmNvisibleItemCount,
                                  ...
                                  XmRInt,
                                  sizeof(int),
                                  XtOffsetOf(XmI18ListRec, ilist.visible_rows),
                                  XmRImmediate,
                                  (XtPointer)XmMultiList_DEFAULT_VISIBLE_COUNT},
                                 {XmNnewVisualStyle,
                                  XmCNewVisualStyle,
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmI18ListRec, ilist.new_visual_style),
                                  XmRImmediate,
                                  (XtPointer)True},
...
XmI18ListClassRec xmI18ListClassRec = {{/* core fields */
...
static void Initialize(Widget req, Widget set, ArgList args, Cardinal *num_args)
{
  ...
  if (XmI18List_v_bar(ilist) != NULL) {
    XtAddCallback(
        XmI18List_v_bar(ilist), XmNvalueChangedCallback, VScrollCallback, (XtPointer)set);
    XtAddCallback(XmI18List_v_bar(ilist), XmNdragCallback, VScrollCallback, (XtPointer)set);
  }
  if (XmI18List_h_bar(ilist) != NULL) {
    XtAddCallback(
        XmI18List_h_bar(ilist), XmNvalueChangedCallback, HScrollCallback, (XtPointer)set);
  ...
  if (XmI18List_h_bar(ilist) != NULL)
    XtAddCallback(
        XmI18List_h_bar(ilist), XmNdecrementCallback, HSlideLeftArrowCallback, (XtPointer)set);
  if (XmI18List_h_bar(ilist) != NULL)
    XtAddCallback(
        XmI18List_h_bar(ilist), XmNincrementCallback, HSlideRightArrowCallback, (XtPointer)set);
  if (XtHeight(req) == 0) {
  ...
  if (XmPrim_layout_direction(ilist) != XmDEFAULT_DIRECTION) {
    XmI18List_string_direction(ilist) = XmDirectionToStringDirection(
        XmPrim_layout_direction(ilist));
  }
  else if (XmI18List_string_direction(ilist) != XmDEFAULT_DIRECTION) {
    XmPrim_layout_direction(ilist) = XmStringDirectionToDirection(
  ...
  if (!XmRepTypeValidValue(XmRID_STRING_DIRECTION, XmI18List_string_direction(ilist), set)) {
    ...
    Widget current, Widget request, Widget set, ArgList args, Cardinal *num_args)
{
  ...
  if (XmI18List_row_data(i_set) != NULL || XmI18List_row_data(i_old) != NULL) {
    ...
    if ((XmI18List_first_col(i_set) != XmI18List_first_col(i_old)) ||
        (XmI18List_first_row(i_set) != XmI18List_first_row(i_old)) || check_pos)
    {
    ...
    if (*num_params == 1) {
      switch (params[0][0]) {
        ...
        case 'T':
          ...
          break;
        default: {
          _XmWarningMsg(w, XmNbadActionParameters, XmNbadActionParametersMsg, params, 1);
        }
      }
    }
  }
 ...
 */
/*ARGSUSED*/
static void ButtonUpOrLeaveAction(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  Boolean notify_type;
  XmI18ListWidget ilist = (XmI18ListWidget)w;
...
static void MotionAction(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  XmI18List_timeout(ilist) = XtAppAddTimeOut(
      XtWidgetToApplicationContext(w), DELAY_TIME(w), MoveListTimeout, (XtPointer)w);
}
 ...
 */
/*ARGSUSED*/
static void SingleClick(XmI18ListWidget ilist)
{
  if (XmI18List_selection_policy(ilist) == XmSINGLE_SELECT) {
    /*
 ...
 */
/*ARGSUSED*/
static void MoveListTimeout(XtPointer w_ptr, XtIntervalId *id)
{
  short row;
  int v_inc = 0;
 ...
 */
/*ARGSUSED*/
static void HSlideLeftArrowCallback(Widget w, XtPointer client_data, XtPointer junk)
{
  XmI18ListWidget ilist = (XmI18ListWidget)client_data;
  /*
  ...
  DisplayList((Widget)ilist,
              XmI18List_first_row(ilist),
              (XmI18List_num_rows(ilist) - XmI18List_first_row(ilist)),
              TRUE);
...
static void CalcLocations(Widget w)
{
  ...
  if (XmI18List_num_columns(ilist) && XmI18List_column_titles(ilist)) /* CR03506 */
    XmI18List_sep_y(ilist) = 2 * VERTICAL_SPACE + XmI18List_title_row_height(ilist);
  else
  ...
  for (i = start_row; i <= end_row; i++) {
    if (XmI18List_row_data(ilist)[i].selected) {
      XFillRectangle(XtDisplay(w),
                     XtWindow(w),
                     XmI18List_gc(ilist),
                     LayoutIsRtoLP(w) ? -tot_width + XtWidth(w) - XmI18List_left_loc(ilist) +
                                            HORIZONTAL_SPACE / 2 :
                                        XmI18List_left_loc(ilist) - HORIZONTAL_SPACE / 2,
                     cur_y,
    ...
    if (redraw_headers) {
      ...
      if (XmI18List_column_titles(ilist) != NULL) {
        ...
        XmStringDraw(XtDisplay(w),
                     XtWindow(w),
                     XmI18List_font_list(ilist),
                     ptr,
                     gc,
                     cur_x,
                     cur_y,
                     col_widths[i],
                     XmI18List_alignment(ilist),
                     XmPrim_layout_direction(ilist),
                     NULL);
      }
    }
        ...
        if (IsValidPixmap(XmI18List_row_data(ilist)[j].pixmap)) {
          ...
          if (XmI18List_row_data(ilist)[j].pix_depth == 1) {
            XCopyPlane(XtDisplay(w),
                       XmI18List_row_data(ilist)[j].pixmap,
                       XtWindow(w),
                       entry_gc,
                       0,
                       0,
                       ...
                       LayoutIsRtoLP(w) ? width - XmI18List_left_loc(ilist) -
                                              XmI18List_row_data(ilist)[j].pix_width :
                                          cur_x,
                       cur_y + pix_y_offset,
                       (unsigned long)1);
 ...
 *	Returns:       none.
 */
static void DrawSeparator(Widget w)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  unsigned int width = ilist->core.width;
  unsigned int height = XmI18List_sep_y(ilist);
  GC gc;
  if (!XmI18List_num_columns(ilist) || !XmI18List_column_titles(ilist))
    return; /* CR03506 */
  if (XmI18List_new_visual_style(ilist)) {
  ...
  for (i = 0; i < num_rows; i++) {
    ...
    if (IsValidPixmap(XmI18List_row_data(ilist)[i].pixmap)) {
      XGetGeometry(XtDisplay(w),
                   XmI18List_row_data(ilist)[i].pixmap,
                   &root,
                   &x,
                   &y,
                   &width,
 ...
 *	Returns:       none
 */
static void SetVisibleSize(Widget w, Boolean set_width)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
...
#if USE_XFT
    XmRenderTableGetDefaultFontExtents(XmI18List_font_list(ilist), &height, NULL, NULL);
    if (height == 0)
...
static void CalcColumnInfo(Widget w, Boolean force)
{
  ...
  for (i = 0; i < num_cols; i++) {
    if (XmI18List_column_titles(ilist) != NULL) {
      ...
      if ((int)height > max_title_height)
        max_title_height = height;
 ...
 *	Returns:       none
 */
static void VScroll(Widget w, short amount)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  int y_start;
  short num_rows;
 ...
 *      Modified:      03/17/92 beth - converted to pixels
 */
static void HScroll(Widget w, short amount)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  int y_start;
 ...
 *      Modified:      03/17/92 beth - converted to pixels
 */
static void CvtPositionToRowColumn(Widget w, short x, short y, short *row, short *column)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  int title_extra;
  if (XmI18List_new_visual_style(ilist))
 ...
 *      Modified:      03/17/92 beth - converted to pixels
 */
static void CvtRowColumnToPosition(Widget w, short row, short column, short *x, short *y)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  int title_extra;
  if (XmI18List_new_visual_style(ilist))
  ...
  if (row == IN_COLUMN_HEADER)
    ...
    *y = (XmI18List_sep_y(ilist) + title_extra +
          (row - XmI18List_first_row(ilist)) * (XmI18List_row_height(ilist) + VERTICAL_SPACE) +
          VERTICAL_SPACE / 2);
  }
 ...
 *	Returns:       none
 */
static void ToggleRow(Widget w, short row)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
 ...
 *	Returns:       none
 */
static void SelectHeader(Widget w, short column)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
 ...
 *	Returns:       none.
 */
static void SortList(Widget w, Boolean redisplay)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
 ...
 *	Returns:
 */
static int QSortTest(const void *row1, const void *row2)
{
 ...
 *      Modified:      03/17/92 beth - converted to pixels
 */
static void InvertArea(Widget w, short row, short column)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  ...
  if ((XmI18List_first_col_pixmaps(ilist)) && (XmI18List_row_data(ilist)[row].pix_depth != 1) &&
      IsValidPixmap(XmI18List_row_data(ilist)[row].pixmap))
  {
    pix_y_offset = (height - XmI18List_row_data(ilist)[row].pix_height) / 2;
    XCopyArea(XtDisplay(w),
              XmI18List_row_data(ilist)[row].pixmap,
              XtWindow(w),
              XmI18List_entry_background_gc(ilist),
              0,
              0,
              XmI18List_row_data(ilist)[row].pix_width,
              XmI18List_row_data(ilist)[row].pix_height,
              LayoutIsRtoLP(w) ? XtWidth(ilist) - XmI18List_left_loc(ilist) -
                                     XmI18List_row_data(ilist)[row].pix_height :
 ...
 *      Modified:      03/17/92 beth - converted to pixels
 */
static void RedrawList(Widget w)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  short num_rows;
  if (XtIsRealized(w)) {
 ...
 *	Returns:       none.
 */
static int IsRowVisible(Widget w, short row)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  short r_row, r_col;
 ...
 */
static void AdjustVisiblePosition(Widget w, short position, Boolean check, short value)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
  /*
...
static void AdjustFirstRowAndCol(XmI18ListWidget ilist)
{
 ...
 *      Modified:      03/17/92 beth - converted to pixels
 */
static Boolean MakePositionVisible(Widget w, short row, short start, short last, int width)
{
  XmI18ListWidget ilist = (XmI18ListWidget)w;
                      ...
                      int *found_column)
{
  ...
  for (row = start_row; row < XmI18List_num_rows(ilist); row++) {
    for (column = start_column; column < XmI18List_num_columns(ilist); column++) {
 ...
 *  Returns:       none
 */
void XmI18ListToggleRow(Widget w, short row)
{
  ToggleRow(w, row);
}
 ...
 *	None.
 */
static void CopyColumnTitles(XmI18ListWidget ilist)
{
  int i;
  XmStringTable copy;
 ...
 *	None.
 */
static void FreeColumnTitles(XmI18ListWidget ilist)
{
  int i;
  if (XmI18List_num_columns(ilist) == 0 || XmI18List_column_titles(ilist) == NULL) {
    return;
 ...
 *  Returns:       rows
 */
static int *GetSelectedRows(XmI18ListWidget i18list, int *num_rows)
{
 ...
 *  Returns:       none
 */
static void SelectRow(XmI18ListWidget i18list, int row, Boolean select, Boolean notify)
{
...
static void SelectItems(
    XmI18ListWidget i18list, XmString item, int column, Boolean select, Boolean notify)
{
  XmMultiListRowInfo *rows = XmI18List_row_data(i18list);
  int i, j;
  ...
  for (i = 0; i < rowcount; i++)
    for (j = colstart; j < colcount; j++)
      ...
      if ((((column == XmANY_COLUMN) || (column == j)) &&
           XmStringCompare(item, rows[i].values[j])) ||
          !item)
      {
 ...
 */
static XmString GetConcatenatedRow(Widget w, int row)
{
  ...
  for (i = 0; i < lw->ilist.num_columns; i++) {
    if (lw->ilist.row_data[row].values[i]) {
      if (result) {
        temp_string = XmStringConcat(tab, lw->ilist.row_data[row].values[i]);
 ...
 ***************************************************************************/
/*ARGSUSED*/
static void ProcessDrag(Widget wid,
                        XEvent *event,
                        ...
                        Cardinal *num_params) /* unused */
{
  ...
  if (col < 0 || row >= lw->ilist.num_rows || col >= lw->ilist.num_columns)
    return;
  location_data = row;
  lw->ilist.drag_conv = ListDragConv = (XmI18ListDragConvertStruct *)XtMalloc(
      sizeof(XmI18ListDragConvertStruct));
  ListDragConv->w = wid;
 ...
 ***************************************************************************/
/*ARGSUSED*/
static void CopyToClipboard(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
  XmI18ListWidget lw = (XmI18ListWidget)w;
  int rowcount;
 ...
 *  Returns:       none
 */
void XmI18ListSelectItems(XmI18ListWidget i18list, XmString item, int column, Boolean notify)
{
 ...
 *  Returns:       none
 */
void XmI18ListDeselectItems(XmI18ListWidget i18list, XmString item, int column)
{
 ...
 *  Returns:       none
 */
void XmI18ListSelectAllItems(XmI18ListWidget i18list, Boolean notify)
{
 ...
 *  Returns:       none
 */
void XmI18ListSelectRow(XmI18ListWidget i18list, int row, Boolean notify)
{
 ...
 *  Returns:       none
 */
void XmI18ListDeselectRow(XmI18ListWidget i18list, int row)
{
 ...
 */
int *XmI18ListGetSelectedRowArray(XmI18ListWidget i18list, int *num_rows)
{
 ...
 *  Returns:       none
 */
void XmI18ListMakeRowVisible(XmI18ListWidget i18list, int row)
{
