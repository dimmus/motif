    ...
    Boolean *success)
{
    ...
    *success = False;
	...
	{
	case 1:
	    val = (XTPOINTER)(long)(*(char*)toVal.addr);    /* may be exists bug */
	    break;
	case 2:
	    val = (XTPOINTER)(long)(*(short*)toVal.addr);    /* may be exists bug */
	    break;
	case 4:
	    val = (XTPOINTER)(long)(*(int*)toVal.addr);      /* may be exists bug */
	    break;
	case 8:
	default:
        val = (*(XTPOINTER*)toVal.addr);
