 ...
 ************************************************************************/
static void
_XmGetDisplayArg(Widget widget, Cardinal *size, XrmValue *value)
{
   if (widget == NULL)
      XtErrorMsg("missingWidget", "_XmGetDisplayArg", "XtToolkitError", "_XmGetDisplayArg called without a widget to reference", (String *)NULL, (Cardinal *)NULL);
...
_XmRegisterConverters(void)
{
   ...
   if (!registered)
   {
      ...
      XtSetTypeConverter(XmRString, XmRWidget, CvtStringToWidget, selfConvertArgs, XtNumber(selfConvertArgs), XtCacheNone, (XtDestructor)NULL);
      XtSetTypeConverter(XmRString, XmRWindow, CvtStringToWindow, selfConvertArgs, XtNumber(selfConvertArgs), XtCacheNone, (XtDestructor)NULL);
      XtSetTypeConverter(XmRString, XmRChar, CvtStringToChar, NULL, 0, XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRFontList, CvtStringToXmFontList, displayConvertArg, XtNumber(displayConvertArg), XtCacheByDisplay, CvtStringToXmFontListDestroy);
      XtSetTypeConverter(XmRString, XmRXmString, CvtStringToXmString, NULL, 0, (XtCacheNone | XtCacheRefCount), CvtStringToXmStringDestroy);
      XtSetTypeConverter(XmRString, XmRKeySym, CvtStringToKeySym, NULL, 0, XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRHorizontalPosition, CvtStringToHorizontalPosition, selfConvertArgs, XtNumber(selfConvertArgs), XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRHorizontalDimension, CvtStringToHorizontalDimension, selfConvertArgs, XtNumber(selfConvertArgs), XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRVerticalPosition, CvtStringToVerticalPosition, selfConvertArgs, XtNumber(selfConvertArgs), XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRVerticalDimension, CvtStringToVerticalDimension, selfConvertArgs, XtNumber(selfConvertArgs), XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRBooleanDimension, CvtStringToBooleanDimension, selfConvertArgs, XtNumber(selfConvertArgs), XtCacheNone, NULL);
      XtSetTypeConverter(XmRCompoundText, XmRXmString, XmCvtTextToXmString, NULL, 0, XtCacheNone, NULL);
      XtSetTypeConverter(XmRXmString, XmRCompoundText, XmCvtXmStringToText, NULL, 0, XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRCharSetTable, CvtStringToCharSetTable, NULL, 0, XtCacheNone, CvtStringToCharSetTableDestroy);
      XtSetTypeConverter(XmRString, XmRKeySymTable, CvtStringToKeySymTable, NULL, 0, XtCacheNone, CvtStringToKeySymTableDestroy);
      XtSetTypeConverter(XmRString, XmRButtonType, ConvertStringToButtonType, NULL, 0, XtCacheNone, ConvertStringToButtonTypeDestroy);
      XtSetTypeConverter(XmRString, XmRXmStringTable, CvtStringToXmStringTable, NULL, 0, (XtCacheNone | XtCacheRefCount), XmStringCvtDestroy);
      XtSetTypeConverter(XmRString, XmRStringTable, CvtStringToStringTable, NULL, 0, (XtCacheNone | XtCacheRefCount), StringCvtDestroy);
      XtSetTypeConverter(XmRString, XmRCardinalList, CvtStringToCardinalList, NULL, 0, XtCacheNone, CardinalListCvtDestroy);
      XtSetTypeConverter(XmRString, XmRAtomList, CvtStringToAtomList, NULL, 0, (XtCacheNone | XtCacheRefCount), SimpleDestructor);
      XtSetTypeConverter(XmRString, XmRCardinal, CvtStringToCardinal, NULL, 0, XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRTextPosition, CvtStringToTextPosition, NULL, 0, XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRTopItemPosition, CvtStringToTopItemPosition, NULL, 0, XtCacheNone, NULL);
      XtSetTypeConverter(XmRString, XmRRenditionPixel, CvtStringToRenditionPixel, (XmConst XtConvertArgList)colorConvertArgs, 2, XtCacheByDisplay, NULL);
      ...
      XtSetTypeConverter(XmRPixel, XmRRenditionPixel, CvtPixelToRenditionPixel, NULL, 0, XtCacheByDisplay, NULL);
      ...
      XtSetTypeConverter(XmRString, XmRTabList, CvtStringToXmTabList, NULL, 0, (XtCacheAll | XtCacheRefCount), CvtStringToXmTabListDestroy);
      XtSetTypeConverter(XmRString, XmRRenderTable, CvtStringToRenderTable, selfConvertArgs, XtNumber(selfConvertArgs), (XtCacheNone | XtCacheRefCount), CvtStringToXmRenderTableDestroy);
      ...
      XtSetTypeConverter(XmRString, XmRButtonFontList, CvtStringToButtonFontList, selfConvertArgs, XtNumber(selfConvertArgs), (XtCacheNone | XtCacheRefCount), CvtStringToXmFontListDestroy);
      XtSetTypeConverter(XmRString, XmRLabelFontList, CvtStringToLabelFontList, selfConvertArgs, XtNumber(selfConvertArgs), (XtCacheNone | XtCacheRefCount), CvtStringToXmFontListDestroy);
      XtSetTypeConverter(XmRString, XmRTextFontList, CvtStringToTextFontList, selfConvertArgs, XtNumber(selfConvertArgs), (XtCacheNone | XtCacheRefCount), CvtStringToXmFontListDestroy);
      registered = True;
   }
   _XmProcessUnlock();
   return;
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   if (from->addr)
   {
      ...
      if (!GetNextFontListEntry(&sPtr, &fontName, &fontTag, &fontType, &delim))
      {
         XtFree(newString);
      ...
      do
      {
         if (*fontName)
         {
            fontListEntry = XmFontListEntryLoad(dpy, fontName, fontType, fontTag);
      ...
      while ((delim == ',') && *++sPtr && GetNextFontListEntry(&sPtr, &fontName, &fontTag, &fontType, &delim));
      XtFree(newString);
   }
   if (got_it)
   {
...
CvtStringToButtonFontList(Display   *dpy,
                          ...
                          XtPointer *converter_data) /* unused */
{
   return (CvtStringToXmFontList(dpy, args, num_args, from, to, converter_data));
}
   ...
   *fontTypeRes = XmFONT_IS_FONT;
   ...
   else
   {
      if (*fontTypeRes == XmFONT_IS_FONTSET)
      {
         ...
         params[0]  = fontName;
         num_params = 1;
         XtWarningMsg("conversionWarning", "string", "XtToolkitError", MSG3, params, &num_params);
         return (FALSE);
      }
      if (*delim == '=')
      {
      ...
      else
      {
         ...
         params[0]  = fontTag;
         num_params = 1;
         XtWarningMsg("conversionWarning", "string", "XtToolkitError", MSG4, params, &num_params);
         return (FALSE);
      }
   }
   ...
   *name = *s;
   if (**s == '"')
   {
      ...
      if (**s == '\0')
      {
         ...
         params[0]  = --(*name);
         num_params = 1;
         XtWarningMsg("conversionWarning", "string", "XtToolkitError", MSG6, params, &num_params);
         return (FALSE);
      }
      **s = '\0';
      (*s)++;
   ...
   *tag = *s;
   ...
   if (*s == *tag)
   {
      if (needs_tag)
      {
         ...
         num_params = 1;
         XtWarningMsg("conversionWarning", "string", "XtToolkitError", MSG7, params, &num_params);
      }
      return (FALSE);
   }
   return (TRUE);
   ...
   XtPointer  *data) /* unused */
{
   ...
   if ((p = from_val->addr) == NULL)
      return (False);
   crd_array = (Cardinal *)XtCalloc(crd_array_size, sizeof(Cardinal));
   while (*p != '\0')
   {
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   Boolean       parseError;
   tmpPix = (Position)
      _XmConvertStringToUnits(screen, from->addr, (int)defaultFromType, XmHORIZONTAL, XmPIXELS, (XtEnum *)&parseError);
   if (parseError)
   {
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   Boolean       parseError;
   tmpPix = (Position)
      _XmConvertStringToUnits(screen, from->addr, (int)defaultFromType, XmVERTICAL, XmPIXELS, (XtEnum *)&parseError);
   if (parseError)
   {
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   if (parseError)
   {
      XtDisplayStringConversionWarning(display, (char *)from->addr, XmRVerticalDimension);
      return False;
   }
   else
      _XM_CONVERTER_DONE(to, Dimension, tmpPix, ;)
...
static XmFontList
DefaultSystemFontList(Display *display, XmFontList fontlist)
{
   ...
   unsigned char fontListType)
{
   ...
   if (!fontlist)
   {
      ...
      while ((delim == ',') && *++sPtr && !fontlist && GetNextFontListEntry(&sPtr, &fontName, &fontTag, &fontType, &delim));
      XtFree(newString);
   ...
   XtPointer *converter_data) /* unused */
{
        ...
        btype_str = _XStrtok(NULL, ",", strtok_buf), ++i)
   {
      ...
      {
         XtDisplayStringConversionWarning(display, (char *)btype_str, XmRButtonType);
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   XtFree((char *)work_str);
   _XM_CONVERTER_DONE(to, XmKeySymTable, keySymTable, XtFree((char *)keySymTable);)
}
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   XtFree((char *)work_str);
   _XM_CONVERTER_DONE(to, XmStringCharSetTable, charsetTable, XtFree((char *)charsetTable);)
}
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   if (isInteger(from->addr, &intermediate))
   {
      ...
      if (intermediate < 0)
      {
         XtDisplayStringConversionWarning(display, (char *)from->addr, XmRBooleanDimension);
         return (FALSE);
      }
      outVal = (Dimension)_XmConvertUnits(screen, XmHORIZONTAL, (int)unitType, intermediate, XmPIXELS);
   }
   else
   { /* Presume Boolean (version 1.1).
      ...
      else
      {
         ...
         {
            XtDisplayStringConversionWarning(display, in_str, XmRBooleanDimension);
            return (FALSE);
         }
      }
   }
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   {
      XtDisplayStringConversionWarning(display, (char *)from->addr, XmRCardinal);
      return False;
   }
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   if (!isInteger(from->addr, &intermediate) || intermediate < 0)
   {
      XtDisplayStringConversionWarning(display, (char *)from->addr, XmRTextPosition);
      return False;
   }
   ...
   XtPointer *converter_data) /* unused */
{
   ...
   if (!isInteger(from->addr, &intermediate) || intermediate < 0)
   {
      XtDisplayStringConversionWarning(display, (char *)from->addr, XmRTopItemPosition);
      return False;
   }
                          ...
                          XtPointer  *converter_data)
{
   ...
   result = XtCallConverter(disp, XtCvtStringToPixel, args, *num_args, from_val, to_val, NULL);
   if (result == False)
   {
                     ...
                     XtPointer *converter_data) /* unused */
{
   ...
   if (from->addr)
   {
      ...
      while (GetNextTab(&s, &value, unitType, &offsetModel))
      {
         ...
         tab = XmTabCreate(value, (unsigned char)units, offsetModel, XmALIGNMENT_BEGINNING, XmS);
                       ...
                       XtPointer *converter_data) /* unused */
{
   ...
   return (cvtStringToXmRenderTable(dpy, wid, XmNrenderTable, XmCRenderTable, from, to));
}
                             ...
                             XtPointer *converter_data) /* unused */
{
   Widget wid;
   wid = *(Widget *)args[0].addr;
   return (cvtStringToXmRenderTable(dpy, wid, XmNbuttonRenderTable, XmCButtonRenderTable, from, to));
}
                            ...
                            XtPointer *converter_data) /* unused */
{
   Widget wid;
   wid = *(Widget *)args[0].addr;
   return (cvtStringToXmRenderTable(dpy, wid, XmNlabelRenderTable, XmCLabelRenderTable, from, to));
}
                           ...
                           XtPointer *converter_data) /* unused */
{
   Widget wid;
   wid = *(Widget *)args[0].addr;
   return (cvtStringToXmRenderTable(dpy, wid, XmNtextRenderTable, XmCTextRenderTable, from, to));
}
