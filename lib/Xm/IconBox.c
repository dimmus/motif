 ...
 *	MACROS
 *************************************************************/
#define GetIconInfo(w) \
  ((IconInfo *)&(((XmIconBoxConstraintsRec *)((char *)((w)->core.constraints)))->icon))
/************************************************************
 *	GLOBAL DECLARATIONS
 *************************************************************/
/************************************************************
 ...
 *	STATIC DECLARATIONS
 *************************************************************/
static XtResource resources[] = {{XmNminimumVerticalCells,
                                  XmCDefaultCells,
                                  XmRDimension,
                                  sizeof(Dimension),
                                  XtOffsetOf(XmIconBoxRec, box.min_v_cells),
                                  XmRImmediate,
                                  (XtPointer)2},
                                 {XmNminimumHorizontalCells,
                                  ...
                                  sizeof(Dimension),
                                  XtOffsetOf(XmIconBoxRec, box.min_h_cells),
                                  XmRImmediate,
                                  (XtPointer)2},
                                 {XmNminimumCellWidth,
                                  XmCMinimumCellSize,
...
static XtResource constraints[] = {{XmNcellX,
                                    XmCCellX,
                                    XmRShort,
                                    sizeof(short),
                                    XtOffsetOf(XmIconBoxConstraintsRec, icon.cell_x),
                                    XmRShort,
                                    (XtPointer)&G_any_cell},
                                   {XmNcellY,
                                    XmCCellY,
                                    XmRShort,
                                    sizeof(short),
                                    XtOffsetOf(XmIconBoxConstraintsRec, icon.cell_y),
                                    XmRShort,
                                    (XtPointer)&G_any_cell}};
...
static void Initialize(Widget req, Widget set, ArgList args, Cardinal *num_args)
{
   ...
   */
  CalcCellSizes(
      set, NULL, FALSE, FALSE, &(XmIconBox_cell_width(ibw)), &(XmIconBox_cell_height(ibw)));
}
    ...
    Widget current, Widget request, Widget set, ArgList args, Cardinal *num_args)
{
      ...
      (XmIconBox_h_margin(old_ibw) != XmIconBox_h_margin(set_ibw)))
  {
    CalcCellSizes(set,
                  ...
                  FALSE,
                  FALSE,
                  &(XmIconBox_cell_width(set_ibw)),
                  &(XmIconBox_cell_height(set_ibw)));
                                        ...
                                        XtWidgetGeometry *result)
{
  ...
  if (((request->x == result->x) || !x_req) && ((request->y == result->y) || !y_req) &&
      ...
      ((request->height == result->height) || !h_req))
  {
    ...
    CalcCellSizes((Widget)ibw,
                  NULL,
                  FALSE,
                  FALSE,
                  &(XmIconBox_cell_width(ibw)),
                  &(XmIconBox_cell_height(ibw)));
...
static void ChangeManaged(Widget w)
{
  ...
  CalcCellSizes(
      w, NULL, FALSE, FALSE, &(XmIconBox_cell_width(ibw)), &(XmIconBox_cell_height(ibw)));
  PlaceChildren(w, NULL);
    ...
    Widget current, Widget request, Widget set, ArgList args, Cardinal *num_args)
{
  ...
  if ((set_info->cell_x != old_info->cell_x) || (set_info->cell_y != old_info->cell_y)) {
    if (XmIconBoxIsCellEmpty(XtParent(set), set_info->cell_x, set_info->cell_y, set)) {
 ...
 *	Returns:       none.
 */
static void GetCellFromXY(Widget w, Position x, Position y, Position *cell_x, Position *cell_y)
{
  XmIconBoxWidget ibw = (XmIconBoxWidget)w;
 ...
 *	Returns: none
 */
static void FindNearestCellLocation(Widget w, Position *x, Position *y)
{
  IconInfo temp;
 ...
 *	Returns:       none.
 */
static void GetXYFromCell(Widget w, IconInfo *info, Position *x, Position *y)
{
  XmIconBoxWidget ibw = (XmIconBoxWidget)w;
 ...
 *	Returns:       none.
 */
static void PlaceChildren(Widget w, Widget child)
{
  Widget *childp;
  Position x, y;
  XmIconBoxWidget ibw = (XmIconBoxWidget)w;
 ...
 *	Returns:       none.
 */
static void CalcCellSizes(Widget w,
                          Widget ignore,
                          Boolean noresize,
                          Boolean query_only,
                          ...
                          Dimension *cell_height)
{
  ...
  if (noresize ||
      (_XmRequestNewSize(w, query_only, d_width, d_height, &width, &height) != XtGeometryYes))
  {
    if (noresize) {
      width = w->core.width;
 ...
 *	Returns:
 */
static void GetMinCells(Widget w, Cardinal *min_x, Cardinal *min_y)
{
  Widget *childp;
  XmIconBoxWidget ibw = (XmIconBoxWidget)w;
 ...
 *	Returns:       none.
 */
static void GetMaxCellSize(Widget w, Widget ignore, Dimension *max_w, Dimension *max_h)
{
  Widget *childp;
  XmIconBoxWidget ibw = (XmIconBoxWidget)w;
  XtWidgetGeometry preferred;
 ...
 */
Boolean XmIconBoxIsCellEmpty(Widget w, Position x, Position y, Widget ignore)
{
  XmIconBoxWidget ibw = (XmIconBoxWidget)w;
  Widget *childp;
 ...
 */
Widget XmCreateIconBox(Widget parent, String name, ArgList args, Cardinal num_args)
{
