...
static void                 _XmPictureParseNode(XmPictureRec *, char **, XmPictureNode **, XmPictureNode **, Boolean);
...
static XmPictureNode       *_XmPictureCopySubGraph(XmPictureRec *, int, XmPictureNode *, XmPictureNode *);
 ...
 */
static void
_XmPictureParseNode(XmPictureRec *picture, char **in_string, XmPictureNode **start_return, XmPictureNode **end_return, Boolean returnNOW)
{
 ...
 */
static void
_XmPictureFollowTransitions(XmPictureStateRec *state, char inc, XmPictureNode *node)
{
 ...
 */
static XmPictureNode *
_XmPictureCopySubGraph(XmPictureRec *picture, int n, XmPictureNode *start, XmPictureNode *end)
{
   XmPictureNode      **table;
