...
/* Access macros */
#  define FS_Directory(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.directory)
#  define FS_DirMask(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.dir_mask)
#  define FS_DirListLabel(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.dir_list_label)
#  define FS_DirListLabelString(w) \
    (((XmFileSelectionBoxWidget)(w))->file_selection_box.dir_list_label_string)
#  define FS_DirList(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.dir_list)
#  define FS_DirListItems(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.dir_list_items)
#  define FS_DirListItemCount(w) \
    (((XmFileSelectionBoxWidget)(w))->file_selection_box.dir_list_item_count)
#  define FS_FilterLabel(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.filter_label)
#  define FS_FilterLabelString(w) \
    (((XmFileSelectionBoxWidget)(w))->file_selection_box.filter_label_string)
#  define FS_FilterText(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.filter_text)
#  define FS_Pattern(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.pattern)
#  define FS_NoMatchString(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.no_match_string)
#  define FS_QualifySearchDataProc(w) \
    (((XmFileSelectionBoxWidget)(w))->file_selection_box.qualify_search_data_proc)
#  define FS_DirSearchProc(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.dir_search_proc)
...
#  define FS_FileTypeMask(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.file_type_mask)
#  define FS_ListUpdated(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.list_updated)
#  define FS_DirectoryValid(w) \
    (((XmFileSelectionBoxWidget)(w))->file_selection_box.directory_valid)
#  define FS_StateFlags(w) (((XmFileSelectionBoxWidget)(w))->file_selection_box.state_flags)
#  define FS_DirListSelectedItemPosition(w) \
    (((XmFileSelectionBoxWidget)w)->file_selection_box.dir_list_selected_item_position)
#  define FS_PathMode(w) (((XmFileSelectionBoxWidget)w)->file_selection_box.path_mode)
#  define FS_FileFilterStyle(w) \
    (((XmFileSelectionBoxWidget)w)->file_selection_box.file_filter_style)
#  define FS_DirText(w) (((XmFileSelectionBoxWidget)w)->file_selection_box.dir_text)
#  define FS_DirTextLabel(w) (((XmFileSelectionBoxWidget)w)->file_selection_box.dir_text_label)
#  define FS_DirTextLabelString(w) \
    (((XmFileSelectionBoxWidget)w)->file_selection_box.dir_text_label_string)
#  define FS_PrevDirModTime(w) (((XmFileSelectionBoxWidget)w)->file_selection_box.prev_dir_modtime)
