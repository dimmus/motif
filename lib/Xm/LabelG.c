...
static XtResource resources[] = {
     ...
     * initialized and that we can access the colors for instance. */
   {
    ...
    XmRPointer,
    sizeof(XtPointer),
    XtOffsetOf(XmLabelGadgetRec,                                                                                                           label.cache),
    XtRImmediate,
    (XtPointer)NULL                                                                                                                                                                                                       },
   { XmNshadowThickness,        XmCShadowThickness,        XmRHorizontalDimension, sizeof(Dimension),         XtOffsetOf(XmLabelGadgetRec, gadget.shadow_thickness),      XmRImmediate, (XtPointer)0                      },
   { XmNlabelPixmap,            XmCLabelPixmap,            XmRDynamicPixmap,       sizeof(Pixmap),            XtOffsetOf(XmLabelGadgetRec, label.pixmap),                 XmRImmediate, (XtPointer)XmUNSPECIFIED_PIXMAP   },
   { XmNlabelInsensitivePixmap, XmCLabelInsensitivePixmap, XmRDynamicPixmap,       sizeof(Pixmap),            XtOffsetOf(XmLabelGadgetRec, label.pixmap_insen),           XmRImmediate, (XtPointer)XmUNSPECIFIED_PIXMAP   },
   { XmNlabelString,            XmCXmString,               XmRXmString,            sizeof(XmString),          XtOffsetOf(XmLabelGadgetRec, label._label),                 XmRImmediate, (XtPointer)NULL                   },
   { "pri.vate",                "Pri.vate",                XmRBoolean,             sizeof(Boolean),           XtOffsetOf(XmLabelGadgetRec, label.check_set_render_table), XmRImmediate, (XtPointer)False                  },
   { XmNfontList,               XmCFontList,               XmRFontList,            sizeof(XmFontList),        XtOffsetOf(XmLabelGadgetRec, label.font),                   XmRCallProc,  (XtPointer)CheckSetRenderTable    },
   { XmNrenderTable,            XmCRenderTable,            XmRRenderTable,         sizeof(XmRenderTable),     XtOffsetOf(XmLabelGadgetRec, label.font),                   XmRCallProc,  (XtPointer)CheckSetRenderTable    },
   { XmNmnemonic,               XmCMnemonic,               XmRKeySym,              sizeof(KeySym),            XtOffsetOf(XmLabelGadgetRec, label.mnemonic),               XmRImmediate, (XtPointer)XK_VoidSymbol          },
   { XmNmnemonicCharSet,        XmCMnemonicCharSet,        XmRString,              sizeof(XmStringCharSet),   XtOffsetOf(XmLabelGadgetRec, label.mnemonicCharset),        XmRImmediate, (XtPointer)XmFONTLIST_DEFAULT_TAG },
   { XmNaccelerator,            XmCAccelerator,            XmRString,              sizeof(char *),            XtOffsetOf(XmLabelGadgetRec, label.accelerator),            XmRImmediate, (XtPointer)NULL                   },
   { XmNacceleratorText,        XmCAcceleratorText,        XmRXmString,            sizeof(XmString),          XtOffsetOf(XmLabelGadgetRec, label._acc_text),              XmRImmediate, (XtPointer)NULL                   },
   { XmNtraversalOn,            XmCTraversalOn,            XmRBoolean,             sizeof(Boolean),           XtOffsetOf(XmGadgetRec,      gadget.traversal_on),          XmRImmediate, (XtPointer)False                  },
   { XmNhighlightThickness,     XmCHighlightThickness,     XmRHorizontalDimension, sizeof(Dimension),         XtOffsetOf(XmGadgetRec,      gadget.highlight_thickness),   XmRImmediate, (XtPointer)0                      },
   { XmNpixmapPlacement,        XmCPixmapPlacement,        XmRPixmapPlacement,     sizeof(XmPixmapPlacement), XtOffsetOf(XmLabelGadgetRec, label.pixmap_placement),       XmRImmediate, (XtPointer)XmPIXMAP_LEFT          },
   { XmNpixmapTextPadding,      XmCSpace,                  XmRVerticalDimension,   sizeof(Dimension),         XtOffsetOf(XmLabelGadgetRec, label.pixmap_text_padding),    XmRImmediate, (XtPointer)2                      }
};
...
static XtResource cache_resources[] = {
   { XmNlabelType,          XmCLabelType,          XmRLabelType,              sizeof(unsigned char), XtOffsetOf(XmLabelGCacheObjRec, label_cache.label_type),           XmRImmediate, (XtPointer)XmSTRING             },
   { XmNalignment,          XmCAlignment,          XmRAlignment,              sizeof(unsigned char), XtOffsetOf(XmLabelGCacheObjRec, label_cache.alignment),            XmRImmediate, (XtPointer)XmALIGNMENT_CENTER   },
   { XmNmarginWidth,        XmCMarginWidth,        XmRHorizontalDimension,    sizeof(Dimension),     XtOffsetOf(XmLabelGCacheObjRec, label_cache.margin_width),         XmRImmediate, (XtPointer)2                    },
   { XmNmarginHeight,       XmCMarginHeight,       XmRVerticalDimension,      sizeof(Dimension),     XtOffsetOf(XmLabelGCacheObjRec, label_cache.margin_height),        XmRImmediate, (XtPointer)2                    },
   { XmNmarginLeft,         XmCMarginLeft,         XmRHorizontalDimension,    sizeof(Dimension),     XtOffsetOf(XmLabelGCacheObjRec, label_cache.margin_left),          XmRImmediate, (XtPointer)0                    },
   { XmNmarginRight,        XmCMarginRight,        XmRHorizontalDimension,    sizeof(Dimension),     XtOffsetOf(XmLabelGCacheObjRec, label_cache.margin_right),         XmRImmediate, (XtPointer)0                    },
   { XmNmarginTop,          XmCMarginTop,          XmRVerticalDimension,      sizeof(Dimension),     XtOffsetOf(XmLabelGCacheObjRec, label_cache.margin_top),           XmRImmediate, (XtPointer)0                    },
   { XmNmarginBottom,       XmCMarginBottom,       XmRVerticalDimension,      sizeof(Dimension),     XtOffsetOf(XmLabelGCacheObjRec, label_cache.margin_bottom),        XmRImmediate, (XtPointer)0                    },
   { XmNrecomputeSize,      XmCRecomputeSize,      XmRBoolean,                sizeof(Boolean),       XtOffsetOf(XmLabelGCacheObjRec, label_cache.recompute_size),       XmRImmediate, (XtPointer)True                 },
   { XmNstringDirection,    XmCStringDirection,    XmRStringDirection,        sizeof(unsigned char), XtOffsetOf(XmLabelGCacheObjRec, label_cache.string_direction),     XmRImmediate, (XtPointer)XmDEFAULT_DIRECTION  },
   { XmNlayoutDirection,    XmCLayoutDirection,    XmRDirection,              sizeof(XmDirection),   XtOffsetOf(XmGadgetRec,         gadget.layout_direction),          XmRImmediate, (XtPointer)XmDEFAULT_DIRECTION  },
   { XmNbackground,         XmCBackground,         XmRPixel,                  sizeof(Pixel),         XtOffsetOf(XmLabelGCacheObjRec, label_cache.background),           XmRImmediate, (XtPointer)INVALID_PIXEL        },
   { XmNforeground,         XmCForeground,         XmRPixel,                  sizeof(Pixel),         XtOffsetOf(XmLabelGCacheObjRec, label_cache.foreground),           XmRImmediate, (XtPointer)INVALID_PIXEL        },
   { XmNtopShadowColor,     XmCTopShadowColor,     XmRPixel,                  sizeof(Pixel),         XtOffsetOf(XmLabelGCacheObjRec, label_cache.top_shadow_color),     XmRImmediate, (XtPointer)INVALID_PIXEL        },
   { XmNtopShadowPixmap,    XmCTopShadowPixmap,    XmRNoScalingDynamicPixmap, sizeof(Pixmap),        XtOffsetOf(XmLabelGCacheObjRec, label_cache.top_shadow_pixmap),    XmRImmediate, (XtPointer)INVALID_PIXMAP       },
   { XmNbottomShadowColor,  XmCBottomShadowColor,  XmRPixel,                  sizeof(Pixel),         XtOffsetOf(XmLabelGCacheObjRec, label_cache.bottom_shadow_color),  XmRImmediate, (XtPointer)INVALID_PIXEL        },
   { XmNbottomShadowPixmap, XmCBottomShadowPixmap, XmRNoScalingDynamicPixmap, sizeof(Pixmap),        XtOffsetOf(XmLabelGCacheObjRec, label_cache.bottom_shadow_pixmap), XmRImmediate, (XtPointer)XmUNSPECIFIED_PIXMAP },
   { XmNhighlightColor,     XmCHighlightColor,     XmRPixel,                  sizeof(Pixel),         XtOffsetOf(XmLabelGCacheObjRec, label_cache.highlight_color),      XmRImmediate, (XtPointer)INVALID_PIXEL        },
   { XmNhighlightPixmap,    XmCHighlightPixmap,    XmRNoScalingDynamicPixmap, sizeof(Pixmap),        XtOffsetOf(XmLabelGCacheObjRec, label_cache.highlight_pixmap),     XmRImmediate, (XtPointer)INVALID_PIXMAP       }
};
/*  Definition for resources that need special processing in get values  */
static XmSyntheticResource syn_resources[] = {
   { XmNlabelString,
    sizeof(XmString),
    XtOffsetOf(XmLabelGadgetRec, label._label),
    GetLabelString,
    NULL                          },
   { XmNaccelerator,
    sizeof(String),
    XtOffsetOf(XmLabelGadgetRec, label.accelerator),
    GetAccelerator,
    NULL                          },
   { XmNacceleratorText,
    sizeof(XmString),
    XtOffsetOf(XmLabelGadgetRec, label._acc_text),
    GetAcceleratorText,
    NULL                          },
   { XmNmnemonicCharSet,
    sizeof(XmStringCharSet),
    XtOffsetOf(XmLabelGadgetRec, label.mnemonicCharset),
    GetMnemonicCharset,
    NULL                          },
   { XmNpixmapTextPadding,
    sizeof(Dimension),
    XtOffsetOf(XmLabelGadgetRec, label.pixmap_text_padding),
    FromPaddingPixels,
    (XmImportProc)ToPaddingPixels }
};
...
GetTopShadowPixmapDefault(Widget widget)
{
   ...
   if (LabG_TopShadowColor(lg) == LabG_Background(lg))
      result = XmGetPixmapByDepth(XtScreen(lg), XmS50_foreground, LabG_TopShadowColor(lg), LabG_Foreground(lg), mw->core.depth);
   else if (DefaultDepthOfScreen(XtScreen(widget)) == 1)
      result = XmGetPixmapByDepth(XtScreen(lg), XmS50_foreground, LabG_TopShadowColor(lg), LabG_Background(lg), mw->core.depth);
   return result;
}
...
GetLabelHighlightPixmapDefault(Widget widget)
{
   ...
   if (LabG_HighlightColor(lg) == LabG_Background(lg))
      result = XmGetPixmapByDepth(XtScreen(lg), XmS50_foreground, LabG_HighlightColor(lg), LabG_Foreground(lg), mw->core.depth);
   return result;
}
...
ClassInitialize(void)
{
   ...
   XmeTraitSet((XtPointer)&xmLabelGadgetClassRec,
               XmQTmenuSavvy,
               (XtPointer)&MenuSavvyGadgetRecord);
}
...
ClassPartInitialize(WidgetClass cl)
{
   ...
   XmeTraitSet((XtPointer)cl, XmQTaccessTextual, (XtPointer)&_XmLabel_AccessTextualRecord);
                      ...
                      Cardinal *num_args)
{
   ...
   /*
     ...
     */
   XtGetSubresources(new_w, newSec, NULL, NULL, wc->core_class.resources, wc->core_class.num_resources, args, *num_args);
   ...
   _XmPushWidgetExtData((Widget)new_w, extData, ((XmLabelGCacheObject)newSec)->ext.extensionType);
...
BorderHighlight(Widget w)
{
   ...
   if (lg->rectangle.width == 0 || lg->rectangle.height == 0 || lg->gadget.highlight_thickness == 0)
   {
      return;
   }
   ...
   XmeDrawHighlight(XtDisplay((Widget)lg), XtWindow((Widget)lg), LabG_HighlightGC(lg), lg->rectangle.x, lg->rectangle.y, lg->rectangle.width, lg->rectangle.height, lg->gadget.highlight_thickness);
}
...
SetNormalGC(XmLabelGadget lw)
{
   ...
   LabG_NormalGC(lw) = XtAllocateGC((Widget)mw, 0, valueMask, &values, dynamicMask, 0);
   /*generally gray insensitive foreground (instead stipple)*/
   values.foreground      = _XmAssignInsensitiveColor((Widget)lw);
   values.background      = LabG_Background(lw);
   LabG_InsensitiveGC(lw) = XtAllocateGC((Widget)mw, 0, valueMask, &values, dynamicMask, 0);
   /*light shadow for insensitive text (instead stipple)*/
   values.foreground = LabG_TopShadowColor(lw);
   LabG_ShadowGC(lw) = XtAllocateGC((Widget)mw, 0, valueMask, &values, dynamicMask, 0);
}
...
_XmLabelSetBackgroundGC(XmLabelGadget lw)
{
   ...
   {
      if ((mw->core.background_pixel != LabG_Background(lw)) && (mw->core.background_pixmap == XmUNSPECIFIED_PIXMAP))
   ...
   {
      int depth;
      XmeGetPixmapData(XtScreen((Widget)lw), mw->core.background_pixmap, NULL, &depth, NULL, NULL, NULL, NULL, NULL, NULL);
      if (depth == 1)
      {
...
_XmCalcLabelGDimensions(Widget wid)
{
   ...
   if (LabG_IsPixmap(newlw) || LabG_IsPixmapAndText(newlw))
   {
      if (XtIsSensitive(wid))
      {
         ...
         {
            XmeGetPixmapData(XtScreen(newlw), Pix(newlw), NULL, NULL, NULL, NULL, NULL, NULL, &w, &h);
      ...
      else
      {
         ...
         if (pix_use != XmUNSPECIFIED_PIXMAP)
         {
            XmeGetPixmapData(XtScreen(newlw), pix_use, NULL, NULL, NULL, NULL, NULL, NULL, &w, &h);
            LabG_PixmapRect(newlw).width  = (unsigned short)w;
            LabG_PixmapRect(newlw).height = (unsigned short)h;
         }
      }
...
_XmLabelGCalcTextRect(Widget wid)
{
   ...
   {
      if (LabG_PixmapPlacement(wid) == XmPIXMAP_TOP || LabG_PixmapPlacement(wid) == XmPIXMAP_BOTTOM)
      {
         LabG_TextRect(wid).height = LabG_PixmapRect(wid).height + LabG_StringRect(wid).height + LabG_PixmapTextPadding(wid);
         LabG_TextRect(wid).width  = MAX(LabG_StringRect(wid).width, LabG_PixmapRect(wid).width);
      }
      else if (LabG_PixmapPlacement(wid) == XmPIXMAP_LEFT || LabG_PixmapPlacement(wid) == XmPIXMAP_RIGHT)
      {
         LabG_TextRect(wid).width  = LabG_PixmapRect(wid).width + LabG_StringRect(wid).width + LabG_PixmapTextPadding(wid);
         LabG_TextRect(wid).height = MAX(LabG_StringRect(wid).height, LabG_PixmapRect(wid).height);
      }
      if (LabG_PixmapPlacement(wid) == XmPIXMAP_TOP)
      {
         LabG_PixmapRect(wid).y = 0;
         LabG_StringRect(wid).y = LabG_PixmapRect(wid).height + LabG_PixmapTextPadding(wid);
      }
      else if (LabG_PixmapPlacement(wid) == XmPIXMAP_BOTTOM)
      {
         LabG_StringRect(wid).y = 0;
         LabG_PixmapRect(wid).y = LabG_StringRect(wid).height + LabG_PixmapTextPadding(wid);
      }
      else if ((LabG_PixmapPlacement(wid) == XmPIXMAP_RIGHT && LayoutIsRtoLG(wid)) || (LabG_PixmapPlacement(wid) == XmPIXMAP_LEFT && !LayoutIsRtoLG(wid)))
      {
         LabG_PixmapRect(wid).x = 0;
         LabG_StringRect(wid).x = LabG_PixmapRect(wid).width + LabG_PixmapTextPadding(wid);
      }
      else if ((LabG_PixmapPlacement(wid) == XmPIXMAP_LEFT && LayoutIsRtoLG(wid)) || (LabG_PixmapPlacement(wid) == XmPIXMAP_RIGHT && !LayoutIsRtoLG(wid)))
      {
         LabG_StringRect(wid).x = 0;
         LabG_PixmapRect(wid).x = LabG_StringRect(wid).width + LabG_PixmapTextPadding(wid);
      }
      if (LabG_PixmapPlacement(wid) == XmPIXMAP_RIGHT || LabG_PixmapPlacement(wid) == XmPIXMAP_LEFT)
      {
         LabG_PixmapRect(wid).y = (LabG_TextRect(wid).height - LabG_PixmapRect(wid).height) / 2;
         LabG_StringRect(wid).y = (LabG_TextRect(wid).height - LabG_StringRect(wid).height) / 2;
      }
      else
      {
         if (LabG_Alignment(wid) == XmALIGNMENT_CENTER)
         {
            LabG_PixmapRect(wid).x = (LabG_TextRect(wid).width - LabG_PixmapRect(wid).width) / 2;
            LabG_StringRect(wid).x = (LabG_TextRect(wid).width - LabG_StringRect(wid).width) / 2;
         }
         else if ((LabG_Alignment(wid) == XmALIGNMENT_END && !LayoutIsRtoLG(wid)) || (LabG_Alignment(wid) == XmALIGNMENT_BEGINNING && LayoutIsRtoLG(wid)))
         {
            LabG_PixmapRect(wid).x = LabG_TextRect(wid).width - LabG_PixmapRect(wid).width;
            LabG_StringRect(wid).x = LabG_TextRect(wid).width - LabG_StringRect(wid).width;
         }
      }
   }
}
...
Resize(Widget wid)
{
   ...
   if (LabG__acceleratorText(newlw) != NULL)
   {
      ...
      {
         if (LabG_MarginLeft(newlw) < LabG_AccTextRect(newlw).width + LABELG_ACC_PAD)
         {
            int delta                    = LabG_AccTextRect(newlw).width + LABELG_ACC_PAD - LabG_MarginLeft(newlw);
      ...
      {
         if (LabG_MarginRight(newlw) < LabG_AccTextRect(newlw).width + LABELG_ACC_PAD)
         {
            int delta                     = LabG_AccTextRect(newlw).width + LABELG_ACC_PAD - LabG_MarginRight(newlw);
   ...
   if (newlw->rectangle.width == 0)
      newlw->rectangle.width = LabG_TextRect(newlw).width + LabG_MarginLeft(newlw) + LabG_MarginRight(newlw) + (2 * (LabG_MarginWidth(newlw) + newlw->gadget.highlight_thickness + newlw->gadget.shadow_thickness));
   leftx  = newlw->gadget.highlight_thickness + newlw->gadget.shadow_thickness + LabG_MarginWidth(newlw) + LabG_MarginLeft(newlw);
   rightx = newlw->rectangle.width - newlw->gadget.highlight_thickness - newlw->gadget.shadow_thickness - LabG_MarginWidth(newlw) - LabG_MarginRight(newlw);
   switch (LabG_Alignment(newlw))
   {
      ...
      default:
         /* XmALIGNMENT_CENTER */
         LabG_TextRect(newlw).x = leftx + (rightx - leftx - (int)LabG_TextRect(newlw).width) / 2;
         break;
   }
   ...
   if (newlw->rectangle.height == 0)
      newlw->rectangle.height = MAX(LabG_TextRect(newlw).height,
                              ...
                              + (2 * (LabG_MarginHeight(newlw) + newlw->gadget.highlight_thickness + newlw->gadget.shadow_thickness));
   LabG_TextRect(newlw).y = (short)(newlw->gadget.highlight_thickness
                                    + newlw->gadget.shadow_thickness
                                    + LabG_MarginHeight(newlw) + LabG_MarginTop(newlw) + ((int)(newlw->rectangle.height - LabG_MarginTop(newlw) - LabG_MarginBottom(newlw) - (2 * (LabG_MarginHeight(newlw) + newlw->gadget.highlight_thickness + newlw->gadget.shadow_thickness)) - LabG_TextRect(newlw).height) / 2));
   if (LabG__acceleratorText(newlw) != NULL)
   {
      Dimension base_label, base_accText, diff;
      if (LayoutIsRtoLG(newlw))
         LabG_AccTextRect(newlw).x = newlw->rectangle.x + (newlw->gadget.highlight_thickness + newlw->gadget.shadow_thickness + LabG_MarginWidth(newlw));
      else
         LabG_AccTextRect(newlw).x = (newlw->rectangle.width - newlw->gadget.highlight_thickness - newlw->gadget.shadow_thickness - LabG_MarginWidth(newlw) - LabG_MarginRight(newlw) + LABELG_ACC_PAD);
      LabG_AccTextRect(newlw).y = newlw->gadget.highlight_thickness
                                + newlw->gadget.shadow_thickness
                                + LabG_MarginHeight(newlw) + LabG_MarginTop(newlw) + ((int)(newlw->rectangle.height - LabG_MarginTop(newlw) - LabG_MarginBottom(newlw) - (2 * (LabG_MarginHeight(newlw) + newlw->gadget.highlight_thickness + newlw->gadget.shadow_thickness)) - LabG_AccTextRect(newlw).height) / 2);
      /* make sure the label and accelerator text line up */
      /* when the fonts are different */
      if (LabG_IsText(newlw))
      {
         base_label   = XmStringBaseline(LabG_Font(newlw), LabG__label(newlw));
         base_accText = XmStringBaseline(LabG_Font(newlw),
                                         LabG__acceleratorText(newlw));
           ...
           Cardinal *num_args)
{
   ...
   if (xmLabelGadgetClassRec.label_class.menuProcs == NULL)
      xmLabelGadgetClassRec.label_class.menuProcs = (XmMenuProc)_XmGetMenuProcContext();
   _XmProcessUnlock();
   ...
   switch (LabG_StringDirection(lw))
   {
      ...
      case XmRIGHT_TO_LEFT:
         ...
         LabG_StringDirection(lw) = XmDirectionToStringDirection(LabG_StringDirection(lw));
         break;
      default:
   ...
   if (lw->gadget.layout_direction != XmDEFAULT_DIRECTION)
   {
      if (LabG_StringDirection(lw) == XmDEFAULT_DIRECTION)
         LabG_StringDirection(lw) = XmDirectionToStringDirection(lw->gadget.layout_direction);
   }
   else if (LabG_StringDirection(lw) != XmDEFAULT_DIRECTION)
   {
      lw->gadget.layout_direction = XmStringDirectionToDirection(LabG_StringDirection(lw));
   }
   else
   {
   ...
   {
      LabG_MnemonicCharset(new_w) = _XmStringCharsetCreate(LabG_MnemonicCharset(new_w));
   }
   else
      LabG_MnemonicCharset(new_w) = _XmStringCharsetCreate(XmFONTLIST_DEFAULT_TAG);
   ...
   if ((LabG__acceleratorText(new_w) != NULL) && LabG_IsMenupane(new_w))
   {
      if (XmeStringIsValid((XmString)LabG__acceleratorText(new_w)))
      {
         ...
         if (XmIsCascadeButtonGadget(new_w))
            ...
            LabG__acceleratorText(new_w) = XmStringCopy((XmString)LabG__acceleratorText(new_w));
      }
      else
      {
   ...
   if ((LabG_MenuType(new_w) == XmMENU_POPUP) || (LabG_MenuType(new_w) == XmMENU_PULLDOWN) || (LabG_MenuType(new_w) == XmMENU_BAR))
   ...
   LabG_HighlightGC(lw)    = _XmGetPixmapBasedGC(XtParent(new_w),
                                              LabG_HighlightColor(lw),
                                              LabG_Background(lw),
                                              LabG_HighlightPixmap(lw));
   LabG_TopShadowGC(lw)    = _XmGetPixmapBasedGC(XtParent(new_w),
                                              LabG_TopShadowColor(lw),
                                              LabG_Background(lw),
                                              LabG_TopShadowPixmap(lw));
   LabG_BottomShadowGC(lw) = _XmGetPixmapBasedGC(XtParent(new_w),
                                                 LabG_BottomShadowColor(lw),
                                                 LabG_Background(lw),
                                                 LabG_BottomShadowPixmap(lw));
   /*  Force the label traversal flag when in a menu  */
   if ((XtClass(lw) == xmLabelGadgetClass) && ((LabG_MenuType(new_w) == XmMENU_POPUP) || (LabG_MenuType(new_w) == XmMENU_PULLDOWN) || (LabG_MenuType(new_w) == XmMENU_OPTION)))
   {
...
InitNewColorBehavior(XmLabelGadget lw)
{
   ...
   {
      _XmBackgroundColorDefault((Widget)lw,
   ...
   {
      _XmForegroundColorDefault((Widget)lw,
   ...
   {
      _XmTopShadowColorDefault((Widget)lw,
   ...
   {
      _XmBottomShadowColorDefault((Widget)lw,
   ...
   {
      _XmHighlightColorDefault((Widget)lw,
...
{
   XmManagerWidget mw = (XmManagerWidget)XtParent(lw);
   if ((LabG_TopShadowPixmap(lw) == INVALID_PIXMAP || LabG_TopShadowPixmap(lw) == mw->manager.top_shadow_pixmap) && (LabG_HighlightPixmap(lw) == INVALID_PIXMAP || LabG_HighlightPixmap(lw) == mw->manager.highlight_pixmap))
   {
              ...
              XtWidgetGeometry *reply)
{
   ...
   reply->width        = LabG_TextRect(lg).width + (2 * (LabG_MarginWidth(lg) + lg->gadget.highlight_thickness + lg->gadget.shadow_thickness)) + LabG_MarginLeft(lg) + LabG_MarginRight(lg);
   if (reply->width == 0)
      reply->width = 1;
   reply->height = MAX(LabG_TextRect(lg).height,
                       LabG_AccTextRect(lg).height)
                 + (2 * (LabG_MarginHeight(lg) + lg->gadget.highlight_thickness + lg->gadget.shadow_thickness)) + LabG_MarginTop(lg) + LabG_MarginBottom(lg);
   if (reply->height == 0)
      reply->height = 1;
   if ((IsWidth(intended) && (reply->width != intended->width)) || (IsHeight(intended) && (reply->height != intended->height)) || (GMode(intended) != GMode(reply)))
   {
                 ...
                 LRectangle *background_box)
{
   ...
   /*
     ...
     */
   marginal_width  = LabG_MarginLeft(lw) + LabG_MarginRight(lw) + (2 * (lw->gadget.highlight_thickness + lw->gadget.shadow_thickness));
   marginal_height = LabG_MarginTop(lw) + LabG_MarginBottom(lw) + (2 * (lw->gadget.highlight_thickness + lw->gadget.shadow_thickness));
   ...
   if (availH < (marginal_height + max_text_height) || availW < (marginal_width + LabG_TextRect(lw).width))
   {
      clip_rect.x = lw->rectangle.x + lw->gadget.highlight_thickness + lw->gadget.shadow_thickness + LabG_MarginLeft(lw);
      clip_rect.y = lw->rectangle.y + lw->gadget.highlight_thickness + lw->gadget.shadow_thickness + LabG_MarginTop(lw);
...
#if USE_XFT
   {
      ...
      XFillRectangle(XtDisplay(lw), XtWindow(lw), LabG_BackgroundGC(lw), x, y, width, height);
   }
#endif
      ...
      if (XtIsSensitive(wid))
      {
         if (Pix(lw) != XmUNSPECIFIED_PIXMAP)
         {
            ...
            if (depth == XtParent(lw)->core.depth)
               XCopyArea(XtDisplay(lw), Pix(lw), XtWindow(lw), gc, 0, 0, LabG_PixmapRect(lw).width, LabG_PixmapRect(lw).height, lw->rectangle.x + LabG_TextRect(lw).x + LabG_PixmapRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_PixmapRect(lw).y);
            else if (depth == 1)
               XCopyPlane(XtDisplay(lw), Pix(lw), XtWindow(lw), gc, 0, 0, LabG_PixmapRect(lw).width, LabG_PixmapRect(lw).height, lw->rectangle.x + LabG_TextRect(lw).x + LabG_PixmapRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_PixmapRect(lw).y, 1);
         }
      }
      else
      {
         ...
         if (pix_use != XmUNSPECIFIED_PIXMAP)
         {
            ...
            if (depth == XtParent(lw)->core.depth)
               XCopyArea(XtDisplay(lw), pix_use, XtWindow(lw), gc, 0, 0, LabG_PixmapRect(lw).width, LabG_PixmapRect(lw).height, lw->rectangle.x + LabG_TextRect(lw).x + LabG_PixmapRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_PixmapRect(lw).y);
            else if (depth == 1)
               XCopyPlane(XtDisplay(lw), pix_use, XtWindow(lw), gc, 0, 0, LabG_PixmapRect(lw).width, LabG_PixmapRect(lw).height, lw->rectangle.x + LabG_TextRect(lw).x + LabG_PixmapRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_PixmapRect(lw).y, 1);
            if (pix_use == Pix(lw))
            {
               XSetFillStyle(XtDisplay(lw), gc, FillStippled);
               XSetStipple(XtDisplay(lw), gc, _XmGetInsensitiveStippleBitmap((Widget)lw));
               XFillRectangle(XtDisplay(lw), XtWindow(lw), gc, lw->rectangle.x + LabG_TextRect(lw).x + LabG_PixmapRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_PixmapRect(lw).y, LabG_PixmapRect(lw).width, LabG_PixmapRect(lw).height);
   ...
   if ((LabG_IsText(lw) || LabG_IsPixmapAndText(lw)) && (LabG__label(lw) != NULL))
   {
      ...
      if (LabG_Mnemonic(lw) != XK_VoidSymbol)
      {
         ...
         {
            /*Draw normal text*/
            XmStringDrawUnderline(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__label(lw), LabG_NormalGC(lw), lw->rectangle.x + LabG_TextRect(lw).x + LabG_StringRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_StringRect(lw).y, LabG_StringRect(lw).width, LabG_Alignment(lw), LayoutG(lw), NULL, underline);
         }
         else
         {
            /*Draw shadow for insensitive text*/
            XmStringDrawUnderline(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__label(lw), LabG_ShadowGC(lw), lw->rectangle.x + 1 + LabG_TextRect(lw).x + LabG_StringRect(lw).x, lw->rectangle.y + 1 + LabG_TextRect(lw).y + LabG_StringRect(lw).y, LabG_StringRect(lw).width, LabG_Alignment(lw), LayoutG(lw), NULL, underline);
            /*Draw insensitive text*/
            XmStringDrawUnderline(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__label(lw), LabG_InsensitiveGC(lw), lw->rectangle.x + LabG_TextRect(lw).x + LabG_StringRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_StringRect(lw).y, LabG_StringRect(lw).width, LabG_Alignment(lw), LayoutG(lw), NULL, underline);
         }
      ...
      else
      {
         ...
         {
            /*Draw normal text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__label(lw), LabG_NormalGC(lw), lw->rectangle.x + LabG_TextRect(lw).x + LabG_StringRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_StringRect(lw).y, LabG_StringRect(lw).width, LabG_Alignment(lw), LayoutG(lw), NULL);
         }
         else
         {
            /*Draw shadow for insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__label(lw), LabG_ShadowGC(lw), lw->rectangle.x + LabG_TextRect(lw).x + 1 + LabG_StringRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + 1 + LabG_StringRect(lw).y, LabG_StringRect(lw).width, LabG_Alignment(lw), LayoutG(lw), NULL);
            /*Draw insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__label(lw), LabG_InsensitiveGC(lw), lw->rectangle.x + LabG_TextRect(lw).x + LabG_StringRect(lw).x, lw->rectangle.y + LabG_TextRect(lw).y + LabG_StringRect(lw).y, LabG_StringRect(lw).width, LabG_Alignment(lw), LayoutG(lw), NULL);
         }
      }
   }
   if (LabG__acceleratorText(lw) != NULL)
   {
      /* Since accelerator text is drawn by moving in from the right,
         ...
         * room for everything */
      if ((lw->rectangle.width) >= (2 * (lw->gadget.highlight_thickness + lw->gadget.shadow_thickness + LabG_MarginWidth(lw)) + LabG_MarginLeft(lw) + LabG_TextRect(lw).width + LabG_MarginRight(lw)))
      {
         if (XtIsSensitive(wid))
         {
            /*Draw normal text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__acceleratorText(lw), LabG_NormalGC(lw), lw->rectangle.x + LabG_AccTextRect(lw).x, lw->rectangle.y + LabG_AccTextRect(lw).y, LabG_AccTextRect(lw).width, XmALIGNMENT_END, LayoutG(lw), NULL);
         }
         else
         {
            /*Draw shadow for insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__acceleratorText(lw), LabG_ShadowGC(lw), lw->rectangle.x + LabG_AccTextRect(lw).x + 1, lw->rectangle.y + LabG_AccTextRect(lw).y + 1, LabG_AccTextRect(lw).width, XmALIGNMENT_END, LayoutG(lw), NULL);
            /*Draw insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), LabG_Font(lw), LabG__acceleratorText(lw), LabG_InsensitiveGC(lw), lw->rectangle.x + LabG_AccTextRect(lw).x, lw->rectangle.y + LabG_AccTextRect(lw).y, LabG_AccTextRect(lw).width, XmALIGNMENT_END, LayoutG(lw), NULL);
         }
      }
   }
   ...
   if (!LabG_IsMenupane(lw) && LabG_MenuType(lw) != XmMENU_BAR)
   {
      ...
      {
         (*((XmGadgetClass)XtClass(lw))->gadget_class.border_highlight)((Widget)lw);
      }
   }
}
          ...
          Cardinal *num_args) /* unused */
{
   ...
   if ((LabG__label(new_w) != LabG__label(current)) || (LabG_Font(new_w) != LabG_Font(current)))
   {
   ...
   if (LabG__label(new_w) != LabG__label(current))
   {
      ...
      if (LabG__label(new_w) == NULL)
      {
         LabG__label(new_w) = XmStringCreateLocalized(XrmQuarkToString(current->object.xrm_name));
      }
      else
      {
         ...
         else
         {
            ...
            LabG__label(new_w) = XmStringCreateLocalized(XrmQuarkToString(new_w->object.xrm_name));
         }
      }
   ...
   if ((LabG__acceleratorText(new_w) != LabG__acceleratorText(current)) && LabG_IsMenupane(new_w))
   {
      ...
      if (LabG__acceleratorText(new_w) != NULL)
      {
         if (XmeStringIsValid((XmString)LabG__acceleratorText(new_w)))
         {
            if ((XmIsCascadeButtonGadget(new_w)) && (LabG__acceleratorText(new_w) != NULL))
               LabG__acceleratorText(new_w) = NULL;
            else
               LabG__acceleratorText(new_w) = XmStringCopy(LabG__acceleratorText(new_w));
   ...
   if (LabG_Font(new_w) != LabG_Font(current))
   {
      ...
      if (LabG_Font(new_w) == NULL)
      {
         ...
         LabG_Font(new_w) = XmeGetDefaultRenderTable((Widget)new_w, XmLABEL_FONTLIST);
      }
      LabG_Font(new_w) = XmFontListCopy(LabG_Font(new_w));
   }
   /*  Reinitialize the interesting input types.  */
   new_w->gadget.event_mask  = XmHELP_EVENT;
   new_w->gadget.event_mask |= XmFOCUS_IN_EVENT | XmFOCUS_OUT_EVENT | XmENTER_EVENT | XmLEAVE_EVENT | XmBDRAG_EVENT;
   if ((LabG_MenuType(new_w) == XmMENU_POPUP) || (LabG_MenuType(new_w) == XmMENU_PULLDOWN) || (LabG_MenuType(new_w) == XmMENU_BAR))
      new_w->gadget.highlight_thickness = 0;
   if (!XmRepTypeValidValue(XmRID_LABEL_TYPE, LabG_LabelType(new_w), (Widget)new_w))
   {
      LabG_LabelType(new_w) = LabG_LabelType(current);
   }
   if (!XmRepTypeValidValue(XmRID_PIXMAP_PLACEMENT, LabG_PixmapPlacement(new_w), (Widget)new_w))
   {
   ...
   if (LayoutG(new_w) != LayoutG(current))
   {
      ...
      if ((LayoutIsRtoLG(current) != LayoutIsRtoLG(new_w)) && (LabG_MarginLeft(current) == LabG_MarginLeft(new_w)) && (LabG_MarginRight(current) == LabG_MarginRight(new_w)))
      {
   ...
   if (((LabG_IsText(new_w) || LabG_IsPixmapAndText(new_w)) && (newstring || (LabG_Font(new_w) != LabG_Font(current)))) || ((LabG_IsPixmap(new_w) || LabG_IsPixmapAndText(new_w)) && ((LabG_Pixmap(new_w) != LabG_Pixmap(current)) || (LabG_PixmapInsensitive(new_w) != LabG_PixmapInsensitive(current)) ||
       ...
       || (LabG_IsPixmapAndText(new_w) && LabG_PixmapPlacement(new_w) != LabG_PixmapPlacement(current)) || (LabG_LabelType(new_w) != LabG_LabelType(current)))
   {
   ...
   if ((LabG_Alignment(new_w) != LabG_Alignment(current)) || (LayoutG(new_w) != LayoutG(current)))
   {
      if (!XmRepTypeValidValue(XmRID_ALIGNMENT, LabG_Alignment(new_w), (Widget)new_w))
      {
   ...
   if ((LabG_MarginHeight(new_w) != LabG_MarginHeight(current)) || (LabG_MarginWidth(new_w) != LabG_MarginWidth(current)) || (LabG_MarginRight(new_w) != LabG_MarginRight(current)) || (LabG_MarginLeft(new_w) != LabG_MarginLeft(current)) || (LabG_MarginTop(new_w) != LabG_MarginTop(current)) || (LabG_MarginBottom(new_w) != LabG_MarginBottom(current)) || (new_w->gadget.shadow_thickness != current->gadget.shadow_thickness) || (new_w->gadget.highlight_thickness != current->gadget.highlight_thickness) || ((new_w->rectangle.width <= 0) || (new_w->rectangle.height <= 0)) || (LabG_PixmapTextPadding(new_w) != LabG_PixmapTextPadding(current)))
   {
      if (LabG_RecomputeSize(new_w))
      {
         if (req->rectangle.width == current->rectangle.width)
   ...
   if (Call_Resize)
   {
      XtWidgetProc resize;
      _XmProcessLock();
      resize = (((XmLabelGadgetClassRec *)(new_w->object.widget_class))->rect_class.resize);
      _XmProcessUnlock();
      (*(resize))((Widget)new_w);
   }
   ...
   if ((XtClass(new_w) == xmLabelGadgetClass) && ((LabG_MenuType(new_w) == XmMENU_POPUP) || (LabG_MenuType(new_w) == XmMENU_PULLDOWN) || (LabG_MenuType(new_w) == XmMENU_OPTION)))
   {
      new_w->gadget.traversal_on       = False;
      new_w->gadget.highlight_on_enter = False;
   }
   if (LabG_Font(new_w) != LabG_Font(current) || LabG_Foreground(new_w) != LabG_Foreground(current) || LabG_Background(new_w) != LabG_Background(current))
   {
   ...
   /*
     ...
     */
   if (LabG_Background(new_w) != LabG_Background(current) || LabG_Foreground(new_w) != LabG_Foreground(current))
   {
      XtReleaseGC(XtParent(current), LabG_BackgroundGC(current));
      _XmLabelSetBackgroundGC(new_w);
      flag = True;
   }
   if (LabG_TopShadowColor(new_w) != LabG_TopShadowColor(current) || LabG_TopShadowPixmap(new_w) != LabG_TopShadowPixmap(current))
   {
      XtReleaseGC(XtParent(current), LabG_TopShadowGC(current));
      LabG_TopShadowGC(new_w) = _XmGetPixmapBasedGC(XtParent(nw),
                                                    LabG_TopShadowColor(new_w),
                                                    LabG_Background(new_w),
                                                    LabG_TopShadowPixmap(new_w));
      flag                    = True;
   }
   if (LabG_BottomShadowColor(new_w) != LabG_BottomShadowColor(current) || LabG_BottomShadowPixmap(new_w) != LabG_BottomShadowPixmap(current))
   {
      XtReleaseGC(XtParent(current), LabG_BottomShadowGC(current));
      LabG_BottomShadowGC(new_w) = _XmGetPixmapBasedGC(XtParent(nw),
                                                       LabG_BottomShadowColor(new_w),
                                                       LabG_Background(new_w),
                                                       LabG_BottomShadowPixmap(new_w));
      flag                       = True;
   }
   if (LabG_HighlightColor(new_w) != LabG_HighlightColor(current) || LabG_HighlightPixmap(new_w) != LabG_HighlightPixmap(current))
   {
      XtReleaseGC(XtParent(current), LabG_HighlightGC(current));
      LabG_HighlightGC(new_w) = _XmGetPixmapBasedGC(XtParent(nw),
                                                    LabG_HighlightColor(new_w),
                                                    LabG_Background(new_w),
                                                    LabG_HighlightPixmap(new_w));
      flag                    = True;
   }
   if ((LabG_MenuType(new_w) != XmWORK_AREA) && (LabG_Mnemonic(new_w) != LabG_Mnemonic(current)))
   {
      /* New grabs only required if mnemonic changes */
      ProcessFlag = TRUE;
      if (LabG_LabelType(new_w) == XmSTRING || LabG_LabelType(new_w) == XmPIXMAP_AND_STRING)
         flag = TRUE;
   }
   ...
   if (LabG_IsMenupane(new_w) && (LabG_Accelerator(new_w) != LabG_Accelerator(current)))
   {
   ...
   if (flag && (LabG_MenuType(new_w) == XmMENU_PULLDOWN) && menuSTrait != NULL)
                   ...
                   Mask   visual_flag)
{
   ...
   /*
     ...
     */
   _XmProcessLock();
   _XmCacheCopy((XtPointer)LabG_Cache(lw), (XtPointer)&oldCopy, sizeof(XmLabelGCacheObjPart));
   _XmCacheDelete((XtPointer)LabG_Cache(lw));
   _XmProcessUnlock();
   LabG_Cache(lw) = &oldCopy;
   if ((visual_flag & VisualBackgroundPixel) && (LabG_Background(lw) == curmw->core.background_pixel))
   {
   ...
   if ((visual_flag & VisualForeground) && (LabG_Foreground(lw) == curmw->manager.foreground))
   {
   ...
   if (visual_flag & (VisualTopShadowColor | VisualTopShadowPixmap))
   {
      ...
      if (LabG_TopShadowColor(lw) == curmw->manager.top_shadow_color)
         LabG_TopShadowColor(lw) = mw->manager.top_shadow_color;
      if (LabG_TopShadowPixmap(lw) == curmw->manager.top_shadow_pixmap && (LabG_TopShadowPixmap(lw) != XmUNSPECIFIED_PIXMAP || LabG_TopShadowColor(lw) == curmw->manager.top_shadow_color))
         LabG_TopShadowPixmap(lw) = mw->manager.top_shadow_pixmap;
      LabG_TopShadowGC(lw) = _XmGetPixmapBasedGC(XtParent(lw),
                                                 LabG_TopShadowColor(lw),
                                                 LabG_Background(lw),
                                                 LabG_TopShadowPixmap(lw));
      redraw               = True;
   ...
   if (visual_flag & (VisualBottomShadowColor | VisualBottomShadowPixmap))
   {
      ...
      if (LabG_BottomShadowColor(lw) == curmw->manager.bottom_shadow_color)
         LabG_BottomShadowColor(lw) = mw->manager.bottom_shadow_color;
      if (LabG_BottomShadowPixmap(lw) == curmw->manager.bottom_shadow_pixmap && (LabG_BottomShadowPixmap(lw) != XmUNSPECIFIED_PIXMAP || LabG_BottomShadowColor(lw) == curmw->manager.bottom_shadow_color))
         LabG_BottomShadowPixmap(lw) = mw->manager.bottom_shadow_pixmap;
      LabG_BottomShadowGC(lw) = _XmGetPixmapBasedGC(XtParent(lw),
                                                    LabG_BottomShadowColor(lw),
                                                    LabG_Background(lw),
                                                    LabG_BottomShadowPixmap(lw));
      redraw                  = True;
   ...
   if (visual_flag & (VisualHighlightColor | VisualHighlightPixmap))
   {
      ...
      if (LabG_HighlightPixmap(lw) == curmw->manager.highlight_pixmap && (LabG_HighlightPixmap(lw) != XmUNSPECIFIED_PIXMAP || LabG_HighlightColor(lw) == curmw->manager.highlight_color))
         LabG_HighlightPixmap(lw) = mw->manager.highlight_pixmap;
      LabG_HighlightGC(lw) = _XmGetPixmapBasedGC(XtParent(lw),
                                                 LabG_HighlightColor(lw),
                                                 LabG_Background(lw),
                                                 LabG_HighlightPixmap(lw));
      redraw               = True;
   ...
   _XmProcessLock();
   LabG_Cache(lw) = (XmLabelGCacheObjPart *)
      _XmCachePart(LabG_ClassCachePart(lw), (XtPointer)LabG_Cache(lw), sizeof(XmLabelGCacheObjPart));
   _XmProcessUnlock();
   return redraw;
}
...
QualifyLabelLocalCache(XmLabelGadget w)
{
   if (!local_cache_inited)
   {
      ...
      ClassCacheCopy(LabG_ClassCachePart(w))(LabG_Cache(w), &local_cache, sizeof(local_cache));
   }
}
...
_XmReCacheLabG(Widget wid)
{
   XmLabelGadget lw = (XmLabelGadget)wid;
   _XmProcessLock();
   if (local_cache_inited && (!_XmLabelCacheCompare((XtPointer)&local_cache, (XtPointer)LabG_Cache(lw))))
   {
      /* Delete the old one. */
      _XmCacheDelete((XtPointer)LabG_Cache(lw));
      LabG_Cache(lw) = (XmLabelGCacheObjPart *)
 ...
 ************************************************************************/
static void
SetGadgetActivateCallbackState(Widget wid, XmActivateState state)
{
 ...
 ************************************************************************/
Widget
XmCreateLabelGadget(Widget parent, char *name, Arg *arglist, Cardinal argCount)
{
   return XtCreateWidget(name, xmLabelGadgetClass, parent, arglist, argCount);
}

Widget
XmVaCreateLabelGadget(Widget parent, char *name, ...)
{
   register Widget w;
   va_list         var;
   int             count;
...
Widget
XmVaCreateManagedLabelGadget(Widget parent, char *name, ...)
{
   Widget  w = NULL;
   va_list var;
   int     count;
 ...
 */
static Cardinal
GetLabelBGClassSecResData(WidgetClass w_class, XmSecondaryResourceData **data_rtn)
{
   int            arrayCount;
   ...
   resource_class = NULL;
   resource_name  = NULL;
   arrayCount     = _XmSecondaryResourceData(bcePtr, data_rtn, client_data, resource_name, resource_class, GetLabelClassResBase);
   _XmProcessUnlock();
   return arrayCount;
}
...
static void
GetColors(Widget w, XmAccessColorData color_data)
{
   if (LabG_Cache(w))
   {
 ...
 ************************************************************************/
static Boolean
XmLabelGadgetGetBaselines(Widget wid, Dimension **baselines, int *line_count)
{
   XmLabelGadget lw = (XmLabelGadget)wid;
   Cardinal      count;
   int           delta;
 ...
 ***********************************************************************/
static Boolean
XmLabelGadgetGetDisplayRect(Widget w, XRectangle *displayrect)
{
 ...
 ***********************************************************************/
static void
XmLabelGadgetMarginsProc(Widget w, XmBaselineMargins *margins_rec)
{
   XmLabelGCacheObjPart localCache;
...
GetPixmapDragIcon(Widget w)
{
   ...
   XmeGetPixmapData(XtScreen(lw), Pix(lw), NULL, &d, NULL, NULL, NULL, NULL, &wid, &hei);
   n = 0;
   ...
   drag_icon = XtCreateWidget("drag_icon", xmDragIconObjectClass, screen_object, args, n);
   return drag_icon;
}

void
_XmProcessDrag(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   XmLabelGadget   lw = (XmLabelGadget)w;
   Widget          drag_icon;
   Arg             args[10];
   ...
   if (!dpy->display.enable_unselectable_drag || (dpy->display.enable_btn1_transfer == XmBUTTON2_ADJUST && event && event->xany.type == ButtonPress && event->xbutton.button == 2)) return;
   n = 0;
...
void
_XmQualifyLabelLocalCache(XmLabelGCacheObjPart *_local_cache,
                          XmLabelGadget         w)
{
   _XmProcessLock();
   ClassCacheCopy(LabG_ClassCachePart(w))(LabG_Cache(w),
                                          _local_cache,
                                          sizeof(XmLabelGCacheObjPart));
   _XmProcessUnlock();
}
