...
#endif
#include <Xm/XmP.h>
#if (defined(__FreeBSD__) && (__FreeBSD__ < 4)) || (defined(__APPLE__) || defined(__NetBSD__) || defined(__OpenBSD__))
/*
...
static wchar_t *
_Xmwcscat(wchar_t *ws1, const wchar_t *ws2)
{
   wchar_t *save = ws1;
   for (; *ws1; ++ws1);
   while (*ws1++ = *ws2++);
...
static wchar_t *
_Xmwcsncat(wchar_t *ws1, const wchar_t *ws2, size_t n)
{
   if (n != 0)
   {
...
static void    doSetHighlight(Widget w, XmTextPosition left, XmTextPosition right, XmHighlightMode mode);
...
static XtResource resources[] = {
   { XmNactivateCallback,        XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.activate_callback),          XmRCallback,  NULL                           },
   { XmNlosingFocusCallback,     XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.losing_focus_callback),      XmRCallback,  NULL                           },
   { XmNfocusCallback,           XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.focus_callback),             XmRCallback,  NULL                           },
   { XmNmodifyVerifyCallback,    XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.modify_verify_callback),     XmRCallback,  NULL                           },
   { XmNmodifyVerifyCallbackWcs, XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.wcs_modify_verify_callback), XmRCallback,  NULL                           },
   { XmNmotionVerifyCallback,    XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.motion_verify_callback),     XmRCallback,  NULL                           },
   { XmNgainPrimaryCallback,     XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.gain_primary_callback),      XmRCallback,  NULL                           },
   { XmNlosePrimaryCallback,     XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.lose_primary_callback),      XmRCallback,  NULL                           },
   { XmNvalueChangedCallback,    XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.value_changed_callback),     XmRCallback,  NULL                           },
   { XmNdestinationCallback,     XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(struct _XmTextFieldRec, text.destination_callback),       XmRCallback,  NULL                           },
   { XmNvalue,                   XmCValue,                 XmRString,              sizeof(String),         XtOffsetOf(struct _XmTextFieldRec, text.value),                      XmRString,    ""                             },
   { XmNvalueWcs,                XmCValueWcs,              XmRValueWcs,            sizeof(wchar_t *),      XtOffsetOf(struct _XmTextFieldRec, text.wc_value),                   XmRString,    NULL                           },
   { XmNmarginHeight,            XmCMarginHeight,          XmRVerticalDimension,   sizeof(Dimension),      XtOffsetOf(struct _XmTextFieldRec, text.margin_height),              XmRImmediate, (XtPointer)5                   },
   { XmNmarginWidth,             XmCMarginWidth,           XmRHorizontalDimension, sizeof(Dimension),      XtOffsetOf(struct _XmTextFieldRec, text.margin_width),               XmRImmediate, (XtPointer)5                   },
   { XmNcursorPosition,          XmCCursorPosition,        XmRTextPosition,        sizeof(XmTextPosition), XtOffsetOf(struct _XmTextFieldRec, text.cursor_position),            XmRImmediate, (XtPointer)0                   },
   { XmNcolumns,                 XmCColumns,               XmRShort,               sizeof(short),          XtOffsetOf(struct _XmTextFieldRec, text.columns),                    XmRImmediate, (XtPointer)20                  },
   { XmNmaxLength,               XmCMaxLength,             XmRInt,                 sizeof(int),            XtOffsetOf(struct _XmTextFieldRec, text.max_length),                 XmRImmediate, (XtPointer)INT_MAX             },
   { XmNblinkRate,               XmCBlinkRate,             XmRInt,                 sizeof(int),            XtOffsetOf(struct _XmTextFieldRec, text.blink_rate),                 XmRImmediate, (XtPointer)500                 },
   { "pri.vate",                 "Pri.vate",               XmRBoolean,             sizeof(Boolean),        XtOffsetOf(struct _XmTextFieldRec, text.check_set_render_table),     XmRImmediate, (XtPointer)False               },
   { XmNfontList,                XmCFontList,              XmRFontList,            sizeof(XmFontList),     XtOffsetOf(struct _XmTextFieldRec, text.font_list),                  XmRCallProc,  (XtPointer)CheckSetRenderTable },
   { XmNrenderTable,             XmCRenderTable,           XmRRenderTable,         sizeof(XmRenderTable),  XtOffsetOf(struct _XmTextFieldRec, text.font_list),                  XmRCallProc,  (XtPointer)CheckSetRenderTable },
   { XmNselectionArray,          XmCSelectionArray,        XmRPointer,             sizeof(XtPointer),      XtOffsetOf(struct _XmTextFieldRec, text.selection_array),            XmRImmediate, (XtPointer)sarray              },
   { XmNselectionArrayCount,     XmCSelectionArrayCount,   XmRInt,                 sizeof(int),            XtOffsetOf(struct _XmTextFieldRec, text.selection_array_count),      XmRImmediate, (XtPointer)XtNumber(sarray)    },
   { XmNresizeWidth,             XmCResizeWidth,           XmRBoolean,             sizeof(Boolean),        XtOffsetOf(struct _XmTextFieldRec, text.resize_width),               XmRImmediate, (XtPointer)False               },
   { XmNpendingDelete,           XmCPendingDelete,         XmRBoolean,             sizeof(Boolean),        XtOffsetOf(struct _XmTextFieldRec, text.pending_delete),             XmRImmediate, (XtPointer)True                },
   { XmNeditable,                XmCEditable,              XmRBoolean,             sizeof(Boolean),        XtOffsetOf(struct _XmTextFieldRec, text.editable),                   XmRImmediate, (XtPointer)True                },
   { XmNcursorPositionVisible,   XmCCursorPositionVisible, XmRBoolean,             sizeof(Boolean),        XtOffsetOf(struct _XmTextFieldRec, text.cursor_position_visible),    XmRCallProc,  (XtPointer)CursorPosVisDefault },
   { XmNverifyBell,              XmCVerifyBell,            XmRBoolean,             sizeof(Boolean),        XtOffsetOf(struct _XmTextFieldRec, text.verify_bell),                XmRImmediate, (XtPointer)XmDYNAMIC_BOOL      },
   { XmNselectThreshold,         XmCSelectThreshold,       XmRInt,                 sizeof(int),            XtOffsetOf(struct _XmTextFieldRec, text.threshold),                  XmRImmediate, (XtPointer)5                   },
   { XmNnavigationType,          XmCNavigationType,        XmRNavigationType,      sizeof(unsigned char),  XtOffsetOf(struct _XmPrimitiveRec, primitive.navigation_type),       XmRImmediate, (XtPointer)XmTAB_GROUP         }
};
...
externaldef(xmtextfieldwidgetclass) WidgetClass xmTextFieldWidgetClass = (WidgetClass)&xmTextFieldClassRec;
...
ClassInitialize(void)
{
   ...
   XmeTraitSet((XtPointer)xmTextFieldWidgetClass, XmQTaccessTextual, (XtPointer)&textFieldCS);
}
...
GetTextFDestData(Widget w)
{
   ...
   if (XFindContext(display, (Window)screen, loc_context, (char **)&dest_data))
   {
      ...
      dest_data                    = (TextFDestData)XtCalloc((unsigned)sizeof(TextFDestDataRec),
                                          (unsigned)1);
      XtAddCallback(xm_display, XmNdestroyCallback, (XtCallbackProc)FreeContextData, (XtPointer)ctx_data);
...
_XmTextFToggleCursorGC(Widget widget)
{
   ...
   else
   {
      if (tf->text.overstrike)
      {
         ...
         if (!tf->text.add_mode && XtIsSensitive(widget) && (tf->text.has_focus || tf->text.has_destination))
         {
      ...
      {
         valueMask = GCStipple;
         if (XGetGCValues(XtDisplay(widget), tf->text.image_gc, valueMask, &values))
            stipple = values.stipple;
         valueMask = GCFillStyle | GCFunction | GCForeground | GCBackground;
         if (XtIsSensitive(widget) && !tf->text.add_mode && (tf->text.has_focus || tf->text.has_destination))
         {
            if (tf->text.cursor == XmUNSPECIFIED_PIXMAP) return;
   ...
   else
   {
      ...
      if (w->text.highlight.number > w->text.highlight.maximum)
      {
         ...
         l = w->text.highlight.list = (_XmHighlightRec *)
            XtRealloc((char *)l, (unsigned)(w->text.highlight.maximum * sizeof(_XmHighlightRec)));
      }
...
PaintCursor(XmTextFieldWidget tf)
{
   ...
   y = (y + (Position)TextF_FontDescent(tf)) - (Position)tf->text.cursor_height;
   /* If time to paint the I Beam... first capture the IBeamOffArea, then draw
   * the IBeam */
   if (tf->text.refresh_ibeam_off == True)
   { /* get area under IBeam first */
      /* Fill is needed to realign clip rectangle with gc */
      XFillRectangle(XtDisplay((Widget)tf), XtWindow((Widget)tf), tf->text.save_gc, 0, 0, 0, 0);
      XCopyArea(XtDisplay(tf), XtWindow(tf), tf->text.ibeam_off, tf->text.save_gc, x, y, tf->text.cursor_width, tf->text.cursor_height, 0, 0);
    ...
    */
   {
      ...
      {
         if ((int)(x + tf->text.cursor_width) > (int)(tf->core.width - tf->primitive.shadow_thickness - tf->primitive.highlight_thickness))
            cursor_width = (tf->core.width - (tf->primitive.shadow_thickness + tf->primitive.highlight_thickness)) - x;
         if (cursor_width > 0 && cursor_height > 0)
         {
            if (!XtIsSensitive((Widget)tf))
            {
               SetShadowGC(tf, tf->text.image_gc);
               XFillRectangle(XtDisplay(tf), XtWindow(tf), tf->text.image_gc, x + 1, y + 1, (unsigned int)cursor_width, (unsigned int)cursor_height);
            }
            _XmTextFToggleCursorGC((Widget)tf);
            XFillRectangle(XtDisplay(tf), XtWindow(tf), tf->text.image_gc, x, y, cursor_width, cursor_height);
         }
      }
      else
      {
         ...
         else if (x < (Position)(tf->primitive.highlight_thickness + tf->primitive.shadow_thickness))
         {
            cursor_width = tf->text.cursor_width - (tf->primitive.highlight_thickness + tf->primitive.shadow_thickness - x);
            src_x        = tf->text.cursor_width - cursor_width;
            x            = tf->primitive.highlight_thickness + tf->primitive.shadow_thickness;
         }
         if ((int)(y + tf->text.cursor_height) > (int)(tf->core.height - (tf->primitive.highlight_thickness + tf->primitive.shadow_thickness)))
         {
            cursor_height = tf->text.cursor_height - ((y + tf->text.cursor_height) - (tf->core.height - (tf->primitive.highlight_thickness + tf->primitive.shadow_thickness)));
         }
         if (cursor_width > 0 && cursor_height > 0)
            XCopyArea(XtDisplay(tf), tf->text.ibeam_off, XtWindow(tf), tf->text.save_gc, src_x, 0, cursor_width, cursor_height, x, y);
      }
   }
}
                               ...
                               Boolean           turn_on)
{
   ...
   else
   {
      if (tf->text.blink_on && (tf->text.cursor_on == 0))
         if (tf->text.blink_on == CurrentCursorState(tf) && XtIsRealized((Widget)tf))
         {
...
{
   if ((tf->text.cursor_on >= 0) && (tf->text.blink_on == CurrentCursorState(tf)) && XtIsRealized((Widget)tf))
   {
      tf->text.blink_on = !tf->text.blink_on;
      PaintCursor(tf);
   }
            ...
            XtIntervalId *id)
{
   ...
   if (TextF_BlinkRate(tf) != 0)
      tf->text.timer_id = XtAppAddTimeOut(XtWidgetToApplicationContext((Widget)tf),
...
GetRect(XmTextFieldWidget tf,
        XRectangle       *rect)
{
   Dimension margin_width  = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Dimension margin_top    = tf->text.margin_top + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Dimension margin_bottom = tf->text.margin_bottom + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
         ...
         int               length)
{
   ...
   {
      if (tf->text.max_char_size != 1)
         XwcDrawString(XtDisplay(tf), XtWindow(tf), (XFontSet)TextF_Font(tf), gc, x, y, (wchar_t *)string, length);
      else /* one byte chars */
         XmbDrawString(XtDisplay(tf), XtWindow(tf), (XFontSet)TextF_Font(tf), gc, x, y, string, length);
#if USE_XFT
   }
   else if (TextF_UseXft(tf))
   {
      ...
      { /* was passed a wchar_t*  */
         ...
         if (num_bytes >= 0)
            _XmXftDrawString2(XtDisplay(tf), XtWindow(tf), gc, TextF_XftFont(tf), 1, x, y, tmp, num_bytes);
         XmStackFree(tmp, stack_cache);
      }
      else /* one byte chars */
         _XmXftDrawString2(XtDisplay(tf), XtWindow(tf), gc, TextF_XftFont(tf), 1, x, y, string, length);
#endif
   }
   else
                ...
                int               length)
{
   ...
   else if (TextF_UseXft(tf))
   {
      ...
      { /* was passed a wchar_t*  */
         ...
         XftTextExtentsUtf8(XtDisplay(tf), TextF_XftFont(tf), (FcChar8 *)string, length, &ext);
      return ext.xOff;
#endif
   }
   else
                ...
                int              *x)
{
   ...
   if (tf->text.max_char_size != 1)
   {
      *x       += FindPixelLength(tf, (char *)(TextF_WcValue(tf) + prev_seg_start), (int)(seg_start - prev_seg_start));
      x_seg_len = FindPixelLength(tf, (char *)(TextF_WcValue(tf) + seg_start), (int)seg_end - (int)seg_start);
   }
   else
   {
      *x       += FindPixelLength(tf, TextF_Value(tf) + prev_seg_start, (int)(seg_start - prev_seg_start));
      x_seg_len = FindPixelLength(tf, TextF_Value(tf) + seg_start, (int)seg_end - (int)seg_start);
   }
   if (mode == XmHIGHLIGHT_SELECTED)
   {
      /* Draw the selected text using an inverse gc */
      SetNormGC(tf, tf->text.gc, False, False);
      XFillRectangle(XtDisplay(tf), XtWindow(tf), tf->text.gc, *x, y - TextF_FontAscent(tf), x_seg_len, TextF_FontAscent(tf) + TextF_FontDescent(tf));
   ...
   if (stipple)
   {
      ...
      if (tf->text.max_char_size != 1)
      {
         DrawText(tf, tf->text.gc, *x + 1, y + 1, (char *)(TextF_WcValue(tf) + seg_start), (int)seg_end - (int)seg_start);
      }
      else
      {
         DrawText(tf, tf->text.gc, *x + 1, y + 1, TextF_Value(tf) + seg_start, (int)seg_end - (int)seg_start);
      }
      SetNormGC(tf, tf->text.gc, True, stipple);
   }
   if (tf->text.max_char_size != 1)
   {
      DrawText(tf, tf->text.gc, *x, y, (char *)(TextF_WcValue(tf) + seg_start), (int)seg_end - (int)seg_start);
   }
   else
   {
      DrawText(tf, tf->text.gc, *x, y, TextF_Value(tf) + seg_start, (int)seg_end - (int)seg_start);
   }
   if (stipple) SetNormGC(tf, tf->text.gc, True, !stipple);
   if (mode == XmHIGHLIGHT_SECONDARY_SELECTED)
      XDrawLine(XtDisplay(tf), XtWindow(tf), tf->text.gc, *x, y, *x + x_seg_len - 1, y);
   /* update x position up to the next highlight position */
   if (tf->text.max_char_size != 1)
      *x += FindPixelLength(tf, (char *)(TextF_WcValue(tf) + seg_start), (int)(next_seg - (int)seg_start));
   else
      *x += FindPixelLength(tf, TextF_Value(tf) + seg_start, (int)(next_seg - (int)seg_start));
}
   ...
   */
   ...
   for (i = 0; i + 1 < tf->text.highlight.number; i++)
   {
      ...
      if (l[i].position <= start && start < l[i + 1].position && l[i].position < end)
      {
         ...
         {
            DrawTextSegment(tf, l[i].mode, l[i].position, start, l[i + 1].position, l[i + 1].position, stipple, y, &x);
         ...
         else
         {
            ...
            DrawTextSegment(tf, l[i].mode, l[i].position, start, end, l[i + 1].position, stipple, y, &x);
            start = end;
         }
      }
      else
      { /* start not within current record */
         if (tf->text.max_char_size != 1)
            x += FindPixelLength(tf, (char *)(TextF_WcValue(tf) + l[i].position), (int)(l[i + 1].position - l[i].position));
         else
            x += FindPixelLength(tf, TextF_Value(tf) + l[i].position, (int)(l[i + 1].position - l[i].position));
      }
   } /* end for loop */
   /* complete the drawing of the text to the end of the line */
   if (l[i].position < end)
   {
      DrawTextSegment(tf, l[i].mode, l[i].position, start, end, tf->text.string_length, stipple, y, &x);
   }
   else
   {
      if (tf->text.max_char_size != 1)
         x += FindPixelLength(tf, (char *)(TextF_WcValue(tf) + l[i].position), tf->text.string_length - (int)l[i].position);
      else
         x += FindPixelLength(tf, TextF_Value(tf) + l[i].position, tf->text.string_length - (int)l[i].position);
   }
   if (x < (Position)(rect.x + rect.width))
   {
      SetInvGC(tf, tf->text.gc);
      XFillRectangle(XtDisplay(tf), XtWindow(tf), tf->text.gc, x, rect.y, rect.x + rect.width - x, rect.height);
   }
   tf->text.refresh_ibeam_off = True;
   _XmTextFieldDrawInsertionPoint(tf, True);
}
...
{
   Dimension tmp = 0;
   if (TextF_ResizeWidth(tf) && TextF_Columns(tf) < tf->text.string_length)
   {
      if (tf->text.max_char_size != 1)
         tmp = FindPixelLength(tf, (char *)TextF_WcValue(tf), tf->text.string_length);
      else
         tmp = FindPixelLength(tf, TextF_Value(tf), tf->text.string_length);
      *width = tmp + (2 * (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness));
   }
   else
   {
      *width = TextF_Columns(tf) * tf->text.average_char_width + 2 * (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness);
   }
   if (height != NULL)
      *height = TextF_FontDescent(tf) + TextF_FontAscent(tf) + 2 * (TextF_MarginHeight(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness);
}
           ...
           Boolean           flag)
{
   ...
   if (tf->text.max_char_size != 1)
   {
      left_edge = FindPixelLength(tf, (char *)TextF_WcValue(tf), (int)position) + (int)tf->text.h_offset;
   }
   else
   {
      left_edge = FindPixelLength(tf, TextF_Value(tf), (int)position) + (int)tf->text.h_offset;
   }
   ...
   if ((diff = left_edge - margin_width) < 0)
   {
      ...
      XFillRectangle(XtDisplay(tf), XtWindow(tf), tf->text.gc, tf->primitive.shadow_thickness + tf->primitive.highlight_thickness, tf->primitive.shadow_thickness + tf->primitive.highlight_thickness, TextF_MarginWidth(tf), temp);
      SetMarginGC(tf, tf->text.gc);
   ...
   else if ((diff = (left_edge - (int)(tf->core.width - margin_width))) > 0)
   {
      ...
      XFillRectangle(XtDisplay(tf), XtWindow(tf), tf->text.gc, tf->core.width - margin_width, tf->primitive.shadow_thickness + tf->primitive.highlight_thickness, TextF_MarginWidth(tf), temp);
      SetMarginGC(tf, tf->text.gc);
      RedisplayText(tf, 0, tf->text.string_length);
      _XmTextFieldDrawInsertionPoint(tf, True);
      return True;
...
AdjustSize(XmTextFieldWidget tf)
{
   ...
   if (tf->text.max_char_size != 1)
   {
      left_edge = FindPixelLength(tf, (char *)TextF_WcValue(tf), tf->text.string_length) + margin_width;
   }
   else
   {
      left_edge = FindPixelLength(tf, TextF_Value(tf), tf->text.string_length) + margin_width;
   }
             ...
             int              *free_insert)
{
   ...
   *free_insert = (int)False;
   ...
   if (*insert_length)
   {
      ...
      {
         newblock.ptr = (char *)XtMalloc((unsigned)newblock.length + tf->text.max_char_size);
         if (tf->text.max_char_size == 1)
         {
                  ...
                  PassDisown        passDisown)
{
   ...
   if (TextF_CursorPosition(tf) != position && call_cb)
   {
      ...
      cb.doit       = True;
      XtCallCallbackList((Widget)tf, TextF_MotionVerifyCallback(tf), (XtPointer)&cb);
      if (!cb.doit)
      {
   ...
   * selected highlight region, restore the normal image GC. */
   ...
   tf->text.refresh_ibeam_off = True;
   _XmTextFieldDrawInsertionPoint(tf, True);
   (void)GetXYFromPos(tf, TextF_CursorPosition(tf), &xmim_point.x, &xmim_point.y);
   (void)TextFieldGetDisplayRect((Widget)tf, &xmim_area);
   XmImVaSetValues((Widget)tf, XmNspotLocation, &xmim_point, XmNarea, &xmim_area, NULL);
   if (set_dest)
      (void)SetDestination((Widget)tf, TextF_CursorPosition(tf), (DontCare == passDisown) ? False : True, XtLastTimestampProcessed(XtDisplay((Widget)tf)));
}
                        ...
                        Boolean           move_cursor)
{
   ...
   */
   if ((delta >= 0) && !FUnderVerifyPreedit(tf) && ((tf->text.string_length + delta) - (TextF_MaxLength(tf)) > 0))
   {
   ...
   */
   ...
   if (TextF_ModifyVerifyCallback(tf) || TextF_ModifyVerifyCallbackWcs(tf))
   {
     ...
     */
      ...
      if (insert_length > 0)
      {
         ...
         insert_orig = NULL;
      if (!ModifyVerify(tf, event, &replace_prev, &replace_next, &insert, &insert_length, &newInsert, &free_insert))
      {
         if (tf->text.verify_bell) XBell(XtDisplay(tf), 0);
      ...
      {
         if (FUnderVerifyPreedit(tf))
            if (insert_length != insert_length_orig || memcmp(insert, insert_orig, insert_length * size) != 0)
            {
               FVerifyCommitNeeded(tf) = True;
   ...
   if (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right)
      doSetHighlight((Widget)tf, tf->text.prim_pos_left, tf->text.prim_pos_right, XmHIGHLIGHT_NORMAL);
   _XmTextFieldDrawInsertionPoint(tf, False);
   ...
   */
   ...
   {
      if ((tf->text.string_length + insert_length - replace_length) * sizeof(wchar_t) >= tf->text.size_allocd)
      {
   ...
   if (tf->text.has_primary && replace_prev < tf->text.prim_pos_right && replace_next > tf->text.prim_pos_left)
   {
   ...
   if (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right)
      doSetHighlight((Widget)tf, tf->text.prim_pos_left, tf->text.prim_pos_right, XmHIGHLIGHT_SELECTED);
   ...
   if (move_cursor)
   {
      ...
      {
         (void)SetDestination((Widget)tf, cursorPos, False, XtLastTimestampProcessed(XtDisplay((Widget)tf)));
      }
                              ...
                              Time    sel_time)
{
   ...
   if (tf != NULL)
   {
      ...
      TextFieldSetHighlight(tf, tf->text.prim_pos_left, tf->text.prim_pos_right, XmHIGHLIGHT_NORMAL);
      tf->text.prim_pos_left = tf->text.prim_pos_right = tf->text.prim_anchor = TextF_CursorPosition(tf);
            ...
            Position          x)
{
   ...
   */
   ...
   for (position = 0; temp_x + next_char_width / 2 < (int)x && position < tf->text.string_length; position++)
   {
     ...
     */
      if (tf->text.string_length > position + 1)
      {
         if (tf->text.max_char_size != 1)
         {
            next_char_width = FindPixelLength(tf, (char *)(TextF_WcValue(tf) + position + 1), 1);
         }
         else
         {
            next_char_width = FindPixelLength(tf,
                                              TextF_Value(tf) + position + 1,
                                              1);
         }
      }
   } /* for */
            ...
            XEvent           *event)
{
   ...
   cbdata.text       = NULL;
   XtCallCallbackList((Widget)tf, TextF_LosingFocusCallback(tf), (XtPointer)&cbdata);
   tf->text.take_primary = True;
   return (cbdata.doit);
}
                           ...
                           XmTextPosition    pos2)
{
   ...
   { /* data is char* and one-byte per char */
      if (isspace((unsigned char)TextF_Value(tf)[pos1]) || isspace((unsigned char)TextF_Value(tf)[pos2])) return True;
   }
   else
   {
   ...
   { /* check for iswspace and iswordboundary in each direction */
      for (start = begin; start > 0; start--)
      {
         if (iswspace(TextF_WcValue(tf)[start - 1])
             || _XmTextFieldIsWordBoundary(tf, (XmTextPosition)start - 1, start))
         {
            break;
         }
      }
             ...
             XmTextPosition   *right)
{
   ...
   if (tf->text.max_char_size == 1)
   {
      if ((start > 0) && (isspace((unsigned char)TextF_Value(tf)[start - 1])))
      {
         for (; start > 0; start--)
         {
            if (!isspace((unsigned char)TextF_Value(tf)[start - 1]))
   ...
   else
   {
      ...
      else if ((start > 0) && _XmTextFieldIsWordBoundary(tf, (XmTextPosition)start - 1, start))
      {
         start--;
      }
      FindWord(tf, start, left, right);
             ...
             XmTextPosition   *right)
{
   ...
   if (tf->text.max_char_size == 1)
   {
     ...
     * current word.
     */
      while (*right < tf->text.string_length && isspace((unsigned char)TextF_Value(tf)[(int)*right]))
         *right = *right + 1;
   ...
   else
   {
      ...
      { /* if for other reasons at word boundry, advance to next word */
         if ((end < tf->text.string_length) && _XmTextFieldIsWordBoundary(tf, end, (XmTextPosition)end + 1))
            end++;
      }
      FindWord(tf, end, left, right);
      /*
     ...
     */
      ...
      {
         while (*right < tf->text.string_length && iswspace(TextF_WcValue(tf)[(int)*right]))
         {
            *right = *right + 1;
         }
         if (*right < tf->text.string_length)
                       ...
                       Time           sel_time)
{
   ...
   if (tf->text.add_mode || (tf->text.has_primary && left != right && position >= left && position <= right))
...
{
   return (tf->text.add_mode ? (TextF_PendingDelete(tf) && tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right && tf->text.prim_pos_left <= TextF_CursorPosition(tf) && tf->text.prim_pos_right >= TextF_CursorPosition(tf)) : (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right));
}

static Boolean
NeedsPendingDeleteDisjoint(XmTextFieldWidget tf)
{
   return (TextF_PendingDelete(tf) && tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right && tf->text.prim_pos_left <= TextF_CursorPosition(tf) && tf->text.prim_pos_right >= TextF_CursorPosition(tf));
}
           ...
           Cardinal *num_params)
{
   ...
   */
   ...
   if (insert_length > 0)
   {
      ...
      {
         if (!tf->text.has_primary || (cursorPos = tf->text.prim_pos_left) == (nextPos = tf->text.prim_pos_right))
         {
      ...
      if (tf->text.max_char_size == 1)
      {
         ...
         replace_res = _XmTextFieldReplaceText(tf, (XEvent *)event, cursorPos, nextPos, insert_string, insert_length, True);
      }
      else
      {
         ...
         if (nextPos > tf->text.string_length) nextPos = tf->text.string_length;
         replace_res = _XmTextFieldReplaceText(tf, (XEvent *)event, cursorPos, nextPos, (char *)wc_insert_string, num_chars, True);
      ...
      if (replace_res)
      {
         if (pending_delete)
         {
            _XmTextFieldStartSelection(tf, TextF_CursorPosition(tf), TextF_CursorPosition(tf), event->xkey.time);
            tf->text.pending_off = False;
         }
   ...
   else
   {
      if (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right)
      {
         if (TextF_CursorPosition(tf) - 1 >= 0)
            if (_XmTextFieldReplaceText(tf, event, TextF_CursorPosition(tf) - 1, TextF_CursorPosition(tf), NULL, 0, True))
            {
               CheckDisjointSelection(w, TextF_CursorPosition(tf), event->xkey.time);
               _XmTextFieldSetCursorPosition(tf, event, TextF_CursorPosition(tf), False, True);
               cb.reason = XmCR_VALUE_CHANGED;
   ...
   else
   {
      if (tf->text.has_primary && tf->text.prim_pos_left != tf->text.prim_pos_right)
      {
         if (TextF_CursorPosition(tf) < tf->text.string_length)
            if (_XmTextFieldReplaceText(tf, event, TextF_CursorPosition(tf), TextF_CursorPosition(tf) + 1, NULL, 0, True))
            {
               CheckDisjointSelection(w, TextF_CursorPosition(tf), event->xkey.time);
               _XmTextFieldSetCursorPosition(tf, event, TextF_CursorPosition(tf), False, True);
               cb.reason = XmCR_VALUE_CHANGED;
                  ...
                  Cardinal *num_params)
{
   ...
   {
      if (_XmTextFieldReplaceText(tf, event, TextF_CursorPosition(tf), tf->text.string_length, NULL, 0, True))
      {
         CheckDisjointSelection(w, TextF_CursorPosition(tf), event->xkey.time);
         _XmTextFieldSetCursorPosition(tf, event, TextF_CursorPosition(tf), False, True);
         cb.reason = XmCR_VALUE_CHANGED;
...
{
   XmTextPosition left = tf->text.prim_pos_left, right = tf->text.prim_pos_right;
   if ((tf->text.add_mode && tf->text.has_primary && position >= left && position <= right) || extend)
      tf->text.pending_off = FALSE;
   else
      tf->text.pending_off = TRUE;
             ...
             Cardinal *num_params)
{
   ...
   if (cursorPos > 0)
   {
      ...
      SimpleMovement((Widget)tf, event, params, num_params, cursorPos, position);
      _XmTextFieldDrawInsertionPoint(tf, True);
   }
}
             ...
             Boolean           redisplay)
{
   ...
   if (left == right && tf->text.prim_pos_left != tf->text.prim_pos_right && tf->text.add_mode)
   {
      _XmTextFieldDrawInsertionPoint(tf, False);
      tf->text.add_mode = False;
      _XmTextFieldDrawInsertionPoint(tf, True);
   ...
   TextFieldSetHighlight(tf, tf->text.prim_pos_left, tf->text.prim_pos_right, XmHIGHLIGHT_SELECTED);
   if (redisplay)
   {
      ...
      else if (old_prim_left < tf->text.prim_pos_left)
      {
         ...
         display_left = (old_prim_right > tf->text.prim_pos_right) ? tf->text.prim_pos_right : old_prim_right;
      ...
      else if (old_prim_right > tf->text.prim_pos_right)
      {
         ...
         display_right = (old_prim_left < tf->text.prim_pos_left) ? tf->text.prim_pos_left : old_prim_left;
                           ...
                           Time              sel_time)
{
   ...
   if (tf->text.take_primary || (tf->text.prim_pos_left == tf->text.prim_pos_right && left != right))
   {
       ...
       */
         ...
         cb.event  = NULL;
         XtCallCallbackList((Widget)tf, tf->text.gain_primary_callback, (XtPointer)&cb);
      }
      else
         /*
                        ...
                        XmTextPosition *position)
{
   ...
   int               direction;
   *position = TextF_CursorPosition(tf);
   if (!tf->text.has_primary || (*left = tf->text.prim_pos_left) == (*right = tf->text.prim_pos_right))
   {
   ...
   if (event->xfocus.send_event && !(tf->text.has_focus))
   {
      ...
      if (_XmGetFocusPolicy(w) == XmEXPLICIT)
      {
         ...
         if (!tf->text.has_destination && !tf->text.sel_start)
            (void)SetDestination(w, TextF_CursorPosition(tf), False, XtLastTimestampProcessed(XtDisplay(w)));
      }
      if (XtIsSensitive(w)) ChangeBlinkBehavior(tf, True);
      _XmTextFieldDrawInsertionPoint(tf, True);
      (void)GetXYFromPos(tf, TextF_CursorPosition(tf), &xmim_point.x, &xmim_point.y);
      (void)TextFieldGetDisplayRect((Widget)tf, &xmim_area);
      XmImVaSetFocusValues(w, XmNspotLocation, &xmim_point, XmNarea, &xmim_area, NULL);
             ...
             XEvent           *event)
{
   ...
   if (sel_time > tf->text.last_time && sel_time - tf->text.last_time < XtGetMultiClickTime(XtDisplay(tf)))
   {
      /*
                    ...
                    XEvent           *event)
{
   ...
   if (!tf->text.has_primary || left == right)
   {
      tf->text.orig_left = tf->text.orig_right = tf->text.prim_anchor = TextF_CursorPosition(tf);
   ...
   switch (TextF_SelectionArray(tf)[tf->text.sarray_index])
   {
      case XmSELECT_POSITION:
         if (tf->text.take_primary && new_position != tf->text.prim_anchor)
            _XmTextFieldStartSelection(tf, tf->text.prim_anchor, new_position, event->xbutton.time);
      ...
      case XmSELECT_WORD:
         ...
         FindWord(tf, tf->text.prim_anchor, &pivot_left, &pivot_right);
         tf->text.pending_off = False;
                 ...
                 XEvent           *event)
{
   ...
   GetXYFromPos(tf, cursorPos, &(tf->text.select_pos_x), &dummy);
   _XmTextFieldDrawInsertionPoint(tf, True);
}
   ...
   switch (TextF_SelectionArray(tf)[tf->text.sarray_index])
   {
      case XmSELECT_POSITION:
         if (tf->text.take_primary && position != tf->text.prim_anchor)
            _XmTextFieldStartSelection(tf, tf->text.prim_anchor, position, time);
         else if (tf->text.has_primary)
...
{
   XmTextFieldWidget tf          = (XmTextFieldWidget)w;
   Dimension         margin_size = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Dimension         top_margin  = TextF_MarginHeight(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   tf->text.select_pos_x         = event->xmotion.x;
   if ((event->xmotion.x > (int)margin_size) && (event->xmotion.x < (int)(tf->core.width - margin_size)) && (event->xmotion.y > (int)top_margin) && (event->xmotion.y < (int)(top_margin + TextF_FontAscent(tf) + TextF_FontDescent(tf))))
   {
      if (tf->text.select_id)
      {
         XtRemoveTimeOut(tf->text.select_id);
   ...
   else
   {
      ...
      if (event->xmotion.x <= (int)margin_size)
         tf->text.select_pos_x = (Position)(margin_size - (tf->text.average_char_width + 1));
      /* to the right of the text */
      else if (event->xmotion.x >= (int)(tf->core.width - margin_size))
         tf->text.select_pos_x = (Position)((tf->core.width - margin_size) + tf->text.average_char_width + 1);
      if (!tf->text.select_id)
         tf->text.select_id = XtAppAddTimeOut(XtWidgetToApplicationContext(w),
...
RestorePrimaryHighlight(XmTextFieldWidget tf,
                        ...
                        XmTextPosition    prim_right)
{
   if (tf->text.sec_pos_right >= prim_left && tf->text.sec_pos_right <= prim_right)
   {
      /* secondary selection is totally inside primary selection */
      if (tf->text.sec_pos_left >= prim_left)
      {
         TextFieldSetHighlight(tf, prim_left, tf->text.sec_pos_left, XmHIGHLIGHT_SELECTED);
         TextFieldSetHighlight(tf, tf->text.sec_pos_left, tf->text.sec_pos_right, XmHIGHLIGHT_NORMAL);
         TextFieldSetHighlight(tf, tf->text.sec_pos_right, prim_right, XmHIGHLIGHT_SELECTED);
         /* right side of secondary selection is inside primary selection */
      }
      else
      {
         TextFieldSetHighlight(tf, tf->text.sec_pos_left, prim_left, XmHIGHLIGHT_NORMAL);
         TextFieldSetHighlight(tf, prim_left, tf->text.sec_pos_right, XmHIGHLIGHT_SELECTED);
      }
   }
   else
   {
      /* left side of secondary selection is inside primary selection */
      if (tf->text.sec_pos_left <= prim_right && tf->text.sec_pos_left >= prim_left)
      {
         TextFieldSetHighlight(tf, tf->text.sec_pos_left, prim_right, XmHIGHLIGHT_SELECTED);
         TextFieldSetHighlight(tf, prim_right, tf->text.sec_pos_right, XmHIGHLIGHT_NORMAL);
      }
      else
      {
         /* secondary selection encompasses the primary selection */
         if (tf->text.sec_pos_left <= prim_left && tf->text.sec_pos_right >= prim_right)
         {
            TextFieldSetHighlight(tf, tf->text.sec_pos_left, prim_left, XmHIGHLIGHT_NORMAL);
            TextFieldSetHighlight(tf, prim_left, prim_right, XmHIGHLIGHT_SELECTED);
            TextFieldSetHighlight(tf, prim_right, tf->text.sec_pos_right, XmHIGHLIGHT_NORMAL);
                    ...
                    Time           sel_time)
{
   ...
   if (tf->text.has_secondary)
   {
     ...
     */
      if (tf->text.has_primary)
         RestorePrimaryHighlight(tf, tf->text.prim_pos_left, tf->text.prim_pos_right);
      else
         TextFieldSetHighlight(tf, tf->text.sec_pos_left, tf->text.sec_pos_right, XmHIGHLIGHT_NORMAL);
   }
   if (left < right)
   ...
   TextFieldSetHighlight((XmTextFieldWidget)w, tf->text.sec_pos_left, tf->text.sec_pos_right, XmHIGHLIGHT_SECONDARY_SELECTED);
          ...
          XtIntervalId *id) /* unused */
{
   ...
   tf->text.drag_id     = 0;
   StartDrag((Widget)tf, tf->text.transfer_action->event, tf->text.transfer_action->params, tf->text.transfer_action->num_params);
}
            ...
            XEvent *event)
{
   ...
   return (tf->text.has_primary && left != right && ((position > left && position < right) || (position == left && GetXYFromPos(tf, left, &left_x, &dummy) && event->xbutton.x > left_x) || (position == right && GetXYFromPos(tf, right, &right_x, &dummy) && event->xbutton.x < right_x)));
}
...
#define ABS_DELTA(x1, x2) (x1 < x2 ? x2 - x1 : x1 - x2)
   ...
   else
   {
      ...
      {
         case ButtonPress:
            if (!InSelection(w, event) || (event_time > tf->text.last_time && event_time - tf->text.last_time < XtGetMultiClickTime(XtDisplay(w))))
            {
               if (*num_params > 0)
                  XtCallActionProc(w, params[0], event, NULL, 0);
            }
            else
            {
               ...
               {
                  tf->text.transfer_action        = (_XmTextActionRec *)XtMalloc(sizeof(_XmTextActionRec));
                  tf->text.transfer_action->event = (XEvent *)XtMalloc(sizeof(XEvent));
               }
               memcpy((void *)tf->text.transfer_action->event, (void *)event, sizeof(XEvent));
         ...
         case ButtonRelease:
            if (tf->text.drag_id)
            {
               ...
               {
                  XtCallActionProc(w, tf->text.transfer_action->params[0], tf->text.transfer_action->event, NULL, 0);
               }
            }
            XtCallActionProc(w, params[0], event, NULL, 0);
            break;
         case MotionNotify:
            if (tf->text.drag_id)
            {
               ...
               if (ABS_DELTA(press->xbutton.x_root, event->xmotion.x_root) > tf->text.threshold || ABS_DELTA(press->xbutton.y_root, event->xmotion.y_root) > tf->text.threshold)
               {
                  XtRemoveTimeOut(tf->text.drag_id);
                  tf->text.drag_id = 0;
                  StartDrag(w, event, params, num_params);
                                    ...
                                    XEvent *event)
{
   ...
   if (dest_data->has_destination)
   {
      ...
      doSetHighlight(w, tf->text.sec_pos_left, tf->text.sec_pos_right, XmHIGHLIGHT_NORMAL);
      ...
      else if (dest_data->position > tf->text.sec_pos_left && dest_data->position < tf->text.sec_pos_right)
      {
                ...
                Cardinal *num_params)
{
   ...
   TextFDestData     dest_data;
   XmTextPosition    left = tf->text.prim_pos_left, right = tf->text.prim_pos_right;
   if (tf->text.selection_move == TRUE && tf->text.has_destination && TextF_CursorPosition(tf) >= tf->text.sec_pos_left && TextF_CursorPosition(tf) <= tf->text.sec_pos_right)
   {
      /* This will mark the has_secondary field to False. */
                    ...
                    Cardinal *num_params)
{
   ...
   if (tf->text.sel_start)
   {
      if (tf->text.has_secondary && tf->text.sec_pos_left != tf->text.sec_pos_right)
      {
         if ((Dimension)ev->x > tf->core.width || ev->x < 0 || (Dimension)ev->y > tf->core.height || ev->y < 0)
         {
            /* This will mark the has_secondary field to False. */
            _XmTextFieldSetSel2(w, 1, 0, False, event->xkey.time);
         }
      ...
      else if (!tf->text.sec_drag && !tf->text.cancel && tf->text.sec_pos_left == position)
      {
         /*
               ...
               Cardinal *num_params)
{
   ...
   if (num_spaces > 0)
   {
      ...
      if (tf->text.max_char_size == 1)
      {
         ...
         spaces[num_spaces] = 0;
         rep_result         = _XmTextFieldReplaceText(tf, (XEvent *)event, left, right, spaces, num_spaces, False);
      ...
      else
      {
         ...
         rep_result = _XmTextFieldReplaceText(tf, (XEvent *)event, left, right, (char *)wc_spaces, num_spaces, False);
          ...
          Cardinal *num_params)
{
   ...
   if (tf->text.max_char_size != 1)
   {
      length = FindPixelLength(tf, (char *)TextF_WcValue(tf), tf->text.string_length);
   }
   else
   {
   ...
   if ((int)(length - ((int)(tf->core.width - (2 * margin_width)) - tf->text.h_offset)) > (int)(tf->core.width - (2 * margin_width)))
         ...
         Cardinal *num_params)
{
   ...
   int               value;
   XmTextFieldWidget tf           = (XmTextFieldWidget)w;
   int               margin_width = (int)TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   TextFieldResetIC(w);
   _XmTextFieldDrawInsertionPoint(tf, False);
   if (*num_params > 0)
   {
   ...
   GetXYFromPos(tf, TextF_CursorPosition(tf), &x, &y);
   if (margin_width <= tf->text.h_offset + ((int)tf->core.width - (2 * margin_width)))
              ...
              Cardinal *num_params)
{
   ...
   if (tf->text.add_mode && (!tf->text.has_primary || tf->text.prim_pos_left == tf->text.prim_pos_right))
      tf->text.prim_anchor = TextF_CursorPosition(tf);
   _XmTextFieldDrawInsertionPoint(tf, True);
}
                     ...
                     Cardinal *num_params)
{
   ...
   if (VerifyLeave(tf, event))
   {
      ...
      dir                                    = (enable_button_tab ? XmTRAVERSE_GLOBALLY_FORWARD : XmTRAVERSE_NEXT_TAB_GROUP);
      tf->text.traversed                     = True;
                     ...
                     Cardinal *num_params)
{
   ...
   if (VerifyLeave(tf, event))
   {
      ...
      XmDisplay            xm_dpy            = (XmDisplay)XmGetXmDisplay(XtDisplay(w));
      Boolean              enable_button_tab = xm_dpy->display.enable_button_tab;
      dir                                    = (enable_button_tab ? XmTRAVERSE_GLOBALLY_BACKWARD : XmTRAVERSE_PREV_TAB_GROUP);
      tf->text.traversed                     = True;
      if (!_XmMgrTraversal(w, dir))
         tf->text.traversed = False;
   }
          ...
          Cardinal *num_params)
{
   ...
   * is child of TextF widget). */
   if (_XmGetFocusPolicy(w) != XmEXPLICIT && !(tf->text.has_focus) && event->xcrossing.focus && (event->xcrossing.detail != NotifyInferior))
   {
      _XmTextFieldDrawInsertionPoint(tf, False);
      tf->text.blink_on  = False;
      tf->text.has_focus = True;
...
ClassPartInitialize(WidgetClass w_class)
{
   ...
   event_bindings = (char *)XtMalloc((unsigned)(strlen(EventBindings1) + strlen(EventBindings2) + strlen(EventBindings3) + 1));
...
Validates(XmTextFieldWidget tf)
{
   ...
   */
   ...
   TextF_SelectionArray(tf) = (XmTextScanType *)XtMalloc(TextF_SelectionArrayCount(tf) * sizeof(XmTextScanType));
   memcpy((void *)TextF_SelectionArray(tf), (void *)temp_ptr, (TextF_SelectionArrayCount(tf) * sizeof(XmTextScanType)));
   /*
   * End fix for HaL DTS 9841
   */
}
   ...
   if (!is_wchar)
   {
     ...
     * instance pointer. */
      if (tf->text.max_char_size == 1)
      {
         ...
         TextF_Value(tf)      = (char *)memcpy(XtMalloc((unsigned)(tf->text.string_length + 30)),
                                          (void *)start_temp,
      ...
      { /* Need wchar_t* data to set as the widget's value */
         ...
         tf->text.string_length = mbstowcs(TextF_WcValue(tf), start_temp, tf->text.string_length + 30);
   ...
   { /* pointer passed points to wchar_t* data */
      ...
      *wcs_temp_str          = (wchar_t)0L; /* terminate with a wchar_t NULL */
      ...
      { /* Need to store data as char* */
         ...
         ret_val         = wcstombs(TextF_Value(tf), wcs_start_temp, tf->text.size_allocd);
...
InitializeTextStruct(XmTextFieldWidget tf)
{
   ...
   */
   ...
   tf->text.h_offset  = (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness);
   ...
   * pointer.  */
   ...
   tf->text.orig_left = tf->text.orig_right = tf->text.prim_pos_left = tf->text.prim_pos_right = tf->text.prim_anchor = TextF_CursorPosition(tf);
   tf->text.sec_pos_left = tf->text.sec_pos_right = tf->text.sec_anchor = TextF_CursorPosition(tf);
   ...
   tf->text.highlight.list                                = (_XmHighlightRec *)XtMalloc((unsigned)sizeof(_XmHighlightRec));
   ...
   if (TextF_Editable(tf))
   {
      ...
      (void)TextFieldGetDisplayRect((Widget)tf, &xmim_area);
      n = 0;
      XtSetArg(args[n], XmNfontList, TextF_FontList(tf));
      n++;
      ...
      n++;
      XtSetArg(args[n], XmNarea, &xmim_area);
      n++;
      XtSetArg(args[n], XmNlineSpace, TextF_FontAscent(tf) + TextF_FontDescent(tf));
      n++;
      /*
   ...
   */
   ...
   tf->text.onthespot->start = tf->text.onthespot->end = tf->text.onthespot->cursor = 0;
        ...
        Pixel             foreground)
{
   ...
   */
   ...
   tf->text.save_gc = XtAllocateGC((Widget)tf, tf->core.depth, valueMask, &values, dynamicMask, unusedMask);
   /*
   ...
   */
   ...
   tf->text.gc  = XtAllocateGC((Widget)tf, tf->core.depth, valueMask, &values, dynamicMask, 0);
   ...
   tf->text.image_gc = XtAllocateGC((Widget)tf, tf->core.depth, valueMask, &values, dynamicMask, 0);
}
                 ...
                 Dimension         height)
{
   ...
   * be painted */
   tf->text.ibeam_off         = XCreatePixmap(dpy, RootWindowOfScreen(screen), width, height, tf->core.depth);
   tf->text.refresh_ibeam_off = True;
}
                 ...
                 int               line_width)
{
   ...
   if (tf->text.cursor == XmUNSPECIFIED_PIXMAP)
   {
      ...
      tf->text.cursor = XCreatePixmap(dpy, XtWindow(tf), tf->text.cursor_width, tf->text.cursor_height, 1);
     ...
     */
      ...
      XFillRectangle(dpy, tf->text.cursor, tf->text.cursor_gc, 0, 0, tf->text.cursor_width, tf->text.cursor_height);
      ...
      (void)_XmCachePixmap(tf->text.cursor, XtScreen(tf), pixmap_name, 1, 0, 1, tf->text.cursor_width, tf->text.cursor_height);
   }
                  ...
                  int               line_width)
{
   ...
   if (tf->text.add_mode_cursor == XmUNSPECIFIED_PIXMAP)
   {
      ...
      XGCValues values;
      Display  *dpy            = XtDisplay(tf);
      tf->text.add_mode_cursor = XCreatePixmap(dpy, XtWindow(tf), tf->text.cursor_width, tf->text.cursor_height, 1);
      values.function          = GXcopy;
      valueMask                = GCFunction;
      XChangeGC(dpy, tf->text.cursor_gc, valueMask, &values);
      XCopyArea(dpy, tf->text.cursor, tf->text.add_mode_cursor, tf->text.cursor_gc, 0, 0, tf->text.cursor_width, tf->text.cursor_height, 0, 0);
      valueMask          = (GCForeground | GCBackground | GCTile | GCFillStyle | GCFunction | GCTileStipXOrigin);
      ...
      values.background  = tf->core.background_pixel;
      XChangeGC(dpy, tf->text.cursor_gc, valueMask, &values);
      XFillRectangle(dpy, tf->text.add_mode_cursor, tf->text.cursor_gc, 0, 0, tf->text.cursor_width, tf->text.cursor_height);
...
MakeCursors(XmTextFieldWidget tf)
{
   ...
   if (tf->text.cursor == XmUNSPECIFIED_PIXMAP || tf->text.add_mode_cursor == XmUNSPECIFIED_PIXMAP || tf->text.ibeam_off == XmUNSPECIFIED_PIXMAP || oldheight != tf->text.cursor_height || oldwidth != tf->text.cursor_width)
   {
      if (tf->text.cursor_gc == NULL)
      {
         unsigned long valueMask = 0;
         XGCValues     values;
         unsigned long dynamicMask = GCForeground | GCLineWidth | GCTile | GCFillStyle | GCBackground | GCFunction | GCTileStipXOrigin;
         tf->text.cursor_gc        = XtAllocateGC((Widget)tf, 1, valueMask, &values, dynamicMask, 0);
      }
      ...
      MakeIBeamOffArea(tf, MAX(tf->text.cursor_height >> 1, tf->text.cursor_height), tf->text.cursor_height);
                 ...
                 XtPointer call)
{
   ...
   switch (cb->reason)
   {
      case XmCR_DROP_SITE_ENTER_MESSAGE:
         if (XmTargetsAreCompatible(XtDisplay(drag_cont), exp_targets, num_exp_targets, targets, 4))
   ...
   {
      if (cb->operation != XmDROP_COPY && cb->operation != XmDROP_MOVE)
         cb->dropSiteStatus = XmINVALID_DROP_SITE;
   }
}
...
RegisterDropSite(Widget w)
{
   ...
   n++;
   XtSetArg(args[n], XmNnumImportTargets, 5);
   n++;
   XtSetArg(args[n], XmNdragProc, DragProcCallback);
   n++;
           ...
           Cardinal *num_args)
{
   ...
   LoadGCs(new_tf, new_tf->core.background_pixel, new_tf->primitive.foreground);
...
Resize(Widget w)
{
   ...
   tf->text.h_offset = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
#else
   new_width = tf->core.width - (2 * (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness));
   offset    = tf->text.h_offset - (TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness);
   if (tf->text.max_char_size != 1)
   ...
   if (text_width - new_width < -offset)
   {
      ...
      {
         tf->text.h_offset = (new_width - text_width) + TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
      }
      else
      {
         tf->text.h_offset = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
                ...
                Region  region)
{
   ...
   */
   ...
   XFillRectangle(XtDisplay(w), tf->text.ibeam_off, tf->text.save_gc, 0, 0, tf->text.cursor_width, tf->text.cursor_height);
   values.foreground = tf->primitive.foreground;
          ...
          Cardinal *num_args)
{
   ...
   * the i-beam. */
   if (TextF_CursorPosition(new_tf) != TextF_CursorPosition(old_tf))
   {
      ...
      (void)SetDestination(new_w, TextF_CursorPosition(new_tf), False, XtLastTimestampProcessed(XtDisplay(new_w)));
      cursor_pos_set = True;
   }
   else
   {
   ...
   if (!XtIsSensitive(new_w) && new_tf->text.has_destination)
   {
      (void)SetDestination(new_w, TextF_CursorPosition(new_tf), True, XtLastTimestampProcessed(XtDisplay(new_w)));
   }
   ...
   */
   if (TextF_SelectionArray(new_tf) != TextF_SelectionArray(old_tf))
   {
      ...
      TextF_SelectionArray(new_tf) = (XmTextScanType *)XtMalloc(TextF_SelectionArrayCount(new_tf) * sizeof(XmTextScanType));
      memcpy((void *)TextF_SelectionArray(new_tf), (void *)temp_ptr, (TextF_SelectionArrayCount(new_tf) * sizeof(XmTextScanType)));
   }
   /*
   * End fix for HaL DTS 9841
   */
   ...
   */
   ...
   if (TextF_FontList(new_tf) != TextF_FontList(old_tf))
   {
      ...
      {
         XtSetArg(im_args[n], XmNfontList, TextF_FontList(new_tf));
         n++;
         redisplay = True;
      }
   }
   ...
   */
   ...
   { /* old value != new value */
     ...
     * the action.
     */
      if (TextF_ModifyVerifyCallback(new_tf) || TextF_ModifyVerifyCallbackWcs(new_tf))
      {
         /* If the function ModifyVerify() returns false then don't
       * continue with the action.
       */
         ...
         if (new_tf->text.max_char_size == 1)
         {
            ...
            mod_ver_ret = ModifyVerify(new_tf, NULL, &fromPos, &toPos, &temp, &new_tf->text.string_length, &newInsert, &free_insert);
         }
         else
         {
            old_s = temp = XtMalloc((unsigned)((new_tf->text.string_length + 1) * new_tf->text.max_char_size));
            ret_val      = wcstombs(temp, TextF_WcValue(new_tf), (new_tf->text.string_length + 1) * new_tf->text.max_char_size);
            if (ret_val < 0) temp[0] = '\0';
            mod_ver_ret = ModifyVerify(new_tf, NULL, &fromPos, &toPos, &temp, &ret_val, &newInsert, &free_insert);
         ...
         if (!mod_ver_ret)
         {
            ...
            if (new_tf->text.max_char_size == 1)
            {
               TextF_Value(new_tf)        = (char *)memcpy(XtRealloc(TextF_Value(new_tf),
            ...
            else
            {
               ...
               TextF_WcValue(new_tf)      = (wchar_t *)memcpy(XtRealloc((char *)TextF_WcValue(new_tf),
                                                                   (unsigned)old_tf->text.size_allocd),
      ...
      if (do_it)
      {
         ...
         if (new_tf->text.max_char_size == 1)
            ...
            XtFree((char *)TextF_WcValue(old_tf));
         doSetHighlight(new_w, new_tf->text.prim_pos_left, new_tf->text.prim_pos_right, XmHIGHLIGHT_NORMAL);
       ...
       */
         ...
         {
            _XmTextFieldSetCursorPosition(new_tf, NULL, new_position, True, False);
         ...
         {
            new_tf->text.h_offset = TextF_MarginWidth(new_tf) + new_tf->primitive.shadow_thickness + new_tf->primitive.highlight_thickness;
   ...
   if (new_tf->primitive.foreground != old_tf->primitive.foreground || TextF_FontList(new_tf) != TextF_FontList(old_tf) || new_tf->core.background_pixel != old_tf->core.background_pixel)
   {
      LoadGCs(new_tf, new_tf->primitive.foreground, new_tf->core.background_pixel);
      MakeCursors(new_tf);
      redisplay = True;
   ...
   if (new_tf->text.has_focus && XtIsSensitive((Widget)new_tf) && TextF_BlinkRate(new_tf) != TextF_BlinkRate(old_tf))
   {
      ...
      {
         new_tf->text.timer_id = XtAppAddTimeOut(XtWidgetToApplicationContext(new_w),
   ...
   new_size = TextF_MarginWidth(new_tf) != TextF_MarginWidth(old_tf) || TextF_MarginHeight(new_tf) != TextF_MarginHeight(old_tf) || TextF_FontList(new_tf) != TextF_FontList(old_tf) || new_tf->primitive.highlight_thickness != old_tf->primitive.highlight_thickness || new_tf->primitive.shadow_thickness != old_tf->primitive.shadow_thickness;
   ...
   GetXYFromPos(new_tf, TextF_CursorPosition(new_tf), &xmim_point.x, &xmim_point.y);
   ...
   n++;
   XtSetArg(im_args[n], XmNarea, &xmim_area);
   n++;
   XtSetArg(im_args[n], XmNlineSpace, TextF_FontAscent(new_tf) + TextF_FontDescent(new_tf));
   n++;
   ...
   * widget.  */
   ...
   if ((!TextF_Editable(new_tf) || !XtIsSensitive(new_w)) && new_tf->text.has_destination)
                ...
                XEvent *event)
{
   ...
   {
      _XmTextFieldStartSelection(tf, TextF_CursorPosition(tf), TextF_CursorPosition(tf), XtLastTimestampProcessed(XtDisplay(w)));
      tf->text.pending_off = False;
      cb.reason            = XmCR_VALUE_CHANGED;
      cb.event             = event;
      XtCallCallbackList((Widget)tf, TextF_ValueChangedCallback(tf), (XtPointer)&cb);
                      ...
                      int        *line_count)
{
   ...
   *line_count   = 1;
   ...
   base_array[0] = tf->text.margin_top + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness + TextF_FontAscent(tf);
...
{
   XmTextFieldWidget tf            = (XmTextFieldWidget)w;
   Position          margin_width  = TextF_MarginWidth(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Position          margin_top    = tf->text.margin_top + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Position          margin_bottom = tf->text.margin_bottom + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
                                  ...
                                  Boolean           move_cursor)
{
   ...
   */
   ...
   /* Disallow insertions that go beyond max length boundries.
  */
   if ((delta >= 0) && ((tf->text.string_length + delta) - (TextF_MaxLength(tf)) > 0))
   {
      if (tf->text.verify_bell) XBell(XtDisplay(tf), 0);
      return False;
   }
...
static void
PreeditVerifyReplace(XmTextFieldWidget tf,
                     XmTextPosition    start,
                     XmTextPosition    end,
                     char             *insert,
                     char              insert_length,
             ...
             XPointer call_data)
{
   ...
   {
      _XmTextFieldDrawInsertionPoint(tf, False);
      if (!XmTextFieldGetSelectionPosition(w, &cursorPos, &nextPos) || cursorPos == nextPos)
      {
         tf->text.prim_anchor = TextF_CursorPosition(tf);
      }
      pending_delete       = True;
      ...
      {
         if (pending_delete)
            XmTextFieldSetSelection(w, TextF_CursorPosition(tf), TextF_CursorPosition(tf), XtLastTimestampProcessed(XtDisplay((Widget)tf)));
         CheckDisjointSelection(w, TextF_CursorPosition(tf), XtLastTimestampProcessed(XtDisplay((Widget)tf)));
   ...
   if (tf->text.overstrike)
   {
      ...
      else
      {
         ...
         memcpy((char *)&tf->text.wc_value[PreStart(tf)], (char *)wc, tf->text.onthespot->over_len * sizeof(wchar_t));
            ...
            XPointer call_data)
{
   ...
   if (PreEnd(tf) > PreStart(tf))
   {
      if (need_verify)
      {
         PreeditVerifyReplace(tf, PreStart(tf), PreEnd(tf), NULL, 0, PreStart(tf), &end_preedit);
         if (end_preedit) return;
      }
      else
         _XmTextFieldReplaceTextForPreedit(tf, PreStart(tf), PreEnd(tf), NULL, 0, True);
   }
   if (tf->text.overstrike)
   {
      if (need_verify)
      {
         PreeditVerifyReplace(tf, PreStart(tf), PreStart(tf), (char *)tf->text.onthespot->over_str, tf->text.onthespot->over_maxlen, PreStart(tf), &end_preedit);
         if (end_preedit) return;
      }
      else
      {
         _XmTextFieldDrawInsertionPoint(tf, False);
         (void)_XmTextFieldReplaceTextForPreedit(tf, PreStart(tf), PreStart(tf), (char *)tf->text.onthespot->over_str, tf->text.onthespot->over_maxlen, True);
            ...
            XIMPreeditDrawCallbackStruct *call_data)
{
   ...
   XtVaGetValues(p, XmNverifyPreedit, &need_verify, NULL);
   _XmTextFieldDrawInsertionPoint(tf, False);
   doSetHighlight(w, PreStart(tf) + call_data->chg_first, PreStart(tf) + call_data->chg_first + call_data->chg_length, XmHIGHLIGHT_NORMAL);
   if (!tf->text.overstrike && (!call_data->text || !insert_length))
   {
      ...
      if (need_verify)
      {
         PreeditVerifyReplace(tf, startPos, endPos, NULL, 0, startPos, &end_preedit);
         if (end_preedit)
         {
            _XmTextFieldDrawInsertionPoint(tf, True);
            return;
      ...
      {
         (void)_XmTextFieldReplaceTextForPreedit(tf, startPos, endPos, NULL, 0, True);
      }
      _XmTextFieldDrawInsertionPoint(tf, True);
      return;
   }
   if (call_data->text)
   {
      if ((call_data->text->encoding_is_wchar && !call_data->text->string.wide_char) || (!call_data->text->encoding_is_wchar && !call_data->text->string.multi_byte))
      {
   ...
   if (insert_length > 0)
   {
      if (TextF_UseFontSet(tf))
      {
         if (call_data->text->encoding_is_wchar)
         {
            ...
            mbstowcs(tab_wc, "\t", 1);
            if (escapement == 0 && overall_ink.width == 0 && wcschr(call_data->text->string.wide_char, *tab_wc) == 0)
            {
               /* cursor on */
               XtFree((char *)tab_wc);
               return;
         ...
         else
         {
            ...
            escapement = XmbTextExtents((XFontSet)TextF_Font(tf),
                                        ...
                                        &overall_ink,
                                        NULL);
            if (escapement == 0 && overall_ink.width == 0 && strchr(call_data->text->string.multi_byte, '\t') == 0)
            {
               /* cursor on */
               if (mb)
                  XtFree(mb);
   ...
   {
      startPos = PreStart(tf) + call_data->chg_first;
      tmp_end  = (XmTextPosition)(PreEnd(tf) + insert_length - call_data->chg_length);
      if (tf->text.onthespot->over_maxlen < tmp_end - PreStart(tf))
      {
         ...
         {
            endPos                          = PreEnd(tf) + tmp_end - PreStart(tf) - tf->text.onthespot->over_maxlen;
            tf->text.onthespot->over_maxlen = tmp_end - PreStart(tf);
         }
      }
      else if (tf->text.onthespot->over_maxlen > tmp_end - PreStart(tf))
      {
         endPos                          = PreEnd(tf);
         recover_len                     = tf->text.onthespot->over_maxlen - tmp_end + PreStart(tf);
         tf->text.onthespot->over_maxlen = tmp_end - PreStart(tf);
      }
      else
         endPos = startPos + call_data->chg_length;
      rest_len = (XmTextPosition)(PreEnd(tf) - PreStart(tf) - call_data->chg_first - call_data->chg_length);
      if (rest_len)
      {
         if (tf->text.max_char_size == 1)
         {
            over_mb = XtMalloc(rest_len + 1);
            memcpy(&tf->text.value[PreStart(tf) + call_data->chg_first + call_data->chg_length], over_mb, rest_len);
            over_mb[rest_len] = '\0';
         }
         else
         {
            over_wc = (wchar_t *)XtMalloc((rest_len + 1) * sizeof(wchar_t));
            memcpy((char *)&tf->text.wc_value[PreStart(tf) + call_data->chg_first + call_data->chg_length],
                   (char *)over_wc,
   ...
   if (tf->text.max_char_size == 1)
   {
      ...
      {
         (void)_XmTextFieldReplaceTextForPreedit(tf, startPos, endPos, mb, strlen(mb), True);
   ...
   else
   {
      ...
      if (need_verify)
      {
         PreeditVerifyReplace(tf, startPos, endPos, (char *)wc, wcslen(wc), PreCursor(tf), &end_preedit);
         if (end_preedit)
         {
            _XmTextFieldDrawInsertionPoint(tf, True);
            return;
      ...
      {
         (void)_XmTextFieldReplaceTextForPreedit(tf, startPos, endPos, (char *)wc, wcslen(wc), True);
         PreeditSetCursorPosition(tf, PreCursor(tf));
      }
   }
   if (insert_length > 0)
...
TextFieldResetIC(Widget w)
{
   ...
   if (FVerifyCommitNeeded(tf))
   {
      ...
      else
      {
         ...
         wc_string = (wchar_t *)XtMalloc((PreEnd(tf) - PreStart(tf) + 1)
                                         * sizeof(wchar_t));
         memcpy((char *)&TextF_WcValue(tf)[PreStart(tf)], (char *)wc_string, (PreEnd(tf) - PreStart(tf)) * sizeof(wchar_t));
   ...
   if (insert_length > 0)
   {
      ...
      {
         XGlyphInfo ext;
         XftTextExtentsUtf8(XtDisplay((Widget)tf), TextF_XftFont(tf), (FcChar8 *)mb, insert_length, &ext);
         if (!ext.xOff)
         {
            ResetUnder(tf);
            return;
   ...
   else
   {
      ...
      replace_res       = _XmTextFieldReplaceText(tf, NULL, cursorPos, nextPos, (char *)wc_insert_string, num_chars, True);
...
XmTextFieldGetString(Widget w)
{
   ...
   if (tf->text.string_length > 0)
   {
      ...
      else
      {
         ...
         ret_val  = wcstombs(temp_str, TextF_WcValue(tf), (tf->text.string_length + 1) * tf->text.max_char_size);
...
XmTextFieldGetStringWcs(Widget w)
{
   ...
   if (tf->text.string_length > 0)
   {
      ...
      if (tf->text.max_char_size != 1)
      {
         memcpy((void *)temp_wcs, (void *)TextF_WcValue(tf), sizeof(wchar_t) * (tf->text.string_length + 1));
      }
      else
      {
         num_wcs = mbstowcs(temp_wcs, TextF_Value(tf), tf->text.string_length + 1);
                           ...
                           wchar_t       *buffer)
{
   ...
   if (num_chars > 0)
   {
      ...
      {
         memcpy((void *)buffer, (void *)&TextF_WcValue(tf)[start], (size_t)num_chars * sizeof(wchar_t));
      }
      buffer[num_chars] = '\0';
   }
   else if (num_chars == 0)
                     ...
                     char  *value)
{
   ...
   if (TextF_ModifyVerifyCallback(tf) || TextF_ModifyVerifyCallbackWcs(tf))
   {
     ...
     */
      if (tf->text.max_char_size == 1)
      {
         if (!ModifyVerify(tf, NULL, &fromPos, &toPos, &value, &length, &newInsert, &free_insert))
         {
            if (tf->text.verify_bell) XBell(XtDisplay(w), 0);
      ...
      else
      {
         ...
         if (!ModifyVerify(tf, NULL, &fromPos, &toPos, (char **)&wbuf, &length, &newInsert, &free_insert))
         {
            if (tf->text.verify_bell) XBell(XtDisplay(w), 0);
   ...
   TextFieldSetHighlight((XmTextFieldWidget)w, 0, tf->text.string_length, XmHIGHLIGHT_NORMAL);
   if (tf->text.max_char_size == 1)
      XtFree(TextF_Value(tf));
                 ...
                 int            is_wc)
{
   ...
   if (tf->text.has_primary)
   {
      if ((tf->text.prim_pos_left > from_pos && tf->text.prim_pos_left < to_pos) || (tf->text.prim_pos_right > from_pos && tf->text.prim_pos_right < to_pos) || (tf->text.prim_pos_left <= from_pos && tf->text.prim_pos_right >= to_pos))
      {
         _XmTextFieldDeselectSelection(w, False, XtLastTimestampProcessed(XtDisplay(w)));
         deselected = True;
      }
   }
   ...
   if (is_wc)
   {
      ...
      if (tf->text.max_char_size != 1)
      {
         rep_result = _XmTextFieldReplaceText(tf, NULL, from_pos, to_pos, (char *)wc_value, length, False);
      }
      else
      { /* need to convert to char* before calling Replace */
         ...
         rep_result = _XmTextFieldReplaceText(tf, NULL, from_pos, to_pos, (char *)value, length, False);
         XtFree(value);
      }
   }
   else
...
XmTextFieldGetSelection(Widget w)
{
   ...
   else
   {
      ...
      length = wcstombs(value, TextF_WcValue(tf) + tf->text.prim_pos_left, (num_chars + 1) * tf->text.max_char_size);
      if (length == (size_t)-1)
      {
         length = 0;
      }
...
static void
doSetHighlight(Widget w, XmTextPosition left, XmTextPosition right, XmHighlightMode mode)
{
   XmTextFieldWidget tf = (XmTextFieldWidget)w;
...
XmTextFieldGetBaseline(Widget w)
{
   ...
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
   margin_top = tf->text.margin_top + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
