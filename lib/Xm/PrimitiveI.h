...
extern void _XmPrimitiveHelp(Widget wid, XEvent *event, String *params, Cardinal *num_params);
extern void _XmPrimitiveParentActivate(Widget pw,
                                       XEvent *event,
                                       String *params,
                                       Cardinal *num_params);
extern void _XmPrimitiveParentCancel(Widget pw,
                                     XEvent *event,
                                     String *params,
                                     Cardinal *num_params);
extern void _XmButtonTakeFocus(Widget wid, XEvent *event, String *params, Cardinal *num_params);
extern void _XmMenuButtonTakeFocus(Widget wid,
                                   XEvent *event,
                                   String *params,
                                   Cardinal *num_params);
extern void _XmMenuButtonTakeFocusUp(Widget wid,
                                     XEvent *event,
                                     String *params,
                                     Cardinal *num_params);
