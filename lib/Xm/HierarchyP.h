...
typedef void (*XmHierarchyBuildTableProc)(Widget, HierarchyConstraints, Cardinal *);
...
#define XmHierarchy_node_state_callback(w) \
  (((XmHierarchyWidget)(w))->hierarchy.node_state_callback)
#define XmHierarchy_node_state_changed_callback(w) \
  (((XmHierarchyWidget)(w))->hierarchy.node_state_changed_callback)
#define XmHierarchy_node_state_beg_end_callback(w) \
  (((XmHierarchyWidget)(w))->hierarchy.node_state_beg_end_callback)
