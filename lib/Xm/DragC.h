...
enum { XmDROP, XmDROP_HELP, XmDROP_CANCEL, XmDROP_INTERRUPT };
...
enum { XmMOVE = XmDROP_MOVE, XmCOPY = XmDROP_COPY, XmLINK = XmDROP_LINK, XmOTHER };

enum { XmBLEND_ALL, XmBLEND_STATE_SOURCE, XmBLEND_JUST_SOURCE, XmBLEND_NONE };
...
extern Widget XmDragStart(Widget w, XEvent *event, ArgList args, Cardinal numArgs);
