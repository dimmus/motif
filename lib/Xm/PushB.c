...
static XtResource resources[] = {
   { XmNmultiClick,                   XmCMultiClick,                   XmRMultiClick,          sizeof(unsigned char),  XtOffsetOf(XmPushButtonRec, pushbutton.multiClick),                      XmRImmediate, (XtPointer)XmINVALID_MULTICLICK  },
   { XmNfillOnArm,                    XmCFillOnArm,                    XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmPushButtonRec, pushbutton.fill_on_arm),                     XmRImmediate, (XtPointer)True                  },
   { XmNarmColor,                     XmCArmColor,                     XmRPixel,               sizeof(Pixel),          XtOffsetOf(XmPushButtonRec, pushbutton.arm_color),                       XmRCallProc,  (XtPointer)_XmSelectColorDefault },
   { XmNarmPixmap,                    XmCArmPixmap,                    XmRDynamicPixmap,       sizeof(Pixmap),         XtOffsetOf(XmPushButtonRec, pushbutton.arm_pixmap),                      XmRImmediate, (XtPointer)XmUNSPECIFIED_PIXMAP  },
   { XmNshowAsDefault,                XmCShowAsDefault,                XmRBooleanDimension,    sizeof(Dimension),      XtOffsetOf(XmPushButtonRec, pushbutton.show_as_default),                 XmRImmediate, (XtPointer)0                     },
   { XmNactivateCallback,             XmCCallback,                     XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmPushButtonRec, pushbutton.activate_callback),               XmRPointer,   (XtPointer)NULL                  },
   { XmNarmCallback,                  XmCCallback,                     XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmPushButtonRec, pushbutton.arm_callback),                    XmRPointer,   (XtPointer)NULL                  },
   { XmNdisarmCallback,               XmCCallback,                     XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmPushButtonRec, pushbutton.disarm_callback),                 XmRPointer,   (XtPointer)NULL                  },
   { XmNshadowThickness,              XmCShadowThickness,              XmRHorizontalDimension, sizeof(Dimension),      XtOffsetOf(XmPushButtonRec, primitive.shadow_thickness),                 XmRCallProc,  (XtPointer)_XmSetThickness       },
   { XmNdefaultButtonShadowThickness, XmCDefaultButtonShadowThickness, XmRHorizontalDimension, sizeof(Dimension),      XtOffsetOf(XmPushButtonRec, pushbutton.default_button_shadow_thickness), XmRImmediate, (XtPointer)0                     },
   { XmNtraversalOn,                  XmCTraversalOn,                  XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmPrimitiveRec,  primitive.traversal_on),                     XmRImmediate, (XtPointer)True                  },
   { XmNhighlightThickness,           XmCHighlightThickness,           XmRHorizontalDimension, sizeof(Dimension),      XtOffsetOf(XmPrimitiveRec,  primitive.highlight_thickness),              XmRCallProc,  (XtPointer)_XmSetThickness       },
};
/* Synthetic resources list */
static XmSyntheticResource syn_resources[] = {
   { XmNshowAsDefault,                sizeof(Dimension), XtOffsetOf(XmPushButtonRec, pushbutton.show_as_default),                 XmeFromHorizontalPixels,  ShowAsDef_ToHorizPix  },
   { XmNdefaultButtonShadowThickness, sizeof(Dimension), XtOffsetOf(XmPushButtonRec, pushbutton.default_button_shadow_thickness), XmeFromHorizontalPixels,  XmeToHorizontalPixels },
   { XmNhighlightThickness,           sizeof(Dimension), XtOffsetOf(XmPrimitiveRec,  primitive.highlight_thickness),              ExportHighlightThickness, XmeToHorizontalPixels },
};
/*************************************<->*************************************
 *
 *
   ...
   XtArgVal *value)
{
   ...
   if (pbw->pushbutton.show_as_default || pbw->pushbutton.default_button_shadow_thickness)
   {
   ...
   Cardinal *num_args) /* unused */
{
   ...
   */
   if (new_w->pushbutton.compatible)
      new_w->pushbutton.default_button_shadow_thickness = new_w->pushbutton.show_as_default;
   ...
   if ((new_w->label.pixmap == XmUNSPECIFIED_PIXMAP) && (new_w->pushbutton.arm_pixmap != XmUNSPECIFIED_PIXMAP))
   {
      XtWidgetProc resize;
   ...
   if ((new_w->label.label_type == XmPIXMAP || new_w->label.label_type == XmPIXMAP_AND_STRING) && (new_w->pushbutton.arm_pixmap != XmUNSPECIFIED_PIXMAP))
   {
      if (request->core.width == 0)
         new_w->core.width = 0;
      if (request->core.height == 0)
   ...
   if (new_w->pushbutton.default_button_shadow_thickness)
   {
      ...
      increase                              = (2 * new_w->pushbutton.default_button_shadow_thickness + new_w->primitive.shadow_thickness + adjustment);
   ...
   XmPushButtonWidget pb)
{
   ...
   dx     = pb->core.width - (Lab_MarginRight(pb) + Lab_MarginWidth(pb) + pb->primitive.highlight_thickness + pb->primitive.shadow_thickness);
   dy     = pb->primitive.highlight_thickness + pb->primitive.shadow_thickness + Lab_MarginTop(pb) + Lab_MarginHeight(pb) + (MAX(Lab_TextRect_height(pb), pb->label.acc_TextRect.height) - def_pixmap_height) / 2;
   ...
   XCopyPlane(XtDisplay(pb), def_pixmap, XtWindow(pb), pb->label.normal_GC, 0, 0, width, height, dx, dy, 1);
}
   ...
   XmPushButtonWidget pb)
{
   ...
   dx     = pb->core.width - (Lab_MarginRight(pb) + Lab_MarginWidth(pb) + pb->primitive.highlight_thickness + pb->primitive.shadow_thickness);
   dy     = pb->primitive.highlight_thickness + pb->primitive.shadow_thickness + Lab_MarginTop(pb) + Lab_MarginHeight(pb);
   width  = Lab_MarginRight(pb);
   height = MAX(Lab_TextRect_height(pb), pb->label.acc_TextRect.height);
   XClearArea(XtDisplay(pb), XtWindow(pb), dx, dy, width, height, False);
}
#endif /* DEFAULT_GLYPH_PIXMAP */
/*
...
#ifdef DEFAULT_GLYPH_PIXMAP
   if (_XmGetDefaultGlyphPixmap(XtScreen((Widget)(pb)), NULL, NULL) != XmUNSPECIFIED_PIXMAP)
   {
      EraseDefaultGlyphPixmap(pb);
      return;
   }
   ...
   Cardinal *num_args) /* unused */
{
   ...
   */
   if ((current->pushbutton.default_button_shadow_thickness) != (new_w->pushbutton.default_button_shadow_thickness))
      new_w->pushbutton.compatible = False;
   if (new_w->pushbutton.compatible)
      new_w->pushbutton.default_button_shadow_thickness = new_w->pushbutton.show_as_default;
   ...
   * Compute size change.
   */
   if (new_w->pushbutton.default_button_shadow_thickness != current->pushbutton.default_button_shadow_thickness)
   {
      if (new_w->pushbutton.default_button_shadow_thickness > current->pushbutton.default_button_shadow_thickness)
      {
         increase = (2 * new_w->pushbutton.default_button_shadow_thickness + new_w->primitive.shadow_thickness);
         if (current->pushbutton.default_button_shadow_thickness > 0)
            increase -= (2 * current->pushbutton.default_button_shadow_thickness + current->primitive.shadow_thickness);
      }
      else
      {
         increase = -(2 * current->pushbutton.default_button_shadow_thickness + current->primitive.shadow_thickness);
   ...
   if ((new_w->pushbutton.arm_pixmap != current->pushbutton.arm_pixmap) && (new_w->label.label_type == XmPIXMAP) && (new_w->pushbutton.armed))
      flag = TRUE;
   /* No unarm_pixmap but do have an arm_pixmap, use that. */
   if ((new_w->label.pixmap == XmUNSPECIFIED_PIXMAP) && (new_w->pushbutton.arm_pixmap != XmUNSPECIFIED_PIXMAP))
   {
      XtWidgetProc resize;
      new_w->label.pixmap = new_w->pushbutton.arm_pixmap;
      if (new_w->label.recompute_size && request->core.width == current->core.width)
         new_w->core.width = 0;
      if (new_w->label.recompute_size && request->core.height == current->core.height)
         new_w->core.width = 0;
      _XmCalcLabelDimensions(nw);
      _XmProcessLock();
      resize = xmLabelClassRec.core_class.resize;
   ...
   if ((new_w->label.label_type == XmPIXMAP || new_w->label.label_type == XmPIXMAP_AND_STRING) && (new_w->pushbutton.arm_pixmap != current->pushbutton.arm_pixmap))
   {
   ...
   if ((new_w->pushbutton.fill_on_arm != current->pushbutton.fill_on_arm) && (new_w->pushbutton.armed == TRUE))
      flag = TRUE;
   if (!Lab_IsMenupane(new_w) || etched_in)
   {
      ...
      if (new_w->core.background_pixel != current->core.background_pixel || (new_w->core.background_pixmap != XmUNSPECIFIED_PIXMAP && new_w->core.background_pixmap != current->core.background_pixmap))
      {
   ...
   if (flag == False && XtIsRealized((Widget)new_w))
   {
      ...
      if ((current->pushbutton.show_as_default != 0) && (new_w->pushbutton.show_as_default == 0))
   ...
   XmPushButtonWidget pb)
{
   ...
   if (tmp_gc)
      XFillRectangle(XtDisplay(pb), XtWindow(pb), tmp_gc, box.x, box.y, box.width, box.height);
}
   ...
   Region             region)
{
   ...
   Boolean   etched_in  = dpy->display.enable_etched_in_menu;
   if (pb->pushbutton.armed && ((!Lab_IsMenupane(pb) && pb->pushbutton.fill_on_arm) || (Lab_IsMenupane(pb) && etched_in)))
   {
      XSetWindowBackground(XtDisplay(pb), XtWindow(pb), pb->pushbutton.arm_color);
      replaceBg = True;
      if ((pb->label.label_type == XmSTRING || pb->label.label_type == XmPIXMAP_AND_STRING) && (pb->pushbutton.arm_color == pb->primitive.foreground))
      {
   ...
   if (pb->label.label_type == XmPIXMAP || pb->label.label_type == XmPIXMAP_AND_STRING)
   {
      if (pb->pushbutton.armed)
      {
   ...
   */
   ...
   if (replaceBg)
   {
      ...
      if (pb->core.background_pixmap != XmUNSPECIFIED_PIXMAP)
      {
         XSetWindowBackgroundPixmap(XtDisplay(pb), XtWindow(pb), pb->core.background_pixmap);
      }
   }
}
   ...
   XmPushButtonWidget pb)
{
   ...
   {
      case XmEXTERNAL_HIGHLIGHT:
         adjust = (pb->primitive.highlight_thickness - (pb->pushbutton.default_button_shadow_thickness ? Xm3D_ENHANCE_PIXEL : 0));
         break;
      case XmINTERNAL_HIGHLIGHT:
         adjust = 0;
         break;
...
#ifdef DEFAULT_GLYPH_PIXMAP
       || (_XmGetDefaultGlyphPixmap(XtScreen((Widget)pb), NULL, NULL) != XmUNSPECIFIED_PIXMAP)
#endif
   )
   {
                    ...
                    Mask   visual_flag)
{
   ...
   if (visual_flag & (VisualBackgroundPixel | VisualBackgroundPixmap))
   {
      ...
      if (!pb->primitive.highlighted && kid_class->primitive_class.border_unhighlight)
   ...
   XRectangle        *box)
{
   int   dx, adjust;
   short fill = 0;
   if ((pb->pushbutton.arm_color == pb->primitive.top_shadow_color) || (pb->pushbutton.arm_color == pb->primitive.bottom_shadow_color))
      fill = 1;
   ...
   if (adjust > 0)
   {
      ...
      dx = (pb->primitive.highlight_thickness + pb->primitive.shadow_thickness + fill);
   box->x      = dx;
   box->y      = dx;
   adjust      = (dx << 1);
   ...
   XmPushButtonWidget pb)
{
   ...
   */
   if ((shadow_thickness > 0) && (top_gc) && (bottom_gc))
   {
      ...
      {
         adjust = (adjust << 1);
         dx     = (pb->primitive.highlight_thickness + adjust + pb->primitive.shadow_thickness);
      }
      else
         dx = pb->primitive.highlight_thickness;
      /* CR 7115: Deal with degenerate cases. */
      if ((pb->core.width > 2 * dx) && (pb->core.height > 2 * dx))
         XmeDrawShadows(XtDisplay(pb), XtWindow(pb), top_gc, bottom_gc, dx, dx, pb->core.width - 2 * dx, pb->core.height - 2 * dx, shadow_thickness, XmSHADOW_OUT);
   }
}
   ...
   XmPushButtonWidget pb)
{
   ...
   XtEnum    default_button_emphasis;
   XmDisplay xm_dpy;
   if (pb->pushbutton.compatible && (pb->pushbutton.show_as_default == 0))
      return;
#ifdef DEFAULT_GLYPH_PIXMAP
   if (_XmGetDefaultGlyphPixmap(XtScreen((Widget)(pb)), NULL, NULL) != XmUNSPECIFIED_PIXMAP)
   {
...
#endif
   if (!pb->pushbutton.compatible && (pb->pushbutton.default_button_shadow_thickness == 0))
      return;
   /*
   ...
   */
   ...
   if (pb->pushbutton.compatible)
      ...
      default_button_shadow_thickness = pb->pushbutton.default_button_shadow_thickness;
   /*
   ...
   */
   ...
   height = pb->core.height - 2 * delta;
   if ((width > 0) && (height > 0))
      XmeDrawShadows(XtDisplay(pb), XtWindow(pb), top_gc, bottom_gc, x, y, width, height, default_button_shadow_thickness, XmSHADOW_OUT);
}
   ...
   Widget wid)
{
   ...
   if (Lab_IsMenupane(pb))
   {
      ...
      {
         XFillRectangle(XtDisplay(pb), XtWindow(pb), pb->pushbutton.fill_gc, 0, 0, pb->core.width, pb->core.height);
         DrawPushButtonLabel(pb, event, NULL);
      }
      if ((pb->core.width > 2 * pb->primitive.highlight_thickness) && (pb->core.height > 2 * pb->primitive.highlight_thickness))
         XmeDrawShadows(XtDisplay(pb), XtWindow(pb), pb->primitive.top_shadow_GC, pb->primitive.bottom_shadow_GC, pb->primitive.highlight_thickness, pb->primitive.highlight_thickness, pb->core.width - 2 * pb->primitive.highlight_thickness, pb->core.height - 2 * pb->primitive.highlight_thickness, pb->primitive.shadow_thickness, etched_in ? XmSHADOW_IN : XmSHADOW_OUT);
   ...
   Widget wid)
{
   ...
   if (highlight_width > 0)
   {
      ...
      width  = pb->core.width - 2 * delta;
      height = pb->core.height - 2 * delta;
      XmeDrawHighlight(XtDisplay(pb), XtWindow(pb), pb->primitive.highlight_GC, x, y, width, height, highlight_width);
   }
}
   ...
   Widget wid)
{
   ...
   if (Lab_IsMenupane(pb))
   {
      ...
      if (etched_in && !XmIsTearOffButton(pb))
      {
         XFillRectangle(XtDisplay(pb), XtWindow(pb), pb->pushbutton.background_gc, 0, 0, pb->core.width, pb->core.height);
         DrawPushButtonLabel(pb, event, NULL);
      }
      else
         XmeClearBorder(
   ...
   XmPushButtonWidget current)
{
   ...
   if (new_w->pushbutton.default_button_shadow_thickness > 0)
   {
      ...
      else if (new_w->primitive.highlight_thickness != current->primitive.highlight_thickness)
      {
         new_w->primitive.highlight_thickness += Xm3D_ENHANCE_PIXEL;
         adjustment                            = Xm3D_ENHANCE_PIXEL;
      }
   ...
   else
   {
      ...
      /* default_button_shadow_thickness was > 0 and is now being set to 0,
         ...
         */
      {
         if (new_w->primitive.highlight_thickness == current->primitive.highlight_thickness)
         {
            new_w->primitive.highlight_thickness -= Xm3D_ENHANCE_PIXEL;
            adjustment                           -= Xm3D_ENHANCE_PIXEL;
         }
   ...
   int                rectheight)
{
   if (XmIsManager(XtParent(pb)))
   {
      ...
      XmeDrawHighlight(XtDisplay(pb), XtWindow(pb), XmParentBackgroundGC(pb), dx, dy, rectwidth, rectheight, borderwidth);
   }
   else
   {
       ...
       */
      XmeClearBorder(XtDisplay(pb), XtWindow(pb), dx, dy, rectwidth, rectheight, borderwidth);
   }
}
   ...
   XmPushButtonWidget newpb)
{
   ...
   if (newpb->pushbutton.arm_pixmap != XmUNSPECIFIED_PIXMAP)
   {
      if (newpb->label.pixmap != XmUNSPECIFIED_PIXMAP)
         XmeGetPixmapData(XtScreen(newpb), newpb->label.pixmap, NULL, NULL, NULL, NULL, NULL, NULL, &onW, &onH);
      XmeGetPixmapData(XtScreen(newpb), newpb->pushbutton.arm_pixmap, NULL, NULL, NULL, NULL, NULL, NULL, &onW2, &onH2);
   ...
   Cardinal *num_params) /* unused */
{
   ...
   pb->pushbutton.armed = TRUE;
   if (event != NULL && (event->xany.type == ButtonPress || event->xany.type == ButtonRelease))
   ...
   Cardinal *num_params)
{
   ...
   */
   if (pb->pushbutton.multiClick == XmMULTICLICK_KEEP)
   {
      if ((buttonEvent->xbutton.time - pb->pushbutton.armTimeStamp) > XtGetMultiClickTime(XtDisplay(pb)))
         pb->pushbutton.click_count = 1;
      else
   ...
   Cardinal *num_params) /* unused */
{
   ...
   if ((event->xany.type == ButtonPress || event->xany.type == ButtonRelease) && _XmGetPointVisibility(wid, event->xbutton.x_root, event->xbutton.y_root))
   {
      ...
      if ((pb->pushbutton.multiClick == XmMULTICLICK_DISCARD) && (call_value.click_count > 1))
         return;
      menuSTrait = (XmMenuSystemTrait)
      ...
      {
         XFlush(XtDisplay(pb));
         XtCallCallbackList((Widget)pb, pb->pushbutton.activate_callback, &call_value);
      }
   }
}
   ...
   Cardinal *num_params) /* unused */
{
   ...
   if (is_menupane && menuSTrait != NULL)
   {
      ...
      if (torn_has_focus)
      {
         ...
         XmProcessTraversal((Widget)pb, XmTRAVERSE_CURRENT);
         if ((pb->core.width > 2 * pb->primitive.highlight_thickness) && (pb->core.height > 2 * pb->primitive.highlight_thickness))
            XmeDrawShadows(XtDisplay(pb), XtWindow(pb), pb->primitive.bottom_shadow_GC, pb->primitive.top_shadow_GC, pb->primitive.highlight_thickness, pb->primitive.highlight_thickness, pb->core.width - 2 * pb->primitive.highlight_thickness, pb->core.height - 2 * pb->primitive.highlight_thickness, pb->primitive.shadow_thickness, etched_in ? XmSHADOW_IN : XmSHADOW_OUT);
      }
   }
   else
   {
   ...
   */
   if (!is_menupane || torn_has_focus)
   {
      if ((pb->core.being_destroyed == False) && (!pb->pushbutton.timer))
         pb->pushbutton.timer = XtAppAddTimeOut(XtWidgetToApplicationContext((Widget)pb),
   ...
   XtIntervalId *id)
{
   ...
   if (XtIsRealized((Widget)pb) && XtIsManaged((Widget)pb))
   {
	   ...
	   */
         if (XmeFocusIsInShell((Widget)pb) && (XmGetFocusWidget((Widget)pb) == (Widget)pb))
         {
            XmDisplay dpy       = (XmDisplay)XmGetXmDisplay(XtDisplay(pb));
            Boolean   etched_in = dpy->display.enable_etched_in_menu;
   ...
   Cardinal *num_params) /* unused */
{
   ...
   if (Lab_IsMenupane(pb))
   {
      if ((((ShellWidget)XtParent(XtParent(pb)))->shell.popped_up) && _XmGetInDragMode((Widget)pb))
      {
         XmDisplay dpy       = (XmDisplay)XmGetXmDisplay(XtDisplay(wid));
         Boolean   etched_in = dpy->display.enable_etched_in_menu;
         if (pb->pushbutton.armed)
   ...
   Cardinal *num_params) /* unused */
{
   ...
   if (Lab_IsMenupane(pb))
   {
      XmDisplay dpy       = (XmDisplay)XmGetXmDisplay(XtDisplay(wid));
      Boolean   etched_in = dpy->display.enable_etched_in_menu;
      if (_XmGetInDragMode((Widget)pb) && pb->pushbutton.armed && (/* !ActiveTearOff || */ event->xcrossing.mode == NotifyNormal))
      {
         pb->pushbutton.armed                                   = FALSE;
         ...
         if (etched_in && !XmIsTearOffButton(pb))
         {
            ...
            XmeClearBorder(XtDisplay(pb), XtWindow(pb), pb->primitive.highlight_thickness, pb->primitive.highlight_thickness, pb->core.width - 2 * pb->primitive.highlight_thickness, pb->core.height - 2 * pb->primitive.highlight_thickness, pb->primitive.shadow_thickness);
         if (pb->pushbutton.disarm_callback)
         {
            XFlush(XtDisplay(pb));
            call_value.reason = XmCR_DISARM;
              ...
              XtEnum state)
{
   ...
   switch (state)
   {
	 ...
	 * pixel, so save it and restore it after the setvalues */
         unsigned char saved_unit_type = ((XmPrimitiveWidget)w)->primitive.unit_type;
#ifdef DEFAULT_GLYPH_PIXMAP
            ...
            if (!pb->pushbutton.default_button_shadow_thickness)
         {
            ...
            pb->pushbutton.compatible                   = False;
            ((XmPrimitiveWidget)w)->primitive.unit_type = XmPIXELS;
            XtVaSetValues(w, XmNdefaultButtonShadowThickness, dbShadowTh, NULL);
            ((XmPrimitiveWidget)w)->primitive.unit_type = saved_unit_type;
         }
      }
      break;
