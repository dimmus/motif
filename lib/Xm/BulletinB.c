...
static XtResource resources[] = {
   ...
   { XmNunmapCallback,
    ...
    XmRImmediate,
    (XtPointer)NULL                                                                                                                                                      },
   { "pri.vate",           "Pri.vate", XmRUnsignedChar, sizeof(unsigned char), XtOffsetOf(struct _XmBulletinBoardRec, bulletin_board.check_set),         XmRImmediate, 0 },
   { XmNbuttonFontList,
    XmCButtonFontList,
    XmRButtonFontList,
    sizeof(XmFontList),
 ...
 */
   ...
   if (XtClass(new_w) == xmBulletinBoardWidgetClass)
   {
      ...
      if (((new_w->bulletin_board.margin_width != current->bulletin_board.margin_width) || (new_w->bulletin_board.margin_height != current->bulletin_board.margin_height)))
      {
         /*
...
****************/
   ...
   if (bbWid->bulletin_board.old_shadow_thickness
       && ((bbWid->bulletin_board.old_width != bbWid->core.width)
           || (bbWid->bulletin_board.old_height != bbWid->core.height)))
   {
      _XmClearShadowType((Widget)bbWid, bbWid->bulletin_board.old_width, bbWid->bulletin_board.old_height, bbWid->bulletin_board.old_shadow_thickness, (Dimension)0);
      bbWid->bulletin_board.old_shadow_thickness = 0;
   }
   geoSpec = (*geoMatrixCreate)((Widget)bbWid, NULL, NULL);
   _XmGeoMatrixGet(geoSpec, XmGET_PREFERRED_SIZE);
   ...
   XmGeoCreateProc   geoMatrixCreate)
{
   ...
   {
      _XmClearShadowType((Widget)bbWid, bbWid->bulletin_board.old_width, bbWid->bulletin_board.old_height, bbWid->bulletin_board.old_shadow_thickness, 0);
      bbWid->bulletin_board.old_shadow_thickness = 0;
   }
   ...
   Widget wid)
{
   ...
   if (classPtr->bulletin_board_class.geo_matrix_create)
   {
      ...
      _XmHandleSizeUpdate((Widget)bbWid, BB_ResizePolicy(bbWid), classPtr->bulletin_board_class.geo_matrix_create);
      if (bbWid->manager.shadow_thickness
          && (XtWidth(bbWid) <= bbWid->bulletin_board.old_width)
          && (XtHeight(bbWid) <= bbWid->bulletin_board.old_height))
      {
   ...
   Widget wid)
{
   ...
   {
      _XmClearShadowType((Widget)bb, bb->bulletin_board.old_width, bb->bulletin_board.old_height, bb->bulletin_board.old_shadow_thickness, 0);
   ...
   XtWidgetGeometry *reply)
{
   ...
   if (classPtr->bulletin_board_class.geo_matrix_create)
   {
      return (HandleGeometryManager(w, request, reply, classPtr->bulletin_board_class.geo_matrix_create));
   }
   /* function shared with DrawingArea */
   return (_XmGMHandleGeometryManager((Widget)bb, w, request, reply, bb->bulletin_board.margin_width, bb->bulletin_board.margin_height, bb->bulletin_board.resize_policy, bb->bulletin_board.allow_overlap));
}
   ...
   XtWidgetGeometry *desired)
{
   ...
   /* function shared with DrawingArea */
   return (_XmGMHandleQueryGeometry(wid, intended, desired, bb->bulletin_board.margin_width, bb->bulletin_board.margin_height, bb->bulletin_board.resize_policy));
}
   ...
   if (BBHasFocus)
   {
      ...
      if (!BBHadFocus)
      {
         ...
         XtCallCallbackList((Widget)bb,
                            bb->bulletin_board.focus_callback,
                            &cb);
      }
   }
   ...
   XmParentProcessData event)
{
               ...
               && BB_DynamicCancelButton(bb))))
   {
      ...
      {
         _XmBulletinBoardReturn((Widget)bb, event->input_action.event, event->input_action.params, event->input_action.num_params);
      }
      else
      {
         _XmBulletinBoardCancel((Widget)bb, event->input_action.event, event->input_action.params, event->input_action.num_params);
      }
      return (TRUE);
   }
