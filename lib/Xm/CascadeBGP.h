...
typedef struct _XmCascadeButtonGadgetPart { /* resources */
...
#  define CBG_Submenu(cb) (((XmCascadeButtonGadget)cb)->cascade_button.submenu)
#  define CBG_ActivateCall(cb) (((XmCascadeButtonGadget)cb)->cascade_button.activate_callback)
#  define CBG_CascadeCall(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cascade_callback)
#  define CBG_Armed(cb) (((XmCascadeButtonGadget)cb)->cascade_button.armed)
#  define CBG_CascadeRect(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cascade_rect)
#  define CBG_Timer(cb) (((XmCascadeButtonGadget)cb)->cascade_button.timer)
#  define CBG_Cascade_x(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cascade_rect.x)
#  define CBG_Cascade_y(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cascade_rect.y)
#  define CBG_Cascade_width(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cascade_rect.width)
#  define CBG_Cascade_height(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cascade_rect.height)
#  define CBG_HasCascade(cb) \
    (((LabG_MenuType(cb) == XmMENU_PULLDOWN) || (LabG_MenuType(cb) == XmMENU_POPUP) || \
      (LabG_MenuType(cb) == XmMENU_OPTION)) && \
     (CBG_Submenu(cb)))
#  define XmCBG_ARMED_BIT (1 << 0)
#  define XmCBG_TRAVERSE_BIT (1 << 1)
#  define XmCBG_WAS_POSTED_BIT (1 << 2)
#  define CBG_IsArmed(cb) (((XmCascadeButtonGadget)(cb))->cascade_button.armed & XmCBG_ARMED_BIT)
#  define CBG_Traversing(cb) \
    (((XmCascadeButtonGadget)(cb))->cascade_button.armed & XmCBG_TRAVERSE_BIT)
#  define CBG_WasPosted(cb) \
    (((XmCascadeButtonGadget)(cb))->cascade_button.armed & XmCBG_WAS_POSTED_BIT)
#  define CBG_SetBit(byte, bit, v) byte = (byte & (~bit)) | (v ? bit : 0)
#  define CBG_SetArmed(cb, v) \
    CBG_SetBit(((XmCascadeButtonGadget)(cb))->cascade_button.armed, XmCBG_ARMED_BIT, v)
#  define CBG_SetTraverse(cb, v) \
    CBG_SetBit(((XmCascadeButtonGadget)(cb))->cascade_button.armed, XmCBG_TRAVERSE_BIT, v)
#  define CBG_SetWasPosted(cb, v) \
    CBG_SetBit(((XmCascadeButtonGadget)(cb))->cascade_button.armed, XmCBG_WAS_POSTED_BIT, v)
/* Access macro definitions  for Cached fields*/
#  define CBG_CascadePixmap(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cache->cascade_pixmap)
#  define CBG_MapDelay(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cache->map_delay)
#  define CBG_ArmedPixmap(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cache->armed_pixmap)
#  define CBG_ArmGC(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cache->arm_gc)
#  define CBG_BackgroundGC(cb) (((XmCascadeButtonGadget)cb)->cascade_button.cache->background_gc)
/******************************/
/* Convenience Macros         */
/******************************/
#  define CBG_Cache(w) (((XmCascadeButtonGadget)(w))->cascade_button.cache)
