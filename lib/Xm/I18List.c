...
XmMultiListRowInfo *XmI18ListFindRow(Widget w, String str, int *found_column, Boolean reset, Boolean do_visual);
...
static Boolean  Search(XmI18ListWidget ilist, XmString xms, int start_row, int start_column, int *found_row, int *found_column);
...
static void     SelectItems(XmI18ListWidget, XmString, int, Boolean, Boolean);
 ...
 */
static char         defaultTranslations[] = "~Ctrl ~Shift <Btn1Down>:		ButtonDown()\n\
...
/* ARGSUSED */
static void
SetEntryBackground(Widget w, int offset, XrmValue *value)
{
...
static XtResource resources[] = {
   { XmNnumColumns,              XmCNumColumns,         XmRShort,           sizeof(short),               XtOffsetOf(XmI18ListRec, ilist.num_columns),            XmRImmediate, (XtPointer)0                                 },
   { XmNnumRows,                 XmCNumRows,            XmRShort,           sizeof(short),               XtOffsetOf(XmI18ListRec, ilist.num_rows),               XmRImmediate, (XtPointer)0                                 },
   { XmNselectedColumn,          XmCSelectedColumn,     XmRShort,           sizeof(short),               XtOffsetOf(XmI18ListRec, ilist.selected_header),        XmRImmediate, (XtPointer)0                                 },
   { XmNcolumnTitles,            XmCColumnTitles,       XmRXmStringTable,   sizeof(XmString *),          XtOffsetOf(XmI18ListRec, ilist.column_titles),          XmRImmediate, (XtPointer)NULL                              },
   { XmNentryData,               XmCEntryData,          XmRPointer,         sizeof(XtPointer),           XtOffsetOf(XmI18ListRec, ilist.row_data),               XmRImmediate, (XtPointer)NULL                              },
   { XmNfirstColumnPixmaps,      XmCFirstColumnPixmaps, XmRBoolean,         sizeof(Boolean),             XtOffsetOf(XmI18ListRec, ilist.first_col_pixmaps),      XmRImmediate, (XtPointer)False                             },
   { "pri.vate",                 "Pri.vate",            XmRBoolean,         sizeof(Boolean),             XtOffsetOf(XmI18ListRec, ilist.check_set_render_table), XmRImmediate, (XtPointer)False                             },
   { XmNfontList,                XmCFontList,           XmRFontList,        sizeof(XmFontList),          XtOffsetOf(XmI18ListRec, ilist.font_list),              XmRCallProc,  (XtPointer)CheckSetRenderTable               },
   { XmNrenderTable,             XmCRenderTable,        XmRRenderTable,     sizeof(XmRenderTable),       XtOffsetOf(XmI18ListRec, ilist.font_list),              XmRCallProc,  (XtPointer)CheckSetRenderTable               },
   { XmNverticalScrollBar,       XmCScrollBar,          XmRWidget,          sizeof(Widget),              XtOffsetOf(XmI18ListRec, ilist.v_bar),                  XmRImmediate, (XtPointer)NULL                              },
   { XmNhorizontalScrollBar,     XmCScrollBar,          XmRWidget,          sizeof(Widget),              XtOffsetOf(XmI18ListRec, ilist.h_bar),                  XmRImmediate, (XtPointer)NULL                              },
   { XmNfirstRow,                XmCFirstLocation,      XmRShort,           sizeof(short),               XtOffsetOf(XmI18ListRec, ilist.first_row),              XmRImmediate, (XtPointer)0                                 },
   { XmNfirstColumn,             XmCFirstLocation,      XmRShort,           sizeof(short),               XtOffsetOf(XmI18ListRec, ilist.first_col),              XmRImmediate, (XtPointer)0                                 },
   { XmNdoubleClickCallback,     XmCCallback,           XmRCallback,        sizeof(XtCallbackList),      XtOffsetOf(XmI18ListRec, ilist.double_click),           XmRImmediate, (XtPointer)NULL                              },
   { XmNsortFunctions,           XmCFunction,           XmRFunction,        sizeof(Xm18SortFunction **), XtOffsetOf(XmI18ListRec, ilist.sort_functions),         XmRImmediate, (XtPointer)NULL                              },
   { XmNselectionPolicy,         XmCSelectionPolicy,    XmRSelectionPolicy, sizeof(unsigned char),       XtOffsetOf(XmI18ListRec, ilist.selection_policy),       XmRImmediate, (XtPointer)XmEXTENDED_SELECT                 },
   { XmNsingleSelectionCallback, XmCCallback,           XmRCallback,        sizeof(XtCallbackList),      XtOffsetOf(XmI18ListRec, ilist.single_select),          XmRImmediate, (XtPointer)NULL                              },
   { XmNalignment,               XmCAlignment,          XmRAlignment,       sizeof(unsigned char),       XtOffsetOf(XmI18ListRec, ilist.alignment),              XmRImmediate, (XtPointer)XmALIGNMENT_BEGINNING             },
   { XmNstringDirection,         XmCStringDirection,    XmRStringDirection, sizeof(unsigned char),       XtOffsetOf(XmI18ListRec, ilist.string_direction),       XmRImmediate, (XtPointer)XmDEFAULT_DIRECTION               },
   { XmNvisibleItemCount,        XmCVisibleItemCount,   XmRInt,             sizeof(int),                 XtOffsetOf(XmI18ListRec, ilist.visible_rows),           XmRImmediate, (XtPointer)XmMultiList_DEFAULT_VISIBLE_COUNT },
   { XmNnewVisualStyle,          XmCNewVisualStyle,     XmRBoolean,         sizeof(Boolean),             XtOffsetOf(XmI18ListRec, ilist.new_visual_style),       XmRImmediate, (XtPointer)True                              },
   /* process this first; set the value to True */
   {
    "is.entry.background.set",
    "I.Really.Wonder",
    XtRBoolean,
    sizeof(Boolean),
    XtOffsetOf(XmI18ListRec,                                                                                                      ilist.entry_background_use),
    XmRImmediate,
    (XtPointer)True                                                                                                                                                                                                         },
   ...
   /* XmNentryBackground currently UNDOCUMENTED */
   {
    ...
    XtRPixel,
    sizeof(Pixel),
    XtOffsetOf(XmI18ListRec,                                                                                                      ilist.entry_background_pixel),
    XmRCallProc,
    (XtPointer)SetEntryBackground                                                                                                                                                                                           }
};
...
Initialize(Widget req, Widget set, ArgList args, Cardinal *num_args)
{
   ...
   {
      XtAddCallback(XmI18List_v_bar(ilist), XmNvalueChangedCallback, VScrollCallback, (XtPointer)set);
      XtAddCallback(XmI18List_v_bar(ilist), XmNdragCallback, VScrollCallback, (XtPointer)set);
   }
   if (XmI18List_h_bar(ilist) != NULL)
   {
      XtAddCallback(XmI18List_h_bar(ilist), XmNvalueChangedCallback, HScrollCallback, (XtPointer)set);
      XtAddCallback(XmI18List_h_bar(ilist), XmNdragCallback, HScrollCallback, (XtPointer)set);
   }
   /*
     * Add the callbacks to handle left and right arrow selection
     */
   if (XmI18List_h_bar(ilist) != NULL)
      XtAddCallback(XmI18List_h_bar(ilist), XmNdecrementCallback, HSlideLeftArrowCallback, (XtPointer)set);
   if (XmI18List_h_bar(ilist) != NULL)
      XtAddCallback(XmI18List_h_bar(ilist), XmNincrementCallback, HSlideRightArrowCallback, (XtPointer)set);
   if (XtHeight(req) == 0)
   {
   ...
   */
   ...
   {
      XmI18List_string_direction(ilist) = XmDirectionToStringDirection(XmPrim_layout_direction(ilist));
   }
   else if (XmI18List_string_direction(ilist) != XmDEFAULT_DIRECTION)
   {
      XmPrim_layout_direction(ilist) = XmStringDirectionToDirection(XmI18List_string_direction(ilist));
   }
   else
   {
...
SetValues(Widget current, Widget request, Widget set, ArgList args, Cardinal *num_args)
{
   ...
   if ((XmI18List_v_bar(i_set) != XmI18List_v_bar(i_old)) || (XmI18List_h_bar(i_set) != XmI18List_h_bar(i_old)))
   {
   ...
   if ((i_set->primitive.foreground != i_old->primitive.foreground) || (i_set->core.background_pixel != i_old->core.background_pixel))
   {
   ...
   /*
     ...
     */
   if (XmI18List_row_data(i_set) != NULL || XmI18List_row_data(i_old) != NULL)
   {
#ifdef UNUSED_CODE
      short column;
...
#endif
      if ((XmI18List_num_rows(i_old) != XmI18List_num_rows(i_set)) || (XmI18List_num_columns(i_old) != XmI18List_num_columns(i_set)) || (XmI18List_row_data(i_set) != XmI18List_row_data(i_old)))
      {
         redisplay = recalculate = XtIsRealized(set);
      }
      if ((XmI18List_first_col(i_set) != XmI18List_first_col(i_old)) || (XmI18List_first_row(i_set) != XmI18List_first_row(i_old)) || check_pos)
      {
         redisplay = readjust = XtIsRealized(set);
      }
   }
   if (XmI18List_entry_background_pixel(i_set) != XmI18List_entry_background_pixel(i_old))
   {
...
ButtonDownAction(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   ...
   if (event->type != ButtonPress)
   {
      ...
      _XmWarningMsg(w, XmNunexpectedEvent, XmNunexpectedEventMsg, _params, 1);
      return;
   }
...
/*ARGSUSED*/
static void
ButtonUpOrLeaveAction(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   Boolean         notify_type;
   XmI18ListWidget ilist = (XmI18ListWidget)w;
   ...
   /*
     ...
     */
   if ((XmI18List_working_col(ilist) >= XmI18List_num_columns(ilist)) || (XmI18List_working_row(ilist) >= XmI18List_num_rows(ilist)))
   {
      return;
   }
   /*
     ...
     */
   notify_type = ((event->xbutton.time - XmI18List_time(ilist)) <= XtGetMultiClickTime(XtDisplay(w)));
...
MotionAction(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   ...
   /*
     ...
     * do nothing.
     */
   if ((row == XmI18List_working_row(ilist)) || (XmI18List_working_row(ilist) == IN_COLUMN_HEADER))
   {
      return;
   }
   /*
   ...
   if (!(XmI18List_state(ilist) & OUTSIDE_WIDGET))
   { /* Not outside widget.*/
...
Notify(Widget w, Boolean dclick)
{
   ...
   if (row == IN_COLUMN_HEADER)
      return;
   if ((row < XmI18List_num_rows(ilist)) && (XmI18List_working_col(ilist) < XmI18List_num_columns(ilist)))
   {
...
VScrollCallback(Widget w, XtPointer client_data, XtPointer call_data)
{
   ...
   VScroll((Widget)ilist, (short)(scroll_info->value - XmI18List_first_row(ilist)));
}
...
HSlideLeftArrowCallback(Widget w, XtPointer client_data, XtPointer junk)
{
   ...
   DisplayList((Widget)ilist, XmI18List_first_row(ilist), (XmI18List_num_rows(ilist) - XmI18List_first_row(ilist)), TRUE);
...
HSlideRightArrowCallback(Widget w, XtPointer client_data, XtPointer junk)
{
   ...
   if ((int)width > (int)(i + ilist->core.width))
   {
      ...
      for (i = 0; i < XmI18List_num_columns(ilist); i++)
      {
         ...
         if ((begin < 0 && end > 0) || (begin >= 0 && i < XmI18List_num_columns(ilist)))
         {
            /*
...
CalcLocations(Widget w)
{
   ...
   if (XmI18List_num_columns(ilist) && XmI18List_column_titles(ilist)) /* CR03506 */
      ...
      XmI18List_sep_y(ilist) = 0; /* CR03506 */
   if (XmI18List_new_visual_style(ilist))
...
DisplayList(Widget w, short start_row, short num_rows, Boolean redraw_headers)
{
   ...
   /*
     ...
     */
   cur_y = (XmI18List_sep_y(ilist) + VERTICAL_SPACE / 2 + (start_row - XmI18List_first_row(ilist)) * row_height);
   if (XmI18List_new_visual_style(ilist))
   {
   ...
   if (XmI18List_entry_background_use(ilist))
   {
      if (XmI18List_new_visual_style(ilist))
         ...
         height -= LINE_HEIGHT;
      XFillRectangle(XtDisplay(w), XtWindow(w), XmI18List_entry_background_fill_gc(ilist), LayoutIsRtoLP(w) ? -tot_width + XtWidth(w) - XmI18List_left_loc(ilist) + HORIZONTAL_SPACE / 2 : XmI18List_left_loc(ilist) - HORIZONTAL_SPACE / 2, cur_y,
...
#undef MaX
   ...
   for (i = start_row; i <= end_row; i++)
   {
      ...
      {
         XFillRectangle(XtDisplay(w), XtWindow(w), XmI18List_gc(ilist), LayoutIsRtoLP(w) ? -tot_width + XtWidth(w) - XmI18List_left_loc(ilist) + HORIZONTAL_SPACE / 2 : XmI18List_left_loc(ilist) - HORIZONTAL_SPACE / 2, cur_y, (unsigned int)tot_width, (unsigned int)row_height);
      }
      cur_y += row_height;
   }
   start_y = ((XmI18List_sep_y(ilist) + VERTICAL_SPACE) + (start_row - XmI18List_first_row(ilist)) * row_height);
   if (XmI18List_new_visual_style(ilist))
   {
   ...
   for (i = 0; i < XmI18List_num_columns(ilist); i++)
   {
      ...
      if (redraw_headers)
      {
	     ...
	     */
         if ((XmI18List_selected_header(ilist) == i) && (XmI18List_sort_functions(ilist) != NULL))
         {
            if (XtIsSensitive(w))
            ...
            XFillRectangle(XtDisplay(w), XtWindow(w), XmI18List_gc(ilist), x_loc, y_loc, (unsigned int)col_widths[i] + HORIZONTAL_SPACE, (unsigned int)title_row_height);
         }
         else
         {
            if (XtIsSensitive(w))
         ...
         if (XmI18List_column_titles(ilist) != NULL)
         {
            ...
            if (XmI18List_new_visual_style(ilist))
               cur_y += ilist->primitive.shadow_thickness;
            XmStringDraw(XtDisplay(w), XtWindow(w), XmI18List_font_list(ilist), ptr, gc, cur_x, cur_y, col_widths[i], XmI18List_alignment(ilist), XmPrim_layout_direction(ilist), NULL);
         }
      }
      /*
	 ...
	 */
      if ((XmI18List_first_col_pixmaps(ilist)) && (i == 0))
      {
         ...
         for (j = start_row; j <= end_row; j++)
         {
		     ...
		     * Copy it in.
		     */
               pix_y_offset = (row_height - XmI18List_row_data(ilist)[j].pix_height) / 2;
               if (XmI18List_row_data(ilist)[j].pix_depth == 1)
               {
                  XCopyPlane(XtDisplay(w), XmI18List_row_data(ilist)[j].pixmap, XtWindow(w), entry_gc, 0, 0, XmI18List_row_data(ilist)[j].pix_width, XmI18List_row_data(ilist)[j].pix_height, LayoutIsRtoLP(w) ? width - XmI18List_left_loc(ilist) - XmI18List_row_data(ilist)[j].pix_width : cur_x, cur_y + pix_y_offset, (unsigned long)1);
               }
               else
               {
                  XCopyArea(XtDisplay(w), XmI18List_row_data(ilist)[j].pixmap, XtWindow(w), entry_gc, 0, 0, XmI18List_row_data(ilist)[j].pix_width, XmI18List_row_data(ilist)[j].pix_height, LayoutIsRtoLP(w) ? width - XmI18List_left_loc(ilist) - XmI18List_row_data(ilist)[j].pix_width : cur_x, cur_y + pix_y_offset);
               }
            }
            cur_y += row_height;
            if (cur_y > (int)height)
      ...
      else
      {
	     ...
	     */
         ...
         for (j = start_row; j <= end_row; j++)
         {
            ...
            XmStringExtent(XmI18List_font_list(ilist), ptr, &width_unused, &text_height);
            /* to center each string within its row */
            cur_y += (int)(XmI18List_row_height(ilist) - VERTICAL_SPACE - text_height) / 2;
            XmStringDraw(XtDisplay(w), XtWindow(w), XmI18List_font_list(ilist), ptr, entry_gc, cur_x, cur_y, col_widths[i], XmI18List_alignment(ilist), XmPrim_layout_direction(ilist), NULL);
            cur_y -= (int)(XmI18List_row_height(ilist) - VERTICAL_SPACE - text_height) / 2;
...
DrawSeparator(Widget w)
{
   ...
   if (XmI18List_new_visual_style(ilist))
   {
      XmeDrawShadows(XtDisplay(w), XtWindow(w), ilist->primitive.top_shadow_GC, ilist->primitive.bottom_shadow_GC, 0, 0, width, height + ilist->primitive.shadow_thickness, ilist->primitive.shadow_thickness, XmSHADOW_OUT);
   }
   else
   {
      if (XtIsSensitive(w))
         ...
         gc = XmI18List_stippled_gc(ilist);
      XFillRectangle(XtDisplay(w), XtWindow(w), gc, 0, XmI18List_sep_y(ilist), width, LINE_HEIGHT);
   }
}
...
CreateGCs(Widget w)
{
   ...
   stipple = XCreateBitmapFromData(XtDisplay(w),
                                   ...
                                   gray_width,
                                   gray_height);
   XtSetArg(args[num_args], XmNforeground, &(values.foreground));
   num_args++;
   XtSetArg(args[num_args], XmNbackground, &(values.background));
   num_args++;
...
GetPixmapInfo(Widget w)
{
   ...
   for (i = 0; i < num_rows; i++)
   {
      ...
      {
         XGetGeometry(XtDisplay(w), XmI18List_row_data(ilist)[i].pixmap, &root, &x, &y, &width, &height, &bw, &depth);
      }
...
SetVisibleSize(Widget w, Boolean set_width)
{
   ...
   title_height = 2 * VERTICAL_SPACE + XmI18List_title_row_height(ilist);
   if (XmI18List_new_visual_style(ilist))
   ...
   if (XmI18List_num_rows(ilist) == 0)
   {
      ...
      XmeRenderTableGetDefaultFont(XmI18List_font_list(ilist), &font);
      if (font)
         height = (font->ascent + font->descent + VERTICAL_SPACE) * XmI18List_visible_rows(ilist);
      else
         height = VERTICAL_SPACE * XmI18List_visible_rows(ilist);
#endif
   }
   ...
   {
      height = (XmI18List_row_height(ilist) + VERTICAL_SPACE) * XmI18List_visible_rows(ilist);
   }
...
CalcColumnInfo(Widget w, Boolean force)
{
   ...
   for (i = 0; i < num_cols; i++)
   {
      ...
      if (XmI18List_first_col_pixmaps(ilist) && (i == 0))
      {
         ...
         {
            if ((int)(height = XmI18List_row_data(ilist)[j].pix_height) > (int)max_height)
               max_height = height;
            if ((int)(width = XmI18List_row_data(ilist)[j].pix_width) > (int)max_width)
               max_width = width;
         }
      }
      else
   ...
   if (XmI18List_num_columns(ilist) && XmI18List_column_titles(ilist)) /* CR03506 */
      ...
      XmI18List_title_row_height(ilist) = 0; /* CR03506 */
}
...
ResizeSliders(Widget w)
{
   ...
   if (((col_width + HORIZONTAL_SPACE) != 0) && (XmI18List_h_bar(ilist) != NULL))
   {
      /*
      ...
      if (slide_pos > (max_width - slide_size))
         slide_pos = max_width - slide_size;
      XtSetArg(args[num_args], XmNvalue, slide_pos);
      num_args++;
      XtSetArg(args[num_args], XmNmaximum, max_width);
      num_args++;
      XtSetArg(args[num_args], XmNsliderSize, slide_size);
      num_args++;
      XtSetArg(args[num_args], XmNpageIncrement, slide_size);
      num_args++;
      XtSetValues(XmI18List_h_bar(ilist), args, num_args);
   }
   height = ilist->core.height - (2 * VERTICAL_SPACE + XmI18List_title_row_height(ilist));
   if (XmI18List_new_visual_style(ilist))
      height -= ilist->primitive.shadow_thickness;
   else
      height -= LINE_HEIGHT;
   if ((height > 0) && (XmI18List_v_bar(ilist) != NULL))
   {
      ...
      if (slide_pos < min)
         slide_pos = min;
      num_args = 0;
      XtSetArg(args[num_args], XmNminimum, min);
      num_args++;
      XtSetArg(args[num_args], XmNvalue, slide_pos);
      num_args++;
      XtSetArg(args[num_args], XmNmaximum, max_width);
...
VScroll(Widget w, short amount)
{
   ...
   if (XmI18List_new_visual_style(ilist))
      ...
      y_start += LINE_HEIGHT;
   XClearArea(XtDisplay(w), XtWindow(w), 0, y_start, (unsigned int)0, (unsigned int)0, FALSE);
   num_rows = XmI18List_num_rows(ilist) - XmI18List_first_row(ilist);
   DisplayList(w, XmI18List_first_row(ilist), num_rows, TRUE);
}
...
HScroll(Widget w, short amount)
{
   ...
   if (XmI18List_new_visual_style(ilist))
      ...
      y_start += LINE_HEIGHT;
   XClearArea(XtDisplay(w), XtWindow(w), 0, 0, (unsigned int)0, title_height, FALSE);
   XClearArea(XtDisplay(w), XtWindow(w), 0, y_start, (unsigned int)0, (unsigned int)0, FALSE);
   num_rows = XmI18List_num_rows(ilist) - XmI18List_first_row(ilist);
   DisplayList(w, XmI18List_first_row(ilist), num_rows, TRUE);
}
...
CvtPositionToRowColumn(Widget w, short x, short y, short *row, short *column)
{
   ...
   else
   {
      ...
      *row = XmI18List_first_row(ilist) + y / (XmI18List_row_height(ilist) + VERTICAL_SPACE);
   }
...
CvtRowColumnToPosition(Widget w, short row, short column, short *x, short *y)
{
   ...
   {
      *y = (XmI18List_sep_y(ilist) + title_extra + (row - XmI18List_first_row(ilist)) * (XmI18List_row_height(ilist) + VERTICAL_SPACE) + VERTICAL_SPACE / 2);
   }
...
{
   XmI18ListWidget ilist = (XmI18ListWidget)w;
   if ((XmI18List_selected_header(ilist) == column) || (XmI18List_sort_functions(ilist) == NULL))
   {
      return;
   }
...
QSortTest(const void *row1, const void *row2)
{
   ...
   return ((*sort_f)(col, (XmMultiListRowInfo *)row1, (XmMultiListRowInfo *)row2));
}
...
InvertArea(Widget w, short row, short column)
{
   ...
   XFillRectangle(XtDisplay(w), XtWindow(w), gc_to_use, (int)x, (int)y, width, height);
   if ((XmI18List_first_col_pixmaps(ilist)) && (XmI18List_row_data(ilist)[row].pix_depth != 1) && IsValidPixmap(XmI18List_row_data(ilist)[row].pixmap))
   {
      pix_y_offset = (height - XmI18List_row_data(ilist)[row].pix_height) / 2;
      XCopyArea(XtDisplay(w), XmI18List_row_data(ilist)[row].pixmap, XtWindow(w), XmI18List_entry_background_gc(ilist), 0, 0, XmI18List_row_data(ilist)[row].pix_width, XmI18List_row_data(ilist)[row].pix_height, LayoutIsRtoLP(w) ? XtWidth(ilist) - XmI18List_left_loc(ilist) - XmI18List_row_data(ilist)[row].pix_height : XmI18List_left_loc(ilist), y + pix_y_offset);
   }
}
...
IsRowVisible(Widget w, short row)
{
   ...
   CvtPositionToRowColumn((Widget)w, 0, (short)(ilist->core.height + 1), &r_row, &r_col);
   if (row >= r_row)
      return (row - r_row + 1);
   return (0);
}
...
AdjustFirstRowAndCol(XmI18ListWidget ilist)
{
   ...
   {
      new_left_loc -= (XmI18List_column_widths(ilist)[j] + HORIZONTAL_SPACE);
   }
   ...
   else if (new_left_loc < (int)((int)ilist->core.width - (int)total_width))
   {
      XmI18List_left_loc(ilist) = (int)((int)ilist->core.width - (int)total_width);
   }
   else
      XmI18List_left_loc(ilist) = new_left_loc;
   height          = ilist->core.height - (2 * VERTICAL_SPACE + XmI18List_title_row_height(ilist) + title_extra);
   rows_per_screen = (int)height / (int)(XmI18List_row_height(ilist) + VERTICAL_SPACE);
   if (XmI18List_num_rows(ilist) < rows_per_screen)
   {
      XmI18List_first_row(ilist) = 0;
   }
   else if (XmI18List_first_row(ilist) > (XmI18List_num_rows(ilist) - rows_per_screen))
   {
...
MakePositionVisible(Widget w, short row, short start, short last, int width)
{
   ...
   else if (start >= before && start <= width)
   {
      ...
      if (move != 0)
         AdjustVisiblePosition((Widget)ilist, move, True, (width - (before + ilist->core.width)));
      return (TRUE);
   }
   return (FALSE);
}
...
XmI18ListDoSearch(Widget w, String str, Boolean reset)
{
   ...
   foundit = Search(ilist, xms, first_selected_row, search_column, &found_row, &found_column);
   if (foundit)
   {
 ...
 */
XmMultiListRowInfo *
XmI18ListFindRow(Widget w, String str, int *found_column, Boolean reset, Boolean do_visual)
{
   XmI18ListWidget     ilist = (XmI18ListWidget)w;
   XmMultiListRowInfo *ptr   = XmI18List_row_data(ilist);
   Boolean             foundit;
...
static Boolean
Search(XmI18ListWidget ilist, XmString xms, int start_row, int start_column, int *found_row, int *found_column)
{
   int      row, column;
   XmString value;
   /*
 ...
 */
static void
SelectRow(XmI18ListWidget i18list, int row, Boolean select, Boolean notify)
{
 ...
 */
static void
SelectItems(XmI18ListWidget i18list, XmString item, int column, Boolean select, Boolean notify)
{
   XmMultiListRowInfo *rows = XmI18List_row_data(i18list);
   int                 i, j;
   ...
   for (i = 0; i < rowcount; i++)
      for (j = colstart; j < colcount; j++)
	     ...
	     */
         if ((((column == XmANY_COLUMN) || (column == j)) && XmStringCompare(item, rows[i].values[j])) || !item)
         {
            ...
            Cardinal *num_params) /* unused */
{
   ...
   else if (row == -2 && lw->ilist.column_titles)
   { /* drag column header */
      ListDragConv->strings    = (XmString *)XtMalloc(sizeof(XmString));
      ListDragConv->num_items  = 1;
