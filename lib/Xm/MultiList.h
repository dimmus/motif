...
typedef int (*Xm18SortFunction)(short, const XmMultiListRowInfo *, const XmMultiListRowInfo *);
/************************************************************
 *	GLOBAL DECLARATIONS
 *************************************************************/
/*
 ...
 *  Returns:       none
 */
extern void XmMultiListSelectItems(Widget w, XmString item, int column, Boolean notify);
 ...
 *  Returns:       none
 */
extern void XmMultiListDeselectItems(Widget w, XmString item, int column);
