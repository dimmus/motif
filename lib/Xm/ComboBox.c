...
/* From GrabShell.c */
#define Events (EnterWindowMask | LeaveWindowMask | ButtonPressMask | ButtonReleaseMask)
...
#define POPUP_EVENT_MASK (EnterWindowMask | ButtonPressMask | ButtonReleaseMask)
...
#define CBS_SelectedPosition(w) (((XmComboBoxWidget)(w))->combo_box.selected_position)
#define CBS_VisibleItemCount(w) (((XmComboBoxWidget)(w))->combo_box.visible_item_count)
#define Offset(field) XtOffsetOf(XmComboBoxRec, field)
static XtResource resources[] = {{XmNarrowSize,
                                  XmCArrowSize,
                                  XmRHorizontalDimension,
                                  sizeof(Dimension),
                                  Offset(combo_box.arrow_size),
                                  XmRImmediate,
                                 ...
                                 {XmNarrowSpacing,
                                  ...
                                  XmRHorizontalDimension,
                                  sizeof(Dimension),
                                  Offset(combo_box.arrow_spacing),
                                  XmRImmediate,
                                  (XtPointer)XmINVALID_DIMENSION},
                                 ...
                                 {XmNmarginHeight,
                                  ...
                                  sizeof(Dimension),
                                  Offset(combo_box.margin_height),
                                  XmRImmediate,
                                  (XtPointer)DEFAULT_MARGINHEIGHT},
                                 {XmNmarginWidth,
                                  XmCMarginWidth,
                                  XmRHorizontalDimension,
                                  sizeof(Dimension),
                                  Offset(combo_box.margin_width),
                                  XmRImmediate,
                                  (XtPointer)DEFAULT_MARGINWIDTH},
                                 {XmNmatchBehavior,
                                  XmCMatchBehavior,
                                  XmRMatchBehavior,
                                  sizeof(unsigned char),
                                  Offset(combo_box.match_behavior),
                                  XmRImmediate,
                                  (XtPointer)XmINVALID_MATCH_BEHAVIOR},
                                 {XmNnavigationType,
                                  XmCNavigationType,
                                  XmRNavigationType,
                                  sizeof(unsigned char),
                                  Offset(manager.navigation_type),
                                  XmRImmediate,
                                 ...
                                 {XmNselectionCallback,
                                  ...
                                  Offset(combo_box.selection_callback),
                                  XmRCallback,
                                  NULL},
                                 {XmNselectedItem,
                                  XmCSelectedItem,
                                  XmRXmString,
                                  sizeof(XmString),
                                  Offset(combo_box.selected_item),
                                  XmRImmediate,
                                  (XtPointer)NULL},
                                 {XmNselectedPosition,
                                  XmCSelectedPosition,
                                  XmRInt,
                                  sizeof(int),
                                  Offset(combo_box.selected_position),
                                  XmRImmediate,
                                  (XtPointer)XmINVALID_POSITION},
                                 {XmNshadowThickness,
                                  XmCShadowThickness,
                                  XmRHorizontalDimension,
                                  sizeof(Dimension),
                                 ...
                                 {XmNitems,
                                  ...
                                  Offset(combo_box.items),
                                  XmRImmediate,
                                  (XtPointer)XmUNSPECIFIED_ITEMS},
                                 {XmNitemCount,
                                  XmCItemCount,
                                  XmRInt,
                                  sizeof(int),
                                  Offset(combo_box.item_count),
                                  XmRImmediate,
                                 ...
                                 {XmNvisibleItemCount,
                                  ...
                                  XmRInt,
                                  sizeof(int),
                                  Offset(combo_box.visible_item_count),
                                  XmRImmediate,
                                  (XtPointer)10},
                                 {XmNcolumns,
                                  XmCColumns,
                                  XmRShort,
                                  sizeof(short),
                                  Offset(combo_box.columns),
                                  XmRImmediate,
                                  (XtPointer)XmUNSPECIFIED_COLUMNS},
                                 {XmNpositionMode,
                                  XmCPositionMode,
                                  XmRPositionMode,
                                  sizeof(XtEnum),
                                  Offset(combo_box.position_mode),
                                  XmRImmediate,
...
static XtActionsRec actionsList[] = {{"CBArmAndDropDownList", CBArmAndDropDownList},
                                     {"CBDisarm", CBDisarm},
...
externaldef(xmcomboboxwidgetclass)
 ...
 */
static void Initialize(Widget request, /* unused */
                       Widget new_w,
                       ArgList args,
                       Cardinal *num_args)
{
  ...
  if (!XmRepTypeValidValue(XmRID_POSITION_MODE, CB_PositionMode(newcb), (Widget)newcb)) {
                         ...
                         Cardinal *num_args) /* unused */
{
  ...
  if (CB_MatchBehavior(curcb) != CB_MatchBehavior(newcb)) {
    if (CB_Type(curcb) != XmDROP_DOWN_LIST && CB_MatchBehavior(newcb) == XmQUICK_NAVIGATE) {
      ...
      XtSetArg(list_args[nlist], XmNmatchBehavior, CB_MatchBehavior(newcb)), nlist++;
    }
  }
  /* Propagate XmNcolumns to the edit box. */
  if (CBS_Columns(newcb) != XmUNSPECIFIED_COLUMNS) {
    XtSetArg(editbox_args[neditbox], XmNcolumns, CBS_Columns(newcb)), neditbox++;
    CBS_Columns(newcb) = XmUNSPECIFIED_COLUMNS;
  ...
  if (XtBorderWidth(curcb) != XtBorderWidth(newcb)) {
    if (CB_Type(curcb) != XmCOMBO_BOX) {
      XtSetArg(shell_args[nshell], XmNborderWidth, XtBorderWidth(newcb)), nshell++;
      redisplay = TRUE;
    }
  }
  ...
  if (CB_RenderTable(curcb) != CB_RenderTable(newcb)) {
    if (CB_RenderTable(newcb) == NULL)
      CB_RenderTable(newcb) = XmeGetDefaultRenderTable(new_w, XmTEXT_FONTLIST);
    CB_RenderTable(newcb) = XmFontListCopy(CB_RenderTable(newcb));
    XtSetArg(editbox_args[neditbox], XmNrenderTable, CB_RenderTable(newcb)), neditbox++;
    XtSetArg(list_args[nlist], XmNrenderTable, CB_RenderTable(newcb)), nlist++;
  ...
  if ((curcb->manager.top_shadow_color != newcb->manager.top_shadow_color) ||
      (curcb->manager.top_shadow_pixmap != newcb->manager.top_shadow_pixmap) ||
      (curcb->manager.bottom_shadow_color != newcb->manager.bottom_shadow_color) ||
      (curcb->manager.bottom_shadow_pixmap != newcb->manager.bottom_shadow_pixmap))
  {
    if (CB_Type(curcb) != XmCOMBO_BOX) {
      XtSetArg(shell_args[nshell], XmNtopShadowColor, newcb->manager.top_shadow_color), nshell++;
      XtSetArg(shell_args[nshell], XmNbottomShadowColor, newcb->manager.bottom_shadow_color),
          nshell++;
      XtSetArg(shell_args[nshell], XmNtopShadowPixmap, newcb->manager.top_shadow_pixmap), nshell++;
      XtSetArg(shell_args[nshell], XmNbottomShadowPixmap, newcb->manager.bottom_shadow_pixmap),
          nshell++;
    }
  }
...
static void CheckMinimalSize(Widget widget, Dimension *pwidth, Dimension *pheight)
{
 ...
 */
static XtGeometryResult GeometryManager(Widget mychild,
                                        ...
                                        XtWidgetGeometry *reply)
{
  ...
  if (request->request_mode & CWWidth) {
    ...
    if (mychild == CB_EditBox(cb))
      ...
      if (width < cb->combo_box.ideal_ebwidth + 2 * (thickW + XtBorderWidth(CB_EditBox(cb)))) {
        width = cb->combo_box.ideal_ebwidth + 2 * (thickW + XtBorderWidth(CB_EditBox(cb)));
  ...
  if (width > 0)
    my_request.width = (Dimension)width;
  if (height > 0)
    my_request.height = (Dimension)height;
 ...
 */
static void Redisplay(Widget widget,
                      XEvent *event, /* unused */
 ...
 * ConstraintDestroy()
 */
static void ConstraintDestroy(Widget child)
{
  XmComboBoxWidget cb;
 ...
 */
static void TextChangedCB(Widget widget, /* unused */
 ...
 */
static void ListSelectionCB(Widget widget, /* unused */
                            XtPointer client_data,
                            XtPointer call_data)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)client_data;
  ...
  if (cb_data->event &&
      (cb_data->event->type == ButtonPress || cb_data->event->type == ButtonRelease))
  {
    if (CB_Type(cb) != XmCOMBO_BOX) {
 ...
 */
static void ShellPopupCB(Widget widget, /* unused */
                         XtPointer client_data,
                         XtPointer call_data) /* unused */
{
  XmComboBoxWidget cb = (XmComboBoxWidget)client_data;
 ...
 */
static void ShellPopdownCB(Widget widget, /* unused */
                           XtPointer client_data,
                           XtPointer call_data) /* unused */
{
  XmComboBoxWidget cb = (XmComboBoxWidget)client_data;
 ...
 */
static void FocusMovedCB(Widget widget, /* unused */
                         XtPointer client_data,
                         XtPointer call_data)
{
  ...
  getting_focus = (((callback->new_focus == NULL) && (CB_ShellState(cb) != POPPED_DOWN)) ||
                   ...
                   ((cb->combo_box.hsb != NULL) && (callback->new_focus == cb->combo_box.hsb)) ||
                   ((cb->combo_box.vsb != NULL) && (callback->new_focus == cb->combo_box.vsb)));
    ...
    if (CB_ShellState(cb) == POPPED_UP)
      getting_focus = TRUE;
             ...
             XQueryPointer(XtDisplay(cb),
                           ...
                           &win_y,
                           &mod_mask) &&
             (win_x >= 0) && (win_x < XtWidth(cb)) && (win_y >= 0) && (win_y < XtHeight(cb)))
      getting_focus = TRUE;
  }
 ...
 */
static void CBArmAndDropDownList(Widget widget,
                                 XEvent *event,
 ...
 */
static void CBDisarm(Widget widget,
                     XEvent *event,        /* unused */
                     String *params,       /* unused */
                     Cardinal *num_params) /* unused */
{
 ...
 */
static void CBDropDownList(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmComboBoxWidget cb = FindComboBox(widget);
  if (!cb) {
    XmeWarning((Widget)cb, WRONGWIDGET);
 ...
 */
static void CBFocusIn(Widget widget,
                      XEvent *event,        /* unused */
                      String *params,       /* unused */
                      Cardinal *num_params) /* unused */
{
 ...
 */
static void CBFocusOut(Widget widget,
                       XEvent *event,
                       String *params,       /* unused */
                       Cardinal *num_params) /* unused */
{
 ...
 */
static void CBTextFocusOut(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmComboBoxWidget cb = FindComboBox(widget);
  if (!cb) {
    XmeWarning((Widget)cb, WRONGWIDGET);
 ...
 */
static void CBActivate(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmComboBoxWidget cb = FindComboBox(widget);
 ...
 */
static void CBCancel(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmComboBoxWidget cb = FindComboBox(widget);
  XmParentInputActionRec p_event;
  if (!cb) {
 ...
 */
static void CBListAction(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  if (_XmConvertActionParamToRepTypeId(
          (Widget)cb, XmRID_COMBO_BOX_LIST_ACTION_ACTION_PARAMS, params[0], False, &direction) ==
      False)
  {
 ...
 */
static void PopupEH(Widget widget, /* unused */
                    XtPointer client_data,
                    XEvent *event,
                    Boolean *dispatch)
{
  ...
  switch (event->type) {
    ...
    case ButtonPress:
      ...
      if ((cb->combo_box.vsb && XtIsRealized(cb->combo_box.vsb) &&
           (event->xbutton.window == XtWindow(cb->combo_box.vsb))) ||
          (cb->combo_box.hsb && XtIsRealized(cb->combo_box.hsb) &&
 ...
 */
static void SBBtnDownEH(Widget w, XtPointer client_data, XEvent *event, Boolean *cont) /* unused */
{
  XmGrabShellWidget shell = (XmGrabShellWidget)client_data;
  XtGrabPointer(w,
                False,
                Events | PointerMotionMask | ButtonMotionMask,
                GrabModeAsync,
                GrabModeAsync,
                None,
                shell->grab_shell.cursor,
                event->xbutton.time);
}

static void SBBtnUpEH(Widget w, /* unused */
                      XtPointer client_data,
                      XEvent *event,
                      Boolean *cont) /* unused */
{
   ...
   */
  XtGrabPointer((Widget)shell,
                shell->grab_shell.owner_events,
                Events,
                shell->grab_shell.grab_style,
                GrabModeAsync,
                None,
                shell->grab_shell.cursor,
                event->xbutton.time);
 ...
 */
static XmComboBoxWidget FindComboBox(Widget widget)
{
  Widget cb = widget;
 ...
 */
static void CallSelectionCallbacks(Widget widget, XEvent *event)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 */
static XmImportOperator CBSetSelectedItem(Widget widget,
                                          int offset, /* unused */
                                          XtArgVal *value)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 */
static void CBGetSelectedItem(Widget widget,
                              int offset, /* unused */
                              XtArgVal *value)
{
 ...
 */
static XmImportOperator CBSetSelectedPos(Widget widget,
                                         int offset, /* unused */
                                         XtArgVal *value)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 *	A synthetic resource export procedure.
 */
static void CBGetSelectedPos(Widget widget,
                             int offset, /* unused */
                             XtArgVal *value)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 *	A synthetic resource export procedure.
 */
static void CBGetColumns(Widget widget,
                         int offset, /* unused */
                         XtArgVal *value)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 *	A synthetic resource export procedure.
 */
static void CBGetItems(Widget widget,
                       int offset, /* unused */
                       XtArgVal *value)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 *	A synthetic resource export procedure.
 */
static void CBGetItemCount(Widget widget,
                           int offset, /* unused */
                           XtArgVal *value)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 *	A synthetic resource export procedure.
 */
static void CBGetVisibleItemCount(Widget widget,
                                  int offset, /* unused */
                                  XtArgVal *value)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
...
static void HighlightBorder(Widget w)
{
  ...
  XmeDrawHighlight(XtDisplay(cb),
                   XtWindow(cb),
                   cb->manager.highlight_GC,
                   0,
                   0,
                   XtWidth(cb),
                   XtHeight(cb),
                   CB_HighlightThickness(cb));
}
 ...
 */
static void DoLayout(Widget widg)
{
  ...
  if (CB_Type(cb) != XmCOMBO_BOX) {
    ...
    if (XtWidth(cb) <= 2 * CB_HighlightThickness(cb))
      listW = 1;
    nargs = 0;
    ...
    htLeft = XtHeight(cb) -
             2 * (XtBorderWidth(CB_EditBox(cb)) + XtBorderWidth(CB_ScrolledW(cb)) +
                  CB_HighlightThickness(cb) + MGR_ShadowThickness(cb) + CB_MarginHeight(cb));
...
static void ComputeSize(
    Widget w, Dimension editW, Dimension editH, Dimension *width, Dimension *height)
{
 ...
 * GetIdealTextSize()
 */
static void GetIdealTextSize(Widget w, int *width, int *height)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)w;
 ...
 * GetDefaultArrowSize()
 */
static Dimension GetDefaultArrowSize(Widget w)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)w;
  if (!cb->combo_box.ideal_ebheight)
    GetIdealTextSize((Widget)cb, NULL, &cb->combo_box.ideal_ebheight);
 ...
 */
static void GetThickness(Widget widg, Dimension *width, Dimension *height)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widg;
  if (width)
  ...
  if (height)
    *height = cb->combo_box.margin_height + cb->combo_box.highlight_thickness +
              cb->manager.shadow_thickness;
}
 ...
 */
static void GetArrowGC(Widget widget)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
  XGCValues values;
  XtGCMask mask;
 ...
 * DrawArrow()
 */
static void DrawArrow(Widget widget, Boolean pressed)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
  ...
  max_height = XtHeight(cb) - 2 * (CB_MarginHeight(cb) + CB_HighlightThickness(cb) +
  ...
  w = h = newbox;
  XmeDrawArrow(XtDisplay(widget),
               XtWindow(widget),
               (pressed ? cb->manager.bottom_shadow_GC : cb->manager.top_shadow_GC),
               (pressed ? cb->manager.top_shadow_GC : cb->manager.bottom_shadow_GC),
               (XtIsSensitive(widget) ? cb->combo_box.arrow_GC : cb->manager.background_GC),
               x,
               y,
               w,
               h,
               cb->combo_box.arrow_shadow_width,
               XmARROW_DOWN);
  y += newbox;
  h = size - newbox;
  XmeDrawShadows(XtDisplay(widget),
                 XtWindow(widget),
 ...
 * DrawShadows()
 */
static void DrawShadows(Widget widget)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 */
static void CreateChildren(Widget widget, ArgList arglist, Cardinal *num_args)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
  Arg loc_args[10];
  Cardinal n_args;
  ...
  /* Create the list. */
  CB_List(cb) = CreateScrolledList(
      CB_ListShell(cb) ? CB_ListShell(cb) : widget, LIST_CHILD_NAME, widget, arglist, num_args);
  XtAddCallback(
      CB_List(cb), XmNbrowseSelectionCallback, (XtCallbackProc)ListSelectionCB, (XtPointer)cb);
  ...
  if (CB_Type(cb) != XmCOMBO_BOX) {
    ...
    if (sb != (Widget)NULL) {
      XtInsertEventHandler(
          sb, ButtonPressMask, False, SBBtnDownEH, (XtPointer)CB_ListShell(cb), XtListHead);
      XtInsertEventHandler(
          sb, ButtonReleaseMask, False, SBBtnUpEH, (XtPointer)CB_ListShell(cb), XtListHead);
    }
    sb = cb->combo_box.hsb;
    if (sb != (Widget)NULL) {
      XtInsertEventHandler(
 ...
 */
static Widget CreateEditBox(
    Widget parent, String name, Widget w, ArgList arglist, Cardinal *num_args)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)w;
  Widget text_widget;
  Arg loc_args[15];
 ...
 */
static Widget CreatePulldown(Widget parent,
                             String name,
                             Widget w, /* unused */
                             ArgList arglist,
                             Cardinal *num_args)
 ...
 */
static Boolean Hit(XButtonEvent *event, XRectangle r)
{
  if (event == NULL)
    return False;
  else
    return ((r.x <= event->x) && (event->x <= (r.x + r.width)) && (r.y <= event->y) &&
            (event->y <= (r.y + r.height)));
}
...
static XmString GetEditBoxValue(Widget cb)
{
  ...
  textTrait = (XmAccessTextualTrait)XmeTraitGet((XtPointer)XtClass(edit_box), XmQTaccessTextual);
  if (textTrait)
...
Widget XmCreateComboBox(Widget parent, char *name, ArgList args, Cardinal num_args)
{
  return XtCreateWidget(name, xmComboBoxWidgetClass, parent, args, num_args);
}

Widget XmCreateDropDownComboBox(Widget parent, char *name, ArgList args, Cardinal num_args)
{
  Arg loc_args[5];
  Cardinal n;
  ArgList merged_args;
...
Widget XmCreateDropDownList(Widget parent, char *name, ArgList args, Cardinal num_args)
{
  Arg loc_args[5];
  Cardinal n;
  ArgList merged_args;
...
Widget XmVaCreateComboBox(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmComboBoxWidgetClass, parent, False, var, count);
  va_end(var);
  return w;
}
...
Widget XmVaCreateManagedComboBox(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmComboBoxWidgetClass, parent, True, var, count);
  va_end(var);
  return w;
}
 ...
 */
void XmComboBoxAddItem(Widget widget, XmString item, int pos, Boolean unique)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
 ...
 */
void XmComboBoxDeletePos(Widget widget, int pos)
{
  XmComboBoxWidget cb = (XmComboBoxWidget)widget;
  int selpos;
  int nitems;
...
XmString XmCombinationBoxGetValue(Widget widget)
{
