...
typedef struct _XmToggleButtonGadgetPart {
  ...
  Boolean Armed;
  XtCallbackList value_changed_CB, arm_CB, disarm_CB;
...
#  define TBG_IndType(w) (((XmToggleButtonGadget)(w))->toggle.cache->ind_type)
#  define TBG_Visible(w) (((XmToggleButtonGadget)(w))->toggle.cache->visible)
#  define TBG_Spacing(w) (((XmToggleButtonGadget)(w))->toggle.cache->spacing)
#  define TBG_IndicatorDim(w) (((XmToggleButtonGadget)(w))->toggle.cache->indicator_dim)
#  define TBG_OnPixmap(w) (((XmToggleButtonGadget)(w))->toggle.cache->on_pixmap)
#  define TBG_InsenPixmap(w) (((XmToggleButtonGadget)(w))->toggle.cache->insen_pixmap)
#  define TBG_IndOn(w) (((XmToggleButtonGadget)(w))->toggle.cache->ind_on)
#  define TBG_FillOnSelect(w) (((XmToggleButtonGadget)(w))->toggle.cache->fill_on_select)
#  define TBG_ReversedSelect(w) (((XmToggleButtonGadget)(w))->toggle.cache->reversed_select)
#  define TBG_SelectColor(w) (((XmToggleButtonGadget)(w))->toggle.cache->select_color)
#  define TBG_SelectGC(w) (((XmToggleButtonGadget)(w))->toggle.cache->select_GC)
#  define TBG_BackgroundGC(w) (((XmToggleButtonGadget)(w))->toggle.cache->background_gc)
#  define TBG_ArmGC(w) (((XmToggleButtonGadget)(w))->toggle.cache->arm_GC)
#  define TBG_ToggleMode(w) (((XmToggleButtonGadget)(w))->toggle.cache->toggle_mode)
...
#  define TBG_IndeterminateInsensitivePixmap(w) \
    (((XmToggleButtonGadget)(w))->toggle.cache->indeterminate_insensitive_pixmap)
#  define TBG_IndeterminateGC(w) (((XmToggleButtonGadget)(w))->toggle.cache->indeterminate_GC)
#  define TBG_IndeterminateBoxGC(w) \
    (((XmToggleButtonGadget)(w))->toggle.cache->indeterminate_box_GC)
#  define TBG_UnselectColor(w) (((XmToggleButtonGadget)(w))->toggle.cache->unselect_color)
#  define TBG_UnselectGC(w) (((XmToggleButtonGadget)(w))->toggle.cache->unselect_GC)
#  define TBG_IndLeftDelta(w) (((XmToggleButtonGadget)(w))->toggle.cache->ind_left_delta)
#  define TBG_IndRightDelta(w) (((XmToggleButtonGadget)(w))->toggle.cache->ind_right_delta)
#  define TBG_IndTopDelta(w) (((XmToggleButtonGadget)(w))->toggle.cache->ind_top_delta)
#  define TBG_IndBottomDelta(w) (((XmToggleButtonGadget)(w))->toggle.cache->ind_bottom_delta)
/***************************************/
/* Macros for uncached instance fields */
#  define TBG_IndicatorSet(w) (((XmToggleButtonGadget)(w))->toggle.indicator_set)
#  define TBG_Set(w) (((XmToggleButtonGadget)(w))->toggle.set)
#  define TBG_VisualSet(w) (((XmToggleButtonGadget)(w))->toggle.visual_set)
#  define TBG_ValueChangedCB(w) (((XmToggleButtonGadget)(w))->toggle.value_changed_CB)
#  define TBG_ArmCB(w) (((XmToggleButtonGadget)(w))->toggle.arm_CB)
#  define TBG_DisarmCB(w) (((XmToggleButtonGadget)(w))->toggle.disarm_CB)
#  define TBG_Armed(w) (((XmToggleButtonGadget)(w))->toggle.Armed)
/******************************/
/* Convenience Macros         */
/******************************/
