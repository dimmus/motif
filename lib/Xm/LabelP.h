...
#  define Lab_IsPixmapAndText(w) (((XmLabelWidget)(w))->label.label_type == XmPIXMAP_AND_STRING)
...
#  define Lab_Baseline(w) \
    (_XmStringBaseline(((XmLabelWidget)(w))->label.font, ((XmLabelWidget)(w))->label._label))
#  define Lab_ComputingSize(w) (((XmLabelWidget)(w))->label.computing_size)
#  define Lab_IsMenupane(w) \
    ((Lab_MenuType(w) == XmMENU_POPUP) || (Lab_MenuType(w) == XmMENU_PULLDOWN))
#  ifdef __cplusplus
