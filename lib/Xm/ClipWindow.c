...
static void ActionGrab(Widget wid, XEvent *event, String *params, Cardinal *num_params);
...
externaldef(xmclipwindowwidgetclass)
    WidgetClass xmClipWindowWidgetClass = (WidgetClass)&xmClipWindowClassRec;
/************************************************************************
 *                                                                      *
...
static void ClassInitialize(void)
{
  ...
  XtRegisterGrabAction(
      ActionGrab, True, KeyPressMask | KeyReleaseMask, GrabModeAsync, GrabModeAsync);
...
static void Resize(Widget w)
{
  ...
  _XmProcessLock();
  resize = ((CoreWidgetClass)xmClipWindowClassRec.core_class.superclass)->core_class.resize;
  _XmProcessUnlock();
  (*resize)(w);
}
...
static void Redisplay(Widget wid, XEvent *event, Region region)
{
  ...
  _XmProcessLock();
  expose = ((CoreWidgetClass)xmClipWindowClassRec.core_class.superclass)->core_class.expose;
  _XmProcessUnlock();
...
static void DeleteChild(Widget child)
{
  ...
  _XmProcessLock();
  delete_child = ((CompositeWidgetClass)xmClipWindowClassRec.core_class.superclass)
