...
static Boolean          CheckPixCache(Display *, Pixmap, unsigned int *, unsigned int *, unsigned int *);
static void             AddPixCache(Display *, Pixmap, unsigned int, unsigned int, unsigned int);
 ...
 * Type Converters
 ******************/
static Boolean CvtStringToIconPlacement(Display *, XrmValuePtr, Cardinal *, XrmValuePtr, XrmValuePtr);
...
static char         defaultTranslations[] = "<Btn1Down>,<Btn1Up>:		XiToggle() XmNotify() XiButtonUp()\n\
 ...
 */
static char         traverseTranslations[] = "<Key>osfBeginLine: PrimitiveTraverseHome()\n\
...
static XtResource resources[] = {
   { XmNlabel,               XmCLabel,           XmRString,               sizeof(String),          XtOffsetOf(XmIconButtonRec, icon.label),                  XmRImmediate, (XtPointer)NULL                  },
   { XmNlabelString,         XmCLabelString,     XmRXmString,             sizeof(XmString),        XtOffsetOf(XmIconButtonRec, icon.label_string),           XmRImmediate, (XtPointer)NULL                  },
   { XmNpixmap,              XmCPixmap,          XmRPrimForegroundPixmap, sizeof(Pixmap),          XtOffsetOf(XmIconButtonRec, icon.pixmap),                 XmRImmediate, (XtPointer)XmUNSPECIFIED_PIXMAP  },
   { "pri.vate",             "Pri.vate",         XmRBoolean,              sizeof(Boolean),         XtOffsetOf(XmIconButtonRec, icon.check_set_render_table), XmRImmediate, (XtPointer)False                 },
   { XmNfontList,            XmCFontList,        XmRFontList,             sizeof(XmFontList),      XtOffsetOf(XmIconButtonRec, icon.font_list),              XmRCallProc,  (XtPointer)CheckSetRenderTable   },
   { XmNrenderTable,         XmCRenderTable,     XmRRenderTable,          sizeof(XmRenderTable),   XtOffsetOf(XmIconButtonRec, icon.font_list),              XmRCallProc,  (XtPointer)CheckSetRenderTable   },
   { XmNalignment,           XmCAlignment,       XmRAlignment,            sizeof(unsigned char),   XtOffsetOf(XmIconButtonRec, icon.alignment),              XmRImmediate, (XtPointer)XmALIGNMENT_BEGINNING },
   { XmNstringDirection,     XmCStringDirection, XmRStringDirection,      sizeof(unsigned char),   XtOffsetOf(XmIconButtonRec, icon.string_direction),       XmRImmediate, (XtPointer)XmDEFAULT_DIRECTION   },
   { XmNiconPlacement,       XmCIconPlacement,   XmRXmIconPlacement,      sizeof(XmIconPlacement), XtOffsetOf(XmIconButtonRec, icon.icon_placement),         XmRImmediate, (XtPointer)XmIconTop             },
   { XmNrecomputeSize,       XmCBoolean,         XmRBoolean,              sizeof(Boolean),         XtOffsetOf(XmIconButtonRec, icon.recompute),              XmRImmediate, (XtPointer)True                  },
   { XmNarmColor,            XmCArmColor,        XmRPixel,                sizeof(Pixel),           XtOffsetOf(XmIconButtonRec, icon.arm_color),              XmRCallProc,  (XtPointer)_XmSelectColorDefault },
   { XmNset,                 XmCBoolean,         XmRBoolean,              sizeof(Boolean),         XtOffsetOf(XmIconButtonRec, icon.set),                    XmRImmediate, (XtPointer)False                 },
   { XmNverticalMargin,      XmCSpace,           XmRVerticalDimension,    sizeof(Dimension),       XtOffsetOf(XmIconButtonRec, icon.v_space),                XmRImmediate, (XtPointer)2                     },
   { XmNhorizontalMargin,    XmCSpace,           XmRHorizontalDimension,  sizeof(Dimension),       XtOffsetOf(XmIconButtonRec, icon.h_space),                XmRImmediate, (XtPointer)2                     },
   { XmNiconTextPadding,     XmCSpace,           XmRVerticalDimension,    sizeof(Dimension),       XtOffsetOf(XmIconButtonRec, icon.icon_text_padding),      XmRImmediate, (XtPointer)2                     },
   { XmNactivateCallback,    XmCCallback,        XmRCallback,             sizeof(XtCallbackList),  XtOffsetOf(XmIconButtonRec, icon.activate_callback),      XmRPointer,   (XtPointer)NULL                  },
   { XmNdoubleClickCallback, XmCCallback,        XmRCallback,             sizeof(XtCallbackList),  XtOffsetOf(XmIconButtonRec, icon.double_click_callback),  XmRPointer,   (XtPointer)NULL                  },
   { XmNpixmapWidth,         XmCDimension,       XmRDimension,            sizeof(Dimension),       XtOffsetOf(XmIconButtonRec, icon.pix_width),              XmRImmediate, (XtPointer)0                     },
   { XmNpixmapHeight,        XmCDimension,       XmRDimension,            sizeof(Dimension),       XtOffsetOf(XmIconButtonRec, icon.pix_height),             XmRImmediate, (XtPointer)0                     },
   { XmNpixmapDepth,         XmCDimension,       XmRDimension,            sizeof(Dimension),       XtOffsetOf(XmIconButtonRec, icon.pix_depth),              XmRImmediate, (XtPointer)0                     }
};
static XmSyntheticResource get_resources[] = {
   { XmNhorizontalMargin, sizeof(Dimension), XtOffsetOf(XmIconButtonRec, icon.h_space),           XmeFromHorizontalPixels, (XmImportProc)XmeToHorizontalPixels },
   { XmNverticalMargin,   sizeof(Dimension), XtOffsetOf(XmIconButtonRec, icon.v_space),           XmeFromVerticalPixels,   (XmImportProc)XmeToVerticalPixels   },
   { XmNiconTextPadding,  sizeof(Dimension), XtOffsetOf(XmIconButtonRec, icon.icon_text_padding), FromPaddingPixels,       (XmImportProc)ToPaddingPixels       },
   { XmNlabelString,      sizeof(XmString),  XtOffsetOf(XmIconButtonRec, icon.label_string),      GetValues_labelString,   NULL                                }
};
...
ClassInit()
{
   XtSetTypeConverter(XmRString, XmRXmIconPlacement, (XtTypeConverter)CvtStringToIconPlacement, NULL, (Cardinal)0, XtCacheAll, (XtDestructor)NULL);
}
...
Initialize(Widget req, Widget set, ArgList args, Cardinal *num_args)
{
   ...
   if (XmIconButton_label_string(iw) == NULL)
   {
      ...
      {
         if ((XmIconButton_label_string(iw) = CreateXmString(set, XmIconButton_label(iw))) == NULL)
         {
            XmIconButton_label_string(iw)    = CreateXmString(set, XtName(set));
            XmIconButton_label_from_name(iw) = True;
         }
   ...
   {
      XmIconButton_label_string(iw) = XmStringCopy(XmIconButton_label_string(iw));
   }
   ...
   if (ValidPixmap(XmIconButton_pixmap(iw)))
   {
      ...
      if ((0 != XmIconButton_pix_width(iw)) && (0 != XmIconButton_pix_height(iw)) && (0 != XmIconButton_pix_depth(iw)))
   ...
   else
   {
      ...
      AddPixCache(XtDisplay(set), XmIconButton_pixmap(iw), XmIconButton_pix_width(iw), XmIconButton_pix_height(iw), XmIconButton_pix_depth(iw));
   ...
   if (XmPrim_layout_direction(iw) != XmDEFAULT_DIRECTION)
   {
      if (XmIconButton_string_direction(iw) == XmDEFAULT_DIRECTION)
         XmIconButton_string_direction(iw) = XmDirectionToStringDirection(XmPrim_layout_direction(iw));
   }
   else if (XmIconButton_string_direction(iw) != XmDEFAULT_DIRECTION)
   {
      XmPrim_layout_direction(iw) = XmStringDirectionToDirection(XmIconButton_string_direction(iw));
   }
   else
   {
...
Redisplay(Widget w, XEvent *event, Region region)
{
   ...
   if (XmIconButton_set(iw))
   {
      ...
      if ((fill_width != 0) && (fill_height != 0))
         XFillRectangle(XtDisplay(w), XtWindow(w), XmIconButton_fill_gc(iw), FILL_SPACE(iw), FILL_SPACE(iw), fill_width, fill_height);
   ...
   XmeDrawShadows(XtDisplay(w), XtWindow(w), topgc, bottomgc, dx, dy, width, height, iw->primitive.shadow_thickness, XmSHADOW_OUT);
...
/* ARGSUSED */
static void
SetValuesAlmost(Widget old, Widget set, XtWidgetGeometry *request, XtWidgetGeometry *reply)
{
...
SetValues(Widget current, Widget request, Widget set, ArgList args, Cardinal *num_args)
{
   ...
   {
      /* here's what we enforce: all must be non-zero */
      if (!((0 != XmIconButton_pix_width(set_iw)) && (0 != XmIconButton_pix_height(set_iw)) && (0 != XmIconButton_pix_depth(set_iw))))
         resetPixmapValues = True;
   }
   ...
   if (resetPixmapValues)
   {
      if (XmIconButton_recompute(set_iw))
      {
         ...
         XmIconButton_pix_height(set_iw) = XmIconButton_pix_depth(set_iw) = 0;
      }
      else
      {
   ...
   /* ----------------------------------------------------------------- */
   if ((old_iw->primitive.foreground != set_iw->primitive.foreground) || (old_iw->core.background_pixel != set_iw->core.background_pixel) || (XmIconButton_arm_color(old_iw) != XmIconButton_arm_color(set_iw)))
   {
   ...
   if ((XmIconButton_icon_placement(old_iw) != XmIconButton_icon_placement(set_iw)) || (XmIconButton_v_space(old_iw) != XmIconButton_v_space(set_iw)) || (XmIconButton_h_space(old_iw) != XmIconButton_h_space(set_iw)) || (XmIconButton_icon_text_padding(old_iw) != XmIconButton_icon_text_padding(set_iw)))
   {
      recalc = redisplay = TRUE;
   }
   if ((XmIconButton_set(old_iw) != XmIconButton_set(set_iw)) || (XmIconButton_alignment(old_iw) != XmIconButton_alignment(set_iw)) || (XmIconButton_string_direction(old_iw) != XmIconButton_string_direction(set_iw)) || (XmPrim_layout_direction(old_iw) != XmPrim_layout_direction(set_iw)))
   {
      redisplay = TRUE;
   }
	...
	*/
      ...
      if (reinit_ls)
      {
         if (XmIconButton_label_string(set_iw) == NULL)
         {
            ...
            {
               if ((XmIconButton_label_string(set_iw) = CreateXmString(set, XmIconButton_label(set_iw))) == NULL)
               {
                  XmIconButton_label_string(set_iw)    = CreateXmString(set, XtName(set));
                  XmIconButton_label_from_name(set_iw) = True;
               }
...
/*ARGSUSED*/
static Boolean
CvtStringToIconPlacement(Display *dpy, XrmValuePtr args, Cardinal *num_args, XrmValuePtr fromVal, XrmValuePtr toVal)
{
 ...
 */
static Boolean
CheckPixCache(Display *disp, Pixmap pixmap, unsigned int *width, unsigned int *height, unsigned int *depth)
{
 ...
 */
static void
AddPixCache(Display *disp, Pixmap pixmap, unsigned int width, unsigned int height, unsigned int depth)
{
   XmListElem    *elem = GetCacheElem(disp, pixmap);
   PixCacheEntry *entry;
   if (elem == NULL)
...
/* ARGSUSED */
static void
GetValues_labelString(Widget w, int n, XtArgVal *value)
{
...
GetDesiredSize(Widget w, Dimension *width, Dimension *height)
{
   ...
   XmStringExtent(XmIconButton_font_list(iw), XmIconButton_label_string(iw), &total_width, &total_height);
   if ((XmIconButton_icon_placement(iw) != XmIconNone) && ValidPixmap(XmIconButton_pixmap(iw)))
   {
	 ...
	 */
      if ((XmIconButton_pix_width(iw) == 0) || (XmIconButton_pix_height(iw) == 0) || (XmIconButton_pix_depth(iw) == 0))
      {
         if (!CheckPixCache(XtDisplay(w), XmIconButton_pixmap(iw), &local_width, &local_height, &depth))
         {
            XGetGeometry(XtDisplay(w), XmIconButton_pixmap(iw), &root, &x, &y, &local_width, &local_height, &bw, &depth);
            AddPixCache(XtDisplay(w), XmIconButton_pixmap(iw), local_width, local_height, depth);
         }
...
CalcLocations(Widget w)
{
	 ...
	 */
      switch (XmIconButton_icon_placement(iw))
      {
         ...
         case XmIconRight: /* Flush Right */
            XmIconButton_pix_x(iw) = (Position)(width - H_SPACE(iw) - XmIconButton_pix_width(iw));
            break;
         default: /* Centered */
            XmIconButton_pix_x(iw) = ((Position)width - (Position)XmIconButton_pix_width(iw)) / 2;
            break;
      }
      /*
	 ...
	 */
      switch (XmIconButton_icon_placement(iw))
      {
         ...
         case XmIconBottom: /* Centered at the bottom */
            XmIconButton_pix_y(iw) = ((Position)height - ((Position)V_SPACE(iw) + (Position)extra_y_space + (Position)XmIconButton_pix_height(iw)));
            break;
         default: /* Centered */
            XmIconButton_pix_y(iw) = ((Position)height - (Position)XmIconButton_pix_height(iw)) / 2;
            break;
      }
   }
   else
   ...
   if (XmIconButton_icon_placement(iw) != XmIconOnly)
   {
	 ...
	 */
      XmStringExtent(XmIconButton_font_list(iw), XmIconButton_label_string(iw), &text_width, &text_height);
      ...
      switch (XmIconButton_icon_placement(iw))
      {
	     ...
	     */
            if (have_pixmap)
            {
               XmIconButton_text_x(iw) = XmIconButton_pix_x(iw) + XmIconButton_pix_width(iw) + XmIconButton_icon_text_padding(iw);
               if ((tmp = (int)width - (int)H_SPACE(iw) - (int)XmIconButton_text_x(iw)) < 0)
               {
                  tmp = 0;
               }
      ...
      switch (XmIconButton_icon_placement(iw))
      {
         case XmIconTop: /* Along Bottom. */
            ...
            if (have_pixmap)
            {
               tmp = XmIconButton_pix_y(iw) + XmIconButton_pix_height(iw) + XmIconButton_icon_text_padding(iw);
         ...
         case XmIconBottom: /* Along Top. */
            ...
            if (have_pixmap)
            {
               tmp = XmIconButton_pix_y(iw) - XmIconButton_icon_text_padding(iw) - XmIconButton_text_y(iw);
               if (tmp < 0) tmp = 0;
               XmIconButton_max_text_height(iw) = tmp;
            }
            break;
...
DrawTextAndImage(Widget w, GC text_gc, GC icon_gc, GC icon_stippled_gc)
{
   ...
   if (XmIconButton_icon_placement(iw) != XmIconNone && ValidPixmap(XmIconButton_pixmap(iw)))
   {
      ...
      {
         XCopyPlane(XtDisplay(w), XmIconButton_pixmap(iw), XtWindow(w), icon_gc, 0, 0, XmIconButton_pix_width(iw), XmIconButton_pix_height(iw), XmIconButton_pix_x(iw), XmIconButton_pix_y(iw), 1L);
      }
      else
      {
         XCopyArea(XtDisplay(w), XmIconButton_pixmap(iw), XtWindow(w), icon_gc, 0, 0, XmIconButton_pix_width(iw), XmIconButton_pix_height(iw), XmIconButton_pix_x(iw), XmIconButton_pix_y(iw));
      }
      /*
	 ...
	 */
      ...
      {
         XFillRectangle(XtDisplay(w), XtWindow(w), icon_stippled_gc, XmIconButton_pix_x(iw), XmIconButton_pix_y(iw), XmIconButton_pix_width(iw), XmIconButton_pix_height(iw));
      }
   }
   if (XmIconButton_icon_placement(iw) != XmIconOnly)
   {
      ...
      if (clip.width != 0 && clip.height != 0)
      {
	     ...
	     */
         XSetClipRectangles(XtDisplay(w), text_gc, 0, 0, &clip, 1, Unsorted);
         /*Draw shadow for insensitive text*/
         if (!XtIsSensitive(w))
         {
            XmStringDraw(XtDisplay(w), XtWindow(w), XmIconButton_font_list(iw), XmIconButton_label_string(iw), XmIconButton_shadow_gc(iw), XmIconButton_text_x(iw) + 1, XmIconButton_text_y(iw) + 1, XmIconButton_max_text_width(iw), XmIconButton_alignment(iw), XmPrim_layout_direction(iw), NULL);
         }
         XmStringDraw(XtDisplay(w), XtWindow(w), XmIconButton_font_list(iw), XmIconButton_label_string(iw), text_gc, XmIconButton_text_x(iw), XmIconButton_text_y(iw), XmIconButton_max_text_width(iw), XmIconButton_alignment(iw), XmPrim_layout_direction(iw), NULL);
...
CreateGCs(Widget w)
{
   ...
   Cardinal           num_args = 0;
   XFontStruct       *fs       = NULL;
   XtSetArg(args[num_args], XmNforeground, &fg);
   num_args++;
   XtSetArg(args[num_args], XmNbackground, &bg);
   num_args++;
 ...
 */
Widget
XmCreateIconButton(Widget parent, String name, ArgList args, Cardinal num_args)
{
   return (XtCreateWidget(name, xmIconButtonWidgetClass, parent, args, num_args));
}
