...
static Boolean CvtStringToXmTabSide
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static Boolean CvtStringToXmPixmapPlacement
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static Boolean CvtStringToXiPixel
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static Boolean CvtStringToXiPixmap
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
...
static void TabTransferProc
    _ARGS((Widget, XtPointer, Atom *, Atom *, XtPointer, unsigned long *, int));
static Boolean TabConvertProc _ARGS((Widget,
                                     Atom *,
                                     Atom *,
                                     Atom *,
                                     XtPointer *,
...
#endif
#define ValidPixmap(p) \
  ((p) != (Pixmap)NULL && (p) != (Pixmap)XmUNSPECIFIED_PIXMAP && (p) != (Pixmap)XmPIXMAP_DYNAMIC)
...
#define XiSelectSpecified(t) \
  (XmTabStack_select_color((t)) != XmCOLOR_DYNAMIC || ValidPixmap(XmTabStack_select_pixmap((t))))
...
#define IsValidChild(t, k) (XtIsManaged(k) && !(k)->core.being_destroyed && !IsTabBox(t, k))
// #define BBPart(w) (*(XmBulletinBoardPart*)((char*)(w) +
// XmTabStack_offsets[XmBulletinBoardIndex]))
...
static String tab_stack_filter[] = {XmNx,
                                    XmNy,
                                    XmNwidth,
                                    XmNheight,
                                    XmNdestroyCallback,
...
static unsigned char tab_pix_bits[] = {
    ...
    0xe0, 0xff, 0xff, 0xa9, 0xea, 0x03, 0x00, 0x54, 0xd5, 0xfb, 0xff, 0xff, 0xbf, 0x00, 0x00,
    0x00, 0xe0, 0xaa, 0xaa, 0xaa, 0xba, 0x54, 0x55, 0x55, 0xf5, 0xaa, 0xaa, 0xaa, 0xba, 0x54,
    0x55, 0x55, 0xf5, 0xaa, 0xaa, 0xaa, 0xba, 0x54, 0x55, 0x55, 0xf5, 0xaa, 0xaa, 0xaa, 0xba,
    0x54, 0x55, 0x55, 0xf5, 0xaa, 0xaa, 0xaa, 0xba, 0x54, 0x55, 0x55, 0xf5, 0xaa, 0xaa, 0xaa,
    0xba, 0x54, 0x55, 0x55, 0xf5, 0xaa, 0xaa, 0xaa, 0xba, 0x54, 0x55, 0x55, 0xf5, 0xaa, 0xaa,
    0xaa, 0xba, 0x54, 0x55, 0x55, 0xf5, 0xaa, 0xaa, 0xaa, 0xba, 0x54, 0x55, 0x55, 0xf5, 0xfe,
...
static unsigned char tab_mask_bits[] = {
    ...
    0x00, 0x00, 0xfe, 0x1f, 0xec, 0xff, 0xff, 0x3f, 0xfc, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f,
    0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f,
    0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f,
    0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f,
    0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f,
    0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0xff, 0xff, 0xff, 0x3f, 0x00, 0x00, 0x00, 0x00,
...
static unsigned char invalid_bits[] = {
    ...
    0x20, 0xe0, 0x07, 0x04, 0x10, 0x1c, 0x38, 0x08, 0x08, 0x02, 0x40, 0x10, 0x08, 0x01, 0x20, 0x10,
    0x86, 0x00, 0x10, 0x20, 0x42, 0x00, 0x08, 0x42, 0x22, 0x00, 0x04, 0x45, 0x22, 0x00, 0x82, 0x44,
    0x21, 0x00, 0x41, 0x84, 0x11, 0x80, 0x20, 0x88, 0x11, 0x40, 0x10, 0x88, 0x11, 0x20, 0x08, 0x88,
    0x11, 0x10, 0x04, 0x88, 0x11, 0x08, 0x02, 0x88, 0x11, 0x04, 0x01, 0x88, 0x21, 0x82, 0x00, 0x84,
    0x22, 0x41, 0x00, 0x44, 0xa2, 0x20, 0x00, 0x44, 0x42, 0x10, 0x00, 0x42, 0x04, 0x08, 0x00, 0x21,
    0x08, 0x04, 0x80, 0x10, 0x08, 0x02, 0x40, 0x10, 0x10, 0x1c, 0x38, 0x08, 0x20, 0xe0, 0x07, 0x04,
...
static unsigned char invalid_mask_bits[] = {
    ...
    0xe0, 0xff, 0xff, 0x07, 0xf0, 0x1f, 0xf8, 0x0f, 0xf8, 0x03, 0xc0, 0x1f, 0xf8, 0x01, 0xe0, 0x1f,
    0xfe, 0x00, 0xf0, 0x3f, 0x7e, 0x00, 0xf8, 0x7f, 0x3e, 0x00, 0xfc, 0x7d, 0x3e, 0x00, 0xfe, 0x7c,
    0x3f, 0x00, 0x7f, 0xfc, 0x1f, 0x80, 0x3f, 0xf8, 0x1f, 0xc0, 0x1f, 0xf8, 0x1f, 0xe0, 0x0f, 0xf8,
    0x1f, 0xf0, 0x07, 0xf8, 0x1f, 0xf8, 0x03, 0xf8, 0x1f, 0xfc, 0x01, 0xf8, 0x3f, 0xfe, 0x00, 0xfc,
    0x3e, 0x7f, 0x00, 0x7c, 0xbe, 0x3f, 0x00, 0x7c, 0xfe, 0x1f, 0x00, 0x7e, 0xfc, 0x0f, 0x00, 0x3f,
    0xf8, 0x07, 0x80, 0x1f, 0xf8, 0x03, 0xc0, 0x1f, 0xf0, 0x1f, 0xf8, 0x0f, 0xe0, 0xff, 0xff, 0x07,
...
static XtResource resources[] = {
    ...
    {XmNautoUnmanage,
     ...
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmBulletinBoardRec, bulletin_board.auto_unmanage),
     XmRImmediate,
     (XtPointer)False},
/* TabBox Resources */
#ifdef TEAR_OFF_TABS
    {XmNallowTearOffTabs,
     ...
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackRec, tab_stack.allow_tear_offs),
     XmRImmediate,
     (XtPointer)True},
    {XmNtearOffLabelString,
     XmCTearOffLabelString,
     XmRXmString,
     sizeof(XmString),
     XtOffsetOf(XmTabStackRec, tab_stack.tear_off_label),
     XmRString,
     (XtPointer) "Tear Off Tab"},
#endif
    {XmNtabAutoSelect,
     XmCTabAutoSelect,
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackRec, tab_stack.tab_auto_select),
     XmRImmediate,
     (XtPointer)True},
    {XmNtabStyle,
     XmCTabStyle,
     XmRTabStyle,
     sizeof(XmTabStyle),
     XtOffsetOf(XmTabStackRec, tab_stack.tab_style),
     XmRImmediate,
    ...
    {XmNtabMode,
     ...
     XmRTabMode,
     sizeof(XmTabMode),
     XtOffsetOf(XmTabStackRec, tab_stack.tab_mode),
     XmRImmediate,
     (XtPointer)XmTABS_BASIC},
    {XmNtabMarginWidth,
     XmCMarginWidth,
    ...
    {"pri.vate",
     ...
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackRec, tab_stack.check_set_render_table),
     XmRImmediate,
     (XtPointer)False},
    {XmNfontList,
     XmCFontList,
     XmRFontList,
     sizeof(XmFontList),
     XtOffsetOf(XmTabStackRec, tab_stack.font_list),
     XmRCallProc,
    ...
    {XmNhighlightThickness,
     ...
     XmRDimension,
     sizeof(Dimension),
     XtOffsetOf(XmTabStackRec, tab_stack.highlight_thickness),
     XmRImmediate,
     (XtPointer)2},
    {XmNtabSide,
     XmCTabSide,
     XmRXmTabSide,
     sizeof(XmTabSide),
     XtOffsetOf(XmTabStackRec, tab_stack.tab_side),
     XmRImmediate,
     (XtPointer)XmTABS_ON_TOP},
    {XmNtabOrientation,
     XmCTabOrientation,
     XmRTabOrientation,
     sizeof(XmTabOrientation),
     XtOffsetOf(XmTabStackRec, tab_stack.tab_orientation),
     XmRImmediate,
     (XtPointer)XmTAB_ORIENTATION_DYNAMIC},
    {XmNuniformTabSize,
     XmCUniformTabSize,
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackRec, tab_stack.uniform_tab_size),
     XmRImmediate,
     (XtPointer)True},
    {XmNtabSelectColor,
     XmCTabSelectColor,
     XmRXmPixel,
     sizeof(Pixel),
     XtOffsetOf(XmTabStackRec, tab_stack.select_color),
     XmRImmediate,
     (XtPointer)XmCOLOR_DYNAMIC},
    {XmNtabSelectPixmap,
     XmCTabSelectPixmap,
     XmRXmPixmap,
     sizeof(Pixmap),
     XtOffsetOf(XmTabStackRec, tab_stack.select_pixmap),
     XmRImmediate,
    ...
    {XmNstackedEffect,
     ...
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackRec, tab_stack.stacked_effect),
     XmRImmediate,
     (XtPointer)True},
    {XmNtabCornerPercent,
     XmCTabCornerPercent,
     XmRInt,
     sizeof(int),
     XtOffsetOf(XmTabStackRec, tab_stack.tab_corner_percent),
     XmRImmediate,
     (XtPointer)40},
    {XmNtabLabelSpacing,
     XmCTabLabelSpacing,
    ...
    {XmNuseImageCache,
     ...
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackRec, tab_stack.use_image_cache),
     XmRImmediate,
     (XtPointer)True},
    {XmNtabSelectedCallback,
     ...
     XtOffsetOf(XmTabStackRec, tab_stack.tab_select_callback),
     XmRImmediate,
     (XtPointer)NULL},
...
static XtResource constraint_resources[] = {
    ...
    {XmNtabAlignment,
     ...
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tab_alignment),
     XmRImmediate,
    ...
    {XmNtabStringDirection,
     ...
     XmRStringDirection,
     sizeof(unsigned char),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tab_string_direction),
     XmRImmediate,
    ...
    {XmNtabLabelPixmap,
     ...
     sizeof(Pixmap),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tab_label_pixmap),
     XmRImmediate,
     (XtPointer)XmUNSPECIFIED_PIXMAP},
    {XmNtabPixmapPlacement,
     XmCTabPixmapPlacement,
     XmRXmPixmapPlacement,
     sizeof(XmPixmapPlacement),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tab_pixmap_placement),
     XmRImmediate,
     (XtPointer)XmPIXMAP_RIGHT},
    {XmNfreeTabPixmap,
     XmCFreeTabPixmap,
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.free_tab_pixmap),
     XmRImmediate,
     (XtPointer)False},
    {XmNtabBackground,
     XmCBackground,
     XmRXmPixel,
     sizeof(Pixel),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tab_background),
     XmRImmediate,
     (XtPointer)XmCOLOR_DYNAMIC},
    {XmNtabBackgroundPixmap,
     ...
     XmRXmPixmap,
     sizeof(Pixmap),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tab_background_pixmap),
     XmRImmediate,
     (XtPointer)XmPIXMAP_DYNAMIC},
    {XmNtabForeground,
     XmCForeground,
     XmRXmPixel,
     sizeof(Pixel),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tab_foreground),
     XmRImmediate,
     (XtPointer)XmCOLOR_DYNAMIC},
#ifdef TEAR_OFF_TABS
    {XmNtabTearOffEnabled,
     XmCTabTearOffEnabled,
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabStackConstraintRec, tab_stack.tear_off_enabled),
     XmRImmediate,
     (XtPointer)True}
#endif
};
...
XmTabStackClassRec xmTabStackClassRec = {{/* Core Fields */
...
static void ClassInitialize(void)
{
  ...
  XtSetTypeConverter(
      XmRString, XmRXmPixmapPlacement, CvtStringToXmPixmapPlacement, NULL, 0, XtCacheNone, NULL);
...
static void ClassPartInitialize(WidgetClass widget_class)
{
  ...
  if (XmTabStack_class(tab).drag_translations != NULL) {
    if ((String)XmTabStack_class(tab).drag_translations == XtInheritTranslations) {
      XmTabStack_class(tab).drag_translations =
          (String)((XmTabStackWidgetClass)tab->core_class.superclass)
              ->tab_stack_class.drag_translations;
    }
    else {
      XmTabStack_class(tab).drag_translations = (String)XtParseTranslationTable(
          (String)XmTabStack_class(tab).drag_translations);
    }
  }
}
#endif
...
static void Initialize(Widget request, Widget set, ArgList arg_list, Cardinal *arg_cnt)
{
  ...
  ++n;
  if (!XmTabStack_uniform_tab_size(ts) && (XmTabStack_tab_mode(ts) == XmTABS_STACKED ||
  ...
  if (XmTabStack_tab_box(ts) == NULL) {
    XmTabStack_tab_box(ts) = XtCreateManagedWidget(
        "tabBox", xmTabBoxWidgetClass, set, merged_args, n + num_filtered_args);
  }
  else {
    XtSetValues(XmTabStack_tab_box(ts), merged_args, n + num_filtered_args);
  }
#ifdef TEAR_OFF_TABS
  if (XmTabStack_tear_off_label(ts) != NULL) {
    XmTabStack_tear_off_label(ts) = XmStringCopy(XmTabStack_tear_off_label(ts));
  }
  ...
  ++n;
  XmTabStack__tear_off_button(ts) = XtCreateManagedWidget(
      "tearOffTab", xmPushButtonWidgetClass, XmTabStack__menu(ts), args, n);
...
static void Realize(Widget w, XtValueMask *mask, XSetWindowAttributes *attr)
{
  ...
  {
    XmTabStackSelectTab(XmTabStack__selected_tab(tab), XmTabStack__selected_notify(tab));
  }
  /*
...
static void Resize(Widget widget)
{
  ...
  if (XtIsRealized(widget)) {
    ...
    if (stacked && active != NULL && cnt > 0) {
      XFillRectangle(XtDisplay(tab),
                     XtWindow(tab),
                     gc,
                     active->core.x - BBPart(tab).margin_width,
                     active->core.y - BBPart(tab).margin_height,
                     XtWidth(active) + 2 * BBPart(tab).margin_width,
                     XtHeight(active) + 2 * BBPart(tab).margin_height);
    }
    else {
      DrawShadows(tab,
...
#define bcfield(f) (((XmBulletinBoardWidget)c_tab)->bulletin_board.f)
#define bsfield(f) (((XmBulletinBoardWidget)s_tab)->bulletin_board.f)

static Boolean SetValues(
    Widget current, Widget request, Widget set, ArgList arg_list, Cardinal *arg_cnt)
{
  XmTabStackWidget c_tab = (XmTabStackWidget)current, s_tab = (XmTabStackWidget)set;
  Arg args[25];
  ArgList filtered_args, merged_args;
  int n = 0;
  Cardinal num_filtered_args;
  Boolean need_redraw = False, need_resize = False, need_layout = False;
  if (c_tab->manager.shadow_thickness != s_tab->manager.shadow_thickness) {
    need_resize = True;
    need_layout = True;
  }
  if (bcfield(margin_width) != bsfield(margin_width) ||
      bcfield(margin_height) != bsfield(margin_height) || cfield(tab_side) != sfield(tab_side) ||
  ...
  if (!sfield(uniform_tab_size) && sfield(uniform_tab_size) != cfield(uniform_tab_size) &&
  ...
  if ((sfield(tab_mode) == XmTABS_STACKED || sfield(tab_mode) == XmTABS_STACKED_STATIC) &&
      sfield(tab_mode) != cfield(tab_mode) && !sfield(uniform_tab_size))
  {
    XmeWarning(set, XmNillegalUniformTabSizeMsg);
    XtSetArg(args[n], XmNuniformTabSize, True);
    ++n;
  ...
  if (cfield(tear_off_label) != sfield(tear_off_label)) {
    ...
    XtVaSetValues(sfield(_tear_off_button), XmNlabelString, sfield(tear_off_label), NULL);
  }
#endif /* TEAR_OFF_TABS */
  if (need_layout) {
    Resize(set);
                                      ...
                                      XtWidgetGeometry *allowed)
{
  ...
  *allowed = *request;
   ...
   */
  for (i = 0, kid = tab->composite.children; i < tab->composite.num_children; ++i) {
    if (!IsValidChild(tab, kid[i]))
      continue;
  ...
  if (XmTabStack_tab_side(tab) == XmTABS_ON_TOP || XmTabStack_tab_side(tab) == XmTABS_ON_BOTTOM) {
  ...
  if (LocalTabBox(tab)) {
        ...
        XmTabStack_tab_mode(tab) == XmTABS_STACKED_STATIC)
    {
      ...
      switch (XmTabStack_tab_side(tab)) {
        case XmTABS_ON_TOP:
        case XmTABS_ON_BOTTOM:
          _XmTabBoxStackedGeometry((XmTabBoxWidget)XmTabStack_tab_box(tab), width, &tab_rect);
          break;
        case XmTABS_ON_RIGHT:
        case XmTABS_ON_LEFT:
          _XmTabBoxStackedGeometry((XmTabBoxWidget)XmTabStack_tab_box(tab), height, &tab_rect);
          break;
      }
                                   ...
                                   XtWidgetGeometry *allowed)
{
  ...
  if (XmCompareXtWidgetGeometryToWidget(allowed, XmTabStack_tab_box(tab))) {
    return (XtGeometryNo);
  }
  if (XmCompareXtWidgetGeometry(request, allowed)) {
    if (!(request->request_mode & XtCWQueryOnly)) {
...
static void ChangeManaged(Widget widget)
{
  ...
  if ((active = XmTabStack__active_child(tab)) != NULL) {
    ...
    XtVaSetValues(XmTabStack_tab_box(tab), XmNtabList, tl, NULL);
  }
  if (XmTabStack__tab_list(tab) != NULL) {
    XmTabbedStackListFree(XmTabStack__tab_list(tab));
  }
...
static void ConstraintInitialize(Widget request, Widget set, ArgList arg_list, Cardinal *arg_cnt)
{
...
static Boolean CvtStringToXiPixel(Display *dpy,
                                  XrmValue *arg_list,
                                  Cardinal *arg_cnt,
                                  XrmValue *from,
                                  XrmValue *to,
...
static Boolean CvtStringToXiPixmap(Display *dpy,
                                   XrmValue *arg_list,
                                   Cardinal *arg_cnt,
                                   XrmValue *from,
                                   XrmValue *to,
...
static Boolean CvtStringToXmTabSide(Display *dpy,
                                    XrmValue *arg_list,
                                    Cardinal *arg_cnt,
                                    XrmValue *from,
                                    XrmValue *to,
...
static Boolean CvtStringToXmPixmapPlacement(Display *dpy,
                                            XrmValue *arg_list,
                                            Cardinal *arg_cnt,
                                            XrmValue *from,
                                            XrmValue *to,
...
static void DrawShadows(
    XmTabStackWidget tab, GC top_GC, GC bottom_GC, int x, int y, int width, int height)
{
  XRectangle top_rects[2], bottom_rects[2];
  XPoint bevel;
  int num_top_rects = 0, num_bottom_rects = 0, shadow = tab->manager.shadow_thickness;
  /*
  ...
  XmDrawBevel(
      XtDisplay(tab), XtWindow(tab), top_GC, bottom_GC, bevel.x, bevel.y, shadow, XmBEVEL_BOTH);
}

static void PickSizes(
    XmTabStackWidget tab, int tab_width, int tab_height, XRectangle *box, XRectangle *kid)
{
  int max, width, height, row_width, offset = 0, num_rows, num_cols;
  XtWidgetGeometry ask, got;
  Boolean stacked = False;
  /*
  ...
  switch (XmTabStack_tab_side(tab)) {
    ...
    case XmTABS_ON_LEFT:
      ...
      if ((int)got.width > max)
        got.height = max;
      height = tab_height -
               2 * ((int)BBPart(tab).margin_height + (int)tab->manager.shadow_thickness);
      width = max - (int)got.width;
      AssignMax(width, 1);
      AssignMax(height, 1);
      break;
  }
  if (XmTabStack_stacked_effect(tab) && (XmTabStack_tab_mode(tab) == XmTABS_STACKED ||
                                         XmTabStack_tab_mode(tab) == XmTABS_STACKED_STATIC))
  {
    Dimension doffset;
    stacked = True;
    XtVaGetValues(XmTabStack_tab_box(tab), XmNtabOffset, &doffset, NULL);
    offset = doffset;
  }
  /*
...
static void Layout(XmTabStackWidget tab)
{
   ...
   */
  if (LocalTabBox(tab)) {
    _XmConfigureWidget(XmTabStack_tab_box(tab), box.x, box.y, box.width, box.height, 0);
  }
  /*
  ...
  for (i = 0, kid = tab->composite.children; i < tab->composite.num_children; ++i, ++kid) {
    ...
    if (XmTabStack__active_child(tab) == *kid) {
      _XmConfigureWidget(
          *kid, child.x, child.y, child.width, child.height, (*kid)->core.border_width);
    }
    else {
      neg_x = -((int)child.width) - 2 * (int)((*kid)->core.border_width);
      _XmConfigureWidget(
          *kid, (Position)neg_x, child.y, child.width, child.height, (*kid)->core.border_width);
    }
  }
}
 ...
 *	None.
 */
static void TabSelectedCallback(Widget widget, XtPointer client, XtPointer cbdata)
{
   ...
   */
  _XmConfigureWidget(
      active, old->core.x, old->core.y, XtWidth(old), XtHeight(old), active->core.border_width);
  ...
  if (XiBackgroundSpecified(old) || XiBackgroundSpecified(active) || XiSelectSpecified(tab)) {
    if (XiSelectSpecified(tab)) {
      ...
      XFillRectangle(
          XtDisplay(tab), XtWindow(tab), tab->manager.background_GC, x, y, width, height);
    }
  }
  /*
...
#endif /* TEAR_OFF_TABS */
static int TabToIndex(XmTabStackWidget tab, Widget child)
{
  WidgetList kid;
  int i;
...
Widget XmCreateTabStack(Widget parent, String name, ArgList arg_list, Cardinal arg_cnt)
{
...
Widget XmVaCreateTabStack(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmTabStackWidgetClass, parent, False, var, count);
  va_end(var);
  return w;
}
...
Widget XmVaCreateManagedTabStack(Widget parent, char *name, ...)
{
  ...
  va_end(var);
  Va_start(var, name);
  w = XmeVLCreateWidget(name, xmTabStackWidgetClass, parent, True, var, count);
  va_end(var);
  return w;
}
...
static void DrawStackedShadows(
    XmTabStackWidget tab, GC top_GC, GC bottom_GC, int x, int y, int base_width, int base_height)
{
  ...
  if (!XmIsManager(parent)) {
    XtVaGetValues(parent, XmNbackground, &pixel, XmNbackgroundPixmap, &pixmap, NULL);
  }
  switch (XmTabStack_tab_side(tab)) {
    case XmTABS_ON_TOP:
    default:
      if (LayoutIsRtoLM(tab)) {
        ...
        for (i = 0; i < num_rows; ++i) {
          if (i == 0) {
            XFillRectangle(
                XtDisplay(tab), XtWindow(tab), tab->manager.top_shadow_GC, x, y, shadow, y2 - y);
            XmDrawBevel(
                XtDisplay(tab), XtWindow(tab), top_GC, bottom_GC, x, y2, shadow, XmBEVEL_BOTH);
            y2 -= offset;
            x -= offset;
            x2 -= offset;
          }
            ...
            if ((idx = _XiGetTabIndex(XmTabStack_tab_box(tab), i, (num_cols - 1))) >= 0) {
              ...
              XFillRectangle(
                  XtDisplay(tab), XtWindow(tab), gc, x, y2, x2 - x, (int)XtHeight(tab) - y2);
              XFillRectangle(
                  XtDisplay(tab), XtWindow(tab), tab->manager.top_shadow_GC, x, y, shadow, y2 - y);
              XFillRectangle(XtDisplay(tab),
                             XtWindow(tab),
        ...
        XFillRectangle(XtDisplay(tab),
                       XtWindow(tab),
                       gc,
                       offset * (num_rows - 1) + base_width + 2 * shadow,
                       0,
                       XtWidth(tab) - offset * (num_rows - 1) + base_width + 2 * shadow,
                       XtHeight(tab));
        ...
        XFillRectangle(XtDisplay(tab),
                       XtWindow(tab),
                       bottom_GC,
                       offset * (num_rows - 1) + base_width + shadow,
                       y,
                       shadow,
                       base_height + shadow);
      }
        ...
        if (x < (int)XtWidth(tab)) {
          XFillRectangle(
              XtDisplay(tab), XtWindow(tab), gc, x, 0, (int)XtWidth(tab) - x, XtHeight(tab));
        }
      }
      break;
    case XmTABS_ON_BOTTOM:
      if (LayoutIsRtoL(tab)) {
        ...
        for (i = 0; i < num_rows; ++i) {
          if (i == 0) {
            ...
            if ((idx = _XiGetTabIndex(XmTabStack_tab_box(tab), i, (num_cols - 1))) >= 0) {
              ...
              XFillRectangle(
                  XtDisplay(tab), XtWindow(tab), gc, x, y2 + shadow, x2 - x, base_height - y2);
              if (XmIsManager(parent)) {
                gc = ((XmManagerWidget)parent)->manager.background_GC;
              }
              else {
        ...
        if (i < (int)XtWidth(tab)) {
          XFillRectangle(
              XtDisplay(tab), XtWindow(tab), gc, i, 0, (int)XtWidth(tab) - i, XtHeight(tab));
        }
        if (_XiGetTabIndex(XmTabStack_tab_box(tab), num_rows - 1, num_cols - 1) < 0) {
          XFillRectangle(XtDisplay(tab), XtWindow(tab), gc, 0, 0, offset, XtHeight(tab));
        }
          ...
          if (i == 0) {
            ...
            if ((idx = _XiGetTabIndex(XmTabStack_tab_box(tab), i, (num_cols - 1))) >= 0) {
              ...
              XFillRectangle(XtDisplay(tab),
                             ...
                             y2 - y);
              XFillRectangle(
                  XtDisplay(tab), XtWindow(tab), tab->manager.top_shadow_GC, x, y, x2 - x, shadow);
              XmDrawBevel(XtDisplay(tab),
                          XtWindow(tab),
                          tab->manager.top_shadow_GC,
                          tab->manager.bottom_shadow_GC,
    ...
    case XmTABS_ON_RIGHT:
      ...
      for (i = 0; i < num_rows; ++i) {
        if (i == 0) {
          XFillRectangle(
              XtDisplay(tab), XtWindow(tab), tab->manager.bottom_shadow_GC, x, y, x2 - x, shadow);
          y += shadow;
          y2 = y + offset;
        }
        else {
      ...
      if (x < (int)XtWidth(tab)) {
        XFillRectangle(
            XtDisplay(tab), XtWindow(tab), gc, 0, y, XtWidth(tab), (int)XtHeight(tab) - y);
      }
      break;
    case XmTABS_ON_LEFT:
      y = 0;
      ...
      for (i = 0; i < num_rows; ++i) {
        if (i == 0) {
          ...
          if ((idx = _XiGetTabIndex(XmTabStack_tab_box(tab), i, (num_cols - 1))) >= 0) {
            ...
            XFillRectangle(
                XtDisplay(tab), XtWindow(tab), gc, x2, y, (int)XtWidth(tab) - x2, y2 - y);
            XFillRectangle(XtDisplay(tab),
                           XtWindow(tab),
                           tab->manager.bottom_shadow_GC,
                           x,
...
Widget XmTabStackIndexToWidget(Widget widget, int idx)
{
  ...
  for (i = 0, cnt = 0, kid = tab->composite.children; i < tab->composite.num_children; ++i, ++kid)
  {
...
#ifdef TEAR_OFF_TABS
static void TearOffCallback(Widget widget, XtPointer client, XtPointer cbdata)
{
  XtPointer data;
...
static void MenuSelectCallback(Widget widget, XtPointer client, XtPointer cbdata)
{
  XtPointer data;
  XtVaGetValues(widget, XmNuserData, &data, NULL);
...
static void BuildMenu(XmTabStackWidget tab)
{
   ...
   * menu.
   */
  XtVaGetValues(tab, XmNchildren, &kids, XmNnumChildren, &kidCnt, NULL);
  for (i = 0, validKids = 0; i < kidCnt; ++i) {
    if (IsValidChild(tab, kids[i]))
      validKids++;
  }
  XtVaGetValues(menu, XmNchildren, &buttons, XmNnumChildren, &buttonCnt, NULL);
  for (i = 0, validButtons = 0; i < buttonCnt; ++i) {
    if (XmIsPushButton(buttons[i]))
      validButtons++;
  }
  ...
  for (j = 0; j < buttonCnt; ++j) {
    if (!XmIsSeparator(buttons[j]) && buttons[j] != XmTabStack__tear_off_button(tab))
      break;
  }
...
static void TabTransferProc(Widget widget,
                            XtPointer closure,
                            Atom *selType,
                            Atom *type,
                            XtPointer value,
                            ...
                            int format)
{
  ...
  if (*length != sizeof(Widget) || *type != WidgetAtom(widget)) {
    XtVaSetValues(widget, XmNtransferStatus, XmTRANSFER_FAILURE, NULL);
    return;
  }
  child = *((Widget *)value);
  /*
   ...
   */
  XtVaGetValues(child, XmNcolormap, &c_cmap, XmNdepth, &c_depth, NULL);
  XtVaGetValues(tab, XmNcolormap, &p_cmap, XmNdepth, &p_depth, NULL);
  ...
  XtVaSetValues(widget, XmNtransferStatus, XmTRANSFER_SUCCESS, NULL);
}

static void HandleTabDrop(Widget widget, XtPointer client, XtPointer cbdata)
{
...
static Boolean TabConvertProc(Widget widget,
                              Atom *selection,
                              Atom *target,
                              Atom *typeRtn,
                              XtPointer *valueRtn,
                              ...
                              XtRequestId request_id)
{
  ...
  XtVaGetValues(widget, XmNclientData, &child_data, NULL);
  child = (Widget)child_data;
  if (*target != TabAtom(widget))
    return (False);
...
Widget XmTabStackXYToWidget(Widget widget, int x, int y)
{
  ...
  _XmAppUnlock(app);
  return (XmTabStackIndexToWidget(tab_stack, XmTabBoxXYToIndex(tab_box, x, y)));
}
...
#  define XiInsertChild(p, c) \
    { \
      (c)->core.parent = (p); \
      _XmProcessLock(); \
      (*((CompositeWidgetClass)(p)->core.widget_class)->composite_class.insert_child)(c); \
      _XmProcessUnlock(); \
    }
...
static void XiMoveTabPanel(Widget panel, Widget to)
{
  ...
  XtVaSetValues(panel, XmNwidth, width, XmNheight, height, NULL);
  XiDeleteChild(panel);
...
static void DragCallback(Widget widget, XtPointer client, XtPointer cbdata)
{
  ...
  switch (info->reason) {
    ...
    case XmCR_DROP_SITE_ENTER: {
      ...
      switch (enter->dropSiteStatus) {
        ...
        default:
          XtVaSetValues(widget, XmNstateCursorIcon, XmTabStack__invalid_icon(tab), NULL);
          break;
        case XmVALID_DROP_SITE:
          XtVaSetValues(widget, XmNstateCursorIcon, NULL, NULL);
          break;
      }
    } break;
...
static void XmTabStackMenu(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  XtVaSetValues(XmTabStack__tear_off_button(tab), XmNuserData, child, NULL);
  XmMenuPosition(XmTabStack__menu(tab), (XButtonPressedEvent *)event);
  XtManageChild(XmTabStack__menu(tab));
}

static void XmTabBoxDragTab(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  Widget parent = XtParent(widget), drag, child, source_icon, invalid_icon;
  XmTabStackWidget tab = (XmTabStackWidget)XtParent(parent);
  Arg args[10];
  Cardinal n = 0;
  Atom target;
...
#  ifdef TEAR_OFF_TABS
  if (!XmTabStack_allow_tear_offs(tab) || event == NULL || event->xany.type != ButtonPress ||
      (child = IndexToTab(tab, XmTabBoxGetIndex(parent, event->xbutton.x, event->xbutton.y))) ==
          NULL ||
...
#  endif /* TEAR_OFF_TABS */
  if (XmTabStack__source_icon(tab) == NULL) {
    source_pixmap = XCreateBitmapFromData(
        XtDisplay(widget), XtWindow(widget), (char *)tab_pix_bits, tab_pix_width, tab_pix_height);
    source_mask = XCreateBitmapFromData(
        XtDisplay(widget), XtWindow(widget), (char *)tab_mask_bits, tab_pix_width, tab_pix_height);
    invalid_pixmap = XCreateBitmapFromData(
        XtDisplay(widget), XtWindow(widget), (char *)invalid_bits, tab_pix_width, tab_pix_height);
