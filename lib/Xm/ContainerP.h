...
enum { CONTAINER_ICON, CONTAINER_OUTLINE_BUTTON, CONTAINER_HEADER };
...
#  define CtrDynamicLargeCellHeight(w) (((XmContainerWidget)(w))->container.large_cell_height == 0)
#  define CtrDynamicLargeCellWidth(w) (((XmContainerWidget)(w))->container.large_cell_width == 0)
...
#  define CtrViewIsANY_ICON(w) (((XmContainerWidget)(w))->container.entry_viewtype == XmANY_ICON)
#  define CtrIsHORIZONTAL(w) \
    (XmDirectionMatchPartial(((XmContainerWidget)(w))->manager.string_direction, \
                             XmDEFAULT_DIRECTION, \
...
#  define CtrLayoutIsDETAIL(w) (((XmContainerWidget)(w))->container.layout_type == XmDETAIL)
...
#  define CtrDrawLinesOUTLINE(w) \
    (CtrLayoutIsOUTLINE_DETAIL(w) && \
     (((XmContainerWidget)(w))->container.outline_sep_style == XmSINGLE))
#  define CtrLayoutIsSPATIAL(w) (((XmContainerWidget)(w))->container.layout_type == XmSPATIAL)
#  define CtrSpatialStyleIsNONE(w) (((XmContainerWidget)(w))->container.spatial_style == XmNONE)
#  define CtrSpatialStyleIsGRID(w) (((XmContainerWidget)(w))->container.spatial_style == XmGRID)
#  define CtrSpatialStyleIsCELLS(w) (((XmContainerWidget)(w))->container.spatial_style == XmCELLS)
#  define CtrIncludeIsAPPEND(w) (((XmContainerWidget)(w))->container.include_model == XmAPPEND)
#  define CtrIncludeIsCLOSEST(w) (((XmContainerWidget)(w))->container.include_model == XmCLOSEST)
#  define CtrIncludeIsFIRST_FIT(w) \
    (((XmContainerWidget)(w))->container.include_model == XmFIRST_FIT)
#  define CtrSnapModelIsNONE(w) (((XmContainerWidget)(w))->container.snap_model == XmNONE)
#  define CtrSnapModelIsSNAP(w) (((XmContainerWidget)(w))->container.snap_model == XmSNAP_TO_GRID)
#  define CtrSnapModelIsCENTER(w) (((XmContainerWidget)(w))->container.snap_model == XmCENTER)
...
#  define CtrPolicyIsBROWSE(w) \
    (((XmContainerWidget)(w))->container.selection_policy == XmBROWSE_SELECT)
#  define CtrPolicyIsMULTIPLE(w) \
    (((XmContainerWidget)(w))->container.selection_policy == XmMULTIPLE_SELECT)
#  define CtrPolicyIsEXTENDED(w) \
    (((XmContainerWidget)(w))->container.selection_policy == XmEXTENDED_SELECT)
#  define CtrTechIsTOUCH_OVER(w) \
    (((XmContainerWidget)(w))->container.selection_technique == XmTOUCH_OVER)
#  define CtrTechIsTOUCH_ONLY(w) \
    (((XmContainerWidget)(w))->container.selection_technique == XmTOUCH_ONLY)
#  define CtrTechIsMARQUEE(w) \
    (((XmContainerWidget)(w))->container.selection_technique == XmMARQUEE)
#  define CtrTechIsMARQUEE_ES(w) \
    (((XmContainerWidget)(w))->container.selection_technique == XmMARQUEE_EXTEND_START)
#  define CtrTechIsMARQUEE_EB(w) \
    (((XmContainerWidget)(w))->container.selection_technique == XmMARQUEE_EXTEND_BOTH)
#  define CtrOB_PRESENT(w) \
    (((XmContainerWidget)(w))->container.ob_policy == XmOUTLINE_BUTTON_PRESENT)
#  define CtrOB_ABSENT(w) \
    (((XmContainerWidget)(w))->container.ob_policy == XmOUTLINE_BUTTON_ABSENT)
#  define GetContainerConstraint(w) (&((XmContainerConstraintPtr)(w)->core.constraints)->container)
#  define CtrItemIsPlaced(w) \
    (((XmContainerConstraintPtr)(w)->core.constraints)->container.cell_idx != NO_CELL)
#  define CtrICON(w) \
    (((XmContainerConstraintPtr)(w)->core.constraints)->container.cwid_type == CONTAINER_ICON)
#  define CtrOUTLINE_BUTTON(w) \
    (((XmContainerConstraintPtr)(w)->core.constraints)->container.cwid_type == \
     CONTAINER_OUTLINE_BUTTON)
#  define CtrHEADER(w) \
    (((XmContainerConstraintPtr)(w)->core.constraints)->container.cwid_type == CONTAINER_HEADER)
