...
#define DSMCreateInfo(dsm, widget, args, numArgs) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.createInfo)( \
      (dsm), (widget), (args), (numArgs))
#define DSMDestroyInfo(dsm, widget) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.destroyInfo)((dsm), (widget))
#define DSMStartUpdate(dsm, widget) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.startUpdate)((dsm), (widget))
#define DSMRetrieveInfo(dsm, widget, args, numArgs) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.retrieveInfo)( \
      (dsm), (widget), (args), (numArgs))
#define DSMUpdateInfo(dsm, widget, args, numArgs) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.updateInfo)( \
      (dsm), (widget), (args), (numArgs))
#define DSMEndUpdate(dsm, widget) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.endUpdate)((dsm), (widget))
#define DSMUpdate(dsm, clientData, callData) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.updateDSM)( \
      (dsm), (clientData), (callData))
#define DSMProcessMotion(dsm, clientData, callData) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.processMotion)( \
      (dsm), (clientData), (callData))
#define DSMProcessDrop(dsm, clientData, callData) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.processDrop)( \
      (dsm), (clientData), (callData))
#define DSMOperationChanged(dsm, clientData, callData) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.operationChanged)( \
      (dsm), (clientData), (callData))
#define DSMChangeRoot(dsm, clientData, callData) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.changeRoot)( \
      (dsm), (clientData), (callData))
#define DSMInsertInfo(dsm, info, call_data) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.insertInfo)( \
      (dsm), (info), (call_data))
#define DSMRemoveInfo(dsm, info) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.removeInfo)((dsm), (info))
#define DSMSyncTree(dsm, shell) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.syncTree)((dsm), (shell))
#define DSMGetTreeFromDSM(dsm, shell, dataPtr) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.getTreeFromDSM)( \
      (dsm), (shell), (dataPtr))
#define DSMCreateTable(dsm) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.createTable)((dsm))
#define DSMDestroyTable(dsm) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.destroyTable)((dsm))
#define DSMRegisterInfo(dsm, widget, info) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.registerInfo)( \
      (dsm), (widget), (info))
#define DSMWidgetToInfo(dsm, widget) \
  (XtPointer)((((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.widgetToInfo)( \
      (dsm), (widget)))
#define DSMUnregisterInfo(dsm, info) \
  (((XmDropSiteManagerObjectClass)XtClass(dsm))->dropManager_class.unregisterInfo)((dsm), (info))
