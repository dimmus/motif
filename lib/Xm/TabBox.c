...
static void CalcTabSize _ARGS((XmTabBoxWidget,
                               XmTabAttributes,
                               XmTabOrientation,
                               XmFontList,
                               int,
...
static Boolean CvtStringToTabOrientation
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static Boolean CvtStringToTabSide
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static Boolean CvtStringToTabStyle
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static Boolean CvtStringToTabMode
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static Boolean CvtStringToTabEdge
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
#ifdef SCROLLED_LAYOUT
static Boolean CvtStringToArrowPlacement
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
#endif
static Boolean CvtStringToTabList
    _ARGS((Display *, XrmValue *, Cardinal *, XrmValue *, XrmValue *, XtPointer *));
static void CvtDestroyTabList _ARGS((XtAppContext, XrmValue *, XtPointer, XrmValue *, Cardinal *));
static void XiDrawCorner _ARGS(
    (Display *, Drawable, GC, GC, int, int, unsigned int, unsigned int, unsigned int, XiQuadrant));
...
static void DrawVerticalTab _ARGS((XmTabBoxWidget,
                                   ...
                                   _XiBoolean,
                                   _XiBoolean));
static void DrawLeftToRightTab _ARGS((XmTabBoxWidget,
                                      XmTabAttributes,
                                      GC,
                                      _XiBoolean,
                                      int,
                                      ...
                                      int,
                                      XRectangle *));
static void DrawRightToLeftTab _ARGS((XmTabBoxWidget,
                                      XmTabAttributes,
                                      GC,
                                      _XiBoolean,
                                      int,
                                      ...
                                      XRectangle *,
                                      _XiBoolean));
static void DrawTopToBottomTab _ARGS((XmTabBoxWidget,
                                      XmTabAttributes,
                                      GC,
                                      _XiBoolean,
                                      int,
                                      ...
                                      XRectangle *,
                                      _XiBoolean));
static void DrawBottomToTopTab _ARGS((XmTabBoxWidget,
                                      XmTabAttributes,
                                      GC,
                                      _XiBoolean,
                                      int,
...
#endif
#define XiRectInRegion(r, x, y, w, h) ((r) == False ? RectangleIn : XRectInRegion(r, x, y, w, h))
...
#define XiTabDegree(x) \
  ((x) == XmTABS_RIGHT_TO_LEFT ? \
       180 : \
       ((x) == XmTABS_TOP_TO_BOTTOM ? 90 : ((x) == XmTABS_BOTTOM_TO_TOP ? 270 : 0)))
#define ValidPixmap(p) \
  ((p) != (Pixmap)NULL && (p) != (Pixmap)XmUNSPECIFIED_PIXMAP && (p) != XmPIXMAP_DYNAMIC)
#define XiCalcTabSize(t, i, w, h) \
  CalcTabSize((t), \
              (i), \
              XmTabBox_tab_orientation((t)), \
              XmTabBox_font_list((t)), \
              (t)->manager.shadow_thickness, \
              XmTabBox_highlight_thickness((t)), \
              XmTabBox_tab_margin_width((t)), \
              XmTabBox_tab_margin_height((t)), \
              XmTabBox_tab_label_spacing((t)), \
              XmTabBox__corner_size((t)), \
              (w), \
              (h))
...
#define XiBackgroundSpecified(i) \
  ((i)->background != XmCOLOR_DYNAMIC || ValidPixmap((i)->background_pixmap))
...
#define XiSelectSpecified(t) \
  (XmTabBox_select_color((t)) != XmCOLOR_DYNAMIC || ValidPixmap(XmTabBox_select_pixmap((t))))
...
static XtResource resources[] = {
    ...
    {XmNtabMode,
     ...
     XmRTabMode,
     sizeof(XmTabMode),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_mode),
     XmRImmediate,
     (XtPointer)XmTABS_BASIC},
    {XmNtabList,
     XmCTabList,
     XmRTabList,
     sizeof(XmTabbedStackList),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_list),
     XmRImmediate,
     (XtPointer)NULL},
    {XmNtabOrientation,
     XmCTabOrientation,
     ...
     XtOffsetOf(XmTabBoxRec, tab_box.tab_orientation),
     XmRImmediate,
     (XtPointer)XmTABS_LEFT_TO_RIGHT},
    {XmNtabAutoSelect,
     XmCTabAutoSelect,
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_auto_select),
     XmRImmediate,
     (XtPointer)True},
    {XmNorientation,
     XmCOrientation,
     ...
     XtOffsetOf(XmTabBoxRec, tab_box.orientation),
     XmRImmediate,
    ...
    {XmNuniformTabSize,
     ...
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabBoxRec, tab_box.uniform_tab_size),
     XmRImmediate,
     (XtPointer)True},
    {XmNtabSelectColor,
     XmCTabSelectColor,
     XmRXmPixel,
     sizeof(Pixel),
     XtOffsetOf(XmTabBoxRec, tab_box.select_color),
     XmRImmediate,
    ...
    {XmNtabSelectPixmap,
     ...
     XmRXmPixmap,
     sizeof(Pixel),
     XtOffsetOf(XmTabBoxRec, tab_box.select_pixmap),
     XmRImmediate,
    ...
    {XmNtabMarginWidth,
     ...
     XmRDimension,
     sizeof(Dimension),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_margin_width),
     XmRImmediate,
     (XtPointer)2},
    {XmNtabMarginHeight,
     XmCMarginHeight,
     XmRDimension,
     sizeof(Dimension),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_margin_height),
     XmRImmediate,
     (XtPointer)2},
    {XmNtabLabelSpacing,
     XmCTabLabelSpacing,
     XmRDimension,
     sizeof(Dimension),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_label_spacing),
     XmRImmediate,
     (XtPointer)2},
    {XmNtabCornerPercent,
     XmCTabCornerPercent,
     XmRInt,
     sizeof(int),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_corner_percent),
     XmRImmediate,
     (XtPointer)40},
    {XmNnumStacks,
     XmCNumStacks,
     XmRInt,
     sizeof(int),
     XtOffsetOf(XmTabBoxRec, tab_box.num_stacks),
     XmRImmediate,
     (XtPointer)5},
#ifdef SCROLLED_LAYOUT
    {XmNtabArrowPlacement,
     XmCTabArrowPlacement,
     XmRTabArrowPlacement,
     sizeof(int),
     XtOffsetOf(XmTabBoxRec, tab_box.arrow_placement),
     XmRImmediate,
     (XtPointer)XmTAB_ARROWS_ON_LEFT},
#endif
    {XmNtabEdge,
     XmCTabEdge,
     XmRTabEdge,
     sizeof(XmTabEdge),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_edge),
     XmRImmediate,
     (XtPointer)XmTAB_EDGE_BOTTOM_RIGHT},
    {XmNtabOffset,
     XmCTabOffset,
     XmRDimension,
     sizeof(Dimension),
     XtOffsetOf(XmTabBoxRec, tab_box.tab_offset),
     XmRImmediate,
     (XtPointer)10},
    {"pri.vate",
     "Pri.vate",
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabBoxRec, tab_box.check_set_render_table),
     XmRImmediate,
     (XtPointer)False},
    {XmNfontList,
     XmCFontList,
     XmRFontList,
     sizeof(XmFontList),
     XtOffsetOf(XmTabBoxRec, tab_box.font_list),
     XmRCallProc,
    ...
    {XmNhighlightThickness,
     ...
     XmRDimension,
     sizeof(Dimension),
     XtOffsetOf(XmTabBoxRec, tab_box.highlight_thickness),
     XmRImmediate,
     (XtPointer)2},
    {XmNstackedEffect,
     XmCStackedEffect,
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabBoxRec, tab_box.stacked_effect),
     XmRImmediate,
     (XtPointer)True},
    {XmNuseImageCache,
     XmCUseImageCache,
     XmRBoolean,
     sizeof(Boolean),
     XtOffsetOf(XmTabBoxRec, tab_box.use_image_cache),
     XmRImmediate,
     (XtPointer)True},
    {XmNselectedIndex,
     XmCSelectedIndex,
     XmRInt,
     sizeof(int),
     XtOffsetOf(XmTabBoxRec, tab_box.selected_index),
     XmRImmediate,
     (XtPointer)-1},
    {XmNtraversalIndex,
     XmCTraversalIndex,
     XmRInt,
     sizeof(int),
     XtOffsetOf(XmTabBoxRec, tab_box.traversal_index),
     XmRImmediate,
     (XtPointer)-1},
    {XmNselectCallback,
     XmCCallback,
     ...
     XtOffsetOf(XmTabBoxRec, tab_box.select_callback),
     XmRImmediate,
     (XtPointer)NULL},
    {XmNunselectCallback,
     XmCCallback,
     XmRCallback,
     sizeof(XtCallbackList),
     XtOffsetOf(XmTabBoxRec, tab_box.unselect_callback),
     XmRImmediate,
     (XtPointer)NULL}};
...
XiTabCanvasClassRec xmTabCanvasClassRec = {{/* Core Fields */
                                           ...
                                           {/* EPak Tab Canvas Fields */
                                            /* extension          */ NULL}};
XmTabBoxClassRec xmTabBoxClassRec = {{/* Core Fields */
...
{
  XtSetTypeConverter(
      XmRString, XmRTabOrientation, CvtStringToTabOrientation, NULL, 0, XtCacheNone, NULL);
...
#ifdef SCROLLED_LAYOUT
  XtSetTypeConverter(
      XmRString, XmRTabArrowPlacement, CvtStringToArrowPlacement, NULL, 0, XtCacheNone, NULL);
#endif
  XtSetTypeConverter(
      XmRString, XmRTabList, CvtStringToTabList, NULL, 0, XtCacheNone, CvtDestroyTabList);
}
...
static void Initialize(Widget request, Widget set, ArgList arg_list, Cardinal *arg_cnt)
{
  ...
  if (XmTabBox_font_list(st) == NULL) {
    XmTabBox_font_list(st) = XmeGetDefaultRenderTable((Widget)st, XmLABEL_FONTLIST);
  }
  ...
  XmTabBox__canvas(st) = XtCreateManagedWidget(
      "canvas", xmTabCanvasWidgetClass, set, filtered_args, num_filtered_args);
#ifdef SCROLLED_LAYOUT
  XmTabBox__left_arrow(st) = XtCreateWidget(
      "leftArrow", xmArrowButtonWidgetClass, set, filtered_args, num_filtered_args);
  XmTabBox__right_arrow(st) = XtCreateWidget(
      "rightArrow", xmArrowButtonWidgetClass, set, filtered_args, num_filtered_args);
#endif
  ...
  XmTabBox__gray_stipple(st) = XmGetPixmapByDepth(XtScreen(st), XmS50_foreground, 1, 0, 1);
...
static void Destroy(Widget widget)
{
  ...
  /* CR03218 */
  if (XmTabBox__tab_GC(tab))
    XtReleaseGC((Widget)tab, XmTabBox__tab_GC(tab));
...
static void Redisplay(Widget widget, XEvent *event, Region region)
{
  ...
  int count = _XmTabbedStackListCount(list), shadow = tab->manager.shadow_thickness;
...
{
  XmTabBoxWidget c_tab = (XmTabBoxWidget)current, s_tab = (XmTabBoxWidget)set;
  Boolean need_layout = False, need_resize = False, clear_cache = False;
  ...
  if (XmTabBox_tab_list(c_tab) != XmTabBox_tab_list(s_tab)) {
    if (XmTabbedStackListCompare(XmTabBox_tab_list(s_tab), XmTabBox_tab_list(c_tab)) ==
        XmTAB_CMP_SIZE)
    {
      clear_cache = True;
      need_resize = True;
  ...
  if (c_tab->manager.shadow_thickness != s_tab->manager.shadow_thickness ||
      cfield(tab_style) != sfield(tab_style) || cfield(tab_mode) != sfield(tab_mode) ||
...
#endif
      cfield(tab_edge) != sfield(tab_edge) || cfield(tab_offset) != sfield(tab_offset) ||
...
static void BorderHighlight(Widget widget)
{
  XmTabBoxWidget tab = XiTabParent(widget);
  DrawBorder(tab, tab->manager.highlight_GC, -1);
}

static void BorderUnhighlight(Widget widget)
{
  XmTabBoxWidget tab = XiTabParent(widget);
 ...
 *	None.
 */
static void XmTabBoxArmAndActivate(Widget widget,
                                   XEvent *event,
                                   String *params,
                                   Cardinal *num_params)
{
  XmTabBoxWidget tab = XiTabParent(widget);
  int old = XmTabBox__selected(tab), idx = XmTabBox__keyboard(tab);
  SelectTab(tab, event, old, idx);
}

static void XmTabBoxArmTab(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmTabBoxWidget tab = XiTabParent(widget);
  int old, idx;
  XmProcessTraversal(widget, XmTRAVERSE_CURRENT);
  if (event == NULL || event->xany.type != ButtonPress)
    return;
  idx = XmTabBox__armed_tab(tab) = XiXYtoTab(tab, event->xbutton.x, event->xbutton.y);
  if (!IsTabSensitive(tab, idx))
    return;
 ...
 *	None.
 */
static void XmTabBoxSelectTab(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmTabBoxWidget tab = XiTabParent(widget);
  int idx;
  /*
   ...
   */
  if (event == NULL || event->xany.type != ButtonRelease || XmTabBox__armed_tab(tab) == -1)
    return;
  /*
...
static void _XmTabBoxTraverseRight(Widget widget,
                                   XEvent *event,
                                   String *params,
                                   Cardinal *num_params)
{
...
static void XmTabBoxTraverseRight(Widget widget,
                                  XEvent *event,
                                  String *params,
                                  Cardinal *num_params)
{
...
static void _XmTabBoxTraverseLeft(Widget widget,
                                  XEvent *event,
                                  String *params,
                                  Cardinal *num_params)
{
...
static void XmTabBoxTraverseLeft(Widget widget,
                                 XEvent *event,
                                 String *params,
                                 Cardinal *num_params)
{
...
static void _XmTabBoxTraverseUp(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmTabBoxWidget tab = XiTabParent(widget);
  ...
  switch (XmTabBox_tab_mode(tab)) {
    ...
    case XmTABS_STACKED_STATIC:
      ...
      if (set < 0 || set == old || new_row == old_row)
        return;
      old_selected = XmTabBox__selected(tab);
      XmTabBox__keyboard(tab) = set;
      DrawBorder(tab, tab->manager.background_GC, old);
...
static void XmTabBoxTraverseUp(Widget widget, XEvent *event, String *params, Cardinal *num_params)
{
  XmTabBoxWidget tab = XiTabParent(widget);
  if (XmTabBox_orientation(tab) == XmVERTICAL) {
    _XmTabBoxTraverseLeft(widget, event, params, num_params);
...
static void _XmTabBoxTraverseDown(Widget widget,
                                  XEvent *event,
                                  String *params,
                                  Cardinal *num_params)
{
...
static void XmTabBoxTraverseDown(Widget widget,
                                 XEvent *event,
                                 String *params,
                                 Cardinal *num_params)
{
...
static void XmTabBoxTraversePrevious(Widget widget,
                                     XEvent *event,
                                     String *params,
                                     Cardinal *num_params)
{
  XmTabBoxWidget tab = XiTabParent(widget);
  int cnt = _XmTabbedStackListCount(XmTabBox_tab_list(tab)), idx, old, tmp, old_selected;
  if (cnt == 0)
    return;
  old = XmTabBox__keyboard(tab);
  old_selected = XmTabBox__selected(tab);
  ...
  if (XmTabBox_tab_mode(tab) == XmTABS_STACKED || XmTabBox_tab_mode(tab) == XmTABS_STACKED_STATIC)
  {
    do {
      ...
      {
        if (XmTabBox__actual(tab)[idx].row != XmTabBox__actual(tab)[tmp].row &&
            XmTabBox_tab_edge(tab) == XmTAB_EDGE_BOTTOM_RIGHT)
        {
          int row = XmTabBox__actual(tab)[tmp].row + 1, col;
          if (row >= XmTabBox__num_rows(tab))
            row = 0;
...
static void XmTabBoxTraverseNext(Widget widget,
                                 XEvent *event,
                                 String *params,
                                 Cardinal *num_params)
{
...
static void CalcTabSize(XmTabBoxWidget tab,
                        XmTabAttributes info,
...
static void CalcUnlimitedGeometry(XmTabBoxWidget tab, XRectangle *geometry)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
  XmTabAttributes info;
  int i, count = _XmTabbedStackListCount(list), width, height, max_width, max_height, tab_width,
         tab_height;
 ...
 *	None.
 */
static void CalcGeometry(XmTabBoxWidget tab, XRectangle *geometry)
{
   ...
   */
  if (XmTabBox__keyboard(tab) < 0)
    XmTabBox__keyboard(tab) = 0;
  if (XmTabBox__selected(tab) < 0)
    XmTabBox__selected(tab) = 0;
  switch (XmTabBox_tab_mode(tab)) {
    case XmTABS_STACKED:
    case XmTABS_STACKED_STATIC:
...
static void DrawSegments(XmTabBoxWidget tab,
                         XmTabAttributes info,
                         XiTabRect *geometry,
                         XmTabEdge edge,
                         int corner_size,
  ...
  switch (edge) {
      ...
      if (XmTabBox_orientation(tab) == XmHORIZONTAL) {
        ...
        if (!selected && geometry->row == 0) {
          if ((geometry->column == 0 && !LayoutIsRtoLP(tab)) ||
              ((geometry->column == XmTabBox__num_columns(tab) - 1) && LayoutIsRtoLP(tab)))
          {
    ...
    case XmTAB_EDGE_BOTTOM_RIGHT:
      if (XmTabBox_orientation(tab) == XmHORIZONTAL) {
        ...
        if (selected) {
          ...
          if ((!stacked &&
              ...
              (stacked && geometry->row == 0 &&
               (((geometry->column != XmTabBox__num_columns(tab) - 1) && !LayoutIsRtoLP(tab)) ||
                XmTabBox__num_rows(tab) == 1 || !XmTabBox_stacked_effect(tab))))
          {
            XmDrawBevel(XtDisplay(tab),
                        XiCanvas(tab),
                        tab->manager.bottom_shadow_GC,
        ...
        else if ((stacked && XmTabBox_stacked_effect(tab) && XmTabBox__num_rows(tab) > 1 &&
                  geometry->row == 0 &&
                  ((geometry->column == XmTabBox__num_columns(tab) - 1 && !LayoutIsRtoLP(tab)) ||
                   (geometry->column == 0 && LayoutIsRtoLP(tab)))) ||
                 (!stacked &&
        ...
        if (selected) {
          XFillRectangle(XtDisplay(tab),
                         ...
                         shadow,
                         (int)geometry->height - 2 * shadow);
          if (!stacked || (stacked && geometry->row == 0 &&
                            ...
                            XmTabBox__num_rows(tab) == 1 || !XmTabBox_stacked_effect(tab))))
          {
            XmDrawBevel(XtDisplay(tab),
                 ...
                 geometry->row == 0 && geometry->column == XmTabBox__num_columns(tab) - 1)
        {
          XmDrawBevel(XtDisplay(tab),
                      XiCanvas(tab),
                      tab->manager.top_shadow_GC,
...
static void DrawSquareShadows(XmTabBoxWidget tab,
                              XmTabAttributes info,
                              XiTabRect *geometry,
                              Boolean selected,
                              XmTabEdge edge,
      ...
      if (XmTabBox_orientation(tab) == XmHORIZONTAL) {
        ...
        if (selected) {
          ...
          if (LayoutIsRtoLP(tab)) {
            ...
            if ((!stacked && ((((geometry->column != XmTabBox__num_columns(tab) - 1) &&
                                !LayoutIsRtoLP(tab))) ||
                              (geometry->column != 0 && LayoutIsRtoLP(tab)))) ||
                (stacked && geometry->row == 0 &&
                 (geometry->column != XmTabBox__num_columns(tab) - 1 ||
...
static void DrawRoundedShadows(XmTabBoxWidget tab,
                               XmTabAttributes info,
                               XiTabRect *geometry,
                               Boolean selected,
                               XmTabEdge edge,
                               int shadow)
{
  ...
  if (geometry->width < geometry->height) {
    if (size > (int)geometry->width / 2)
      size = (int)geometry->width / 2;
  }
  else {
    if (size > (int)geometry->height / 2)
      size = (int)geometry->height / 2;
  }
...
static void DrawBeveledShadows(XmTabBoxWidget tab,
                               XmTabAttributes info,
                               XiTabRect *geometry,
                               Boolean selected,
                               XmTabEdge edge,
...
static void DrawTab(XmTabBoxWidget tab,
                    XmTabAttributes info,
                    XiTabRect *geometry,
                    Boolean selected,
                    Boolean keyboard)
{
   ...
   */
  if (!XtIsRealized(canvas) || info == NULL)
    return;
  if ((XmTabBox_tab_mode(tab) == XmTABS_STACKED ||
       XmTabBox_tab_mode(tab) == XmTABS_STACKED_STATIC) &&
    ...
    if (above != NULL) {
      ...
      if (XiBackgroundSpecified(above)) {
        ...
        if (ValidPixmap(tab->core.background_pixmap)) {
          SetTiledXYGC(
              XtDisplay(tab), gc, tab->core.background_pixmap, -(tab->core.x), -(tab->core.y));
        }
        else {
      ...
      Pixel pixel;
      Pixmap pixmap;
      XtVaGetValues(gcParent, XmNbackground, &pixel, XmNbackgroundPixmap, &pixmap, NULL);
      if (ValidPixmap(pixmap)) {
...
static Boolean CvtStringToTabOrientation(Display *dpy,
                                         XrmValue *arg_list,
                                         Cardinal *arg_cnt,
                                         XrmValue *from,
                                         XrmValue *to,
...
static Boolean CvtStringToTabSide(Display *dpy,
                                  XrmValue *arg_list,
                                  Cardinal *arg_cnt,
                                  XrmValue *from,
                                  XrmValue *to,
...
static Boolean CvtStringToTabStyle(Display *dpy,
                                   XrmValue *arg_list,
                                   Cardinal *arg_cnt,
                                   XrmValue *from,
                                   XrmValue *to,
...
static Boolean CvtStringToTabMode(Display *dpy,
                                  XrmValue *arg_list,
                                  Cardinal *arg_cnt,
                                  XrmValue *from,
                                  XrmValue *to,
...
static Boolean CvtStringToTabEdge(Display *dpy,
                                  XrmValue *arg_list,
                                  Cardinal *arg_cnt,
                                  XrmValue *from,
                                  XrmValue *to,
...
#ifdef SCROLLED_LAYOUT
static Boolean CvtStringToArrowPlacement(Display *dpy,
                                         XrmValue *arg_list,
                                         Cardinal *arg_cnt,
                                         XrmValue *from,
                                         XrmValue *to,
...
static Boolean CvtStringToTabList(Display *dpy,
                                  XrmValue *arg_list,
                                  Cardinal *arg_cnt,
                                  XrmValue *from,
                                  XrmValue *to,
...
static void CvtDestroyTabList(
    XtAppContext app_context, XrmValue *to, XtPointer data, XrmValue *args, Cardinal *num_args)
{
}

static short XiCosSinData[][2] = {
    {1000, 0},  {998, 52},  {994, 104}, {987, 156}, {978, 207}, {965, 258}, {951, 309}, {933, 358},
    {913, 406}, {891, 453}, {866, 499}, {838, 544}, {809, 587}, {777, 629}, {743, 669}, {707, 707},
    {669, 743}, {629, 777}, {587, 809}, {544, 838}, {500, 866}, {453, 891}, {406, 913}, {358, 933},
    {309, 951}, {258, 965}, {207, 978}, {156, 987}, {104, 994}, {52, 998},  {0, 1000}};
#define NUM_PTS 31
#define NUM_PTSx2 62
#define HALF_PTS 16
...
static void XiDrawCorner(Display *dpy,
                         Drawable d,
                         GC top_gc,
                         GC bottom_gc,
                         int x,
...
static void XiFillCorner(Display *dpy,
                         Drawable d,
                         GC gc,
                         int x,
                         int y,
...
static void HorizontalBasicLayout(XmTabBoxWidget tab)
{
...
static void VerticalBasicLayout(XmTabBoxWidget tab)
{
...
static void Layout(XmTabBoxWidget tab)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
 ...
 *	None.
 */
static void HorizontalBasicRedisplay(XmTabBoxWidget tab)
{
  XiTabRect *geom;
 ...
 *	None.
 */
static void VerticalBasicRedisplay(XmTabBoxWidget tab)
{
  XiTabRect *geom;
 ...
 */
static XImage *XiRotateImage(XmTabBoxWidget tab, XImage *src, int degree)
{
  XImage *dst;
  char *data;
...
static int XiXYtoTab(XmTabBoxWidget tab, int x, int y)
{
  ...
  for (i = 0; i < cnt; ++i) {
    if (x < area[i].x || x > (area[i].x + (int)area[i].width) || y < area[i].y ||
        y > (area[i].y + (int)area[i].height))
    {
      continue;
    }
    return (i);
  ...
  if (XmTabBox_orientation(tab) == XmHORIZONTAL) {
     ...
     * done.
     */
    if (row == -1 || row == (XmTabBox__num_rows(tab) - 1))
      return (-1);
    /*
     ...
     * we found a winner.
     */
    for (i = 0, ++row, idx = 0; idx >= 0 && i < XmTabBox__num_columns(tab); ++i) {
...
static int CalcGeometryMinor(XmTabBoxWidget tab, int major_d)
{
  ...
  if (XmTabBox_orientation(tab) == XmHORIZONTAL) {
    ...
    switch (XmTabBox_tab_mode(tab)) {
      ...
      case XmTABS_STACKED:
      case XmTABS_STACKED_STATIC: {
        int per_line, num_rows, tmp, tab_width, tab_height, offset = XmTabBox_tab_offset(tab);
...
static int CalcGeometryMajor(XmTabBoxWidget tab, int minor_d)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
 ...
 *	None.
 */
static void CallCallbacks(XmTabBoxWidget tab, XEvent *event, int from, int to)
{
...
/* ARGSUSED */
static void DrawLeftToRightTab(XmTabBoxWidget tab,
                               XmTabAttributes info,
                               GC gc,
                               Boolean have_pixmap,
                               int pix_width,
                               ...
                               XRectangle *clip)
{
  ...
  if (!sensitive) {
    ...
    XFillRectangle(
        XtDisplay(tab), XiCanvas(tab), tab->manager.background_GC, x, y, pix_width, pix_height);
 ...
 */
/* ARGSUSED */
static void DrawRightToLeftTab(XmTabBoxWidget tab,
                               XmTabAttributes info,
                               GC gc,
                               Boolean have_pixmap,
                               int pix_width,
                               ...
                               Boolean selected)
{
  ...
  if (have_pixmap) {
    ...
    if (!XmTabBox_use_image_cache(tab) || (dst_ximage = CachePixmap(tab, info)) == NULL) {
      src_ximage = XGetImage(
          XtDisplay(tab), info->label_pixmap, 0, 0, pix_width, pix_height, AllPlanes, XYPixmap);
   ...
   * label string.
   */
  if (!have_label || info->label_string == NULL)
    return;
  /*
   ...
   */
  src_ximage = NULL;
  if (!XmTabBox_use_image_cache(tab) || (sensitive != CacheSensitive(tab, info)) ||
      (dst_ximage = CacheLabel(tab, info)) == NULL)
  {
    if (ValidPixmap(XmTabBox__bitmap(tab)) &&
        (XmTabBox__bitmap_width(tab) < label_width || XmTabBox__bitmap_height(tab) < label_height))
    {
      /*
     ...
     */
    if (!ValidPixmap(XmTabBox__bitmap(tab))) {
      XmTabBox__bitmap(tab) = XCreatePixmap(
          XtDisplay(tab), XiCanvas(tab), label_width, label_height, 1);
    ...
    if (XmTabBox__zero_GC(tab) == NULL) {
      ...
      XmTabBox__zero_GC(tab) = XCreateGC(
   ...
   */
  if (ValidPixmap(tab->core.background_pixmap) || XiBackgroundSpecified(info) ||
      (selected && XiSelectSpecified(tab)))
  {
    ...
    Pixmap pix = XCreatePixmap(
        XtDisplay(tab),
        (XtIsRealized((Widget)tab) ? XtWindow(tab) : RootWindowOfScreen(XtScreen(tab))),
        label_width,
        label_height,
        1);
    /*
    ...
    XPutImage(
        XtDisplay(tab), XiCanvas(tab), gc, dst_ximage, 0, 0, x, y, label_width, label_height);
    /*
 ...
 *	None.
 */
static void DrawBottomToTopTab(XmTabBoxWidget tab,
                               XmTabAttributes info,
                               GC gc,
                               Boolean have_pixmap,
                               int pix_width,
 ...
 *	None.
 */
static void DrawTopToBottomTab(XmTabBoxWidget tab,
                               XmTabAttributes info,
                               GC gc,
                               Boolean have_pixmap,
                               int pix_width,
 ...
 */
/* ARGSUSED */
static void DrawVerticalTab(XmTabBoxWidget tab,
                            XmTabAttributes info,
                            GC gc,
                            Boolean have_pixmap,
                            int pix_width,
...
static void FillRoundedTab(XmTabBoxWidget tab, GC gc, XiTabRect *geometry, XmTabEdge edge)
{
  XRectangle rect[2];
  int x = geometry->x, y = geometry->y, width = geometry->width, height = geometry->height, side;
  ...
  switch (edge) {
    ...
    default:
      if (XmTabBox_orientation(tab) == XmHORIZONTAL) {
        ...
        rect[1].height = side;
        XiFillCorner(
            XtDisplay(tab), XiCanvas(tab), gc, x, y + height - side, side, side, XiQUAD_3);
        XiFillCorner(XtDisplay(tab),
                     XiCanvas(tab),
                     gc,
                     x + width - side,
                     y + height - side,
...
static void FillBeveledTab(XmTabBoxWidget tab, GC gc, XiTabRect *geometry, XmTabEdge edge)
{
  XPoint pt[6];
  int x = geometry->x, y = geometry->y, width = geometry->width, height = geometry->height, side;
  side = XmTabBox__corner_size(tab);
...
int XmTabBoxGetIndex(Widget widget, int x, int y)
{
  return (XiXYtoTab((XmTabBoxWidget)widget, x, y));
}

static void CalcStackedGeometry(XmTabBoxWidget tab, XRectangle *rect)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
  XmTabAttributes info;
  int i, count = _XmTabbedStackListCount(list), max_width, max_height, tab_width, tab_height,
...
static void HorizontalStackedLayout(XmTabBoxWidget tab, Boolean is_static)
{
  int i, x, y, width, per_line, num_rows, tab_width, tab_height, tmp, on_line, start_x, offset,
      row, idx, cnt = _XmTabbedStackListCount(XmTabBox_tab_list(tab));
  XiTabRect *actual = XmTabBox__actual(tab);
  XRectangle *wanted = XmTabBox__wanted(tab);
  if (cnt == 0)
    return;
   ...
   */
  if (is_static) {
    start_x = x = (LayoutIsRtoLP(tab) ? (per_line - 1) * tab_width + offset * (num_rows - 1) : 0);
    on_line = 0;
    row = 0;
    if (XmTabBox_tab_edge(tab) == XmTAB_EDGE_BOTTOM_RIGHT) {
...
static void VerticalStackedLayout(XmTabBoxWidget tab, Boolean is_static)
{
  int i, x, y, height, per_line, num_rows, tab_width, tab_height, tmp, on_line, start_y, offset,
      row, idx, cnt = _XmTabbedStackListCount(XmTabBox_tab_list(tab));
  XiTabRect *actual = XmTabBox__actual(tab);
  XRectangle *wanted = XmTabBox__wanted(tab);
  if (cnt == 0)
 ...
 *	None.
 */
static void RedisplayTabs(XmTabBoxWidget tab, Region region)
{
  XiTabRect *geom;
...
static void HorizontalStackedBottomEdgeRedisplay(XmTabBoxWidget tab)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
  int i, count = _XmTabbedStackListCount(list), row = 0, col,
         shadow = tab->manager.shadow_thickness, x = 0, height, offset, idx, below, corner, cnt,
         first, last, x1, x2;
  XmTabAttributes info;
  XiTabRect *geom;
  GC gc = XmTabBox__tab_GC(tab);
...
#define _NUM_RECTS 10
      ...
      (idx = GetTabIndex(tab, 0, XmTabBox__num_columns(tab) - 1)) >= 0)
  {
    Pixel pixel;
    Pixmap pixmap;
    XtVaGetValues(XiGCParent(tab), XmNbackground, &pixel, XmNbackgroundPixmap, &pixmap, NULL);
    if (ValidPixmap(pixmap)) {
   ...
   */
  if (GetTabIndex(tab, 0, XmTabBox__num_columns(tab) - 1) >= 0 && XmTabBox_stacked_effect(tab))
    return;
  /*
...
static void HorizontalStackedTopEdgeRedisplay(XmTabBoxWidget tab)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
  int i, count = _XmTabbedStackListCount(list), row = 0, col,
         shadow = tab->manager.shadow_thickness, x, height, offset, idx, below, corner, cnt, first,
         last, x1, x2;
  XmTabAttributes info;
  XiTabRect *geom;
  GC gc = XmTabBox__tab_GC(tab);
...
#define _NUM_RECTS 10
  ...
  for (i = 0; i < count; ++i) {
    ...
    if (geom[i].row > 0 && (corner < 0 || below < 0)) {
      ...
      if (do_bottom) {
        XFillRectangle(XtDisplay(tab),
                       XiCanvas(tab),
                       LayoutIsRtoLP(tab) ? tab->manager.top_shadow_GC :
                                            tab->manager.bottom_shadow_GC,
                       bottom.x,
                       bottom.y,
                       bottom.width,
   ...
   */
  XFillRectangle(
      XtDisplay(tab), XiCanvas(tab), tab->manager.bottom_shadow_GC, x1, 0, x2 - x1, shadow);
}

static void HorizontalStackedRedisplay(XmTabBoxWidget tab)
{
  if (XmTabBox_tab_edge(tab) == XmTAB_EDGE_BOTTOM_RIGHT) {
...
static void VerticalStackedRightEdgeRedisplay(XmTabBoxWidget tab)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
  int i, count = _XmTabbedStackListCount(list), row = 0, col,
         shadow = tab->manager.shadow_thickness, y, width, offset, idx, below, corner, cnt = 0,
         first, last, y1, y2;
  XmTabAttributes info;
  XiTabRect *geom;
  GC gc = XmTabBox__tab_GC(tab);
...
static void VerticalStackedLeftEdgeRedisplay(XmTabBoxWidget tab)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
  int i, count = _XmTabbedStackListCount(list), row = 0, col,
         shadow = tab->manager.shadow_thickness, y, width, offset, idx, below, corner, cnt = 0,
...
#define _NUM_RECTS 10
   ...
   */
  XFillRectangle(
      XtDisplay(tab), XiCanvas(tab), tab->manager.bottom_shadow_GC, 0, y1, shadow, y2 - y1);
}

static void VerticalStackedRedisplay(XmTabBoxWidget tab)
{
  if (XmTabBox_tab_edge(tab) == XmTAB_EDGE_BOTTOM_RIGHT) {
...
static XmTabAttributes GetTabInfo(XmTabBoxWidget tab, int row, int column)
{
...
static int GetTabIndex(XmTabBoxWidget tab, int row, int column)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
...
static void SelectTab(XmTabBoxWidget tab, XEvent *event, int old, int set)
{
  int old_row, set_row;
  if (old == set)
    return;
  ...
  if (XmTabBox_tab_mode(tab) == XmTABS_STACKED && old_row != set_row) {
    ...
    if (old != -1) {
      DrawTab(tab,
              _XmTabbedStackListGet(XmTabBox_tab_list(tab), old),
              &(XmTabBox__actual(tab)[old]),
              False,
              False);
    }
    DrawTab(tab,
            _XmTabbedStackListGet(XmTabBox_tab_list(tab), set),
            &(XmTabBox__actual(tab)[set]),
            True,
            True);
  }
...
void _XmTabBoxSelectTab(Widget widget, int idx)
{
  XmTabBoxWidget tab = (XmTabBoxWidget)widget;
  if (!XmIsTabBox(widget) || idx < 0 || idx >= _XmTabbedStackListCount(XmTabBox_tab_list(tab)))
    return;
  SelectTab(tab, NULL, XmTabBox__selected(tab), idx);
}

static Boolean IsTabSensitive(XmTabBoxWidget tab, int idx)
{
...
void _XmTabBoxStackedGeometry(XmTabBoxWidget tab, Dimension size, XRectangle *rect)
{
  XmTabbedStackList list = XmTabBox_tab_list(tab);
  XmTabAttributes info;
  int i, count = _XmTabbedStackListCount(list), max_width, max_height, tab_width, tab_height,
...
int XmTabBoxGetNumRows(Widget widget)
{
  XmTabBoxWidget tab = (XmTabBoxWidget)widget;
...
int XmTabBoxGetNumColumns(Widget widget)
{
  XmTabBoxWidget tab = (XmTabBoxWidget)widget;
  if (!XmIsTabBox(widget))
    return (0);
...
void _XmTabBoxGetNumRowsColumns(Widget widget, int size, int *num_rows, int *num_cols)
{
  XmTabBoxWidget tab = (XmTabBoxWidget)widget;
  ...
  *num_rows = 0;
  *num_cols = 0;
  if (!XmIsTabBox(widget) || (cnt = _XmTabbedStackListCount(XmTabBox_tab_list(tab))) == 0 ||
...
int _XmTabBoxGetMaxTabWidth(Widget widget)
{
  XmTabBoxWidget tab = (XmTabBoxWidget)widget;
  int i, max = 0, cnt;
  XRectangle *wanted;
...
int _XmTabBoxGetMaxTabHeight(Widget widget)
{
  XmTabBoxWidget tab = (XmTabBoxWidget)widget;
  int i, max = 0, cnt;
  XRectangle *wanted;
...
static Visual *GetShellVisual(Widget widget)
{
  Visual *visual;
  if (widget == NULL) {
    return (NULL);
  ...
  if (XtIsShell(widget)) {
    XtVaGetValues(widget, XmNvisual, &visual, NULL);
    return (visual);
  }
...
Widget XmCreateTabBox(Widget parent, String name, ArgList arg_list, Cardinal arg_cnt)
{
