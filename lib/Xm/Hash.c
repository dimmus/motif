...
XmHashTable _XmAllocHashTable(Cardinal size_hint, XmHashCompareProc cproc, XmHashFunction hproc)
{
  XmHashTable table;
  int i;
...
void _XmFreeHashTable(XmHashTable table)
{
  int i;
...
void _XmResizeHashTable(XmHashTable table, Cardinal new_size)
{
  int i, index;
  int oldsize;
...
XtPointer _XmGetHashEntryIterate(XmHashTable table, XmHashKey key, XtPointer *iterator)
{
  XmHashValue index;
  XmHashBucket entry;
...
void _XmAddHashEntry(XmHashTable table, XmHashKey key, XtPointer value)
{
  int hash;
  XmHashValue index;
  XmHashBucket entry;
...
XtPointer _XmRemoveHashEntry(XmHashTable table, XmHashKey key)
{
  XmHashValue index;
...
XtPointer _XmRemoveHashIterator(XmHashTable table, XtPointer *iterator)
{
  XmHashValue index;
...
Cardinal _XmHashTableCount(XmHashTable table)
{
  return (table->count);
}

Cardinal _XmHashTableSize(XmHashTable table)
{
  return (table->size);
}
...
/****************************************************************/
void _XmMapHashTable(XmHashTable table, XmHashMapProc proc, XtPointer client_data)
{
  int i;
