...
#  define IG_LargeIconRectWidth(w) (((XmIconGadget)(w))->icong.large_icon_rect_width)
#  define IG_LargeIconRectHeight(w) (((XmIconGadget)(w))->icong.large_icon_rect_height)
#  define IG_SmallIconRectWidth(w) (((XmIconGadget)(w))->icong.small_icon_rect_width)
#  define IG_SmallIconRectHeight(w) (((XmIconGadget)(w))->icong.small_icon_rect_height)
...
#  define IG_Depth(w) (((XmManagerWidget)(((XmGadget)(w))->object.parent))->core.depth)
...
#  define IG_InverseGC(w) (((XmIconGadget)(w))->icong.cache->inverse_GC)
/** These are gadget resources really. hopefully in 2.1,
    ...
    etc, etc ***/
#  define IG_Background(w) (((XmIconGadget)(w))->icong.cache->background)
#  define IG_Foreground(w) (((XmIconGadget)(w))->icong.cache->foreground)
#  define IG_TopShadowColor(w) (((XmIconGadget)(w))->icong.cache->top_shadow_color)
#  define IG_BottomShadowColor(w) (((XmIconGadget)(w))->icong.cache->bottom_shadow_color)
#  define IG_HighlightColor(w) (((XmIconGadget)(w))->icong.cache->highlight_color)
#  define IG_BackgroundPixmap(w) (((XmIconGadget)(w))->icong.cache->background_pixmap)
#  define IG_TopShadowPixmap(w) (((XmIconGadget)(w))->icong.cache->top_shadow_pixmap)
#  define IG_BottomShadowPixmap(w) (((XmIconGadget)(w))->icong.cache->bottom_shadow_pixmap)
#  define IG_HighlightPixmap(w) (((XmIconGadget)(w))->icong.cache->highlight_pixmap)
...
#  define IG_InsensitiveGC(w) (((XmIconGadget)(w))->icong.cache->insensitive_GC)
#  define IG_ShadowGC(w) (((XmIconGadget)(w))->icong.cache->shadow_GC)
#  define IG_TopShadowGC(w) (((XmIconGadget)(w))->icong.cache->top_shadow_GC)
#  define IG_BottomShadowGC(w) (((XmIconGadget)(w))->icong.cache->bottom_shadow_GC)
#  define IG_HighlightGC(w) (((XmIconGadget)(w))->icong.cache->highlight_GC)
