...
externaldef(xmVendorShellExtobjectclass) WidgetClass
   ...
   = (WidgetClass)(&xmVendorShellExtClassRec);
   ...
   XtArgVal *value)
{
   ...
   XGetWindowProperty(XtDisplay(shell), XtWindow(shell), mwm_hints_atom, 0, (long)PROP_MWM_HINTS_ELEMENTS, FALSE, mwm_hints_atom, &actual_type, &actual_format, &num_items, &bytes_after, (unsigned char **)&prop);
