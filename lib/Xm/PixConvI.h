...
extern void _XmTopShadowPixmapDefault(Widget widget, int offset, XrmValue *value);
extern void _XmHighlightPixmapDefault(Widget widget, int offset, XrmValue *value);
extern GC _XmGetPixmapBasedGC(Widget w, Pixel foreground, Pixel background, Pixmap pixmap);
