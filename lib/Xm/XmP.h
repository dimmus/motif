...
\
      if (to_rtn->addr) { \
        if (to_rtn->size < sizeof(type)) { \
          failure to_rtn->size = sizeof(type); \
          return FALSE; \
        } \
        else { \
...
#  define XmIsInDragMode(mask) (mask & XmMENU_IN_DRAG_MODE_BIT)
...
enum { XmGET_ACTUAL_SIZE = 1, XmGET_PREFERRED_SIZE, XmGEO_PRE_SET, XmGEO_POST_SET };

/* Defaults for Geometry Utility defines are always 0. */
enum { XmGEO_EXPAND, XmGEO_CENTER, XmGEO_PACK };

enum { XmGEO_PROPORTIONAL, XmGEO_AVERAGING, XmGEO_WRAP };
...
#  define XmIsCascadeButton(w) (_XmIsFastSubclass(XtClass(w), XmCASCADE_BUTTON_BIT))
#  undef XmIsCascadeButtonGadget
#  define XmIsCascadeButtonGadget(w) (_XmIsFastSubclass(XtClass(w), XmCASCADE_BUTTON_GADGET_BIT))
#  undef XmIsClipWindow
#  define XmIsClipWindow(w) (_XmIsFastSubclass(XtClass(w), XmCLIP_WINDOW_BIT))
#  undef XmIsComboBox
#  define XmIsComboBox(w) (_XmIsFastSubclass(XtClass(w), XmCOMBO_BOX_BIT))
#  undef XmIsCommandBox
#  define XmIsCommandBox(w) (_XmIsFastSubclass(XtClass(w), XmCOMMAND_BOX_BIT))
#  undef XmIsContainer
#  define XmIsContainer(w) (_XmIsFastSubclass(XtClass(w), XmCONTAINER_BIT))
#  undef XmIsDialogShell
#  define XmIsDialogShell(w) (_XmIsFastSubclass(XtClass(w), XmDIALOG_SHELL_BIT))
#  undef XmIsDisplay
#  define XmIsDisplay(w) (_XmIsFastSubclass(XtClass(w), XmDISPLAY_BIT))
#  undef XmIsGrabShell
#  define XmIsGrabShell(w) (_XmIsFastSubclass(XtClass(w), XmGRAB_SHELL_BIT))
#  undef XmIsIconGadget
#  define XmIsIconGadget(w) (_XmIsFastSubclass(XtClass(w), XmICONGADGET_BIT))
#  undef XmIsList
#  define XmIsList(w) (_XmIsFastSubclass(XtClass(w), XmLIST_BIT))
#  undef XmIsForm
#  define XmIsForm(w) (_XmIsFastSubclass(XtClass(w), XmFORM_BIT))
#  undef XmIsTextField
#  define XmIsTextField(w) (_XmIsFastSubclass(XtClass(w), XmTEXT_FIELD_BIT))
#  undef XmIsGadget
#  define XmIsGadget(w) (_XmIsFastSubclass(XtClass(w), XmGADGET_BIT))
#  undef XmIsLabel
#  define XmIsLabel(w) (_XmIsFastSubclass(XtClass(w), XmLABEL_BIT))
#  undef XmIsLabelGadget
#  define XmIsLabelGadget(w) (_XmIsFastSubclass(XtClass(w), XmLABEL_GADGET_BIT))
#  undef XmIsMainWindow
#  define XmIsMainWindow(w) (_XmIsFastSubclass(XtClass(w), XmMAIN_WINDOW_BIT))
#  undef XmIsManager
#  define XmIsManager(w) (_XmIsFastSubclass(XtClass(w), XmMANAGER_BIT))
#  undef XmIsMenuShell
#  define XmIsMenuShell(w) (_XmIsFastSubclass(XtClass(w), XmMENU_SHELL_BIT))
#  undef XmIsNotebook
#  define XmIsNotebook(w) (_XmIsFastSubclass(XtClass(w), XmNOTEBOOK_BIT))
#  undef XmIsDragIcon
#  define XmIsDragIcon(w) (_XmIsFastSubclass(XtClass(w), XmDRAG_ICON_BIT))
#  undef XmIsDropSiteManager
#  define XmIsDropSiteManager(w) (_XmIsFastSubclass(XtClass(w), XmDROP_SITE_MANAGER_BIT))
#  undef XmIsDropTransfer
#  define XmIsDropTransfer(w) (_XmIsFastSubclass(XtClass(w), XmDROP_TRANSFER_BIT))
#  undef XmIsDragOverShell
#  define XmIsDragOverShell(w) (_XmIsFastSubclass(XtClass(w), XmDRAG_OVER_SHELL_BIT))
#  undef XmIsDragContext
#  define XmIsDragContext(w) (_XmIsFastSubclass(XtClass(w), XmDRAG_CONTEXT_BIT))
#  undef XmIsDrawnButton
#  define XmIsDrawnButton(w) (_XmIsFastSubclass(XtClass(w), XmDRAWN_BUTTON_BIT))
#  undef XmIsPrimitive
#  define XmIsPrimitive(w) (_XmIsFastSubclass(XtClass(w), XmPRIMITIVE_BIT))
#  undef XmIsPushButton
#  define XmIsPushButton(w) (_XmIsFastSubclass(XtClass(w), XmPUSH_BUTTON_BIT))
#  undef XmIsPushButtonGadget
#  define XmIsPushButtonGadget(w) (_XmIsFastSubclass(XtClass(w), XmPUSH_BUTTON_GADGET_BIT))
#  undef XmIsRowColumn
#  define XmIsRowColumn(w) (_XmIsFastSubclass(XtClass(w), XmROW_COLUMN_BIT))
#  undef XmIsScreen
#  define XmIsScreen(w) (_XmIsFastSubclass(XtClass(w), XmSCREEN_BIT))
#  undef XmIsScrollBar
#  define XmIsScrollBar(w) (_XmIsFastSubclass(XtClass(w), XmSCROLL_BAR_BIT))
...
#  define XmIsSelectionBox(w) (_XmIsFastSubclass(XtClass(w), XmSELECTION_BOX_BIT))
#  undef XmIsSeparator
#  define XmIsSeparator(w) (_XmIsFastSubclass(XtClass(w), XmSEPARATOR_BIT))
#  undef XmIsSeparatorGadget
#  define XmIsSeparatorGadget(w) (_XmIsFastSubclass(XtClass(w), XmSEPARATOR_GADGET_BIT))
#  undef XmIsSpinButton
#  define XmIsSpinButton(w) (_XmIsFastSubclass(XtClass(w), XmSPINBUTTON_BIT))
#  undef XmIsText
#  define XmIsText(w) (_XmIsFastSubclass(XtClass(w), XmTEXT_BIT))
#  undef XmIsTearOffButton
#  define XmIsTearOffButton(w) (_XmIsFastSubclass(XtClass(w), XmTEAROFF_BUTTON_BIT))
#  undef XmIsToggleButton
#  define XmIsToggleButton(w) (_XmIsFastSubclass(XtClass(w), XmTOGGLE_BUTTON_BIT))
#  undef XmIsToggleButtonGadget
#  define XmIsToggleButtonGadget(w) (_XmIsFastSubclass(XtClass(w), XmTOGGLE_BUTTON_GADGET_BIT))
#  undef XmIsPrintShell
#  define XmIsPrintShell(w) (_XmIsFastSubclass(XtClass(w), XmPRINT_SHELL_BIT))
#  undef XmIsArrowButton
#  define XmIsArrowButton(w) (_XmIsFastSubclass(XtClass(w), XmARROW_BUTTON_BIT))
#  undef XmIsArrowButtonGadget
#  define XmIsArrowButtonGadget(w) (_XmIsFastSubclass(XtClass(w), XmARROW_BUTTON_GADGET_BIT))
#  undef XmIsBulletinBoard
#  define XmIsBulletinBoard(w) (_XmIsFastSubclass(XtClass(w), XmBULLETIN_BOARD_BIT))
#  undef XmIsDrawingArea
#  define XmIsDrawingArea(w) (_XmIsFastSubclass(XtClass(w), XmDRAWING_AREA_BIT))
#  undef XmIsFileSelectionBox
#  define XmIsFileSelectionBox(w) (_XmIsFastSubclass(XtClass(w), XmFILE_SELECTION_BOX_BIT))
#  undef XmIsFrame
#  define XmIsFrame(w) (_XmIsFastSubclass(XtClass(w), XmFRAME_BIT))
#  undef XmIsMessageBox
#  define XmIsMessageBox(w) (_XmIsFastSubclass(XtClass(w), XmMESSAGE_BOX_BIT))
#  undef XmIsSash
#  define XmIsSash(w) (_XmIsFastSubclass(XtClass(w), XmSASH_BIT))
#  undef XmIsScale
#  define XmIsScale(w) (_XmIsFastSubclass(XtClass(w), XmSCALE_BIT))
#  undef XmIsPanedWindow
#  define XmIsPanedWindow(w) (_XmIsFastSubclass(XtClass(w), XmPANED_WINDOW_BIT))
#  undef XmIsCSText
#  define XmIsCSText(w) (_XmIsFastSubclass(XtClass(w), XmCSTEXT_BIT))
#  undef XmIsCombinationBox2
#  define XmIsCombinationBox2(w) (_XmIsFastSubclass(XtClass(w), XmCOMBINATION_BOX_2_BIT))
#  undef XmIsDropDown
#  define XmIsDropDown(w) (_XmIsFastSubclass(XtClass(w), XmDROP_DOWN_BIT))
#  undef XmIsExt18List
#  define XmIsExt18List(w) (_XmIsFastSubclass(XtClass(w), XmEXT18LIST_BIT))
#  undef XmIsMultiList
#  define XmIsMultiList(w) (_XmIsFastSubclass(XtClass(w), XmMULTI_LIST_BIT))
/************************************************************************
 *
 *  ResolveP.h
 *
...
#    define XmConstraintPartOffset(part, variable) \
      ((part##Index) << XmOFFSETBITS) + XtOffsetOf(part##ConstraintPart, variable)
#    define XmGetPartOffset(r, offset) \
      ((r)->resource_offset & XmOFFSETMASK) + (*(offset))[(r)->resource_offset >> XmOFFSETBITS]
...
#    define XmConstraintField(widget, offsetrecord, part, variable, type) \
      (*(type *)(((char *)(widget)->core.constraints) + offsetrecord[part##Index] + \
...
/********    ResConvert.c    ********/
enum { XmLABEL_FONTLIST = 1, XmBUTTON_FONTLIST, XmTEXT_FONTLIST };

enum { XmLABEL_RENDER_TABLE = 1, XmBUTTON_RENDER_TABLE, XmTEXT_RENDER_TABLE };
...
/********    ResInd.c    ********/
typedef enum { XmPARSE_ERROR, XmPARSE_NO_UNITS, XmPARSE_UNITS_OK } XmParseResult;
...
/* Traversal.c */
extern void XmeNavigChangeManaged(Widget wid);
extern Boolean XmeFocusIsInShell(Widget wid);
/* ResInd.c */
extern XmImportOperator XmeToHorizontalPixels(Widget widget, int offset, XtArgVal *value);
...
extern XmStringComponentType XmeStringGetComponent(_XmStringContext context,
                                                   ...
                                                   XtPointer *value);
/* XmFontList.c */
extern Boolean XmeRenderTableGetDefaultFont(XmFontList fontlist, XFontStruct **font_struct);
/* GMUtils.c */
extern XtGeometryResult XmeReplyToQueryGeometry(Widget widget,
                                                XtWidgetGeometry *intended,
                                                XtWidgetGeometry *desired);
/* Color.c */
extern void XmeGetDefaultPixel(Widget widget, int type, int offset, XrmValue *value);
/* Xmos.c */
 ...
 * compatibility.
 */
extern void _XmDestroyParentCallback(Widget w, XtPointer client_data, XtPointer call_data);
/*
