...
#  endif
/*  Access Macros  */
#  define XmParentTopShadowGC(w) (((XmManagerWidget)XtParent(w))->manager.top_shadow_GC)
#  define XmParentBottomShadowGC(w) (((XmManagerWidget)XtParent(w))->manager.bottom_shadow_GC)
#  define XmParentHighlightGC(w) (((XmManagerWidget)XtParent(w))->manager.highlight_GC)
#  define XmParentBackgroundGC(w) (((XmManagerWidget)XtParent(w))->manager.background_GC)
