...
extern void _XmBuildResources(XmSyntheticResource **wc_resources_ptr,
                              int *wc_num_resources_ptr,
                              XmSyntheticResource *sc_resources,
                              int sc_num_resources);
extern void _XmInitializeSyntheticResources(XmSyntheticResource *resources, int num_resources);
...
#  if XM_PRINTING
extern void _XmPrintShellGetValuesHook(Widget w, ArgList args, Cardinal *num_args);
#  endif
extern void _XmExtGetValuesHook(Widget w, ArgList args, Cardinal *num_args);
...
extern void _XmGadgetImportSecondaryArgs(Widget w, ArgList args, Cardinal *num_args);
