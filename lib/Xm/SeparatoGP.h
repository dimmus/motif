...
#  define SEPG_Margin(w) (((XmSeparatorGadget)(w))->separator.cache->margin)
#  define SEPG_Orientation(w) (((XmSeparatorGadget)(w))->separator.cache->orientation)
#  define SEPG_SeparatorType(w) (((XmSeparatorGadget)(w))->separator.cache->separator_type)
#  define SEPG_SeparatorGC(w) (((XmSeparatorGadget)(w))->separator.cache->separator_GC)
#  define SEPG_BackgroundGC(w) (((XmSeparatorGadget)(w))->separator.cache->background_GC)
#  define SEPG_TopShadowGC(w) (((XmSeparatorGadget)(w))->separator.cache->top_shadow_GC)
#  define SEPG_BottomShadowGC(w) (((XmSeparatorGadget)(w))->separator.cache->bottom_shadow_GC)
#  define SEPG_Foreground(w) (((XmSeparatorGadget)(w))->separator.cache->foreground)
#  define SEPG_Background(w) (((XmSeparatorGadget)(w))->separator.cache->background)
#  define SEPG_TopShadowColor(w) (((XmSeparatorGadget)(w))->separator.cache->top_shadow_color)
#  define SEPG_TopShadowPixmap(w) (((XmSeparatorGadget)(w))->separator.cache->top_shadow_pixmap)
...
/* Convenience Macros */
#  define SEPG_Cache(w) (((XmSeparatorGadget)(w))->separator.cache)
