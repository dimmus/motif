...
#define MESSAGE2 _XmMMsgManager_0001
    ...
    static void
    GetXFromShell(Widget wid, int resource_offset, XtArgVal *value);
static void GetYFromShell(Widget wid, int resource_offset, XtArgVal *value);
static void ClassInitialize(void);
static CompositeClassExtension FindCompClassExtension(WidgetClass widget_class);
static void BuildManagerResources(WidgetClass c);
...
static void ManagerMotion(Widget wid, XtPointer closure, XEvent *event, Boolean *cont);
static void ManagerEnter(Widget wid, XtPointer closure, XEvent *event, Boolean *cont);
static void ManagerLeave(Widget wid, XtPointer closure, XEvent *event, Boolean *cont);
...
static Boolean ConstraintSetValues(
    Widget current, Widget request, Widget new_w, ArgList args, Cardinal *num_args);
static Boolean ManagerParentProcess(Widget widget, XmParentProcessData data);
...
static XtResource resources[] = {{XmNunitType,
                                  XmCUnitType,
                                  XmRUnitType,
                                  sizeof(unsigned char),
                                  XtOffsetOf(XmManagerRec, manager.unit_type),
                                  XmRCallProc,
                                  (XtPointer)_XmUnitTypeDefault},
                                 {XmNx,
                                  XmCPosition,
                                 ...
                                 {XmNforeground,
                                  ...
                                  XmRPixel,
                                  sizeof(Pixel),
                                  XtOffsetOf(XmManagerRec, manager.foreground),
                                  XmRCallProc,
                                 ...
                                 {XmNbackground,
                                  ...
                                  XmRPixel,
                                  sizeof(Pixel),
                                  XtOffsetOf(WidgetRec, core.background_pixel),
                                  XmRCallProc,
                                 ...
                                 {XmNhighlightColor,
                                  ...
                                  XmRPixel,
                                  sizeof(Pixel),
                                  XtOffsetOf(XmManagerRec, manager.highlight_color),
                                  XmRCallProc,
                                 ...
                                 {XmNhighlightPixmap,
                                  ...
                                  sizeof(Pixmap),
                                  XtOffsetOf(XmManagerRec, manager.highlight_pixmap),
                                  XmRCallProc,
                                 ...
                                 {XmNtopShadowColor,
                                  ...
                                  XmRPixel,
                                  sizeof(Pixel),
                                  XtOffsetOf(XmManagerRec, manager.top_shadow_color),
                                  XmRCallProc,
                                 ...
                                 {XmNtopShadowPixmap,
                                  ...
                                  XmRNoScalingDynamicPixmap,
                                  sizeof(Pixmap),
                                  XtOffsetOf(XmManagerRec, manager.top_shadow_pixmap),
                                  XmRCallProc,
                                 ...
                                 {XmNbottomShadowColor,
                                  ...
                                  XmRPixel,
                                  sizeof(Pixel),
                                  XtOffsetOf(XmManagerRec, manager.bottom_shadow_color),
                                  XmRCallProc,
                                 ...
                                 {XmNbottomShadowPixmap,
                                  ...
                                  XmRNoScalingDynamicPixmap,
                                  sizeof(Pixmap),
                                  XtOffsetOf(XmManagerRec, manager.bottom_shadow_pixmap),
                                  XmRImmediate,
                                  (XtPointer)XmUNSPECIFIED_PIXMAP},
                                 {XmNhelpCallback,
                                  XmCCallback,
                                  ...
                                  XtOffsetOf(XmManagerRec, manager.help_callback),
                                  XmRPointer,
                                  (XtPointer)NULL},
#ifndef XM_PART_BC
                                 ...
                                 {XmNuserData,
                                  ...
                                  XmRPointer,
                                  sizeof(XtPointer),
                                  XtOffsetOf(XmManagerRec, manager.user_data),
                                  XmRPointer,
                                  (XtPointer)NULL},
                                 {XmNtraversalOn,
                                  XmCTraversalOn,
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  XtOffsetOf(XmManagerRec, manager.traversal_on),
                                  XmRImmediate,
                                  (XtPointer)TRUE},
                                 {XmNstringDirection,
                                  XmCStringDirection,
                                 ...
                                 {XmNinitialFocus,
                                  ...
                                  XmRWidget,
                                  sizeof(Widget),
                                  XtOffsetOf(XmManagerRec, manager.initial_focus),
                                  XmRImmediate,
                                  NULL}};
/***************************************/
/*  Definition for synthetic resources */
static XmSyntheticResource syn_resources[] = {
    {XmNx, sizeof(Position), XtOffsetOf(WidgetRec, core.x), GetXFromShell, XmeToHorizontalPixels},
    {XmNy, sizeof(Position), XtOffsetOf(WidgetRec, core.y), GetYFromShell, XmeToVerticalPixels},
    {XmNwidth,
     sizeof(Dimension),
     XtOffsetOf(WidgetRec, core.width),
...
externaldef(xmmanagerwidgetclass)
    WidgetClass xmManagerWidgetClass = (WidgetClass)&xmManagerClassRec;
static XmConst XmSpecifyLayoutDirectionTraitRec manLDT = {0, /* version */
                                                          GetDirection};
/* Access Colors Trait record for Manager */
static XmConst XmAccessColorsTraitRec manACT = {0, /* version */
                                                GetColors};
/* Unit Type Trait record for Manager */
static XmConst XmSpecUnitTypeTraitRec manUTT = {0, /* version */
                                                GetUnitType};
...
**
**************************************************************************/
static void GetXFromShell(Widget wid, int resource_offset, XtArgVal *value)
{
...
static CompositeClassExtension FindCompClassExtension(WidgetClass widget_class)
{
  ...
  ext = (CompositeClassExtension)((CompositeWidgetClass)widget_class)->composite_class.extension;
...
static void BuildManagerResources(WidgetClass c)
{
  ...
  _XmInitializeSyntheticResources(wc->manager_class.syn_constraint_resources,
                                  wc->manager_class.num_syn_constraint_resources);
  if (sc == (XmManagerWidgetClass)constraintWidgetClass)
    return;
...
static void ClassPartInitialize(WidgetClass wc)
{
  ...
  XmManagerWidgetClass super = (XmManagerWidgetClass)mw->core_class.superclass;
  XmManagerClassExt *mext = (XmManagerClassExt *)_XmGetClassExtensionPtr(
  ...
  if (FindCompClassExtension(wc) == NULL) {
    ...
    XtPointer *comp_extP = &((CompositeWidgetClass)wc)->composite_class.extension;
    comp_ext = XtNew(CompositeClassExtensionRec);
    memcpy(comp_ext,
           FindCompClassExtension(wc->core_class.superclass),
           sizeof(CompositeClassExtensionRec));
  ...
  if (mw->manager_class.translations == XtInheritTranslations)
    ...
    mw->manager_class.translations = (String)XtParseTranslationTable(
        mw->manager_class.translations);
  ...
  if ((WidgetClass)mw != xmManagerWidgetClass) {
    XmManagerClassExt *smext = (XmManagerClassExt *)_XmGetClassExtensionPtr(
        (XmGenericClassExt *)&(super->manager_class.extension), NULLQUARK);
  ...
  if (first_time) {
    ...
    _XmReOrderResourceList(xmManagerWidgetClass, XmNforeground, XmNbackground);
    first_time = FALSE;
  }
...
static void Initialize(Widget request, Widget new_w, ArgList args, Cardinal *num_args)
{
  ...
  _XmProcessLock();
  translations = (XtTranslations)((XmManagerClassRec *)XtClass(mw))->manager_class.translations;
  _XmProcessUnlock();
  if (mw->manager.traversal_on && translations && mw->core.tm.translations && !XmIsRowColumn(mw)) {
  ...
  if ((mw->manager.navigation_type != XmDYNAMIC_DEFAULT_TAB_GROUP) &&
      !XmRepTypeValidValue(XmRID_NAVIGATION_TYPE, mw->manager.navigation_type, (Widget)mw))
  {
  ...
  mw->manager.background_GC = _XmGetPixmapBasedGC(
      new_w, mw->core.background_pixel, mw->manager.foreground, mw->core.background_pixmap);
  mw->manager.highlight_GC = _XmGetPixmapBasedGC(
      new_w, mw->manager.highlight_color, mw->core.background_pixel, mw->manager.highlight_pixmap);
    ...
    Widget current, Widget request, Widget new_w, ArgList args, Cardinal *num_args)
{
  ...
  if (newmw->manager.traversal_on &&
      (newmw->manager.traversal_on != curmw->manager.traversal_on) && newmw->core.tm.translations)
  {
    XtTranslations translations;
    _XmProcessLock();
    translations =
        (XtTranslations)((XmManagerClassRec *)XtClass(newmw))->manager_class.translations;
    _XmProcessUnlock();
    if (translations)
      XtOverrideTranslations((Widget)newmw, translations);
  }
  if (newmw->manager.initial_focus != curmw->manager.initial_focus) {
    _XmSetInitialOfTabGroup((Widget)newmw, newmw->manager.initial_focus);
  }
  if (curmw->manager.navigation_type != newmw->manager.navigation_type) {
    if (!XmRepTypeValidValue(XmRID_NAVIGATION_TYPE, newmw->manager.navigation_type, (Widget)newmw))
    {
  ...
  if (!XmRepTypeValidValue(XmRID_DIRECTION, newmw->manager.string_direction, (Widget)newmw)) {
    newmw->manager.string_direction = curmw->manager.string_direction;
  }
  ...
  if (curmw->manager.bottom_shadow_color != newmw->manager.bottom_shadow_color ||
      curmw->manager.bottom_shadow_pixmap != newmw->manager.bottom_shadow_pixmap)
  {
...
static void DeleteChild(Widget child)
{
  ...
  if ((tab_group = XmGetTabGroup(child)) && (tab_group != (Widget)mw) && XmIsManager(tab_group) &&
 ...
 ************************************************************************/
/*ARGSUSED*/
static void ManagerMotion(Widget wid,
 ...
 ************************************************************************/
/*ARGSUSED*/
static void ManagerEnter(Widget wid,
                         XtPointer closure, /* unused */
                         XEvent *event,
                         Boolean *cont) /* unused */
{
 ...
 ************************************************************************/
/*ARGSUSED*/
static void ManagerLeave(Widget wid,
                         XtPointer closure, /* unused */
                         XEvent *event,
                         Boolean *cont) /* unused */
{
 ...
 ************************************************************************/
/*ARGSUSED*/
static void ConstraintInitialize(Widget request, /* unused */
                                 Widget new_w,
                                 ArgList args,       /* unused */
 ...
 ****************************************************************/
/*ARGSUSED*/
void _XmGadgetTraversePrevTabGroup(Widget wid,
                                   XEvent *event,        /* unused */
...
/*ARGSUSED*/
void _XmGadgetTraverseNextTabGroup(Widget wid,
                                   XEvent *event,        /* unused */
                                   String *params,       /* unused */
                                   Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraverseCurrent(Widget wid,
                              XEvent *event,
                              String *params,       /* unused */
                              Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraverseLeft(Widget wid,
                           XEvent *event,        /* unused */
                           String *params,       /* unused */
                           Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraverseRight(Widget wid,
                            XEvent *event,        /* unused */
                            String *params,       /* unused */
                            Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraverseUp(Widget wid,
                         XEvent *event,        /* unused */
                         String *params,       /* unused */
                         Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraverseDown(Widget wid,
                           XEvent *event,        /* unused */
                           String *params,       /* unused */
                           Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraverseNext(Widget wid,
                           XEvent *event,        /* unused */
                           String *params,       /* unused */
                           Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraversePrev(Widget wid,
                           XEvent *event,        /* unused */
                           String *params,       /* unused */
                           Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetTraverseHome(Widget wid,
                           XEvent *event,        /* unused */
                           String *params,       /* unused */
                           Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetSelect(Widget wid,
                     XEvent *event,
                     String *params,       /* unused */
                     Cardinal *num_params) /* unused */
{
  ...
  if (child && (((XmGadgetClass)XtClass(child))->gadget_class.arm_and_activate)) {
    (*(((XmGadgetClass)XtClass(child))->gadget_class.arm_and_activate))(child, event, NULL, NULL);
  }
  return;
}

void _XmManagerParentActivate(Widget mw, XEvent *event, String *params, Cardinal *num_params)
{
...
void _XmManagerParentCancel(Widget mw, XEvent *event, String *params, Cardinal *num_params)
{
  XmParentInputActionRec pp_data;
  pp_data.process_type = XmINPUT_ACTION;
...
/*ARGSUSED*/
void _XmGadgetButtonMotion(Widget wid,
                           XEvent *event,
                           String *params,       /* unused */
                           Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetKeyInput(Widget wid,
                       XEvent *event,
                       String *params,       /* unused */
                       Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmGadgetActivate(Widget wid,
                       XEvent *event,
                       String *params,       /* unused */
                       Cardinal *num_params) /* unused */
{
...
/*ARGSUSED*/
void _XmManagerHelp(Widget wid,
                    XEvent *event,
                    String *params,       /* unused */
                    Cardinal *num_params) /* unused */
{
  ...
  if (_XmGetFocusPolicy((Widget)mw) == XmEXPLICIT) {
    ...
    if ((widget = XmObjectAtPoint((Widget)mw, event->xkey.x, event->xkey.y)) != NULL)
      _XmDispatchGadgetInput(widget, event, XmHELP_EVENT);
    else
      _XmSocorro((Widget)mw, event, NULL, NULL);
  }
...
void _XmGadgetMultiArm(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  XmManagerWidget mw = (XmManagerWidget)wid;
  XmGadget gadget;
...
void _XmGadgetMultiActivate(Widget wid, XEvent *event, String *params, Cardinal *num_params)
{
  XmManagerWidget mw = (XmManagerWidget)wid;
  XmGadget gadget;
  /*
   ...
   */
  if (mw->manager.eligible_for_multi_button_event &&
      ((gadget = mw->manager.selected_gadget) == mw->manager.eligible_for_multi_button_event))
  {
