...
#define XmColumnC_label_alignment(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.label_alignment)
#define XmColumnC_label_type(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.label_type)
#define XmColumnC_fill_style(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.fill_style)
#define XmColumnC_show_label(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.show_label)
#define XmColumnC_stretchable(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.stretchable)
#define XmColumnC_label_pixmap(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.label_pixmap)
#define XmColumnC_label_string(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.label_string)
#define XmColumnC_label_font_list(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.label_font_list)
#define XmColumnC_label_widget(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.label_widget)
#define XmColumnC_request_width(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.request_width)
#define XmColumnC_request_height(w) \
  (((XmColumnConstraintPtr)((w)->core.constraints))->column.request_height)
