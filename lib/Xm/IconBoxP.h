...
#define XmIconBoxC_pref_width(w) \
  (((XmIconBoxConstraintsRec *)((w)->core.constraints))->icon.pref_width)
#define XmIconBoxC_pref_height(w) \
  (((XmIconBoxConstraintsRec *)((w)->core.constraints))->icon.pref_height)
