...
extern void _XmTextFreeContextData(Widget w, XtPointer clientData, XtPointer callData);
...
extern void _XmTextMovingCursorPosition(XmTextWidget tw, XmTextPosition position);
...
extern Boolean _XmTextGetBaselines(Widget widget, Dimension **baselines, int *line_count);
...
extern void _XmTextChangeVOffset(XmTextWidget widget, int length);
