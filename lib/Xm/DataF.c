...
static XtResource resources[] = {
   { XmNpicture,                 XmCPicture,               XmRString,              sizeof(String),         XtOffsetOf(XmDataFieldRec, data.picture_source),             XmRImmediate, (XtPointer)NULL                  },
   { XmNautoFill,                XmCAutoFill,              XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmDataFieldRec, data.auto_fill),                  XmRImmediate, (XtPointer)True                  },
   { XmNalignment,               XmCAlignment,             XmRAlignment,           sizeof(unsigned char),  XtOffsetOf(XmDataFieldRec, data.alignment),                  XmRImmediate, (XtPointer)XmALIGNMENT_BEGINNING },
   { XmNpictureErrorCallback,    XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, data.picture_error_cb),           XmRCallback,  (XtPointer)NULL                  },
   { XmNvalidateCallback,        XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, data.validate_cb),                XmRCallback,  (XtPointer)NULL                  },
   /* the following are undocumented overrides of XmTextField resources */
   {
    ...
    XmRCallback,
    NULL                                                                                                                                                                                                               },
   { XmNlosingFocusCallback,     XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.losing_focus_callback),      XmRCallback,  NULL                             },
   { XmNfocusCallback,           XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.focus_callback),             XmRCallback,  NULL                             },
   { XmNmodifyVerifyCallback,    XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.modify_verify_callback),     XmRCallback,  NULL                             },
   { XmNmodifyVerifyCallbackWcs, XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.wcs_modify_verify_callback), XmRCallback,  NULL                             },
   { XmNmotionVerifyCallback,    XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.motion_verify_callback),     XmRCallback,  NULL                             },
   { XmNgainPrimaryCallback,     XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.gain_primary_callback),      XmRCallback,  NULL                             },
   { XmNlosePrimaryCallback,     XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.lose_primary_callback),      XmRCallback,  NULL                             },
   { XmNvalueChangedCallback,    XmCCallback,              XmRCallback,            sizeof(XtCallbackList), XtOffsetOf(XmDataFieldRec, text.value_changed_callback),     XmRCallback,  NULL                             },
   { XmNvalue,                   XmCValue,                 XmRString,              sizeof(String),         XtOffsetOf(XmDataFieldRec, text.value),                      XmRString,    ""                               },
   { XmNvalueWcs,                XmCValueWcs,              XmRValueWcs,            sizeof(wchar_t *),      XtOffsetOf(XmDataFieldRec, text.wc_value),                   XmRString,    NULL                             },
   { XmNmarginHeight,            XmCMarginHeight,          XmRVerticalDimension,   sizeof(Dimension),      XtOffsetOf(XmDataFieldRec, text.margin_height),              XmRImmediate, (XtPointer)5                     },
   { XmNmarginWidth,             XmCMarginWidth,           XmRHorizontalDimension, sizeof(Dimension),      XtOffsetOf(XmDataFieldRec, text.margin_width),               XmRImmediate, (XtPointer)5                     },
   { XmNcursorPosition,          XmCCursorPosition,        XmRTextPosition,        sizeof(XmTextPosition), XtOffsetOf(XmDataFieldRec, text.cursor_position),            XmRImmediate, (XtPointer)0                     },
   { XmNcolumns,                 XmCColumns,               XmRShort,               sizeof(short),          XtOffsetOf(XmDataFieldRec, text.columns),                    XmRImmediate, (XtPointer)20                    },
   { XmNmaxLength,               XmCMaxLength,             XmRInt,                 sizeof(int),            XtOffsetOf(XmDataFieldRec, text.max_length),                 XmRImmediate, (XtPointer)INT_MAX               },
   { XmNblinkRate,               XmCBlinkRate,             XmRInt,                 sizeof(int),            XtOffsetOf(XmDataFieldRec, text.blink_rate),                 XmRImmediate, (XtPointer)500                   },
   { "pri.vate",                 "Pri.vate",               XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmDataFieldRec, text.check_set_render_table),     XmRImmediate, (XtPointer)False                 },
   { XmNfontList,                XmCFontList,              XmRFontList,            sizeof(XmFontList),     XtOffsetOf(XmDataFieldRec, text.font_list),                  XmRCallProc,  (XtPointer)CheckSetRenderTable   },
   { XmNrenderTable,             XmCRenderTable,           XmRRenderTable,         sizeof(XmRenderTable),  XtOffsetOf(XmDataFieldRec, text.font_list),                  XmRCallProc,  (XtPointer)CheckSetRenderTable   },
   { XmNselectionArray,          XmCSelectionArray,        XmRPointer,             sizeof(XtPointer),      XtOffsetOf(XmDataFieldRec, text.selection_array),            XmRImmediate, (XtPointer)df_sarray             },
   { XmNselectionArrayCount,     XmCSelectionArrayCount,   XmRInt,                 sizeof(int),            XtOffsetOf(XmDataFieldRec, text.selection_array_count),      XmRInt,       (XtPointer)&df_sarraysize        },
   { XmNresizeWidth,             XmCResizeWidth,           XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmDataFieldRec, text.resize_width),               XmRImmediate, (XtPointer)False                 },
   { XmNpendingDelete,           XmCPendingDelete,         XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmDataFieldRec, text.pending_delete),             XmRImmediate, (XtPointer)True                  },
   { XmNeditable,                XmCEditable,              XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmDataFieldRec, text.editable),                   XmRImmediate, (XtPointer)True                  },
   { XmNcursorPositionVisible,   XmCCursorPositionVisible, XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmDataFieldRec, text.cursor_position_visible),    XmRImmediate, (XtPointer)True                  },
   { XmNverifyBell,              XmCVerifyBell,            XmRBoolean,             sizeof(Boolean),        XtOffsetOf(XmDataFieldRec, text.verify_bell),                XmRImmediate, (XtPointer)XmDYNAMIC_BOOL        },
   { XmNselectThreshold,         XmCSelectThreshold,       XmRInt,                 sizeof(int),            XtOffsetOf(XmDataFieldRec, text.threshold),                  XmRImmediate, (XtPointer)5                     },
   { XmNnavigationType,          XmCNavigationType,        XmRNavigationType,      sizeof(unsigned char),  XtOffsetOf(XmDataFieldRec, primitive.navigation_type),       XmRImmediate, (XtPointer)XmTAB_GROUP           },
};
...
externaldef(xmdatafieldwidgetclass) WidgetClass xmDataFieldWidgetClass = (WidgetClass)&xmDataFieldClassRec;
   ...
   Widget w)
{
   ...
   if (XFindContext(display, (Window)screen, _XmDataFDestContext, (char **)&dest_data))
   {
      ...
      XtAddCallback(xm_display, XmNdestroyCallback, (XtCallbackProc)df_FreeContextData, (XtPointer)ctx_data);
   ...
   Widget w)
{
   ...
   if (!XFindContext(XtDisplay(w), (Window)XtScreen(w), _XmDataFDNDContext, (char **)&widget))
   {
      return widget;
   }
   return NULL;
   ...
   Widget widget)
{
   ...
   else
   {
      if (XmTextF_overstrike(tf))
      {
         if (!XmTextF_add_mode(tf) && XtIsSensitive(widget) && (XmTextF_has_focus(tf) || XmTextF_has_destination(tf)))
         {
         ...
         values.foreground = values.background = tf->primitive.foreground ^ tf->core.background_pixel;
         values.function                       = GXxor;
      }
      else
      {
         if (XtIsSensitive(widget) && !XmTextF_add_mode(tf) && (XmTextF_has_focus(tf) || XmTextF_has_destination(tf)))
         {
            if (XmTextF_cursor(tf) == XmUNSPECIFIED_PIXMAP) return;
            values.stipple = XmTextF_cursor(tf);
         }
   ...
   Position         *y)
{
   ...
   {
      int length;
      *x     = tf->core.width - (XmTextF_margin_width(tf) + tf->primitive.highlight_thickness + tf->primitive.shadow_thickness);
      *y     = 0;
      length = XmTextF_string_length(tf) - position;
      if (length < 0) return False;
      if (XmTextF_max_char_size(tf) != 1)
      {
         x1 = df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + position), length);
      }
      else
      {
   ...
   XmDataFieldWidget tf)
{
   ...
   y = (y + (Position)XmTextF_font_descent(tf)) - (Position)XmTextF_cursor_height(tf);
   /* If time to paint the I Beam... first capture the IBeamOffArea, then draw
 * the IBeam */
   if (XmTextF_refresh_ibeam_off(tf) == True)
   {  /* get area under IBeam first */
      /* Fill is needed to realign clip rectangle with gc */
      XFillRectangle(XtDisplay((Widget)tf), XtWindow((Widget)tf), XmTextF_save_gc(tf), 0, 0, 0, 0);
      XCopyArea(XtDisplay(tf), XtWindow(tf), XmTextF_ibeam_off(tf), XmTextF_save_gc(tf), x, y, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf), 0, 0);
   ...
   if ((XmTextF_cursor_on(tf) >= 0) && XmTextF_blink_on(tf))
   {
      if (!XtIsSensitive((Widget)tf))
      {
         ...
         XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_image_gc(tf), x + 1, y + 1, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf));
      }
      _XmDataFToggleCursorGC((Widget)tf);
      XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_image_gc(tf), x, y, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf));
   }
   else
   {
      XCopyArea(XtDisplay(tf), XmTextF_ibeam_off(tf), XtWindow(tf), XmTextF_save_gc(tf), 0, 0, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf), x, y);
   }
}
   ...
   Boolean           turn_on)
{
   ...
   else
   {
      if (XmTextF_blink_on(tf) && (XmTextF_cursor_on(tf) == 0))
         if (XmTextF_blink_on(tf) == df_CurrentCursorState(tf) && XtIsRealized((Widget)tf))
         {
...
df_BlinkInsertionPoint(
   XmDataFieldWidget tf)
{
   if ((XmTextF_cursor_on(tf) >= 0) && XmTextF_blink_on(tf) == df_CurrentCursorState(tf) && XtIsRealized((Widget)tf))
   {
      XmTextF_blink_on(tf) = !XmTextF_blink_on(tf);
      df_PaintCursor(tf);
   }
   ...
   XtIntervalId *id)
{
   ...
   if (XmTextF_blink_rate(tf) != 0)
      XmTextF_timer_id(tf) = XtAppAddTimeOut(XtWidgetToApplicationContext((Widget)tf),
 ...
 */
static void
df_ChangeBlinkBehavior(XmDataFieldWidget tf, Boolean turn_on)
{
   if (turn_on)
   {
...
static void
df_GetRect(XmDataFieldWidget tf, XRectangle *rect)
{
   Dimension margin_width  = XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Dimension margin_top    = XmTextF_margin_top(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Dimension margin_bottom = XmTextF_margin_bottom(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
...
static void
df_CheckHasRect(XmDataFieldWidget tf)
{
   /*
...
static void
df_XmSetFullGC(XmDataFieldWidget tf, GC gc)
{
   XRectangle ClipRect;
   /* adjust clip rectangle to allow the cursor to paint into the margins */
   ClipRect.x      = tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   ClipRect.y      = tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   ClipRect.width  = tf->core.width - (2 * (tf->primitive.shadow_thickness + tf->primitive.highlight_thickness));
   ClipRect.height = tf->core.height - (2 * (tf->primitive.shadow_thickness + tf->primitive.highlight_thickness));
   XSetClipRectangles(XtDisplay(tf), gc, 0, 0, &ClipRect, 1, Unsorted);
}

static void
df_XmSetMarginGC(XmDataFieldWidget tf, GC gc)
{
   XRectangle ClipRect;
...
static void
df_XmResetSaveGC(XmDataFieldWidget tf, GC gc)
{
 ...
 */
void
_XmDataFieldSetClipRect(XmDataFieldWidget tf)
{
   XGCValues     values;
  ...
  */
   ...
   if (XmTextF_image_gc(tf))
   {
      ...
      if (XmTextF_overstrike(tf))
      {
         values.background = values.foreground = tf->core.background_pixel ^ tf->primitive.foreground;
      }
...
static void
df_XmSetNormGC(XmDataFieldWidget tf, GC gc, Boolean change_stipple, Boolean stipple)
{
...
static void
df_XmSetShadowGC(XmDataFieldWidget tf, GC gc)
{
   unsigned long valueMask = (GCForeground | GCBackground);
   XGCValues     values;
...
static void
df_XmSetInvGC(XmDataFieldWidget tf, GC gc)
{
   unsigned long valueMask = (GCForeground | GCBackground);
   XGCValues     values;
   if (!XmTextF_has_rect(tf)) _XmDataFieldSetClipRect(tf);
...
static void
df_DrawText(XmDataFieldWidget tf, GC gc, int x, int y, char *string, int length)
{
   if (XmTextF_have_fontset(tf))
   {
      if (XmTextF_max_char_size(tf) != 1)
         XwcDrawString(XtDisplay(tf), XtWindow(tf), (XFontSet)XmTextF_font(tf), gc, x, y, (wchar_t *)string, length);
      else /* one byte chars */
         XmbDrawString(XtDisplay(tf), XtWindow(tf), (XFontSet)XmTextF_font(tf), gc, x, y, string, length);
#if USE_XFT
   }
   else if (XmTextF_use_xft(tf))
   {
      if (XmTextF_max_char_size(tf) != 1)
      { /* was passed a wchar_t*  */
         ...
         if (num_bytes >= 0)
            _XmXftDrawString2(XtDisplay(tf), XtWindow(tf), gc, XmTextF_xft_font(tf), 1, x, y, tmp, num_bytes);
         XmStackFree(tmp, stack_cache);
      }
      else /* one byte chars */
         _XmXftDrawString2(XtDisplay(tf), XtWindow(tf), gc, XmTextF_xft_font(tf), 1, x, y, string, length);
#endif
   }
   else
   { /* have a font struct, not a font set */
      if (XmTextF_max_char_size(tf) != 1)
      { /* was passed a wchar_t*  */
         char     stack_cache[400], *tmp;
         wchar_t  tmp_wc;
...
static int
df_FindPixelLength(XmDataFieldWidget tf, char *string, int length)
{
   if (XmTextF_have_fontset(tf))
   {
      if (XmTextF_max_char_size(tf) != 1)
   ...
   else if (XmTextF_use_xft(tf))
   {
      ...
      { /* was passed a wchar_t*  */
         ...
         XftTextExtentsUtf8(XtDisplay(tf), XmTextF_xft_font(tf), (FcChar8 *)string, length, &ext);
      return ext.xOff;
#endif
   }
   else
   { /* have font struct, not a font set */
      if (XmTextF_max_char_size(tf) != 1)
      { /* was passed a wchar_t*  */
         wchar_t *wc_string = (wchar_t *)string;
         wchar_t  wc_tmp    = wc_string[length];
   ...
   int              *x)
{
...
#if PWC_DEBUG
   {
      ...
      strncpy(seg, (char *)(XmTextF_value(tf) + seg_start), seg_end - seg_start);
      seg[seg_end] = '\0';
      printf("df_DrawText(\"%s\" - %s) :: [start(%d), end(%d), x(%d), offset(%d)]\n",
             seg,
             (mode == XmHIGHLIGHT_NORMAL ? "NORMAL" : "HIGHLIGHT"),
             seg_start,
             seg_end,
             *x,
             XmTextF_h_offset(tf));
   ...
   if (XmTextF_max_char_size(tf) != 1)
   {
      *x       += df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + prev_seg_start), (int)(seg_start - prev_seg_start));
      x_seg_len = df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + seg_start), (int)seg_end - (int)seg_start);
   }
   else
   {
      *x       += df_FindPixelLength(tf, XmTextF_value(tf) + prev_seg_start, (int)(seg_start - prev_seg_start));
      x_seg_len = df_FindPixelLength(tf, XmTextF_value(tf) + seg_start, (int)seg_end - (int)seg_start);
   }
   if (mode == XmHIGHLIGHT_SELECTED)
   {
      /* Draw the selected text using an inverse gc */
      df_XmSetNormGC(tf, XmTextF_gc(tf), False, False);
      XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_gc(tf), *x, y - XmTextF_font_ascent(tf), x_seg_len, XmTextF_font_ascent(tf) + XmTextF_font_descent(tf));
   ...
   if (stipple)
   {
      ...
      {
         df_DrawText(tf, XmTextF_gc(tf), *x + 1, y + 1, (char *)(XmTextF_wc_value(tf) + seg_start), (int)seg_end - (int)seg_start);
      }
      else
      {
         df_DrawText(tf, XmTextF_gc(tf), *x + 1, y + 1, XmTextF_value(tf) + seg_start, (int)seg_end - (int)seg_start);
      }
      df_XmSetNormGC(tf, XmTextF_gc(tf), True, stipple);
   }
   if (XmTextF_max_char_size(tf) != 1)
   {
      df_DrawText(tf, XmTextF_gc(tf), *x, y, (char *)(XmTextF_wc_value(tf) + seg_start), (int)seg_end - (int)seg_start);
   }
   else
   {
      df_DrawText(tf, XmTextF_gc(tf), *x, y, XmTextF_value(tf) + seg_start, (int)seg_end - (int)seg_start);
   }
   if (stipple) df_XmSetNormGC(tf, XmTextF_gc(tf), True, !stipple);
   if (mode == XmHIGHLIGHT_SECONDARY_SELECTED)
      XDrawLine(XtDisplay(tf), XtWindow(tf), XmTextF_gc(tf), *x, y, *x + x_seg_len - 1, y);
   /* update x position up to the next highlight position */
   if (XmTextF_max_char_size(tf) != 1)
      *x += df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + seg_start), (int)(next_seg - (int)seg_start));
   else
      *x += df_FindPixelLength(tf, XmTextF_value(tf) + seg_start, (int)(next_seg - (int)seg_start));
}
 ...
 */
static void
df_RedisplayText(XmDataFieldWidget tf, XmTextPosition start, XmTextPosition end)
{
  ...
  */
   ...
   if (XmDataField_alignment(tf) == XmALIGNMENT_END)
   {
      ...
      if (XmTextF_max_char_size(tf) != 1)
         x -= df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + l[0].position), XmTextF_string_length(tf) - l[0].position);
      else
         x -= df_FindPixelLength(tf, XmTextF_value(tf) + l[0].position, XmTextF_string_length(tf) - l[0].position);
   ...
   for (i = 0; i + 1 < XmTextF_highlight(tf).number; i++)
   {
      ...
      if (l[i].position <= start && start < l[i + 1].position && l[i].position < end)
      {
         ...
         {
            df_DrawTextSegment(tf, l[i].mode, l[i].position, start, l[i + 1].position, l[i + 1].position, stipple, y, &x);
            /* update start position to the next highlight position */
            start = l[i + 1].position;
         }
         else
         {
            df_DrawTextSegment(tf, l[i].mode, l[i].position, start, end, l[i + 1].position, stipple, y, &x);
            start = end;
         }
      }
      else
      { /* start not within current record */
         if (XmTextF_max_char_size(tf) != 1)
         {
            x += df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + l[i].position), (int)(l[i + 1].position - l[i].position));
         }
         else
         {
            x += df_FindPixelLength(tf, XmTextF_value(tf) + l[i].position, (int)(l[i + 1].position - l[i].position));
         }
      }
   } /* end for loop */
   if (l[i].position < end)
   {
      ...
      df_DrawTextSegment(tf, l[i].mode, l[i].position, start, end, XmTextF_string_length(tf), stipple, y, &x);
   }
   else
   {
      if (XmTextF_max_char_size(tf) != 1)
         x += df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + l[i].position), XmTextF_string_length(tf) - (int)l[i].position);
      else
         x += df_FindPixelLength(tf, XmTextF_value(tf) + l[i].position, XmTextF_string_length(tf) - (int)l[i].position);
   }
   if (x < (int)(rect.x + rect.width)
       && XmDataField_alignment(tf) == XmALIGNMENT_BEGINNING)
   {
      df_XmSetInvGC(tf, XmTextF_gc(tf));
      XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_gc(tf), x, rect.y, rect.x + rect.width - x, rect.height);
   }
   else if (XmTextF_h_offset(tf) < startx
            && XmDataField_alignment(tf) == XmALIGNMENT_END)
   {
      df_XmSetInvGC(tf, XmTextF_gc(tf));
      XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_gc(tf), XmTextF_h_offset(tf), rect.y, startx - XmTextF_h_offset(tf), rect.height);
   }
   XmTextF_refresh_ibeam_off(tf) = True;
   _XmDataFieldDrawInsertionPoint(tf, True);
}
 ...
 */
static void
df_ComputeSize(XmDataFieldWidget tf, Dimension *width, Dimension *height)
{
   Dimension tmp = 0;
   if (XmTextF_resize_width(tf) && XmTextF_columns(tf) < XmTextF_string_length(tf))
   {
      if (XmTextF_max_char_size(tf) != 1)
         tmp = df_FindPixelLength(tf, (char *)XmTextF_wc_value(tf), XmTextF_string_length(tf));
      else
         tmp = df_FindPixelLength(tf, XmTextF_value(tf), XmTextF_string_length(tf));
      *width = tmp + (2 * (XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness));
   }
   else
   {
      *width = XmTextF_columns(tf) * XmTextF_average_char_width(tf) + 2 * (XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness);
   }
   if (height != NULL)
      *height = XmTextF_font_descent(tf) + XmTextF_font_ascent(tf) + 2 * (XmTextF_margin_height(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness);
}
...
df_TryResize(XmDataFieldWidget tf, Dimension width, Dimension height)
{
   Dimension        reswidth, resheight;
   Dimension        origwidth = tf->core.width;
   XtGeometryResult result;
   result = XtMakeResizeRequest((Widget)tf, width, height, &reswidth, &resheight);
   if (result == XtGeometryAlmost)
   {
      result = XtMakeResizeRequest((Widget)tf, reswidth, resheight, &reswidth, &resheight);
...
df_AdjustText(XmDataFieldWidget tf, XmTextPosition position, Boolean flag)
{
   ...
   int       diff;
   Dimension margin_width = XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Dimension thickness    = 2 * (tf->primitive.shadow_thickness + tf->primitive.highlight_thickness);
   Dimension temp;
   if (XmDataField_alignment(tf) == XmALIGNMENT_END)
   {
      if (XmTextF_max_char_size(tf) != 1)
      {
         left_edge = tf->core.width - margin_width + XmTextF_h_offset(tf) - df_FindPixelLength(tf, (char *)(XmTextF_wc_value(tf) + position), XmTextF_string_length(tf) - (int)position);
      }
      else
      {
         left_edge = tf->core.width - margin_width + XmTextF_h_offset(tf) - df_FindPixelLength(tf, XmTextF_value(tf) + position, XmTextF_string_length(tf) - (int)position);
      }
   }
   else
   {
      if (XmTextF_max_char_size(tf) != 1)
      {
         left_edge = df_FindPixelLength(tf, (char *)XmTextF_wc_value(tf), (int)position) + (int)XmTextF_h_offset(tf);
      }
      else
      {
         left_edge = df_FindPixelLength(tf, XmTextF_value(tf), (int)position) + (int)XmTextF_h_offset(tf);
      }
   }
   /*
  * Make sure the cached GC has the clipping rectangle
  ...
  */
   ...
   if ((diff = left_edge - margin_width) < 0)
   {
      ...
      XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_gc(tf), tf->primitive.shadow_thickness + tf->primitive.highlight_thickness, tf->primitive.shadow_thickness + tf->primitive.highlight_thickness, XmTextF_margin_width(tf), temp);
      df_XmSetMarginGC(tf, XmTextF_gc(tf));
      df_RedisplayText(tf, 0, XmTextF_string_length(tf));
      _XmDataFieldDrawInsertionPoint(tf, True);
      return True;
   }
   else if ((diff = (left_edge - (int)(tf->core.width - margin_width))) > 0)
   {
      ...
      XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_gc(tf), tf->core.width - margin_width, tf->primitive.shadow_thickness + tf->primitive.highlight_thickness, XmTextF_margin_width(tf), temp);
      df_XmSetMarginGC(tf, XmTextF_gc(tf));
      df_RedisplayText(tf, 0, XmTextF_string_length(tf));
      _XmDataFieldDrawInsertionPoint(tf, True);
      return True;
 ...
 */
static void
df_AdjustSize(XmDataFieldWidget tf)
{
   ...
   if (XmTextF_max_char_size(tf) != 1)
   {
      left_edge = df_FindPixelLength(tf, (char *)XmTextF_wc_value(tf), XmTextF_string_length(tf)) + margin_width;
   }
   else
   {
      left_edge = df_FindPixelLength(tf, XmTextF_value(tf), XmTextF_string_length(tf)) + margin_width;
   }
   ...
   int              *free_insert)
{
   ...
   *free_insert = (int)False;
   ...
   if (*insert_length)
   {
      ...
      {
         newblock.ptr = (char *)XtMalloc((unsigned)newblock.length + XmTextF_max_char_size(tf));
         if (XmTextF_max_char_size(tf) == 1)
         {
            (void)memcpy((void *)newblock.ptr, (void *)*insert, newblock.length);
            newblock.ptr[newblock.length] = '\0';
         }
         else
         {
            count = (int)wcstombs(newblock.ptr, (wchar_t *)*insert, newblock.length);
            if (count < 0)
            { /* bad wchar; don't pass anything */
               newblock.ptr[0] = '\0';
               newblock.length = 0;
            }
   ...
   if (XmTextF_modify_verify_callback(tf))
      XtCallCallbackList((Widget)tf, XmTextF_modify_verify_callback(tf), (XtPointer)&vcb);
   if (XmTextF_wcs_modify_verify_callback(tf) && vcb.doit)
   {
      if (do_free)
      { /* there is a char* modify verify callback; the data we
		       * want is in vcb struct */
         wcs_newblock.wcsptr = (wchar_t *)XtMalloc((unsigned)(vcb.text->length + 1) * sizeof(wchar_t));
         wcs_newblock.length = mbstowcs(wcs_newblock.wcsptr, vcb.text->ptr, vcb.text->length);
         if (wcs_newblock.length < 0)
         { /* bad value; don't pass anything */
      ...
      { /* there was no char* modify verify callback; use data
         ...
         else
         {
            ...
            (void)memcpy((void *)wcs_newblock.wcsptr, (void *)*insert, *insert_length * sizeof(wchar_t));
         }
         if (wcs_newblock.length < 0)
         { /* bad value; don't pass anything */
            wcs_newblock.wcsptr[0] = 0L;
      ...
      XtCallCallbackList((Widget)tf, XmTextF_wcs_modify_verify_callback(tf), (XtPointer)&wcs_vcb);
   }
   /*
         ...
         { /* callback struct has wchar*; caller expects wchar* */
            if (*insert_length > 0)
            {
               *insert      = XtMalloc((unsigned)(*insert_length + 1)
                                  * sizeof(wchar_t));
               *free_insert = (int)True;
               (void)memcpy((void *)*insert, (void *)wcs_vcb.text->wcsptr, *insert_length * sizeof(wchar_t));
               wptr                 = (wchar_t *)*insert;
...
static void
df_ResetClipOrigin(XmDataFieldWidget tf, Boolean clip_mask_reset)
{
   unsigned long valuemask = (GCTileStipXOrigin | GCTileStipYOrigin | GCClipXOrigin | GCClipYOrigin);
   XGCValues     values;
   ...
   if (x < (int)(tf->primitive.highlight_thickness + tf->primitive.shadow_thickness + XmTextF_margin_width(tf)))
   {
      clip_mask_x = tf->primitive.highlight_thickness + tf->primitive.shadow_thickness + (int)(XmTextF_margin_width(tf));
   }
   else
      clip_mask_x = x;
   if (clip_mask_reset)
...
static void
df_InvertImageGC(XmDataFieldWidget tf)
{
   unsigned long valuemask = (GCForeground | GCBackground);
   XGCValues     values;
...
static void
df_ResetImageGC(XmDataFieldWidget tf)
{
   unsigned long valuemask = (GCForeground | GCBackground);
   XGCValues     values;
   Display      *dpy = XtDisplay(tf);
   ...
   Boolean           set_dest)
{
   ...
   if (XmTextF_cursor_position(tf) != position && call_cb)
   {
      ...
      cb.doit       = True;
      XtCallCallbackList((Widget)tf, XmTextF_motion_verify_callback(tf), (XtPointer)&cb);
      if (!cb.doit)
      {
   ...
   XmTextF_refresh_ibeam_off(tf) = True;
   _XmDataFieldDrawInsertionPoint(tf, True);
   (void)df_GetXYFromPos(tf, XmTextF_cursor_position(tf), &xmim_point.x, &xmim_point.y);
   XmImVaSetValues((Widget)tf, XmNspotLocation, &xmim_point, NULL);
   if (set_dest)
      (void)df_SetDestination((Widget)tf, XmTextF_cursor_position(tf), False, XtLastTimestampProcessed(XtDisplay((Widget)tf)));
}
 ...
 */
static void
df_VerifyBounds(XmDataFieldWidget tf,
                XmTextPosition   *from,
                XmTextPosition   *to)
{
   XmTextPosition tmp;
   ...
   Boolean           move_cursor)
{
  ...
  */
   if ((delta >= 0) && ((XmTextF_string_length(tf) + delta) - (XmTextF_max_length(tf)) > 0))
   {
  ...
  */
   ...
   if (XmTextF_modify_verify_callback(tf) || XmTextF_wcs_modify_verify_callback(tf))
   {
     ...
     */
      if (!df_ModifyVerify(tf, event, &replace_prev, &replace_next, &insert, &insert_length, &newInsert, &free_insert))
      {
   ...
   if (XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf))
      XmDataFieldSetHighlight((Widget)tf, XmTextF_prim_pos_left(tf), XmTextF_prim_pos_right(tf), XmHIGHLIGHT_NORMAL);
   _XmDataFieldDrawInsertionPoint(tf, False);
   ...
   */
   ...
   {
      if ((XmTextF_string_length(tf) + insert_length - replace_length) * sizeof(wchar_t) >= XmTextF_size_allocd(tf))
      {
   ...
   if (XmTextF_has_primary(tf) && replace_prev < XmTextF_prim_pos_right(tf) && replace_next > XmTextF_prim_pos_left(tf))
   {
  ...
  */
   if (XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf))
   {
      XmDataFieldSetHighlight((Widget)tf, XmTextF_prim_pos_left(tf), XmTextF_prim_pos_right(tf), XmHIGHLIGHT_SELECTED);
   }
   ...
   if (move_cursor)
   {
      ...
      {
         (void)df_SetDestination((Widget)tf, cursorPos, False, XtLastTimestampProcessed(XtDisplay((Widget)tf)));
      }
   ...
   if (XmDataField_alignment(tf) == XmALIGNMENT_END)
   {
      ...
      if ((x2 > 0) && (x1 < x2) && (y2 < y1))
      {
         ...
         df_XmSetInvGC(tf, XmTextF_gc(tf));
         XFillRectangle(XtDisplay(tf), XtWindow(tf), XmTextF_gc(tf), x1, y2, x2, y1);
#if PWC_DEBUG
 ...
 */
void
_XmDataFieldDeselectSelection(Widget w, Boolean disown, Time sel_time)
{
   ...
   if (tf != NULL)
   {
      ...
      DataFieldSetHighlight(tf, XmTextF_prim_pos_left(tf), XmTextF_prim_pos_right(tf), XmHIGHLIGHT_NORMAL);
      XmTextF_prim_pos_left(tf) = XmTextF_prim_pos_right(tf) = XmTextF_prim_anchor(tf) = XmTextF_cursor_position(tf);
...
df_GetPosFromX(XmDataFieldWidget tf, Position x)
{
   XmTextPosition position;
   int            temp_x          = 0;
   ...
   for (position = 0; temp_x + next_char_width / 2 < (int)x && position < XmTextF_string_length(tf); position++)
   {
      ...
      if (XmTextF_string_length(tf) > position + 1)
      {
         if (XmTextF_max_char_size(tf) != 1)
         {
            next_char_width = df_FindPixelLength(tf,
                                                 (char *)(XmTextF_wc_value(tf) + position + 1),
                                                 1);
         }
         else
         {
            next_char_width = df_FindPixelLength(tf,
                                                 XmTextF_value(tf) + position + 1,
                                                 1);
         }
      }
   } /* for */
 ...
 */
static XmTextPosition
RightAlignedGetPosFromX(XmDataFieldWidget tf, Position x)
{
   XmTextPosition position;
   int            margin_width = XmTextF_margin_width(tf) + tf->primitive.highlight_thickness + tf->primitive.shadow_thickness;
   int            temp_x;
   int            next_char_width = 0;
   position                       = XmTextF_string_length(tf);
   ...
   if (XmTextF_string_length(tf) > 0)
   {
      if (XmTextF_max_char_size(tf) != 1)
      {
         next_char_width = df_FindPixelLength(tf, (char *)XmTextF_wc_value(tf) + position - 1, 1);
      }
      else
      {
         next_char_width = df_FindPixelLength(tf, XmTextF_value(tf) + position - 1, 1);
      }
   }
   for (; x < (temp_x - next_char_width / 2) && (position > 0); position--)
   {
	 ...
	 */
      if (position > 1)
      {
         ...
         {
            next_char_width = df_FindPixelLength(tf,
                                                 (char *)(XmTextF_wc_value(tf) + position - 2),
                                                 1);
         }
         else
         {
            next_char_width = df_FindPixelLength(tf,
                                                 XmTextF_value(tf) + position - 2,
                                                 1);
         }
      }
   } /* for */
...
static Boolean
df_SetDestination(Widget w, XmTextPosition position, Boolean disown, Time set_time)
{
   XmDataFieldWidget tf                = (XmDataFieldWidget)w;
   Boolean           result            = TRUE;
   ...
   if (!disown)
   {
      if (!XmTextF_has_destination(tf))
      {
         ...
         result                      = XtOwnSelection(w, MOTIF_DESTINATION, set_time, _XmDataFieldConvert, _XmDataFieldLoseSelection, (XtSelectionDoneProc)NULL);
...
Boolean
_XmDataFielddf_SetDestination(Widget w, XmTextPosition position, Time set_time)
{
 ...
 */
static Boolean
df_VerifyLeave(XmDataFieldWidget tf, XEvent *event)
{
   ...
   cbdata.text       = NULL;
   XtCallCallbackList((Widget)tf, XmTextF_losing_focus_callback(tf), (XtPointer)&cbdata);
   return (cbdata.doit);
}
...
static Boolean
_XmDataFieldIsWordBoundary(XmDataFieldWidget tf,
                           XmTextPosition    pos1,
                           XmTextPosition    pos2)
{
   int  size_pos1 = 0;
   ...
   if (pos1 < pos2 && ((pos2 - pos1) != 1))
      ...
      return False;
   if (XmTextF_max_char_size(tf) == 1)
   { /* data is char* and one-byte per char */
      if (isspace(XmTextF_value(tf)[pos1]) || isspace(XmTextF_value(tf)[pos2])) return True;
   }
   else
   {
      size_pos1 = wctomb(s1, XmTextF_wc_value(tf)[pos1]);
      size_pos2 = wctomb(s2, XmTextF_wc_value(tf)[pos2]);
      if (size_pos1 == 1 && (size_pos2 != 1 || isspace(*s1)))
         return True;
      if (size_pos2 == 1 && (size_pos1 != 1 || isspace(*s2)))
         return True;
   }
   return False;
}
...
static void
df_FindWord(XmDataFieldWidget tf, XmTextPosition begin, XmTextPosition *left, XmTextPosition *right)
{
   ...
   { /* check for iswspace and iswordboundary in each direction */
      for (start = begin; start > 0; start--)
      {
         if (iswspace(XmTextF_wc_value(tf)[start - 1])
             || _XmDataFieldIsWordBoundary(tf, (XmTextPosition)start - 1, start))
         {
            break;
         }
      }
...
static void
df_FindPrevWord(XmDataFieldWidget tf, XmTextPosition *left, XmTextPosition *right)
{
   XmTextPosition start = XmTextF_cursor_position(tf);
   if (XmTextF_max_char_size(tf) == 1)
   {
      if ((start > 0) && (isspace(XmTextF_value(tf)[start - 1])))
      {
         for (; start > 0; start--)
         {
            if (!isspace(XmTextF_value(tf)[start - 1]))
   ...
   else
   {
      ...
      else if ((start > 0) && _XmDataFieldIsWordBoundary(tf, (XmTextPosition)start - 1, start))
      {
         start--;
      }
      df_FindWord(tf, start, left, right);
...
static void
df_FindNextWord(XmDataFieldWidget tf, XmTextPosition *left, XmTextPosition *right)
{
   ...
   if (XmTextF_max_char_size(tf) == 1)
   {
       ...
       * current word.
       */
      while (*right < XmTextF_string_length(tf) && isspace(XmTextF_value(tf)[(int)*right]))
         *right = *right + 1;
   ...
   else
   {
      ...
      { /* if for other reasons at word boundry, advance to next word */
         if ((end < XmTextF_string_length(tf)) && _XmDataFieldIsWordBoundary(tf, end, (XmTextPosition)end + 1))
            end++;
      }
      df_FindWord(tf, end, left, right);
      /*
      ...
      {
         while (*right < XmTextF_string_length(tf) && iswspace(XmTextF_wc_value(tf)[(int)*right]))
         {
            *right = *right + 1;
         }
         if (*right < XmTextF_string_length(tf))
...
static void
df_CheckDisjointSelection(Widget w, XmTextPosition position, Time sel_time)
{
   XmDataFieldWidget tf   = (XmDataFieldWidget)w;
   XmTextPosition    left = 0, right = 0;
   if (XmTextF_add_mode(tf) || (XmDataFieldGetSelectionPosition(w, &left, &right) && left != right && position >= left && position <= right))
...
static Boolean
df_NeedsPendingDelete(XmDataFieldWidget tf)
{
   return (XmTextF_add_mode(tf) ? (XmTextF_pending_delete(tf) && XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf) && XmTextF_prim_pos_left(tf) <= XmTextF_cursor_position(tf) && XmTextF_prim_pos_right(tf) >= XmTextF_cursor_position(tf)) : (XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf)));
}

static Boolean
df_NeedsPendingDeleteDisjoint(XmDataFieldWidget tf)
{
   return (XmTextF_pending_delete(tf) && XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf) && XmTextF_prim_pos_left(tf) <= XmTextF_cursor_position(tf) && XmTextF_prim_pos_right(tf) >= XmTextF_cursor_position(tf));
}

static Time
df_GetServerTime(Widget w)
{
   XEvent    event;
   EventMask shellMask;
   ...
   if (!(shellMask & PropertyChangeMask))
      XSelectInput(XtDisplay(w), XtWindow(w), (long)(shellMask | PropertyChangeMask));
   XChangeProperty(XtDisplay(w), XtWindow(w), XA_WM_HINTS, XA_WM_HINTS, 32, PropModeAppend, (unsigned char *)NULL, 0);
...
static Boolean
PrintableString(XmDataFieldWidget tf, char *str, int n, Boolean use_wchar) /* sometimes unused */
{
...
#   if USE_XFT
   ...
   {
      XGlyphInfo ext;
      XftTextExtentsUtf8(XtDisplay(tf), TextF_XftFont(tf), (FcChar8 *)str, n, &ext);
      return ext.xOff != 0;
#   endif
   }
   else
 ...
 ****************************************************************/
static void
df_InsertChar(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
  ...
  */
   insert_length = XmImMbLookupString(w, (XKeyEvent *)event, insert_string, TEXT_MAX_INSERT_SIZE, (KeySym *)NULL, &status_return);
  ...
  */
   ...
   if (insert_length > 0)
   {
      ...
      {
         if (!XmDataFieldGetSelectionPosition(w, &cursorPos, &nextPos) || cursorPos == nextPos)
         {
      ...
      if (XmTextF_max_char_size(tf) == 1)
      {
         ...
         replace_res = _XmDataFieldReplaceText(tf, (XEvent *)event, cursorPos, nextPos, insert_string, insert_length, True);
      }
      else
      {
         ...
         if (nextPos > XmTextF_string_length(tf)) nextPos = XmTextF_string_length(tf);
         replace_res = _XmDataFieldReplaceText(tf, (XEvent *)event, cursorPos, nextPos, (char *)wc_insert_string, num_chars, True);
      ...
      if (replace_res)
      {
         if (pending_delete)
         {
            XmDataFieldSetSelection(w, XmTextF_cursor_position(tf), XmTextF_cursor_position(tf), event->xkey.time);
         }
         df_CheckDisjointSelection(w, XmTextF_cursor_position(tf), event->xkey.time);
         _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), False, True);
         cb.reason = XmCR_VALUE_CHANGED;
         cb.event  = event;
         XtCallCallbackList((Widget)tf, XmTextF_value_changed_callback(tf), (XtPointer)&cb);
      }
      _XmDataFieldDrawInsertionPoint(tf, True);
   }
}
...
static void
df_InsertString(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   char              insert_string[TEXT_MAX_INSERT_SIZE];
   XmTextPosition    cursorPos, nextPos;
   ...
   for (i = 0; i < *num_params; i++)
   {
      ...
      if (insert_length > 0)
      {
         ...
         if (XmTextF_have_fontset(tf))
         {
            if (!XmbTextEscapement((XFontSet)XmTextF_font(tf), insert_string, insert_length))
               return;
         }
         else
         {
...
static void
df_DeletePrevChar(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmAnyCallbackStruct cb;
   /* if pending delete is on and there is a selection */
   _XmDataFieldDrawInsertionPoint(tf, False);
   if (df_NeedsPendingDelete(tf))
   ...
   else
   {
      if (XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf))
      {
         if (XmTextF_cursor_position(tf) - 1 >= 0)
            if (_XmDataFieldReplaceText(tf, event, XmTextF_cursor_position(tf) - 1, XmTextF_cursor_position(tf), NULL, 0, True))
            {
               df_CheckDisjointSelection(w, XmTextF_cursor_position(tf), event->xkey.time);
               _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), False, True);
               cb.reason = XmCR_VALUE_CHANGED;
...
static void
df_DeleteNextChar(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmAnyCallbackStruct cb;
   /* if pending delete is on and there is a selection */
   ...
   else
   {
      if (XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf))
      {
         if (XmTextF_cursor_position(tf) < XmTextF_string_length(tf))
            if (_XmDataFieldReplaceText(tf, event, XmTextF_cursor_position(tf), XmTextF_cursor_position(tf) + 1, NULL, 0, True))
            {
               df_CheckDisjointSelection(w, XmTextF_cursor_position(tf), event->xkey.time);
               _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), False, True);
               cb.reason = XmCR_VALUE_CHANGED;
...
static void
df_DeletePrevWord(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   ...
   else
   {
      ...
      if (XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf))
      {
         if (_XmDataFieldReplaceText(tf, event, left, XmTextF_cursor_position(tf), NULL, 0, True))
         {
            df_CheckDisjointSelection(w, XmTextF_cursor_position(tf), event->xkey.time);
            _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), False, True);
            cb.reason = XmCR_VALUE_CHANGED;
...
static void
df_DeleteNextWord(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmTextPosition      left, right;
   XmAnyCallbackStruct cb;
   ...
   else
   {
      ...
      if (XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf))
      {
         if (_XmDataFieldReplaceText(tf, event, XmTextF_cursor_position(tf), right, NULL, 0, True))
         {
            df_CheckDisjointSelection(w, XmTextF_cursor_position(tf), event->xkey.time);
            _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), False, True);
            cb.reason = XmCR_VALUE_CHANGED;
...
static void
df_DeleteToEndOfLine(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmAnyCallbackStruct cb;
   /* if pending delete is on and there is a selection */
   ...
   {
      if (_XmDataFieldReplaceText(tf, event, XmTextF_cursor_position(tf), XmTextF_string_length(tf), NULL, 0, True))
      {
         df_CheckDisjointSelection(w, XmTextF_cursor_position(tf), event->xkey.time);
         _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), False, True);
         cb.reason = XmCR_VALUE_CHANGED;
...
static void
df_DeleteToStartOfLine(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmAnyCallbackStruct cb;
   /* if pending delete is on and there is a selection */
   ...
   {
      if (_XmDataFieldReplaceText(tf, event, 0, XmTextF_cursor_position(tf), NULL, 0, True))
      {
         df_CheckDisjointSelection(w, XmTextF_cursor_position(tf), event->xkey.time);
         _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), False, True);
         cb.reason = XmCR_VALUE_CHANGED;
...
static void
df_ProcessCancel(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget      tf = (XmDataFieldWidget)w;
   ...
   if (XmTextF_has_primary(tf) && XmTextF_extending(tf))
   {
      ...
      XmDataFieldSetSelection(w, XmTextF_orig_left(tf), XmTextF_orig_right(tf), event->xkey.time);
   }
...
static void
df_Activate(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmAnyCallbackStruct    cb;
   XmDataFieldWidget      tf = (XmDataFieldWidget)w;
   XmParentInputActionRec p_event;
...
static void
df_SetAnchorBalancing(XmDataFieldWidget tf, XmTextPosition position)
{
   XmTextPosition left, right;
   float          bal_point;
   if (!XmDataFieldGetSelectionPosition((Widget)tf, &left, &right) || left == right)
   {
      XmTextF_prim_anchor(tf) = position;
   }
   else
...
static void
df_SetNavigationAnchor(XmDataFieldWidget tf, XmTextPosition position, Boolean extend)
{
   XmTextPosition left, right;
...
static void
df_CompleteNavigation(XmDataFieldWidget tf, XEvent *event, XmTextPosition position, Time time, Boolean extend)
{
   XmTextPosition left, right;
   Boolean        backward = False;
   if ((XmTextF_add_mode(tf) && XmDataFieldGetSelectionPosition((Widget)tf, &left, &right) && position >= left && position <= right) || extend)
      XmTextF_pending_off(tf) = FALSE;
   else
      XmTextF_pending_off(tf) = TRUE;
...
static void
df_SimpleMovement(Widget w, XEvent *event, String *params, Cardinal *num_params, XmTextPosition cursorPos, XmTextPosition position)
{
   XmDataFieldWidget tf     = (XmDataFieldWidget)w;
...
static void
df_BackwardChar(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   ...
   if (cursorPos > 0)
   {
      ...
      df_SimpleMovement((Widget)tf, event, params, num_params, cursorPos, position);
      _XmDataFieldDrawInsertionPoint(tf, True);
   }
}

static void
df_ForwardChar(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    cursorPos, position;
   cursorPos = XmTextF_cursor_position(tf);
...
static void
df_BackwardWord(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
static void
df_ForwardWord(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    cursorPos, position, dummy;
   cursorPos = XmTextF_cursor_position(tf);
...
static void
df_EndOfLine(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    cursorPos, position;
   cursorPos = XmTextF_cursor_position(tf);
...
static void
df_BeginningOfLine(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    cursorPos, position;
   cursorPos = XmTextF_cursor_position(tf);
...
static void
df_SetSelection(XmDataFieldWidget tf, XmTextPosition left, XmTextPosition right, Boolean redisplay)
{
   ...
   DataFieldSetHighlight(tf, XmTextF_prim_pos_left(tf), XmTextF_prim_pos_right(tf), XmHIGHLIGHT_SELECTED);
   if (redisplay)
   {
      ...
      else if (old_prim_left < XmTextF_prim_pos_left(tf))
      {
         ...
         display_left = (old_prim_right > XmTextF_prim_pos_right(tf)) ? XmTextF_prim_pos_right(tf) : old_prim_right;
      ...
      else if (old_prim_right > XmTextF_prim_pos_right(tf))
      {
         ...
         display_right = (old_prim_left < XmTextF_prim_pos_left(tf)) ? XmTextF_prim_pos_left(tf) : old_prim_left;
 ...
 */
void
_XmDataFieldStartSelection(XmDataFieldWidget tf, XmTextPosition left, XmTextPosition right, Time sel_time)
{
   if (!XtIsRealized((Widget)tf)) return;
   ...
   if (!XmTextF_has_primary(tf))
   {
     ...
     */
      if (XtOwnSelection((Widget)tf, XA_PRIMARY, sel_time, _XmDataFieldConvert, _XmDataFieldLoseSelection, (XtSelectionDoneProc)NULL))
      {
         XmAnyCallbackStruct cb;
       ...
       */
         ...
         cb.event  = NULL;
         XtCallCallbackList((Widget)tf, XmTextF_gain_primary_callback(tf), (XtPointer)&cb);
      }
      else
         /*
...
static void
df_ProcessHorizontalParams(Widget w, XEvent *event, char **params, Cardinal *num_params, XmTextPosition *left, XmTextPosition *right, XmTextPosition *position)
{
   XmDataFieldWidget tf            = (XmDataFieldWidget)w;
...
static void
df_ProcessSelectParams(Widget w, XEvent *event, XmTextPosition *left, XmTextPosition *right, XmTextPosition *position)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   *position            = XmTextF_cursor_position(tf);
   if (!XmDataFieldGetSelectionPosition(w, left, right) || *left == *right)
...
static void
df_KeySelection(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   ...
   else if (*num_params > 0 && (!strcmp(*params, "right") || !strcmp(*params, "left")))
   {
...
static void
df_TextFocusIn(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmAnyCallbackStruct cb;
   XPoint              xmim_point;
...
static void
df_TextFocusOut(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XtWidgetProc      buhl;
   if (event->xfocus.send_event && XmTextF_has_focus(tf))
   ...
   if (event->xfocus.send_event && !XmTextF_traversed(tf) && _XmGetFocusPolicy(w) == XmEXPLICIT)
   {
...
static void
df_SetScanIndex(XmDataFieldWidget tf, XEvent *event)
{
   Time sel_time;
   ...
   if (sel_time > XmTextF_last_time(tf) && sel_time - XmTextF_last_time(tf) < XtGetMultiClickTime(XtDisplay(tf)))
   {
      /*
...
static void
df_ExtendScanSelection(XmDataFieldWidget tf, XEvent *event)
{
   ...
   if (!XmDataFieldGetSelectionPosition((Widget)tf, &left, &right) || left == right)
   {
      XmTextF_orig_left(tf) = XmTextF_orig_right(tf) = XmTextF_prim_anchor(tf) = XmTextF_cursor_position(tf);
   ...
   switch (XmTextF_selection_array(tf)[XmTextF_sarray_index(tf)])
   {
      case XmSELECT_POSITION:
         if (XmTextF_has_primary(tf))
            ...
            _XmDataFieldStartSelection(tf, XmTextF_prim_anchor(tf), new_position, event->xbutton.time);
         XmTextF_pending_off(tf) = False;
      ...
      case XmSELECT_WORD:
         ...
         df_FindWord(tf, XmTextF_prim_anchor(tf), &pivot_left, &pivot_right);
         XmTextF_pending_off(tf) = False;
...
static void
df_SetScanSelection(XmDataFieldWidget tf, XEvent *event)
{
   XmTextPosition left, right;
   ...
   switch (XmTextF_selection_array(tf)[XmTextF_sarray_index(tf)])
   {
      ...
      case XmSELECT_ALL:
         if (XmTextF_has_primary(tf))
            ...
            _XmDataFieldStartSelection(tf, 0, XmTextF_string_length(tf), event->xbutton.time);
         XmTextF_pending_off(tf) = False;
         if (event->type == ButtonPress)
         {
   ...
   df_GetXYFromPos(tf, cursorPos, &(XmTextF_select_pos_x(tf)), &dummy);
   _XmDataFieldDrawInsertionPoint(tf, True);
}

static void
df_StartPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
static void
df_MoveDestination(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    left, right;
   ...
   * me to gain focus... Cursor is now on when it shouldn't be. */
   if ((reset_cursor = !old_has_focus && XmTextF_has_focus(tf)) != False)
      _XmDataFieldDrawInsertionPoint(tf, False);
   _XmDataFielddf_SetCursorPosition(tf, event, new_position, True, True);
...
static void
df_ExtendPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
static void
df_ExtendEnd(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
static void
df_DoExtendedSelection(Widget w, Time time)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   ...
   switch (XmTextF_selection_array(tf)[XmTextF_sarray_index(tf)])
   {
      case XmSELECT_POSITION:
         if (XmTextF_has_primary(tf))
            ...
            _XmDataFieldStartSelection(tf, XmTextF_prim_anchor(tf), position, time);
         XmTextF_pending_off(tf) = False;
         cursorPos               = position;
         break;
      case XmSELECT_WHITESPACE:
...
static void
df_DoSecondaryExtend(Widget w, Time ev_time)
{
   XmDataFieldWidget tf       = (XmDataFieldWidget)w;
 ...
 ************************************************************************/
static void
df_BrowseScroll(XtPointer closure, XtIntervalId *id)
{
...
static Boolean
df_CheckTimerScrolling(Widget w, XEvent *event)
{
   XmDataFieldWidget tf          = (XmDataFieldWidget)w;
   Dimension         margin_size = XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Dimension         top_margin  = XmTextF_margin_height(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   XmTextF_select_pos_x(tf)      = event->xmotion.x;
   if ((event->xmotion.x > (int)margin_size) && (event->xmotion.x < (int)(tf->core.width - margin_size)) && (event->xmotion.y > (int)top_margin) && (event->xmotion.y < (int)(top_margin + XmTextF_font_ascent(tf) + XmTextF_font_descent(tf))))
   {
      if (XmTextF_select_id(tf))
      {
         XtRemoveTimeOut(XmTextF_select_id(tf));
   ...
   else
   {
      ...
      if (event->xmotion.x <= (int)margin_size)
         XmTextF_select_pos_x(tf) = (Position)(margin_size - (XmTextF_average_char_width(tf) + 1));
      /* to the right of the text */
      else if (event->xmotion.x >= (int)(tf->core.width - margin_size))
         XmTextF_select_pos_x(tf) = (Position)((tf->core.width - margin_size) + XmTextF_average_char_width(tf) + 1);
      if (!XmTextF_select_id(tf))
         XmTextF_select_id(tf) = XtAppAddTimeOut(XtWidgetToApplicationContext(w),
...
static void
df_RestorePrimaryHighlight(XmDataFieldWidget tf, XmTextPosition prim_left, XmTextPosition prim_right)
{
   if (XmTextF_sec_pos_right(tf) >= prim_left && XmTextF_sec_pos_right(tf) <= prim_right)
   {
      /* secondary selection is totally inside primary selection */
      if (XmTextF_sec_pos_left(tf) >= prim_left)
      {
         DataFieldSetHighlight(tf, prim_left, XmTextF_sec_pos_left(tf), XmHIGHLIGHT_SELECTED);
         DataFieldSetHighlight(tf, XmTextF_sec_pos_left(tf), XmTextF_sec_pos_right(tf), XmHIGHLIGHT_NORMAL);
         DataFieldSetHighlight(tf, XmTextF_sec_pos_right(tf), prim_right, XmHIGHLIGHT_SELECTED);
         /* right side of secondary selection is inside primary selection */
      }
      else
      {
         DataFieldSetHighlight(tf, XmTextF_sec_pos_left(tf), prim_left, XmHIGHLIGHT_NORMAL);
         DataFieldSetHighlight(tf, prim_left, XmTextF_sec_pos_right(tf), XmHIGHLIGHT_SELECTED);
      }
   }
   else
   {
      /* left side of secondary selection is inside primary selection */
      if (XmTextF_sec_pos_left(tf) <= prim_right && XmTextF_sec_pos_left(tf) >= prim_left)
      {
         DataFieldSetHighlight(tf, XmTextF_sec_pos_left(tf), prim_right, XmHIGHLIGHT_SELECTED);
         DataFieldSetHighlight(tf, prim_right, XmTextF_sec_pos_right(tf), XmHIGHLIGHT_NORMAL);
      }
      else
      {
         /* secondary selection encompasses the primary selection */
         if (XmTextF_sec_pos_left(tf) <= prim_left && XmTextF_sec_pos_right(tf) >= prim_right)
         {
            DataFieldSetHighlight(tf, XmTextF_sec_pos_left(tf), prim_left, XmHIGHLIGHT_NORMAL);
            DataFieldSetHighlight(tf, prim_left, prim_right, XmHIGHLIGHT_SELECTED);
            DataFieldSetHighlight(tf, prim_right, XmTextF_sec_pos_right(tf), XmHIGHLIGHT_NORMAL);
...
void
_XmDataFieldSetSel2(Widget w, XmTextPosition left, XmTextPosition right, Boolean disown, Time sel_time)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   Boolean           result;
   if (XmTextF_has_secondary(tf))
   ...
   if (left < right)
   {
      if (!XmTextF_has_secondary(tf))
      {
         result                    = XtOwnSelection(w, XA_SECONDARY, sel_time, _XmDataFieldConvert, _XmDataFieldLoseSelection, (XtSelectionDoneProc)NULL);
   ...
   DataFieldSetHighlight((XmDataFieldWidget)w, XmTextF_sec_pos_left(tf), XmTextF_sec_pos_right(tf), XmHIGHLIGHT_SECONDARY_SELECTED);
   /* This can be optimized for performance enhancement */
   df_RedisplayText(tf, 0, XmTextF_string_length(tf));
}

static void
df_StartDrag(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   Atom              targets[5];
   ...
   int               n;
   tmp_prop.value = NULL;
   status         = XmbTextListToTextProperty(XtDisplay(w), &tmp_string, 1, (XICCEncodingStyle)XTextStyle, &tmp_prop);
   if (status == Success)
   ...
   n                      = 0;
   XtSetArg(args[n], XmNcursorBackground, tf->core.background_pixel);
   n++;
   XtSetArg(args[n], XmNcursorForeground, tf->primitive.foreground);
   n++;
   ...
   n++;
   XtSetArg(args[n], XmNconvertProc, _XmDataFieldConvert);
   n++;
...
static void
df_StartSecondary(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf       = (XmDataFieldWidget)w;
...
static void
df_ProcessBDrag(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   ...
   if (XmDataFieldGetSelectionPosition(w, &left, &right) && left != right)
   {
      if ((position > left && position < right) ||
          ...
          (position == left && df_GetXYFromPos(tf, left, &left_x, &dummy) && event->xbutton.x > left_x) || (position == right && df_GetXYFromPos(tf, right, &right_x, &dummy) && event->xbutton.x < right_x))
      {
...
static void
df_ExtendSecondary(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf       = (XmDataFieldWidget)w;
   XmTextPosition    position = df_GetPosFromX(tf, (Position)event->xbutton.x);
   if (XmTextF_cancel(tf)) return;
   ...
   if (position < XmTextF_sec_anchor(tf))
   {
      _XmDataFieldSetSel2(w, position, XmTextF_sec_anchor(tf), False, event->xbutton.time);
   }
   else if (position > XmTextF_sec_anchor(tf))
   {
      _XmDataFieldSetSel2(w, XmTextF_sec_anchor(tf), position, False, event->xbutton.time);
   }
   else
   {
...
static void
df_DoStuff(Widget w, XtPointer closure, Atom *seltype, Atom *type, XtPointer value, unsigned long *length, int *format)
{
   XmDataFieldWidget   tf          = (XmDataFieldWidget)w;
   ...
   if (!(*length) && *type != NULL_ATOM)
   {
      ...
      if (prim_select->target == XmInternAtom(XtDisplay(w), "TEXT", False))
      {
         ...
         XtGetSelectionValue(w, XA_PRIMARY, XA_STRING, df_DoStuff, (XtPointer)prim_select, prim_select->time);
      }
      XtFree((char *)value);
      value = NULL;
      return;
   ...
   if (*type == NULL_ATOM)
   {
      if (prim_select->num_chars > 0 && XmTextF_selection_move(tf))
      {
         ...
         XmDataFieldSetSelection(w, prim_select->position, prim_select->position + prim_char_length, prim_select->time);
         XmTextF_prim_anchor(tf) = prim_select->position;
         (void)df_SetDestination(w, XmTextF_cursor_position(tf), False, prim_select->time);
      }
   }
   else
   {
          ...
          *type == XA_STRING)
      {
         ...
         num_vals          = 0;
         status            = XmbTextPropertyToTextList(XtDisplay(w), &tmp_prop, &tmp_value, &num_vals);
         ...
         if (num_vals && (status == Success || status > 0))
         {
            if (XmTextF_max_char_size(tf) == 1)
            {
               ...
               replace_res = _XmDataFieldReplaceText(tf, NULL, prim_select->position, prim_select->position, total_tmp_value, strlen(total_tmp_value), False);
            ...
            else
            {
               ...
               for (i = 0; i < num_vals; i++)
                  prim_select->num_chars += mbstowcs(wc_value + prim_select->num_chars,
                                                     tmp_value[i],
                                                     (size_t)malloc_size - prim_select->num_chars);
               replace_res = _XmDataFieldReplaceText(tf, NULL, prim_select->position, prim_select->position, (char *)wc_value, prim_select->num_chars, False);
               XtFree((char *)wc_value);
            }
         }
         else
         { /* initialize prim_select values for possible delete oper */
            prim_select->num_chars = 0;
         }
      }
      else
      {
         if (XmTextF_max_char_size(tf) == 1)
         {
            ...
            replace_res            = _XmDataFieldReplaceText(tf, NULL, prim_select->position, prim_select->position, (char *)value, prim_select->num_chars, False);
         }
         else
         {
            wchar_t *wc_value;
      ...
      if (replace_res)
      {
         ...
         {
            if (!XmTextF_selection_move(tf) && !XmTextF_add_mode(tf) && prim_select->num_chars != 0)
               XmTextF_prim_anchor(tf) = prim_select->position;
         }
         if (XmTextF_selection_move(tf))
         {
            prim_select->ref_count++;
            XtGetSelectionValue(w, XA_PRIMARY, XmInternAtom(XtDisplay(w), "DELETE", False), df_DoStuff, (XtPointer)prim_select, prim_select->time);
         }
         cb.reason = XmCR_VALUE_CHANGED;
...
static void
df_Stuff(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
 ...
 */
   ...
   XtGetSelectionValue(w, XA_PRIMARY, XmInternAtom(XtDisplay(w), "TARGETS", False), df_HandleTargets, (XtPointer)tmp, event->xbutton.time);
}

static void
df_HandleSelectionReplies(Widget w, XtPointer closure, XEvent *event, Boolean *cont)
{
   XmDataFieldWidget   tf       = (XmDataFieldWidget)w;
   ...
   XtRemoveEventHandler(w, (EventMask)NULL, TRUE, df_HandleSelectionReplies, (XtPointer)XmInternAtom(XtDisplay(w), "_XM_TEXT_I_S_PROP", False));
   ...
   else
   {
      if (dest_data->has_destination)
      {
         ...
         XmDataFieldSetHighlight(w, XmTextF_sec_pos_left(tf), XmTextF_sec_pos_right(tf), XmHIGHLIGHT_NORMAL);
         ...
         else if (dest_data->position > XmTextF_sec_pos_left(tf) && dest_data->position < XmTextF_sec_pos_right(tf))
         {
         ...
         if (_XmDataFieldReplaceText(tf, event, left, right, NULL, 0, False))
         {
            if (dest_data->has_destination && XmTextF_cursor_position(tf) > right)
            {
               ...
               if (!dest_data->quick_key)
                  _XmDataFielddf_SetCursorPosition(tf, event, cursorPos, True, True);
               (void)df_SetDestination((Widget)tf, cursorPos, False, event->xselection.time);
            }
            if (!dest_data->has_destination)
            {
               XmTextF_prim_anchor(tf) = XmTextF_cursor_position(tf);
...
/* REQUEST TARGETS FROM SELECTION RECEIVER; THEN CALL HANDLETARGETS
    ...
    */
static void
df_SecondaryNotify(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget  tf           = (XmDataFieldWidget)w;
   ...
   XmTextPosition     left, right;
   int                status = 0;
   if (XmTextF_selection_move(tf) == TRUE && XmTextF_has_destination(tf) && XmTextF_cursor_position(tf) >= XmTextF_sec_pos_left(tf) && XmTextF_cursor_position(tf) <= XmTextF_sec_pos_right(tf))
   {
   ...
   XChangeProperty(XtDisplay(w), XtWindow(w), XM_TEXT_PROP, XmInternAtom(XtDisplay(w), "ATOM_PAIR", False), 32, PropModeReplace, (unsigned char *)pair, 2);
   dest_data                  = df_GetTextFDestData(w);
   ...
   if (*(num_params) == 1)
      dest_data->quick_key = True;
   else
      dest_data->quick_key = False;
   if (XmDataFieldGetSelectionPosition(w, &left, &right) && left != right)
   {
   ...
   XtAddEventHandler(w, (EventMask)NULL, TRUE, df_HandleSelectionReplies, (XtPointer)XM_TEXT_PROP);
   /*
...
/*
    ...
    */
static void
df_HandleTargets(Widget w, XtPointer closure, Atom *seltype, Atom *type, XtPointer value, unsigned long *length, int *format)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   Atom              CS_OF_LOCALE; /* to be initialized by XmbTextListToTextProperty */
   ...
   */
   ...
   if (XmDataFieldGetSelectionPosition(w, &left, &right) && left != right && select_pos > left && select_pos < right)
   {
      XtFree((char *)value);
      value = NULL;
      XtFree((char *)tmp_action->event);
   ...
   if (supports_locale_data)
      prim_select->target = targets[0] = XmInternAtom(XtDisplay(w), "TEXT", False);
#if XM_UTF8
   ...
   XtGetSelectionValue(w, XA_PRIMARY, targets[0], df_DoStuff, (XtPointer)prim_select, tmp_action->event->xbutton.time);
   XtFree((char *)value);
   XtFree((char *)tmp_action->event);
   XtFree((char *)tmp_action);
}
...
static void
df_ProcessBDragRelease(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   ...
   {
      if (XmTextF_has_secondary(tf) && XmTextF_sec_pos_left(tf) != XmTextF_sec_pos_right(tf))
      {
         if (ev->x > (int)tf->core.width || ev->x < 0 || ev->y > (int)tf->core.height || ev->y < 0)
         {
            _XmDataFieldSetSel2(w, 0, 0, False, event->xkey.time);
            XmTextF_has_secondary(tf) = False;
         }
      ...
      else if (!XmTextF_sec_drag(tf) && !XmTextF_cancel(tf) && XmTextF_sec_pos_left(tf) == position)
      {
...
static void
df_ProcessCopy(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
   XmTextF_selection_move(tf) = FALSE;
...
static void
df_ProcessMove(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
...
static void
df_DeleteSelection(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   (void)DataFieldRemove(w, event);
}

static void
df_ClearSelection(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget   tf         = (XmDataFieldWidget)w;
   ...
   if (num_spaces)
   {
      ...
      if (XmTextF_max_char_size(tf) == 1)
      {
         ...
         spaces[num_spaces] = 0;
         rep_result         = _XmDataFieldReplaceText(tf, (XEvent *)event, left, right, spaces, num_spaces, False);
      ...
      else
      {
         ...
         rep_result = _XmDataFieldReplaceText(tf, (XEvent *)event, left, right, (char *)wc_spaces, num_spaces, False);
         if (XmTextF_cursor_position(tf) > left)
            df_ResetClipOrigin(tf, False);
...
static void
df_PageRight(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   Position          x, y;
   int               length       = 0;
   XmDataFieldWidget tf           = (XmDataFieldWidget)w;
   ...
   if (XmTextF_max_char_size(tf) != 1)
   {
      length = df_FindPixelLength(tf, (char *)XmTextF_wc_value(tf), XmTextF_string_length(tf));
   }
   else
   {
   ...
   if (length - ((int)(tf->core.width - (2 * margin_width)) - XmTextF_h_offset(tf)) > (int)(tf->core.width - (2 * margin_width)))
      XmTextF_h_offset(tf) -= tf->core.width - (2 * margin_width);
   else
      XmTextF_h_offset(tf) = -(length - (tf->core.width - (2 * margin_width)));
   df_RedisplayText(tf, 0, XmTextF_string_length(tf));
   _XmDataFielddf_SetCursorPosition(tf, event, df_GetPosFromX(tf, x), True, True);
   if (*num_params > 0 && !strcmp(*params, "extend"))
...
static void
df_PageLeft(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   Position          x, y;
   XmDataFieldWidget tf           = (XmDataFieldWidget)w;
   int               margin_width = (int)XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   _XmDataFieldDrawInsertionPoint(tf, False);
   if (*num_params > 0 && !strcmp(*params, "extend"))
      df_SetAnchorBalancing(tf, XmTextF_cursor_position(tf));
   df_GetXYFromPos(tf, XmTextF_cursor_position(tf), &x, &y);
   if (margin_width <= XmTextF_h_offset(tf) + ((int)tf->core.width - (2 * margin_width)))
...
static void
df_CopyPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
   XmTextF_selection_move(tf) = False;
...
static void
df_CutPrimary(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
   XmTextF_selection_move(tf) = True;
...
static void
df_SetAnchor(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    left, right;
   XmTextF_prim_anchor(tf) = XmTextF_cursor_position(tf);
   ...
   if (XmDataFieldGetSelectionPosition(w, &left, &right))
   {
      _XmDataFieldStartSelection(tf, XmTextF_prim_anchor(tf), XmTextF_prim_anchor(tf), event->xkey.time);
      XmDataFieldSetAddMode(w, False);
   }
}

static void
df_ToggleOverstrike(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
...
static void
df_ToggleAddMode(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    left, right;
   _XmDataFieldDrawInsertionPoint(tf, False);
   XmDataFieldSetAddMode(w, !XmTextF_add_mode(tf));
   if (XmTextF_add_mode(tf) && (!(XmDataFieldGetSelectionPosition(w, &left, &right)) || left == right))
      XmTextF_prim_anchor(tf) = XmTextF_cursor_position(tf);
   _XmDataFieldDrawInsertionPoint(tf, True);
}

static void
df_SelectAll(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
   if (XmTextF_has_primary(tf))
   ...
   XmTextF_pending_off(tf) = False;
   _XmDataFielddf_SetCursorPosition(tf, NULL, XmTextF_cursor_position(tf), False, False);
...
static void
df_DeselectAll(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
   df_SetSelection(tf, XmTextF_cursor_position(tf), XmTextF_cursor_position(tf), True);
   XmTextF_pending_off(tf) = True;
   _XmDataFielddf_SetCursorPosition(tf, event, XmTextF_cursor_position(tf), True, True);
   XmTextF_prim_anchor(tf) = XmTextF_cursor_position(tf);
   (void)df_SetDestination(w, XmTextF_cursor_position(tf), False, event->xkey.time);
   _XmDataFieldDrawInsertionPoint(tf, True);
}
...
static void
df_VoidAction(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   /* Do Nothing */
}

static void
df_CutClipboard(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
...
static void
df_CopyClipboard(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmDataFieldDrawInsertionPoint(tf, False);
...
static void
df_PasteClipboard(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   _XmDataFieldDrawInsertionPoint((XmDataFieldWidget)w, False);
...
static void
df_TraverseDown(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
static void
df_TraverseUp(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   if (tf->primitive.navigation_type == XmNONE && df_VerifyLeave(tf, event))
   {
...
static void
df_TraverseHome(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
static void
df_TraverseNextTabGroup(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   /* Allow the verification routine to control the traversal */
   if (df_VerifyLeave(tf, event))
...
static void
df_TraversePrevTabGroup(Widget w, XEvent *event, char **params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   /* Allow the verification routine to control the traversal */
   if (df_VerifyLeave(tf, event))
...
static void
df_TextEnter(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmAnyCallbackStruct cb;
   XPoint              xmim_point;
   ...
   if (_XmGetFocusPolicy(w) != XmEXPLICIT && !(XmTextF_has_focus(tf)) && event->xcrossing.focus && (event->xcrossing.detail != NotifyInferior))
   {
      if (!XmTextF_has_rect(tf)) _XmDataFieldSetClipRect(tf);
      _XmDataFieldDrawInsertionPoint(tf, False);
      XmTextF_blink_on(tf)  = False;
...
static void
df_TextLeave(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
 ...
 */
static void
df_ClassPartInitialize(WidgetClass w_class)
{
   char *event_bindings;
   _XmFastSubclassInit(w_class, XmDATAFIELD_BIT);
   /* Install traits */
   XmeTraitSet((XtPointer)w_class, XmQTaccessTextual, (XtPointer)&dataFieldCS);
   event_bindings = XtMalloc((strlen(EventBindings1) + strlen(EventBindings2) + strlen(EventBindings3) + strlen("\n") + strlen(EventBindings4) + 1));
 ...
 */
static void
df_Validates(XmDataFieldWidget tf)
{
   XtPointer temp_ptr;
 ...
 */
   ...
   memcpy((void *)XmTextF_selection_array(tf), (void *)temp_ptr, (XmTextF_selection_array_count(tf) * sizeof(XmTextScanType)));
   /*
 * End fix for HaL DTS 9841
 */
}
...
static Boolean
df_LoadFontMetrics(XmDataFieldWidget tf)
{
   ...
   do
   {
      ...
      if (next_entry)
      {
         ...
         if (type_return == XmFONT_IS_FONTSET)
         {
            ...
            if (!have_font_set)
            { /* this saves the first fontset found, just in
   ...
   if (XmTextF_have_fontset(tf))
   {
      ...
      XmTextF_font_descent(tf) = fs_extents->max_ink_extent.height + fs_extents->max_ink_extent.y;
#if USE_XFT
   }
   else if (XmTextF_use_xft(tf))
   {
   ...
   else
   {
      ...
      {
         if (font->per_char && font->min_char_or_byte2 <= '0' && font->max_char_or_byte2 >= '0')
 ...
 */
static void
df_ValidateString(XmDataFieldWidget tf, char *value, Boolean is_wchar)
{
   ...
   if (!is_wchar)
   {
      ...
      *temp_str = '\0';
      ...
      { /* Need wchar_t* data to set as the widget's value */
         ...
         XmTextF_string_length(tf) = mbstowcs(XmTextF_wc_value(tf), start_temp, XmTextF_string_length(tf) + 30);
         XmTextF_value(tf)         = NULL;
      }
      XmStackFree((char *)start_temp, stack_cache);
   }
   else
   { /* pointer passed points to wchar_t* data */
 ...
 */
static void
df_InitializeTextStruct(XmDataFieldWidget tf)
{
   ...
   if (XmDataField_alignment(tf) == XmALIGNMENT_END)
      ...
      XmTextF_new_h_offset(tf) = XmTextF_h_offset(tf) = XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   /* df_ValidateString will verify value contents, convert to appropriate
     ...
     * pointer.  */
   if (XmTextF_wc_value(tf) != NULL)
   { /* XmNvalueWcs was set - it rules */
      XmTextF_value(tf) = NULL;
   ...
   XmTextF_orig_left(tf) = XmTextF_orig_right(tf) = XmTextF_prim_pos_left(tf) = XmTextF_prim_pos_right(tf) = XmTextF_prim_anchor(tf) = XmTextF_cursor_position(tf);
   XmTextF_sec_pos_left(tf) = XmTextF_sec_pos_right(tf) = XmTextF_sec_anchor(tf) = XmTextF_cursor_position(tf);
   ...
   XmTextF_highlight(tf).list                                   = (_XmHighlightRec *)XtMalloc((unsigned)sizeof(_XmHighlightRec));
   ...
   if (XmDataField_picture_source(tf))
   {
      ...
      XtAddCallback((Widget)tf, XmNmodifyVerifyCallback, PictureVerifyCallback, NULL);
   }
   else
   {
   ...
   if (XmTextF_editable(tf))
   {
      ...
      df_GetXYFromPos(tf, XmTextF_cursor_position(tf), &xmim_point.x, &xmim_point.y);
      n = 0;
      XtSetArg(args[n], XmNfontList, XmTextF_font_list(tf));
      n++;
      XtSetArg(args[n], XmNbackground, tf->core.background_pixel);
      n++;
      XtSetArg(args[n], XmNforeground, tf->primitive.foreground);
      n++;
      XtSetArg(args[n], XmNbackgroundPixmap, tf->core.background_pixmap);
      n++;
      XtSetArg(args[n], XmNspotLocation, &xmim_point);
      n++;
      XtSetArg(args[n], XmNlineSpace, XmTextF_font_ascent(tf) + XmTextF_font_descent(tf));
      n++;
...
static Pixmap
df_GetClipMask(XmDataFieldWidget tf, char *pixmap_name)
{
   Display  *dpy    = XtDisplay(tf);
   ...
   GC        fillGC;
   Pixmap    clip_mask;
   clip_mask         = XCreatePixmap(dpy, RootWindowOfScreen(screen), XmTextF_cursor_width(tf), XmTextF_cursor_height(tf), 1);
   values.foreground = 1;
   values.background = 0;
   fillGC            = XCreateGC(dpy, clip_mask, GCForeground | GCBackground, &values);
   XFillRectangle(dpy, clip_mask, fillGC, 0, 0, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf));
 ...
 */
static void
df_LoadGCs(XmDataFieldWidget tf, Pixel background, Pixel foreground)
{
   ...
   XmTextF_stipple_tile(tf) = (Pixmap)
      XmGetPixmapByDepth(XtScreen(tf), XmS50_foreground, tf->primitive.foreground, tf->core.background_pixel, tf->core.depth);
   if (context == 0)
   ...
   */
   ...
   dynamic_mask         = (GCForeground | GCBackground | GCStipple | GCFillStyle | GCTileStipXOrigin | GCTileStipYOrigin | GCFunction | GCClipMask | GCClipXOrigin | GCClipYOrigin);
...
static void
df_MakeIBeamOffArea(XmDataFieldWidget tf, Dimension width, Dimension height)
{
   Display *dpy    = XtDisplay(tf);
   Screen  *screen = XtScreen(tf);
   GC       fillGC;
   ...
   * be painted */
   XmTextF_ibeam_off(tf) = XCreatePixmap(dpy, RootWindowOfScreen(screen), width, height, tf->core.depth);
...
static void
df_MakeIBeamStencil(XmDataFieldWidget tf, int line_width)
{
   Screen       *screen = XtScreen(tf);
   char          pixmap_name[17];
   XGCValues     values;
   ...
   if (XmTextF_cursor(tf) == XmUNSPECIFIED_PIXMAP)
   {
      ...
      XmTextF_cursor(tf) = XCreatePixmap(dpy, XtWindow(tf), XmTextF_cursor_width(tf), XmTextF_cursor_height(tf), 1);
      ...
      */
      XFillRectangle(dpy, XmTextF_cursor(tf), fillGC, 0, 0, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf));
   ...
   valuemask = (GCClipMask | GCStipple | GCForeground | GCBackground | GCFillStyle);
   if (!XmTextF_overstrike(tf))
   {
      values.foreground = tf->primitive.foreground;
      values.background = tf->core.background_pixel;
 ...
 */
static void
df_MakeAddModeCursor(XmDataFieldWidget tf, int line_width)
{
   Screen *screen = XtScreen(tf);
   char    pixmap_name[25];
   if (!XmTextF_has_rect(tf)) _XmDataFieldSetClipRect(tf);
   ...
   if (XmTextF_add_mode_cursor(tf) == XmUNSPECIFIED_PIXMAP)
   {
      ...
      {
         XGetGeometry(XtDisplay(tf), pixmap, &root, &unused_origin, &unused_origin, &pix_width, &pix_height, &unused, &unused);
         image                       = XGetImage(XtDisplay(tf), (Drawable)pixmap, 0, 0, pix_width, pix_height, AllPlanes, XYPixmap);
         stipple                     = XCreatePixmap(dpy, XtWindow(tf), image->width, image->height, 1);
         XmTextF_add_mode_cursor(tf) = XCreatePixmap(dpy, XtWindow(tf), XmTextF_cursor_width(tf), XmTextF_cursor_height(tf), 1);
         fillGC                      = XCreateGC(dpy, XmTextF_add_mode_cursor(tf), 0, (XGCValues *)NULL);
         XPutImage(dpy, stipple, fillGC, image, 0, 0, 0, 0, image->width, image->height);
         XCopyArea(dpy, XmTextF_cursor(tf), XmTextF_add_mode_cursor(tf), fillGC, 0, 0, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf), 0, 0);
         valueMask         = (GCTile | GCFillStyle | GCForeground | GCBackground | GCFunction);
         ...
         XFillRectangle(dpy, XmTextF_add_mode_cursor(tf), fillGC, 0, 0, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf));
...
static void
df_MakeCursors(XmDataFieldWidget tf)
{
   Screen *screen     = XtScreen(tf);
   int     line_width = 1;
   if (!XtIsRealized((Widget)tf)) return;
   ...
   df_MakeIBeamOffArea(tf, MAX(XmTextF_cursor_height(tf) >> 1, XmTextF_cursor_height(tf)), XmTextF_cursor_height(tf));
...
static void
df_DropDestroyCB(Widget w, XtPointer clientData, XtPointer callData)
{
...
static void
df_DropTransferCallback(Widget w, XtPointer closure, Atom *seltype, Atom *type, XtPointer value, unsigned long *length, int *format)
{
   ...
   if (*type == XmInternAtom(XtDisplay(transfer_rec->widget), "NULL", False))
   {
      if (transfer_rec->num_chars > 0 && transfer_rec->move)
      {
         ...
         _XmDataFielddf_SetCursorPosition(tf, NULL, cursorPos, False, True);
         (void)df_SetDestination((Widget)tf, XmTextF_cursor_position(tf), False, transfer_rec->timestamp);
         XmDataFieldSetSelection((Widget)tf, XmTextF_prim_anchor(tf), XmTextF_cursor_position(tf), transfer_rec->timestamp);
      }
      if (value)
      {
         XtFree((char *)value);
   ...
   if (XmTextF_pending_delete(tf) && XmTextF_has_primary(tf) && XmTextF_prim_pos_left(tf) != XmTextF_prim_pos_right(tf) && insertPosLeft > XmTextF_prim_pos_left(tf) && insertPosRight < XmTextF_prim_pos_right(tf))
   {
      insertPosLeft  = XmTextF_prim_pos_left(tf);
      insertPosRight = XmTextF_prim_pos_right(tf);
   }
   transfer_rec->num_chars = _XmDataFieldCountCharacters(tf, total_tmp_value, (int)total_length);
   _XmDataFieldDrawInsertionPoint(tf, False);
   ...
   if (XmTextF_max_char_size(tf) == 1)
   {
      if (_XmDataFieldReplaceText(tf, NULL, insertPosLeft, insertPosRight, (char *)total_tmp_value, (int)total_length, False))
         replace = True;
   }
   else
   {
      ...
      if (_XmDataFieldReplaceText(tf, NULL, insertPosLeft, insertPosRight, (char *)wc_total_tmp_value, (int)total_length, False))
         replace = True;
   ...
   if (replace)
   {
      ...
      if (transfer_rec->num_chars > 0 && !transfer_rec->move)
      {
         cursorPos = transfer_rec->insert_pos + transfer_rec->num_chars;
         _XmDataFielddf_SetCursorPosition(tf, NULL, cursorPos, False, True);
         df_SetDestination((Widget)tf, XmTextF_cursor_position(tf), False, transfer_rec->timestamp);
      }
      ...
      {
         if (!transfer_rec->move && !XmTextF_add_mode(tf) && transfer_rec->num_chars != 0)
...
static void
df_HandleDrop(Widget w, XmDropProcCallbackStruct *cb)
{
   static XtCallbackRec dropdf_DestroyCB[] = {
      { df_DropDestroyCB,     NULL },
   ...
   if (cb->operation & XmDROP_MOVE && w == initiator && XmDataFieldGetSelectionPosition(w, &left, &right) && left != right && insert_pos >= left && insert_pos <= right)
   {
      XtSetArg(args[n], XmNtransferStatus, XmTRANSFER_FAILURE);
      n++;
      XtSetArg(args[n], XmNnumDropTransfers, 0);
   ...
   else
   {
      ...
      int                     status;
      status = XmbTextListToTextProperty(display, &tmp_string, 1, (XICCEncodingStyle)XTextStyle, &tmp_prop);
      if (status == Success)
         CS_OF_LOCALE = tmp_prop.encoding;
      else
         CS_OF_LOCALE = 99999; /* XmbTextList... should never fail for XPCS
      ...
      XtSetArg(args[n], XmNdestroyCallback, dropdf_DestroyCB);
      n++;
      XtSetArg(args[n], XmNtransferProc, df_DropTransferCallback);
      n++;
   }
   df_SetDropContext(w);
...
static void
df_DragProcCallback(Widget w, XtPointer client, XtPointer call)
{
   ...
   drag_cont = cb->dragContext;
   n         = 0;
   XtSetArg(args[n], XmNexportTargets, &exp_targets);
   n++;
   XtSetArg(args[n], XmNnumExportTargets, &num_exp_targets);
   n++;
...
static void
df_DropProcCallback(Widget w, XtPointer client, XtPointer call)
{
...
df_RegisterDropSite(Widget w)
{
   ...
   n++;
#endif
   XtSetArg(args[n], XmNdropProc, df_DragProcCallback);
   n++;
   XtSetArg(args[n], XmNdropProc, df_DropProcCallback);
   n++;
 ...
 */
static void
df_Initialize(Widget request, Widget new_w, ArgList args, Cardinal *num_args)
{
   ...
   df_LoadGCs(new_tf, new_tf->core.background_pixel, new_tf->primitive.foreground);
...
static void
df_Realize(Widget w, XtValueMask *valueMask, XSetWindowAttributes *attributes)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
df_Resize(Widget w)
{
   ...
   if (XmDataField_alignment(tf) == XmALIGNMENT_END)
      ...
      XmTextF_h_offset(tf) = XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   XmTextF_refresh_ibeam_off(tf) = True;
 ...
 ************************************************************************/
static XtGeometryResult
df_QueryGeometry(Widget            widget,
                 XtWidgetGeometry *intended,
...
DataFieldExpose(Widget w, XEvent *event, Region region)
{
   ...
   */
   ...
   XFillRectangle(XtDisplay(w), XmTextF_ibeam_off(tf), XmTextF_save_gc(tf), 0, 0, XmTextF_cursor_width(tf), XmTextF_cursor_height(tf));
   values.foreground = tf->primitive.foreground;
   XChangeGC(XtDisplay(w), XmTextF_save_gc(tf), GCForeground, &values);
   _XmDataFieldDrawInsertionPoint(tf, False);
   if (XtIsRealized((Widget)tf))
   {
      if (tf->primitive.shadow_thickness > 0)
         XmeDrawShadows(XtDisplay(tf), XtWindow(tf), tf->primitive.bottom_shadow_GC, tf->primitive.top_shadow_GC, (int)tf->primitive.highlight_thickness, (int)tf->primitive.highlight_thickness, (int)(tf->core.width - (2 * tf->primitive.highlight_thickness)), (int)(tf->core.height - (2 * tf->primitive.highlight_thickness)), (int)tf->primitive.shadow_thickness, XmSHADOW_OUT);
 ...
 */
static Boolean
df_SetValues(Widget old, Widget request, Widget new_w, ArgList args, Cardinal *num_args)
{
   XmDataFieldWidget new_tf         = (XmDataFieldWidget)new_w;
   ...
   if (XmDataField_picture_source(old_tf) != XmDataField_picture_source(new_tf))
   {
	 ...
	 */
      if (XmDataField_picture(new_tf))
      {
         XtAddCallback((Widget)new_tf, XmNmodifyVerifyCallback, PictureVerifyCallback, NULL);
      }
      else
      {
         XtRemoveCallback((Widget)new_tf, XmNmodifyVerifyCallback, PictureVerifyCallback, NULL);
      }
   }
   if (XmDataField_alignment(old_tf) != XmDataField_alignment(new_tf))
   {
      if (XmDataField_alignment(new_tf) == XmALIGNMENT_END)
         ...
         XmTextF_h_offset(new_tf) = XmTextF_new_h_offset(new_tf) = XmTextF_margin_width(new_tf) + new_tf->primitive.shadow_thickness + new_tf->primitive.highlight_thickness;
      redisplay = True;
   }
   ...
   if (XmTextF_cursor_position(new_tf) != XmTextF_cursor_position(old_tf))
   {
      ...
      _XmDataFielddf_SetCursorPosition(new_tf, NULL, new_position, True, True);
      (void)df_SetDestination(new_w, XmTextF_cursor_position(new_tf), False, XtLastTimestampProcessed(XtDisplay(new_w)));
      cursor_pos_set = True;
   }
   else
   {
   ...
   if (new_w->core.sensitive == False && XmTextF_has_destination(new_tf))
   {
      (void)df_SetDestination(new_w, XmTextF_cursor_position(new_tf), True, XtLastTimestampProcessed(XtDisplay(new_w)));
   }
 ...
 */
   if (XmTextF_selection_array(new_tf) != XmTextF_selection_array(old_tf))
   {
      ...
      memcpy((void *)XmTextF_selection_array(new_tf), (void *)temp_ptr, (XmTextF_selection_array_count(new_tf) * sizeof(XmTextScanType)));
   }
   /*
 * End fix for HaL DTS 9841
 */
   ...
   if (XmTextF_font_list(new_tf) != XmTextF_font_list(old_tf))
   {
      ...
      XmTextF_font_list(new_tf) = (XmFontList)XmFontListCopy(XmTextF_font_list(new_tf));
      if (!df_LoadFontMetrics(new_tf))
      { /* Fails if font set required but not
                                       * available. */
      ...
      {
         XtSetArg(im_args[n], XmNfontList, XmTextF_font_list(new_tf));
         n++;
         redisplay = True;
      }
   }
   ...
   { /* old value != new value */
       ...
       * the action.
       */
      if (XmTextF_modify_verify_callback(new_tf) || XmTextF_wcs_modify_verify_callback(new_tf))
      {
         /* If the function df_ModifyVerify() returns false then don't
          * continue with the action.
          */
         ...
         if (XmTextF_max_char_size(new_tf) == 1)
         {
            ...
            mod_ver_ret = df_ModifyVerify(new_tf, NULL, &fromPos, &toPos, &temp, &XmTextF_string_length(new_tf), &newInsert, &free_insert);
         }
         else
         {
            s_old = temp = XtMalloc((unsigned)((XmTextF_string_length(new_tf) + 1) * XmTextF_max_char_size(new_tf)));
            (void)wcstombs(temp, XmTextF_wc_value(new_tf), (XmTextF_string_length(new_tf) + 1) * XmTextF_max_char_size(new_tf));
            mod_ver_ret = df_ModifyVerify(new_tf, NULL, &fromPos, &toPos, &temp, &XmTextF_string_length(new_tf), &newInsert, &free_insert);
      ...
      if (do_it)
      {
         ...
         if (XmTextF_max_char_size(new_tf) == 1)
            ...
            XtFree((char *)XmTextF_wc_value(old_tf));
         XmDataFieldSetHighlight(new_w, XmTextF_prim_pos_left(new_tf), XmTextF_prim_pos_right(new_tf), XmHIGHLIGHT_NORMAL);
	   ...
	   */
         ...
         {
            _XmDataFielddf_SetCursorPosition(new_tf, NULL, new_position, True, False);
         ...
         else
         {
            if (XmDataField_alignment(new_tf) == XmALIGNMENT_END)
               ...
               XmTextF_h_offset(new_tf) = XmTextF_margin_width(new_tf) + new_tf->primitive.shadow_thickness + new_tf->primitive.highlight_thickness;
            if (!df_AdjustText(new_tf, XmTextF_cursor_position(new_tf), False))
               redisplay_text = True;
         }
         cb.reason = XmCR_VALUE_CHANGED;
         cb.event  = NULL;
         XtCallCallbackList(new_w, XmTextF_value_changed_callback(new_tf), (XtPointer)&cb);
      }
   }
   if (new_tf->primitive.foreground != old_tf->primitive.foreground || XmTextF_font_list(new_tf) != XmTextF_font_list(old_tf) || new_tf->core.background_pixel != old_tf->core.background_pixel)
   {
      df_LoadGCs(new_tf, new_tf->primitive.foreground, new_tf->core.background_pixel);
      ...
      redisplay = True;
      XtSetArg(im_args[n], XmNbackground, new_tf->core.background_pixel);
      n++;
      XtSetArg(im_args[n], XmNforeground, new_tf->primitive.foreground);
      n++;
   }
   if (XmTextF_has_focus(new_tf) && XtIsSensitive((Widget)new_tf) && XmTextF_blink_rate(new_tf) != XmTextF_blink_rate(old_tf))
   {
      ...
      {
         XmTextF_timer_id(new_tf) = XtAppAddTimeOut(XtWidgetToApplicationContext(new_w),
   ...
   new_size = XmTextF_margin_width(new_tf) != XmTextF_margin_width(old_tf) || XmTextF_margin_height(new_tf) != XmTextF_margin_height(old_tf) || XmTextF_font_list(new_tf) != XmTextF_font_list(old_tf) || new_tf->primitive.highlight_thickness != old_tf->primitive.highlight_thickness || new_tf->primitive.shadow_thickness != old_tf->primitive.shadow_thickness;
   if (XmTextF_columns(new_tf) < 0)
   {
      XmeWarning(new_w, MSG7);
      XmTextF_columns(new_tf) = XmTextF_columns(old_tf);
   }
   if (!(new_width != old_tf->core.width && new_height != old_tf->core.height))
   {
   ...
   df_GetXYFromPos(new_tf, XmTextF_cursor_position(new_tf), &xmim_point.x, &xmim_point.y);
   ...
   XtSetArg(im_args[n], XmNbackgroundPixmap, new_tf->core.background_pixmap);
   n++;
   XtSetArg(im_args[n], XmNspotLocation, &xmim_point);
   n++;
   XtSetArg(im_args[n], XmNlineSpace, XmTextF_font_ascent(new_tf) + XmTextF_font_descent(new_tf));
   n++;
   ...
   if ((!XmTextF_editable(new_tf) || !XtIsSensitive(new_w)) && XmTextF_has_destination(new_tf))
...
static Boolean
DataFieldRemove(Widget w, XEvent *event)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmTextPosition      left, right;
   XmAnyCallbackStruct cb;
   ...
   {
      XmDataFieldSetSelection(w, XmTextF_cursor_position(tf), XmTextF_cursor_position(tf), XtLastTimestampProcessed(XtDisplay(w)));
      cb.reason = XmCR_VALUE_CHANGED;
      cb.event  = event;
      XtCallCallbackList((Widget)tf, XmTextF_value_changed_callback(tf), (XtPointer)&cb);
   }
...
XmDataFieldGetString(Widget w)
{
   ...
   if (XmTextF_string_length(tf) > 0)
   {
      ...
      else
      {
         ...
         ret_val  = wcstombs(temp_str, XmTextF_wc_value(tf), (XmTextF_string_length(tf) + 1) * XmTextF_max_char_size(tf));
         if (ret_val < 0)
         {
            temp_str[0] = '\0';
         }
...
int
XmDataFieldGetSubstring(Widget widget, XmTextPosition start, int num_chars, int buf_size, char *buffer)
{
   XmDataFieldWidget tf        = (XmDataFieldWidget)widget;
   ...
   if (num_chars > 0)
   {
      ...
      {
         wcs_ret = wcstombs(buffer, &XmTextF_wc_value(tf)[start], n_bytes);
...
wchar_t *
XmDataFieldGetStringWcs(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   wchar_t          *temp_wcs;
   int               num_wcs;
   ...
   if (XmTextF_string_length(tf) > 0)
   {
      ...
      {
         num_wcs = mbstowcs(temp_wcs, XmTextF_value(tf), XmTextF_string_length(tf) + 1);
      }
      _XmAppUnlock(app);
      return temp_wcs;
   }
...
int
XmDataFieldGetSubstringWcs(Widget widget, XmTextPosition start, int num_chars, int buf_size, wchar_t *buffer)
{
   XmDataFieldWidget tf        = (XmDataFieldWidget)widget;
   int               ret_value = XmCOPY_SUCCEEDED;
   int               num_wcs   = 0;
...
XmTextPosition
XmDataFieldGetLastPosition(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
...
void
XmDataFieldSetString(Widget w, char *value)
{
   XmDataFieldWidget   tf = (XmDataFieldWidget)w;
   XmAnyCallbackStruct cb;
   ...
   if (XmTextF_modify_verify_callback(tf) || XmTextF_wcs_modify_verify_callback(tf))
   {
	 ...
	 */
      if (!df_ModifyVerify(tf, NULL, &fromPos, &toPos, &value, &length, &newInsert, &free_insert))
      {
         if (XmTextF_verify_bell(tf)) XBell(XtDisplay(w), 0);
   ...
   XmDataFieldSetHighlight(w, 0, XmTextF_string_length(tf), XmHIGHLIGHT_NORMAL);
   if (XmTextF_max_char_size(tf) == 1)
   {
      XtFree(XmTextF_value(tf));
   }
...
static void
XmDataFieldSetStringWcs(Widget w, wchar_t *wc_value)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   char             *tmp;
   wchar_t          *tmp_wc;
...
void
XmDataFieldReplace(Widget w, XmTextPosition from_pos, XmTextPosition to_pos, char *value)
{
   XmDataFieldWidget   tf             = (XmDataFieldWidget)w;
   ...
   if (XmTextF_has_primary(tf))
   {
      if ((XmTextF_prim_pos_left(tf) > from_pos && XmTextF_prim_pos_left(tf) < to_pos) || (XmTextF_prim_pos_right(tf) > from_pos && XmTextF_prim_pos_right(tf) < to_pos) || (XmTextF_prim_pos_left(tf) <= from_pos && XmTextF_prim_pos_right(tf) >= to_pos))
      {
   ...
   { /* need to convert to wchar_t* before calling Replace */
      wc_value   = (wchar_t *)XtMalloc(sizeof(wchar_t) * (1 + strlen(value)));
      length     = mbstowcs(wc_value, value, strlen(value) + 1);
      rep_result = _XmDataFieldReplaceText(tf, NULL, from_pos, to_pos, (char *)wc_value, length, False);
      XtFree((char *)wc_value);
   }
...
void
XmDataFieldReplaceWcs(Widget w, XmTextPosition from_pos, XmTextPosition to_pos, wchar_t *wc_value)
{
   XmDataFieldWidget   tf             = (XmDataFieldWidget)w;
   int                 save_maxlength = XmTextF_max_length(tf);
   Boolean             save_editable  = XmTextF_editable(tf);
...
void
XmDataFieldInsert(Widget w, XmTextPosition position, char *value)
{
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
void
XmDataFieldInsertWcs(Widget w, XmTextPosition position, wchar_t *wcstring)
{
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
void
XmDataFieldSetAddMode(Widget w, Boolean state)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
Boolean
XmDataFieldGetAddMode(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   Boolean           ret_val;
   _XmWidgetToAppContext(w);
...
Boolean
XmDataFieldGetEditable(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   Boolean           ret_val;
   _XmWidgetToAppContext(w);
...
void
XmDataFieldSetEditable(Widget w, Boolean editable)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XPoint            xmim_point;
   Arg               args[6]; /* To set initial values to input method */
...
int
XmDataFieldGetMaxLength(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   int               ret_val;
   _XmWidgetToAppContext(w);
...
void
XmDataFieldSetMaxLength(Widget w, int max_length)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
XmTextPosition
XmDataFieldGetCursorPosition(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    ret_val;
   _XmWidgetToAppContext(w);
...
XmTextPosition
XmDataFieldGetInsertionPosition(Widget w)
{
   XmTextPosition ret_val;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
void
XmDataFieldSetInsertionPosition(Widget w, XmTextPosition position)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
Boolean
XmDataFieldGetSelectionPosition(Widget w, XmTextPosition *left, XmTextPosition *right)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
char *
XmDataFieldGetSelection(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   ...
   else
   {
      ...
      length = wcstombs(value, XmTextF_wc_value(tf) + XmTextF_prim_pos_left(tf), (num_chars + 1) * XmTextF_max_char_size(tf));
      if (length == (size_t)-1)
      {
         length = 0;
      }
...
wchar_t *
XmDataFieldGetSelectionWcs(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   size_t            length;
   wchar_t          *wc_value;
...
Boolean
XmDataFieldCopy(Widget w, Time clip_time)
{
   ...
   if (selected_string != NULL)
   {
      ...
      status = XmClipboardStartCopy(display, window, clip_label, clip_time, w, (XmCutPasteProc)NULL, &item_id);
      ...
      status = XmbTextListToTextProperty(display, &selected_string, 1, (XICCEncodingStyle)XStdICCTextStyle, &tmp_prop);
      ...
      status = XmClipboardCopy(display, window, item_id, atom_name, (XtPointer)tmp_prop.value, tmp_prop.nitems, 0, &data_id);
      XtFree(atom_name);
      if (status != ClipboardSuccess)
      {
...
Boolean
XmDataFieldCut(Widget w, Time clip_time)
{
   XmDataFieldWidget tf      = (XmDataFieldWidget)w;
...
XmDataFieldPaste(Widget w)
{
   ...
   if (status == ClipboardNoData || length == 0)
   {
      ...
      {
#if XM_UTF8
         status = XmClipboardInquireLength(display, window, XmSUTF8_STRING, &length);
#endif
         if (status == ClipboardNoData || length == 0)
         {
            _XmAppUnlock(app);
   ...
   if (!get_ct && !get_us)
   {
      status = XmClipboardRetrieve(display, window, "STRING", buffer, length, &outlength, &private_id);
   }
#if XM_UTF8
   else if (!get_ct && get_us)
   {
      status = XmClipboardRetrieve(display, window, XmSUTF8_STRING, buffer, length, &outlength, &private_id);
   }
#endif
   else
   {
      status = XmClipboardRetrieve(display, window, "COMPOUND_TEXT", buffer, length, &outlength, &private_id);
   }
   if (status != ClipboardSuccess)
   {
   ...
   {
      if (XmTextF_pending_delete(tf) && paste_pos_left >= sel_left && paste_pos_right <= sel_right)
      {
   ...
   num_vals        = 0;
   status          = XmbTextPropertyToTextList(display, &tmp_prop, &tmp_value, &num_vals);
   /* add new text */
   if (num_vals && (status == Success || status > 0))
   {
      if (XmTextF_max_char_size(tf) == 1)
      {
         ...
         rep_status = _XmDataFieldReplaceText(tf, NULL, paste_pos_left, paste_pos_right, total_tmp_value, strlen(total_tmp_value), True);
         XFreeStringList(tmp_value);
      ...
      else
      {
         ...
         rep_status = _XmDataFieldReplaceText(tf, NULL, paste_pos_left, paste_pos_right, (char *)wc_value, num_chars, True);
   ...
   if (rep_status)
   {
      ...
      (void)df_SetDestination(w, XmTextF_cursor_position(tf), False, XtLastTimestampProcessed(display));
      if (sel_left != sel_right)
      {
         if (!dest_disjoint || !XmTextF_add_mode(tf))
         {
            XmDataFieldSetSelection(w, XmTextF_cursor_position(tf), XmTextF_cursor_position(tf), XtLastTimestampProcessed(display));
         }
      }
      cb.reason = XmCR_VALUE_CHANGED;
      cb.event  = NULL;
...
void
XmDataFieldSetSelection(Widget w, XmTextPosition first, XmTextPosition last, Time sel_time)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
XmTextPosition
XmDataFieldXYToPos(Widget w, Position x, Position y)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   XmTextPosition    ret_val;
   _XmWidgetToAppContext(w);
...
Boolean
XmDataFieldPosToXY(Widget w, XmTextPosition position, Position *x, Position *y)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   Boolean           ret_val;
   _XmWidgetToAppContext(w);
 ...
 */
void
XmDataFieldShowPosition(Widget w, XmTextPosition position)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
void
XmDataFieldSetHighlight(Widget w, XmTextPosition left, XmTextPosition right, XmHighlightMode mode)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
...
static Boolean
DataFieldGetBaselines(Widget w, Dimension **baselines, int *line_count)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   ...
   *line_count   = 1;
   ...
   base_array[0] = XmTextF_margin_top(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness + XmTextF_font_ascent(tf);
...
int
XmDataFieldGetBaseline(Widget w)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
   ...
   _XmWidgetToAppContext(w);
   _XmAppLock(app);
   margin_top = XmTextF_margin_top(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
...
static Boolean
DataFieldGetDisplayRect(Widget w, XRectangle *display_rect)
{
   XmDataFieldWidget tf            = (XmDataFieldWidget)w;
   Position          margin_width  = XmTextF_margin_width(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Position          margin_top    = XmTextF_margin_top(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
   Position          margin_bottom = XmTextF_margin_bottom(tf) + tf->primitive.shadow_thickness + tf->primitive.highlight_thickness;
...
static void
DataFieldMarginsProc(Widget w, XmBaselineMargins *margins_rec)
{
   XmDataFieldWidget tf = (XmDataFieldWidget)w;
 ...
 */
Widget
XmCreateDataField(Widget parent, char *name, ArgList arglist, Cardinal argcount)
{
   return XtCreateWidget(name, xmDataFieldWidgetClass, parent, arglist, argcount);
}

Widget
XmVaCreateDataField(Widget parent, char *name, ...)
{
   register Widget w;
   va_list         var;
   int             count;
...
Widget
XmVaCreateManagedDataField(Widget parent, char *name, ...)
{
   Widget  w = NULL;
   va_list var;
   int     count;
