...
static void             Enter(Widget wid, XEvent *event, String *params, Cardinal *num_params);
static void             Leave(Widget wid, XEvent *event, String *params, Cardinal *num_params);
...
static XtPointer        ConvertToEncoding(Widget, char *, Atom, unsigned long *, Boolean *);
...
static XtResource resources[] = {
   { XmNshadowThickness,        XmCShadowThickness,        XmRHorizontalDimension, sizeof(Dimension),         XtOffsetOf(XmLabelRec,     primitive.shadow_thickness),    XmRImmediate, (XtPointer)0                      },
   { XmNalignment,              XmCAlignment,              XmRAlignment,           sizeof(unsigned char),     XtOffsetOf(XmLabelRec,     label.alignment),               XmRImmediate, (XtPointer)XmALIGNMENT_CENTER     },
   { XmNlabelType,              XmCLabelType,              XmRLabelType,           sizeof(unsigned char),     XtOffsetOf(XmLabelRec,     label.label_type),              XmRImmediate, (XtPointer)XmSTRING               },
   { XmNmarginWidth,            XmCMarginWidth,            XmRHorizontalDimension, sizeof(Dimension),         XtOffsetOf(XmLabelRec,     label.margin_width),            XmRImmediate, (XtPointer)2                      },
   { XmNmarginHeight,           XmCMarginHeight,           XmRVerticalDimension,   sizeof(Dimension),         XtOffsetOf(XmLabelRec,     label.margin_height),           XmRImmediate, (XtPointer)2                      },
   { XmNmarginLeft,             XmCMarginLeft,             XmRHorizontalDimension, sizeof(Dimension),         XtOffsetOf(XmLabelRec,     label.margin_left),             XmRImmediate, (XtPointer)0                      },
   { XmNmarginRight,            XmCMarginRight,            XmRHorizontalDimension, sizeof(Dimension),         XtOffsetOf(XmLabelRec,     label.margin_right),            XmRImmediate, (XtPointer)0                      },
   { XmNmarginTop,              XmCMarginTop,              XmRVerticalDimension,   sizeof(Dimension),         XtOffsetOf(XmLabelRec,     label.margin_top),              XmRImmediate, (XtPointer)0                      },
   { XmNmarginBottom,           XmCMarginBottom,           XmRVerticalDimension,   sizeof(Dimension),         XtOffsetOf(XmLabelRec,     label.margin_bottom),           XmRImmediate, (XtPointer)0                      },
   { "pri.vate",                "Pri.vate",                XmRBoolean,             sizeof(Boolean),           XtOffsetOf(XmLabelRec,     label.check_set_render_table),  XmRImmediate, (XtPointer)False                  },
   { XmNfontList,               XmCFontList,               XmRFontList,            sizeof(XmFontList),        XtOffsetOf(XmLabelRec,     label.font),                    XmRCallProc,  (XtPointer)CheckSetRenderTable    },
   { XmNrenderTable,            XmCRenderTable,            XmRRenderTable,         sizeof(XmRenderTable),     XtOffsetOf(XmLabelRec,     label.font),                    XmRCallProc,  (XtPointer)CheckSetRenderTable    },
   { XmNlabelPixmap,            XmCLabelPixmap,            XmRDynamicPixmap,       sizeof(Pixmap),            XtOffsetOf(XmLabelRec,     label.pixmap),                  XmRImmediate, (XtPointer)XmUNSPECIFIED_PIXMAP   },
   { XmNlabelInsensitivePixmap, XmCLabelInsensitivePixmap, XmRDynamicPixmap,       sizeof(Pixmap),            XtOffsetOf(XmLabelRec,     label.pixmap_insen),            XmRImmediate, (XtPointer)XmUNSPECIFIED_PIXMAP   },
   { XmNlabelString,            XmCXmString,               XmRXmString,            sizeof(XmString),          XtOffsetOf(XmLabelRec,     label._label),                  XmRImmediate, (XtPointer)NULL                   },
   { XmNmnemonic,               XmCMnemonic,               XmRKeySym,              sizeof(KeySym),            XtOffsetOf(XmLabelRec,     label.mnemonic),                XmRImmediate, (XtPointer)XK_VoidSymbol          },
   { XmNmnemonicCharSet,        XmCMnemonicCharSet,        XmRString,              sizeof(XmStringCharSet),   XtOffsetOf(XmLabelRec,     label.mnemonicCharset),         XmRImmediate, (XtPointer)XmFONTLIST_DEFAULT_TAG },
   { XmNaccelerator,            XmCAccelerator,            XmRString,              sizeof(char *),            XtOffsetOf(XmLabelRec,     label.accelerator),             XmRImmediate, (XtPointer)NULL                   },
   { XmNacceleratorText,        XmCAcceleratorText,        XmRXmString,            sizeof(XmString),          XtOffsetOf(XmLabelRec,     label._acc_text),               XmRImmediate, (XtPointer)NULL                   },
   { XmNrecomputeSize,          XmCRecomputeSize,          XmRBoolean,             sizeof(Boolean),           XtOffsetOf(XmLabelRec,     label.recompute_size),          XmRImmediate, (XtPointer)True                   },
   { XmNstringDirection,        XmCStringDirection,        XmRStringDirection,     sizeof(unsigned char),     XtOffsetOf(XmLabelRec,     label.string_direction),        XmRImmediate, (XtPointer)XmDEFAULT_DIRECTION    },
   { XmNtraversalOn,            XmCTraversalOn,            XmRBoolean,             sizeof(Boolean),           XtOffsetOf(XmPrimitiveRec, primitive.traversal_on),        XmRImmediate, (XtPointer)False                  },
   { XmNhighlightThickness,     XmCHighlightThickness,     XmRHorizontalDimension, sizeof(Dimension),         XtOffsetOf(XmPrimitiveRec, primitive.highlight_thickness), XmRImmediate, (XtPointer)0                      },
#ifndef XM_PART_BC
...
#endif
   { XmNpixmapPlacement,        XmCPixmapPlacement,        XmRPixmapPlacement,     sizeof(XmPixmapPlacement), XtOffsetOf(XmLabelRec,     label.pixmap_placement),        XmRImmediate, (XtPointer)XmPIXMAP_LEFT          },
   { XmNpixmapTextPadding,      XmCSpace,                  XmRVerticalDimension,   sizeof(Dimension),         XtOffsetOf(XmLabelRec,     label.pixmap_text_padding),     XmRImmediate, (XtPointer)2                      }
};
/* Definition for resources that need special processing in get values. */
static XmSyntheticResource syn_resources[] = {
   { XmNmarginWidth,       sizeof(Dimension),       XtOffsetOf(XmLabelRec, label.margin_width),        XmeFromHorizontalPixels, XmeToHorizontalPixels         },
   { XmNmarginHeight,      sizeof(Dimension),       XtOffsetOf(XmLabelRec, label.margin_height),       XmeFromVerticalPixels,   XmeToVerticalPixels           },
   ...
   { XmNmarginTop,         sizeof(Dimension),       XtOffsetOf(XmLabelRec, label.margin_top),          XmeFromVerticalPixels,   XmeToVerticalPixels           },
   { XmNmarginBottom,      sizeof(Dimension),       XtOffsetOf(XmLabelRec, label.margin_bottom),       XmeFromVerticalPixels,   XmeToVerticalPixels           },
   { XmNlabelString,       sizeof(XmString),        XtOffsetOf(XmLabelRec, label._label),              GetLabelString,          NULL                          },
   { XmNmnemonicCharSet,   sizeof(XmStringCharSet), XtOffsetOf(XmLabelRec, label.mnemonicCharset),     GetMnemonicCharSet,      NULL                          },
   { XmNaccelerator,       sizeof(String),          XtOffsetOf(XmLabelRec, label.accelerator),         GetAccelerator,          NULL                          },
   { XmNacceleratorText,   sizeof(XmString),        XtOffsetOf(XmLabelRec, label._acc_text),           GetAcceleratorText,      NULL                          },
   { XmNpixmapTextPadding, sizeof(Dimension),       XtOffsetOf(XmLabelRec, label.pixmap_text_padding), FromPaddingPixels,       (XmImportProc)ToPaddingPixels }
};
...
externaldef(xmlabelwidgetclass) WidgetClass xmLabelWidgetClass = (WidgetClass)&xmLabelClassRec;
...
ClassInitialize(void)
{
   ...
   xmLabelClassRec.label_class.translations = (String)(XtParseTranslationTable(menu_traversal_events));
   /* Install menu savvy on just this class */
   XmeTraitSet((XtPointer)&xmLabelClassRec,
               XmQTmenuSavvy,
               (XtPointer)&MenuSavvyRecord);
}
...
ClassPartInitialize(WidgetClass c)
{
   ...
   XmeTraitSet((XtPointer)c, XmQTaccessTextual, (XtPointer)&_XmLabel_AccessTextualRecord);
}
...
SetNormalGC(XmLabelWidget lw)
{
   ...
   lw->label.normal_GC = XtAllocateGC((Widget)lw, 0, valueMask, &values, dynamicMask, 0);
   /*generally gray insensitive foreground (instead stipple)*/
   values.foreground        = _XmAssignInsensitiveColor((Widget)lw);
   values.background        = lw->core.background_pixel;
   lw->label.insensitive_GC = XtAllocateGC((Widget)lw, 0, valueMask, &values, dynamicMask, 0);
   /*light shadow for insensitive text (instead stipple)*/
   values.foreground   = lw->primitive.top_shadow_color;
   lw->label.shadow_GC = XtAllocateGC((Widget)lw, 0, valueMask, &values, dynamicMask, 0);
}
...
_XmLabelCalcTextRect(Widget wid)
{
   ...
   {
      if (lp->pixmap_placement == XmPIXMAP_TOP || lp->pixmap_placement == XmPIXMAP_BOTTOM)
      {
         lp->TextRect.height = lp->PixmapRect.height + lp->StringRect.height + lp->pixmap_text_padding;
         lp->TextRect.width  = MAX(lp->StringRect.width, lp->PixmapRect.width);
      }
      else if (lp->pixmap_placement == XmPIXMAP_LEFT || lp->pixmap_placement == XmPIXMAP_RIGHT)
      {
         lp->TextRect.width  = lp->PixmapRect.width + lp->StringRect.width + lp->pixmap_text_padding;
      ...
      else if ((lp->pixmap_placement == XmPIXMAP_RIGHT && LayoutIsRtoLP(wid)) || (lp->pixmap_placement == XmPIXMAP_LEFT && !LayoutIsRtoLP(wid)))
      {
         lp->PixmapRect.x = 0;
         lp->StringRect.x = lp->PixmapRect.width + lp->pixmap_text_padding;
      }
      else if ((lp->pixmap_placement == XmPIXMAP_LEFT && LayoutIsRtoLP(wid)) || (lp->pixmap_placement == XmPIXMAP_RIGHT && !LayoutIsRtoLP(wid)))
      {
         lp->StringRect.x = 0;
         lp->PixmapRect.x = lp->StringRect.width + lp->pixmap_text_padding;
      }
      if (lp->pixmap_placement == XmPIXMAP_RIGHT || lp->pixmap_placement == XmPIXMAP_LEFT)
      {
      ...
      else
      {
         ...
         {
            lp->PixmapRect.x = (lp->TextRect.width - lp->PixmapRect.width) / 2;
            lp->StringRect.x = (lp->TextRect.width - lp->StringRect.width) / 2;
         }
         else if ((lp->alignment == XmALIGNMENT_END && !LayoutIsRtoLP(wid)) || (lp->alignment == XmALIGNMENT_BEGINNING && LayoutIsRtoLP(wid)))
         {
...
Resize(Widget wid)
{
   ...
   if (lp->_acc_text != NULL)
   {
      if (LayoutIsRtoLP(newlw))
      {
         ...
         {
            int delta           = lp->acc_TextRect.width + LABEL_ACC_PAD - lp->margin_left;
      ...
      else
      {
         ...
         {
            int delta            = lp->acc_TextRect.width + LABEL_ACC_PAD - lp->margin_right;
   ...
   if (newlw->core.width == 0)
      newlw->core.width = (Dimension)
                             lp->TextRect.width
                        + lp->margin_left + lp->margin_right + (2 * (lp->margin_width + newlw->primitive.highlight_thickness + newlw->primitive.shadow_thickness));
   leftx  = (newlw->primitive.highlight_thickness + newlw->primitive.shadow_thickness + lp->margin_width + lp->margin_left);
   rightx = (newlw->core.width - (newlw->primitive.highlight_thickness + newlw->primitive.shadow_thickness + lp->margin_width + lp->margin_right));
   switch (lp->alignment)
   {
   ...
   if (newlw->core.height == 0)
      newlw->core.height = (Dimension)
                         ...
                         + (2 * (lp->margin_height + newlw->primitive.highlight_thickness + newlw->primitive.shadow_thickness));
   lp->TextRect.y = (short)(newlw->primitive.highlight_thickness
                            + newlw->primitive.shadow_thickness
                            + lp->margin_height + lp->margin_top + ((int)(newlw->core.height - lp->margin_top - lp->margin_bottom - (2 * (lp->margin_height + newlw->primitive.highlight_thickness + newlw->primitive.shadow_thickness)) - lp->TextRect.height) / 2));
   if (lp->_acc_text != NULL)
   {
      Dimension base_label, base_accText, diff;
      if (LayoutIsRtoLP(newlw))
         lp->acc_TextRect.x = newlw->primitive.highlight_thickness + newlw->primitive.shadow_thickness + newlw->label.margin_width;
      else
         lp->acc_TextRect.x = (short)newlw->core.width - newlw->primitive.highlight_thickness - newlw->primitive.shadow_thickness - newlw->label.margin_width - newlw->label.margin_right + LABEL_ACC_PAD;
      lp->acc_TextRect.y = (short)(newlw->primitive.highlight_thickness
                                   + newlw->primitive.shadow_thickness
                                   + lp->margin_height + lp->margin_top + ((int)(newlw->core.height - lp->margin_top - lp->margin_bottom - (2 * (lp->margin_height + newlw->primitive.highlight_thickness + newlw->primitive.shadow_thickness)) - lp->acc_TextRect.height) / 2));
   ...
   Cardinal *num_args) /* unused */
{
   ...
   */
   switch (lw->label.string_direction)
   {
      ...
      case XmRIGHT_TO_LEFT:
         ...
         lw->label.string_direction = XmDirectionToStringDirection(lw->label.string_direction);
         break;
      default:
   ...
   */
   if (XmPrim_layout_direction(lw) != XmDEFAULT_DIRECTION)
   {
      if (lw->label.string_direction == XmDEFAULT_DIRECTION)
         lw->label.string_direction = XmDirectionToStringDirection(XmPrim_layout_direction(lw));
   }
   else if (lw->label.string_direction != XmDEFAULT_DIRECTION)
   {
      XmPrim_layout_direction(lw) = XmStringDirectionToDirection(lw->label.string_direction);
   }
   else
   {
   ...
   */
   if (lw->label.mnemonicCharset != NULL)
      lw->label.mnemonicCharset = _XmStringCharSetCreate(lw->label.mnemonicCharset);
   else
      lw->label.mnemonicCharset = _XmStringCharSetCreate(XmFONTLIST_DEFAULT_TAG);
   ...
   if ((lw->label._acc_text != NULL) && Lab_IsMenupane(lw))
   {
	   ...
	   */
         if (XmIsCascadeButton(lw))
            ...
            lw->label._acc_text = XmStringCopy((XmString)lw->label._acc_text);
      }
      else
      {
   ...
   if ((lw->label.menu_type == XmMENU_POPUP) || (lw->label.menu_type == XmMENU_PULLDOWN) || (lw->label.menu_type == XmMENU_BAR))
   ...
   if ((XtClass(lw) == xmLabelWidgetClass) && ((lw->label.menu_type == XmMENU_POPUP) || (lw->label.menu_type == XmMENU_PULLDOWN) || (lw->label.menu_type == XmMENU_OPTION)))
   {
      lw->primitive.traversal_on       = FALSE;
      lw->primitive.highlight_on_enter = FALSE;
   }
   /* if in menu, override with menu traversal translations */
   if ((lw->label.menu_type == XmMENU_POPUP) || (lw->label.menu_type == XmMENU_PULLDOWN) || (lw->label.menu_type == XmMENU_BAR) || (lw->label.menu_type == XmMENU_OPTION))
   {
      _XmProcessLock();
      trans = (XtTranslations)((XmLabelClassRec *)XtClass(lw))->label_class.translations;
      _XmProcessUnlock();
   ...
   {
      _XmProcessLock();
      trans = (XtTranslations)((XmPrimitiveClassRec *)XtClass(lw))->primitive_class.translations;
      _XmProcessUnlock();
   ...
   XtWidgetGeometry *desired)
{
   ...
   {
      desired->width = (Dimension)lw->label.TextRect.width + (2 * (lw->label.margin_width + lw->primitive.highlight_thickness + lw->primitive.shadow_thickness)) + lw->label.margin_left + lw->label.margin_right;
      if (desired->width == 0)
         desired->width = 1;
      desired->height = (Dimension)MAX(lw->label.TextRect.height,
                                       lw->label.acc_TextRect.height)
                      + (2 * (lw->label.margin_height + lw->primitive.highlight_thickness + lw->primitive.shadow_thickness)) + lw->label.margin_top + lw->label.margin_bottom;
      if (desired->height == 0)
         desired->height = 1;
   }
   ...
   Region  region)
{
   ...
   */
   ...
   marginal_width  = lp->margin_left + lp->margin_right + (2 * (lw->primitive.highlight_thickness + lw->primitive.shadow_thickness));
   marginal_height = lp->margin_top + lp->margin_bottom + (2 * (lw->primitive.highlight_thickness + lw->primitive.shadow_thickness));
   max_text_height = MAX(lp->TextRect.height, lp->acc_TextRect.height);
   if (XtIsSensitive(wid))
      clipgc = lp->normal_GC;
   else
      clipgc = lp->insensitive_GC;
   if ((availH < (Dimension)(marginal_height + max_text_height)) || (availW < (Dimension)(marginal_width + lp->TextRect.width)))
   {
      clip_rect.x = lw->primitive.highlight_thickness + lw->primitive.shadow_thickness + lp->margin_left;
      clip_rect.y = lw->primitive.highlight_thickness + lw->primitive.shadow_thickness + lp->margin_top;
   ...
   {
      XClearArea(XtDisplay(lw), XtWindow(lw), lp->TextRect.x, lp->TextRect.y, lp->TextRect.width, lp->TextRect.height, False);
   }
#endif
      ...
      if (XtIsSensitive(wid))
      {
         if (Pix(lw) != XmUNSPECIFIED_PIXMAP)
         {
            ...
            if (depth == lw->core.depth)
               XCopyArea(XtDisplay(lw), Pix(lw), XtWindow(lw), gc, 0, 0, lp->PixmapRect.width, lp->PixmapRect.height, lp->TextRect.x + lp->PixmapRect.x, lp->TextRect.y + lp->PixmapRect.y);
            else if (depth == 1)
               XCopyPlane(XtDisplay(lw), Pix(lw), XtWindow(lw), gc, 0, 0, lp->PixmapRect.width, lp->PixmapRect.height, lp->TextRect.x + lp->PixmapRect.x, lp->TextRect.y + lp->PixmapRect.y, 1);
         }
      }
      else
      {
         ...
         if (pix_use != XmUNSPECIFIED_PIXMAP)
         {
            ...
            if (depth == lw->core.depth)
               XCopyArea(XtDisplay(lw), pix_use, XtWindow(lw), gc, 0, 0, lp->PixmapRect.width, lp->PixmapRect.height, lp->TextRect.x + lp->PixmapRect.x, lp->TextRect.y + lp->PixmapRect.y);
            else if (depth == 1)
               XCopyPlane(XtDisplay(lw), pix_use, XtWindow(lw), gc, 0, 0, lp->PixmapRect.width, lp->PixmapRect.height, lp->TextRect.x + lp->PixmapRect.x, lp->TextRect.y + lp->PixmapRect.y, 1);
            if (pix_use == Pix(lw))
            {
               XSetFillStyle(XtDisplay(lw), gc, FillStippled);
               XSetStipple(XtDisplay(lw), gc, _XmGetInsensitiveStippleBitmap((Widget)lw));
               XFillRectangle(XtDisplay(lw), XtWindow(lw), gc, lp->TextRect.x + lp->PixmapRect.x, lp->TextRect.y + lp->PixmapRect.y, lp->PixmapRect.width, lp->PixmapRect.height);
   ...
   if ((Lab_IsText(lw) || Lab_IsPixmapAndText(lw)) && (lp->_label != NULL))
   {
      if (lp->mnemonic != XK_VoidSymbol)
      {
         ...
         {
            /*Draw normal text*/
            XmStringDrawUnderline(XtDisplay(lw), XtWindow(lw), lp->font, lp->_label, lp->normal_GC, lp->TextRect.x + lp->StringRect.x, lp->TextRect.y + lp->StringRect.y, lp->StringRect.width, lp->alignment, XmPrim_layout_direction(lw), NULL, underline);
         }
         else
         {
            /*Draw shadow for insensitive text*/
            XmStringDrawUnderline(XtDisplay(lw), XtWindow(lw), lp->font, lp->_label, lp->shadow_GC, lp->TextRect.x + 1 + lp->StringRect.x, lp->TextRect.y + 1 + lp->StringRect.y, lp->StringRect.width, lp->alignment, XmPrim_layout_direction(lw), NULL, underline);
            /*Draw insensitive text*/
            XmStringDrawUnderline(XtDisplay(lw), XtWindow(lw), lp->font, lp->_label, lp->insensitive_GC, lp->TextRect.x + lp->StringRect.x, lp->TextRect.y + lp->StringRect.y, lp->StringRect.width, lp->alignment, XmPrim_layout_direction(lw), NULL, underline);
         }
      ...
      else
      {
         ...
         {
            /*Draw normal text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), lp->font, lp->_label, lp->normal_GC, lp->TextRect.x + lp->StringRect.x, lp->TextRect.y + lp->StringRect.y, lp->StringRect.width, lp->alignment, XmPrim_layout_direction(lw), NULL);
         }
         else
         {
            /*Draw shadow for insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), lp->font, lp->_label, lp->shadow_GC, lp->TextRect.x + 1 + lp->StringRect.x, lp->TextRect.y + 1 + lp->StringRect.y, lp->StringRect.width, lp->alignment, XmPrim_layout_direction(lw), NULL);
            /*Draw insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), lp->font, lp->_label, lp->insensitive_GC, lp->TextRect.x + lp->StringRect.x, lp->TextRect.y + lp->StringRect.y, lp->StringRect.width, lp->alignment, XmPrim_layout_direction(lw), NULL);
         }
      }
   }
   if (lp->_acc_text != NULL)
   {
       ...
       * room for everything
       */
      if (lw->core.width >= (Dimension)(2 * (lw->primitive.highlight_thickness + lw->primitive.shadow_thickness + lp->margin_width) + lp->margin_left + lp->TextRect.width + lp->margin_right))
      {
         if (XtIsSensitive(wid))
         {
            /*Draw normal text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), lp->font, lp->_acc_text, lp->normal_GC, lp->acc_TextRect.x, lp->acc_TextRect.y, lp->acc_TextRect.width, XmALIGNMENT_END, XmPrim_layout_direction(lw), NULL);
         }
         else
         {
            /*Draw shadow for insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), lp->font, lp->_acc_text, lp->shadow_GC, lp->acc_TextRect.x + 1, lp->acc_TextRect.y + 1, lp->acc_TextRect.width, XmALIGNMENT_END, XmPrim_layout_direction(lw), NULL);
            /*Draw insensitive text*/
            XmStringDraw(XtDisplay(lw), XtWindow(lw), lp->font, lp->_acc_text, lp->insensitive_GC, lp->acc_TextRect.x, lp->acc_TextRect.y, lp->acc_TextRect.width, XmALIGNMENT_END, XmPrim_layout_direction(lw), NULL);
         }
      }
   }
          ...
          Cardinal *num_args) /* unused */
{
   ...
   if ((newlp->_label != curlp->_label) || (newlp->font != curlp->font))
   {
      if (newlp->baselines)
      {
   ...
   if ((newlp->_acc_text != curlp->_acc_text) && Lab_IsMenupane(new_w))
   {
   ...
   if (newlp->font != curlp->font)
   {
      ...
      if (newlp->font == NULL)
      {
         ...
         newlp->font = XmeGetDefaultRenderTable((Widget)new_w, XmLABEL_FONTLIST);
      }
      newlp->font = XmFontListCopy(newlp->font);
   }
   if ((new_w->label.menu_type == XmMENU_POPUP) || (new_w->label.menu_type == XmMENU_PULLDOWN) || (new_w->label.menu_type == XmMENU_BAR))
      new_w->primitive.highlight_thickness = 0;
   if (!XmRepTypeValidValue(XmRID_LABEL_TYPE, new_w->label.label_type, (Widget)new_w))
   {
      new_w->label.label_type = current->label.label_type;
   }
   if (!XmRepTypeValidValue(XmRID_PIXMAP_PLACEMENT, new_w->label.pixmap_placement, (Widget)new_w))
   {
   ...
   if (LayoutP(new_w) != LayoutP(current))
   {
      ...
      if ((LayoutIsRtoLP(current) != LayoutIsRtoLP(new_w)) && (Lab_MarginLeft(current) == Lab_MarginLeft(new_w)) && (Lab_MarginRight(current) == Lab_MarginRight(new_w)))
      {
   ...
   Boolean pixmap_size_changed = ((newlp->PixmapRect.width
                                   != curlp->PixmapRect.width)
                                  || (newlp->PixmapRect.height
                                      != curlp->PixmapRect.height));
   if (((Lab_IsText(new_w) || Lab_IsPixmapAndText(new_w)) && ((newstring) || (newlp->font != curlp->font))) || ((Lab_IsPixmap(new_w) || Lab_IsPixmapAndText(new_w)) && ((newlp->pixmap != curlp->pixmap) || (newlp->pixmap_insen != curlp->pixmap_insen) || (XtIsSensitive(nw) != XtIsSensitive(cw))) && pixmap_size_changed) || (Lab_IsPixmapAndText(new_w) && (newlp->pixmap_placement != curlp->pixmap_placement)) || (newlp->label_type != curlp->label_type))
   {
   ...
   else if ((Lab_IsPixmap(new_w) || Lab_IsPixmapAndText(new_w)) && ((newlp->pixmap != curlp->pixmap) || (newlp->pixmap_insen != curlp->pixmap_insen) || (XtIsSensitive(nw) != XtIsSensitive(cw))))
   {
      flag = True;
   }
   if ((newlp->alignment != curlp->alignment) || (XmPrim_layout_direction(new_w) != XmPrim_layout_direction(current)))
   {
      if (!XmRepTypeValidValue(XmRID_ALIGNMENT, new_w->label.alignment, (Widget)new_w))
      {
   ...
   */
   ...
   if ((new_w->primitive.foreground != current->primitive.foreground) || (new_w->core.background_pixel != current->core.background_pixel) || (newlp->font != curlp->font))
   {
   ...
   if ((XtClass(new_w) == xmLabelWidgetClass) && ((new_w->label.menu_type == XmMENU_POPUP) || (new_w->label.menu_type == XmMENU_PULLDOWN) || (new_w->label.menu_type == XmMENU_OPTION)))
   {
      new_w->primitive.traversal_on       = FALSE;
      new_w->primitive.highlight_on_enter = FALSE;
   }
   if (new_w->primitive.traversal_on && (new_w->primitive.traversal_on != current->primitive.traversal_on) && new_w->core.tm.translations)
   {
      XtTranslations trans;
      if ((new_w->label.menu_type == XmMENU_POPUP) || (new_w->label.menu_type == XmMENU_PULLDOWN) || (new_w->label.menu_type == XmMENU_BAR) || (new_w->label.menu_type == XmMENU_OPTION))
      {
         _XmProcessLock();
         trans = (XtTranslations)((XmLabelClassRec *)XtClass(new_w))->label_class.translations;
         _XmProcessUnlock();
      ...
      {
         _XmProcessLock();
         trans = (XtTranslations)((XmLabelClassRec *)XtClass(new_w))->primitive_class.translations;
         _XmProcessUnlock();
         if (trans) XtOverrideTranslations((Widget)new_w, trans);
      }
   }
   if ((new_w->label.menu_type != XmWORK_AREA) && (new_w->label.mnemonic != current->label.mnemonic))
   {
      /* New grabs only required if mnemonic changes */
      ProcessFlag = TRUE;
      if (new_w->label.label_type == XmSTRING || new_w->label.label_type == XmPIXMAP_AND_STRING)
         flag = TRUE;
   }
   if (new_w->label.mnemonicCharset != current->label.mnemonicCharset)
   {
      if (new_w->label.mnemonicCharset)
         new_w->label.mnemonicCharset = _XmStringCharSetCreate(new_w->label.mnemonicCharset);
      else
         new_w->label.mnemonicCharset = _XmStringCharSetCreate(XmFONTLIST_DEFAULT_TAG);
      if (current->label.mnemonicCharset != NULL)
         XtFree(current->label.mnemonicCharset);
      if (new_w->label.label_type == XmSTRING || new_w->label.label_type == XmPIXMAP_AND_STRING)
         flag = TRUE;
   }
   if (Lab_IsMenupane(new_w) && (new_w->label.accelerator != current->label.accelerator))
   {
   ...
   if (flag && (new_w->label.menu_type == XmMENU_PULLDOWN) && menuSTrait != NULL)
...
GetPixmapDragIcon(Widget w)
{
   ...
   XmeGetPixmapData(XtScreen(lw), Pix(lw), NULL, &depth, NULL, NULL, NULL, NULL, &width, &height);
   n = 0;
            ...
            Cardinal *num_params)
{
   ...
   if (event && !(event->xbutton.state & ~((Button1Mask >> 1) << event->xbutton.button) & (Button1Mask | Button2Mask | Button3Mask | Button4Mask | Button5Mask)))
   {
      n = 0;
                ...
                XmConvertCallbackStruct *cs)
{
   ...
   XInternAtoms(XtDisplayOfObject(w), atom_names, XtNumber(atom_names), False, atoms);
   ...
   else if (cs->target == atoms[XmACOMPOUND_TEXT] || cs->target == atoms[XmATEXT] || cs->target == XA_STRING || cs->target == C_ENCODING)
   {
      ...
      {
         Boolean success;
         value = ConvertToEncoding(w, (char *)value, XA_STRING, &size, &success);
      ...
      else if ((cs->target == atoms[XmATEXT] || cs->target == C_ENCODING) && value != NULL)
      {
         char   *cvt;
         Boolean success;
         cvt = (char *)ConvertToEncoding(w, (char *)value, C_ENCODING, &size, &success);
 ...
 **************************************************************************/
static XtPointer
ConvertToEncoding(Widget w, char *str, Atom encoding, unsigned long *length, Boolean *flag)
{
   XtPointer     rval = NULL;
   ...
   if (encoding == XA_STRING)
   {
      ...
      ret_status = XmbTextListToTextProperty(XtDisplay(w), (char **)&str, 1, (XICCEncodingStyle)XStringStyle, &tmp_prop);
   ...
   else if (encoding == UTF8_STRING)
   {
      ...
      ret_status = Xutf8TextListToTextProperty(XtDisplay(w), (char **)&str, 1, (XICCEncodingStyle)XUTF8StringStyle, &tmp_prop);
      if (ret_status == Success || ret_status > 0)
      {
         rval    = (XtPointer)tmp_prop.value;
         *length = tmp_prop.nitems;
   ...
   else
   {
     ...
     */
      *length = str ? strlen(str) : 0;
      rval    = _XmTextToLocaleText(w, (XtPointer)str, COMPOUND_TEXT, 8, *length, flag);
   }
   return (rval);
}
...
LabelGetValue(Widget w, int type)
{
   ...
   else if (type == XmFORMAT_MBYTE || type == XmFORMAT_WCS)
   {
      XtPointer temp;
      temp = (type == XmFORMAT_MBYTE) ? _XmStringUngenerate(value, NULL, XmMULTIBYTE_TEXT, XmMULTIBYTE_TEXT) : _XmStringUngenerate(value, NULL, XmWIDECHAR_TEXT, XmWIDECHAR_TEXT);
      XmStringFree(value);
      return temp;
   }
   else
