...
static void MouseWheel(Widget grabshell, XEvent *event, String *params, Cardinal *num_params);
static void BtnUp(Widget grabshell, XEvent *event, String *params, Cardinal *num_params);
static void BtnDown(Widget grabshell, XEvent *event, String *params, Cardinal *num_params);
static void Popdown(Widget grabshell, XEvent *event, String *params, Cardinal *num_params);
...
static XtResource resources[] = {{XmNallowShellResize,
                                  XmCAllowShellResize,
                                  XmRBoolean,
                                  sizeof(Boolean),
                                 ...
                                 {XmNshadowThickness,
                                  ...
                                  sizeof(Dimension),
                                  Offset(grab_shell.shadow_thickness),
                                  XmRImmediate,
                                  (XtPointer)2},
                                 {XmNtransient,
                                  XmCTransient,
                                 ...
                                 {XmNtopShadowColor,
                                  ...
                                  XmRPixel,
                                  sizeof(Pixel),
                                  Offset(grab_shell.top_shadow_color),
                                  XmRCallProc,
                                 ...
                                 {XmNtopShadowPixmap,
                                  ...
                                  sizeof(Pixmap),
                                  Offset(grab_shell.top_shadow_pixmap),
                                  XmRCallProc,
                                 ...
                                 {XmNbottomShadowColor,
                                  ...
                                  XmRPixel,
                                  sizeof(Pixel),
                                  Offset(grab_shell.bottom_shadow_color),
                                  XmRCallProc,
                                 ...
                                 {XmNbottomShadowPixmap,
                                  ...
                                  XmRNoScalingDynamicPixmap,
                                  sizeof(Pixmap),
                                  Offset(grab_shell.bottom_shadow_pixmap),
                                  XmRImmediate,
                                 ...
                                 {XmNownerEvents,
                                  ...
                                  XmRBoolean,
                                  sizeof(Boolean),
                                  Offset(grab_shell.owner_events),
                                  XmRImmediate,
                                  (XtPointer)FALSE}};
#undef Offset
...
externaldef(xmgrabshellwidgetclass)
                       ...
                       Cardinal *num_args) /* unused */
{
  ...
  grabsh->grab_shell.bottom_shadow_GC = _XmGetPixmapBasedGC(
      new_w,
                         ...
                         Cardinal *num_args) /* unused */
{
  ...
  if ((old_w->grab_shell.top_shadow_color != new_w->grab_shell.top_shadow_color) ||
      (old_w->grab_shell.top_shadow_pixmap != new_w->grab_shell.top_shadow_pixmap))
  {
  ...
  if ((old_w->grab_shell.bottom_shadow_color != new_w->grab_shell.bottom_shadow_color) ||
      (old_w->grab_shell.bottom_shadow_pixmap != new_w->grab_shell.bottom_shadow_pixmap))
  {
    XtReleaseGC(nw, new_w->grab_shell.bottom_shadow_GC);
    new_w->grab_shell.bottom_shadow_GC = _XmGetPixmapBasedGC(
        nw,
 ...
 */
/*ARGSUSED*/
static void MapNotifyHandler(Widget shell, XtPointer client_data, XEvent *event, Boolean *cont)
{
  ...
  _XmFastExpose(shell);
  (void)XtGrabKeyboard(shell,
                       grabshell->grab_shell.owner_events,
                       grabshell->grab_shell.grab_style,
                       GrabModeAsync,
                       time);
  (void)XtGrabPointer(shell,
                      grabshell->grab_shell.owner_events,
                      Events,
                      grabshell->grab_shell.grab_style,
                      GrabModeAsync,
 ...
 *
 */
static void BtnUp(Widget w, XEvent *event, String *params, Cardinal *num_params)
{
...
static void BtnDown(Widget grabshell, XEvent *event, String *params, Cardinal *num_params)
{
  ...
  XTranslateCoordinates(XtDisplay(grabshell),
 ...
 */
/*ARGSUSED*/
static void Popdown(Widget shell,
                    XEvent *event, /* unused */
                    String *params,
                    Cardinal *num_params)
{
 ...
 */
static void GSAllowEvents(Widget gs, int mode, Time time)
{
 ...
 * Destroy()
 */
static void Destroy(Widget widg)
{
 ...
 * DoLayout()
 */
static void DoLayout(Widget wid)
{
 ...
 * DrawBorder()
 */
static void DrawBorder(Widget widg)
{
  XmGrabShellWidget gs = (XmGrabShellWidget)widg;
  int offset = 0;
  XmeDrawShadows(XtDisplay(widg),
                 XtWindow(widg),
 ...
 * Public Routines *
 *******************/
Widget XmCreateGrabShell(Widget parent, char *name, ArgList al, Cardinal ac)
{
