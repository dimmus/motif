...
static XtResource  resources[]                                 = {
   {
    ...
    XmCDropSiteManagerClass,
    XmRWidgetClass,
    sizeof(WidgetClass),
    Offset(display.dropSiteManagerClass),
    XmRImmediate,
    (XtPointer)&xmDropSiteManagerClassRec,
    },
   {
    XmNdropTransferClass,
    XmCDropTransferClass,
    XmRWidgetClass,
    sizeof(WidgetClass),
    Offset(display.dropTransferClass),
    XmRImmediate,
    (XtPointer)&xmDropTransferClassRec,
    },
   {
    XmNdragContextClass,
    XmCDragContextClass,
    XmRWidgetClass,
    sizeof(WidgetClass),
    Offset(display.dragContextClass),
    XmRImmediate,
    (XtPointer)&xmDragContextClassRec,
    },
   {
    ...
    XmRImmediate,
    (XtPointer)XmDRAG_PREFER_RECEIVER,
    },
   {
    ...
    XmRImmediate,
    (XtPointer)XmDRAG_PREFER_PREREGISTER,
    },
   {
   ...
   { XmNuserData, XmCUserData, XmRPointer, sizeof(XtPointer), Offset(display.user_data), XmRImmediate, (XtPointer)NULL },
   { XmNmotifVersion, XmCMotifVersion, XmRInt, sizeof(int), Offset(display.motif_version), XmRImmediate, (XtPointer)XmVersion },
   { XmNenableWarp, XmCEnableWarp, XmREnableWarp, sizeof(XtEnum), Offset(display.enable_warp), XmRImmediate, (XtPointer)True },
   {
   ...
   { XmNenableBtn1Transfer, XmCEnableBtn1Transfer, XmREnableBtn1Transfer, sizeof(XtEnum), Offset(display.enable_btn1_transfer), XmRImmediate, (XtPointer)XmOFF },
   { XmNenableButtonTab, XmCEnableButtonTab, XmRBoolean, sizeof(Boolean), Offset(display.enable_button_tab), XmRImmediate, (XtPointer)False },
   { XmNenableEtchedInMenu, XmCEnableEtchedInMenu, XmRBoolean, sizeof(Boolean), Offset(display.enable_etched_in_menu), XmRImmediate, (XtPointer)False },
   { XmNdefaultButtonEmphasis, XmCDefaultButtonEmphasis, XmRDefaultButtonEmphasis, sizeof(XtEnum), Offset(display.default_button_emphasis), XmRImmediate, (XtPointer)XmEXTERNAL_HIGHLIGHT },
   { XmNenableToggleColor, XmCEnableToggleColor, XmRBoolean, sizeof(Boolean), Offset(display.enable_toggle_color), XmRImmediate, (XtPointer)False },
   { XmNenableToggleVisual, XmCEnableToggleVisual, XmRBoolean, sizeof(Boolean), Offset(display.enable_toggle_visual), XmRImmediate, (XtPointer)False },
   { XmNenableDragIcon, XmCEnableDragIcon, XmRBoolean, sizeof(Boolean), Offset(display.enable_drag_icon), XmRImmediate, (XtPointer)False },
   { XmNenableUnselectableDrag, XmCEnableUnselectableDrag, XmRBoolean, sizeof(Boolean), Offset(display.enable_unselectable_drag), XmRImmediate, (XtPointer)True },
   { XmNenableThinThickness, XmCEnableThinThickness, XmRBoolean, sizeof(Boolean), Offset(display.enable_thin_thickness), XmRImmediate, (XtPointer)False },
   { XmNenableMultiKeyBindings, XmCEnableMultiKeyBindings, XmRBoolean, sizeof(Boolean), Offset(display.enable_multi_key_bindings), XmRImmediate, (XtPointer)False },
   ...
   { XmNiconPixmap, XmCIconPixmap, XmRBitmap, sizeof(Pixmap), XtOffsetOf(WMShellRec, wm.wm_hints.icon_pixmap), XmRImmediate, NULL },
};
#undef Offset
...
DisplayClassInitialize(void)
{
   ...
   _Xm_MOTIF_DRAG_AND_DROP_MESSAGE = XmMakeCanonicalString("_MOTIF_DRAG_AND_DROP_MESSAGE");
}
   ...
   Boolean  *dontSwallow)
{
   ...
   if (XtIsRealized(w))
   {
      ...
      XtRemoveEventHandler(w, StructureNotifyMask, False, SetDragReceiverInfo, client_data);
   }
}
   ...
   XtPointer call)
{
   ...
   switch (anyCB->reason)
   {
      ...
      {
         XmDropSiteTreeAddCallback cb = (XmDropSiteTreeAddCallback)anyCB;
	     ...
	     */
         XtAddEventHandler(cb->rootShell, NoEventMask, True, ReceiverShellExternalSourceHandler, (XtPointer)dd);
      }
      break;
      case XmCR_DROP_SITE_TREE_REMOVE:
      {
         XmDropSiteTreeRemoveCallback cb = (XmDropSiteTreeRemoveCallback)anyCB;
         XtRemoveEventHandler(cb->rootShell, NoEventMask, True, ReceiverShellExternalSourceHandler, (XtPointer)dd);
         if (XtIsRealized(cb->rootShell))
   ...
   Cardinal *num_args)
{
   static char *atom_names[] = {
      ...
      XmIRESOLUTION_Y,
      XmIWM_DELETE_WINDOW,
      XmI_MOTIF_DRAG_ATOMS,
      XmI_MOTIF_DRAG_INITIATOR_INFO,
      XmI_MOTIF_DRAG_PROXY_WINDOW,
      XmI_MOTIF_DRAG_RECEIVER_INFO,
      XmI_MOTIF_DRAG_TARGETS,
      ...
      XmS_MOTIF_CLIP_HEADER,
      XmS_MOTIF_CLIP_LOCK_ACCESS_VALID,
      XmS_MOTIF_CLIP_MESSAGE,
      XmS_MOTIF_CLIP_NEXT_ID,
      XmS_MOTIF_CLIP_TIME,
   ...
   /*
     ...
     */
   XInternAtoms(XtDisplay(xmDisplay), atom_names, XtNumber(atom_names), False, atoms);
   ...
   xmDisplay->display.proxyWindow = _XmGetDragProxyWindow(XtDisplay(xmDisplay));
   ...
   ((XmDisplayInfo *)(xmDisplay->display.displayInfo))->destinationWidget            = (Widget)NULL;
   ((XmDisplayInfo *)(xmDisplay->display.displayInfo))->excParentPane.pane           = (Widget *)NULL;
   ...
   ((XmDisplayInfo *)(xmDisplay->display.displayInfo))->traversal_in_progress        = FALSE;
   xmDisplay->display.displayHasShapeExtension                                       = XShapeQueryExtension(XtDisplay(xmDisplay), &dummy1, &dummy2);
   /* Handle dynamic default of receiver protocol style */
   if (xmDisplay->display.dragReceiverProtocolStyle == INVALID_PROTOCOL_VALUE)
   {
      if (xmDisplay->display.displayHasShapeExtension)
         xmDisplay->display.dragReceiverProtocolStyle = XmDRAG_PREFER_DYNAMIC;
      else
         xmDisplay->display.dragReceiverProtocolStyle = XmDRAG_PREFER_PREREGISTER;
   }
   ...
   _XmProcessUnlock();
   if (!XFindContext(XtDisplay(xmDisplay), None, context, (char **)&xmDisplay))
   {
      /*
   ...
   Time   time)
{
   ...
   for (i = 0; i < xmDisplay->composite.num_children; i++)
   {
      ...
      if ((XmIsDragContext((Widget)dc)) && (CHECK_TIME(dc, time)) && ((!matchedDC) || (matchedDC->drag.dragStartTime < dc->drag.dragStartTime)) && !dc->core.being_destroyed)
         matchedDC = dc;
   }
   _XmAppUnlock(app);
   ...
   Atom   iccHandle)
{
   ...
   {
      dc = (XmDragContext)(xmDisplay->composite.children[i]);
      if ((XmIsDragContext((Widget)dc)) && (dc->drag.iccHandle == iccHandle) && !dc->core.being_destroyed)
         return ((Widget)dc);
   }
   return (NULL);
}
   ...
   Boolean   sourceIsExternal)
{
   ...
   {
      dc = (XmDragContext)(xmDisplay->composite.children[i]);
      if ((XmIsDragContext((Widget)dc)) && (CHECK_TIME(dc, time)) && (dc->drag.sourceIsExternal == sourceIsExternal) && !dc->core.being_destroyed)
         return (dc);
   }
   return (NULL);
}
   ...
   char            *arg)
{
   ...
   if (!_XmICCEventToICCCallback((XClientMessageEvent *)event,
      ...
      return (False);
   if ((cb->any.reason == XmCR_DROP_SITE_ENTER) || (cb->any.reason == XmCR_DROP_SITE_LEAVE))
   {
      /*
   ...
   Boolean  *dontSwallow)
{
   ...
   q.hasEnter = q.hasDropStart = q.hasLeave = q.hasMotion = False;
   /*
      ...
      if (q.hasEnter || q.hasDropStart)
      {
         if (!q.dc)
         {
            ...
            else
            {
               ...
               XtSetArg(args[i], XmNexportTargets, teCallback->targets);
               i++;
               XtSetArg(args[i], XmNnumExportTargets, teCallback->n_targets);
               i++;
            }
            XtSetArg(args[i], XmNsourceWindow, window);
            i++;
            XtSetArg(args[i], XmNsourceIsExternal, True);
            i++;
            XtSetArg(args[i], XmNstartTime, timeStamp);
            i++;
            XtSetArg(args[i], XmNiccHandle, iccHandle);
            i++;
            dc = (XmDragContext)XtCreateWidget("dragContext",
                                               dd->display.dragContextClass,
                                               (Widget)dd,
                                               args,
                                               i);
            /*
		 ...
		 */
            ...
            dc->drag.currReceiverInfo->dragProtocolStyle = dd->display.dragReceiverProtocolStyle;
   ...
   Display *display)
{
   ...
   context = displayContext;
   _XmProcessUnlock();
   if ((context == 0) || (XFindContext(display, None, context, (char **)&xmDisplay)))
   {
      String name, w_class;
      ...
      n++;
      xmDisplay = (XmDisplay)XtAppCreateShell(name, w_class, xmDisplayClass, display, args, n);
   }
