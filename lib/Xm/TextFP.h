 ...
 *
 ****************/
#define TextF_ActivateCallback(tfg) (((XmTextFieldWidget)(tfg))->text.activate_callback)
#define TextF_LosingFocusCallback(tfg) (((XmTextFieldWidget)(tfg))->text.losing_focus_callback)
#define TextF_FocusCallback(tfg) (((XmTextFieldWidget)(tfg))->text.focus_callback)
#define TextF_ModifyVerifyCallback(tfg) (((XmTextFieldWidget)(tfg))->text.modify_verify_callback)
#define TextF_ModifyVerifyCallbackWcs(tfg) \
  (((XmTextFieldWidget)(tfg))->text.wcs_modify_verify_callback)
#define TextF_MotionVerifyCallback(tfg) (((XmTextFieldWidget)(tfg))->text.motion_verify_callback)
#define TextF_ValueChangedCallback(tfg) (((XmTextFieldWidget)(tfg))->text.value_changed_callback)
#define TextF_Value(tfg) (((XmTextFieldWidget)(tfg))->text.value)
#define TextF_WcValue(tfg) (((XmTextFieldWidget)(tfg))->text.wc_value)
#define TextF_MarginHeight(tfg) (((XmTextFieldWidget)(tfg))->text.margin_height)
#define TextF_MarginWidth(tfg) (((XmTextFieldWidget)(tfg))->text.margin_width)
#define TextF_CursorPosition(tfg) (((XmTextFieldWidget)(tfg))->text.cursor_position)
#define TextF_Columns(tfg) (((XmTextFieldWidget)(tfg))->text.columns)
#define TextF_MaxLength(tfg) (((XmTextFieldWidget)(tfg))->text.max_length)
#define TextF_BlinkRate(tfg) (((XmTextFieldWidget)(tfg))->text.blink_rate)
#define TextF_FontList(tfg) (((XmTextFieldWidget)(tfg))->text.font_list)
#define TextF_Font(tfg) ((XFontStruct *)(((XmTextFieldWidget)(tfg))->text.font))
#define TextF_FontAscent(tfg) (((XmTextFieldWidget)(tfg))->text.font_ascent)
#define TextF_FontDescent(tfg) (((XmTextFieldWidget)(tfg))->text.font_descent)
...
#define TextF_Threshold(tfg) (((XmTextFieldWidget)(tfg))->text.threshold)
#define TextF_UseFontSet(tfg) (((XmTextFieldWidget)(tfg))->text.have_fontset)
#if USE_XFT
#  define TextF_UseXft(tfg) (((XmTextFieldWidget)(tfg))->text.use_xft)
#  define TextF_XftFont(tfg) ((XftFont *)(((XmTextFieldWidget)(tfg))->text.font))
#endif
/*
 * On the spot support.
 */
#define PreStart(tfg) (((XmTextFieldWidget)(tfg))->text.onthespot->start)
#define PreEnd(tfg) (((XmTextFieldWidget)(tfg))->text.onthespot->end)
#define PreCursor(tfg) (((XmTextFieldWidget)(tfg))->text.onthespot->cursor)
#define FUnderVerifyPreedit(tfg) (((XmTextFieldWidget)(tfg))->text.onthespot->under_verify_preedit)
#define FVerifyCommitNeeded(tfg) (((XmTextFieldWidget)(tfg))->text.onthespot->verify_commit)
#ifdef __cplusplus
