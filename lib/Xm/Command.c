   ...
   Cardinal *num_args) /* unused */
{
   ...
   XtAddCallback(new_w->selection_box.text, XmNvalueChangedCallback, CommandCallback, (XtPointer)new_w);
   ...
   XmParentProcessData event)
{
               ...
               && BB_CancelButton(cmd))))
   {
      ...
      {
         _XmCommandReturn((Widget)cmd, event->input_action.event, event->input_action.params, event->input_action.num_params);
      }
      else
      {
