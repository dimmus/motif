 ...
 */
#  define LabG_LabelType(w) (((XmLabelGadget)(w))->label.cache->label_type)
#  define LabG_Alignment(w) (((XmLabelGadget)(w))->label.cache->alignment)
#  define LabG_StringDirection(w) (((XmLabelGadget)(w))->label.cache->string_direction)
#  define LabG_MarginHeight(w) (((XmLabelGadget)(w))->label.cache->margin_height)
#  define LabG_MarginWidth(w) (((XmLabelGadget)(w))->label.cache->margin_width)
#  define LabG_MarginLeft(w) (((XmLabelGadget)(w))->label.cache->margin_left)
#  define LabG_MarginRight(w) (((XmLabelGadget)(w))->label.cache->margin_right)
#  define LabG_MarginTop(w) (((XmLabelGadget)(w))->label.cache->margin_top)
#  define LabG_MarginBottom(w) (((XmLabelGadget)(w))->label.cache->margin_bottom)
#  define LabG_RecomputeSize(w) (((XmLabelGadget)(w))->label.cache->recompute_size)
#  define LabG_SkipCallback(w) (((XmLabelGadget)(w))->label.cache->skipCallback)
#  define LabG_MenuType(w) (((XmLabelGadget)(w))->label.cache->menu_type)
#  define LabG_BackgroundGC(w) (((XmLabelGadget)(w))->label.cache->background_GC)
#  define LabG_TopShadowGC(w) (((XmLabelGadget)(w))->label.cache->top_shadow_GC)
#  define LabG_BottomShadowGC(w) (((XmLabelGadget)(w))->label.cache->bottom_shadow_GC)
#  define LabG_HighlightGC(w) (((XmLabelGadget)(w))->label.cache->highlight_GC)
#  define LabG_Foreground(w) (((XmLabelGadget)(w))->label.cache->foreground)
#  define LabG_Background(w) (((XmLabelGadget)(w))->label.cache->background)
#  define LabG_TopShadowColor(w) (((XmLabelGadget)(w))->label.cache->top_shadow_color)
#  define LabG_TopShadowPixmap(w) (((XmLabelGadget)(w))->label.cache->top_shadow_pixmap)
#  define LabG_BottomShadowColor(w) (((XmLabelGadget)(w))->label.cache->bottom_shadow_color)
#  define LabG_BottomShadowPixmap(w) (((XmLabelGadget)(w))->label.cache->bottom_shadow_pixmap)
#  define LabG_HighlightColor(w) (((XmLabelGadget)(w))->label.cache->highlight_color)
#  define LabG_HighlightPixmap(w) (((XmLabelGadget)(w))->label.cache->highlight_pixmap)
/********
 * Macros for UNcached instance fields
 */
#  define LabG__label(w) (((XmLabelGadget)(w))->label._label)
#  define LabG__acceleratorText(w) (((XmLabelGadget)(w))->label._acc_text)
#  define LabG_Font(w) (((XmLabelGadget)(w))->label.font)
#  define LabG_Mnemonic(w) (((XmLabelGadget)(w))->label.mnemonic)
#  define LabG_MnemonicCharset(w) (((XmLabelGadget)(w))->label.mnemonicCharset)
#  define LabG_Accelerator(w) (((XmLabelGadget)(w))->label.accelerator)
#  define LabG_Pixmap(w) (((XmLabelGadget)(w))->label.pixmap)
#  define LabG_PixmapInsensitive(w) (((XmLabelGadget)(w))->label.pixmap_insen)
#  define LabG_NormalGC(w) (((XmLabelGadget)(w))->label.normal_GC)
#  define LabG_InsensitiveGC(w) (((XmLabelGadget)(w))->label.insensitive_GC)
#  define LabG_ShadowGC(w) (((XmLabelGadget)(w))->label.shadow_GC)
#  define LabG_TextRect(w) (((XmLabelGadget)(w))->label.TextRect)
#  define LabG_AccTextRect(w) (((XmLabelGadget)(w))->label.acc_TextRect)
#  define LabG_PixmapRect(w) (((XmLabelGadget)(w))->label.PixmapRect)
#  define LabG_StringRect(w) (((XmLabelGadget)(w))->label.StringRect)
#  define LabG_PixmapPlacement(w) (((XmLabelGadget)(w))->label.pixmap_placement)
#  define LabG_PixmapTextPadding(w) (((XmLabelGadget)(w))->label.pixmap_text_padding)
/********
 * Convenience Macros
 */
...
#  define LabG_IsPixmapAndText(w) (LabG_LabelType(w) == XmPIXMAP_AND_STRING)
#  define LabG_Cache(w) (((XmLabelGadget)(w))->label.cache)
...
#  define LabG_IsMenupane(w) \
    ((LabG_MenuType(w) == XmMENU_POPUP) || (LabG_MenuType(w) == XmMENU_PULLDOWN))
#  define _XmAssignLabG_MarginHeight_r(cache, val) cache->margin_height = val
#  define _XmAssignLabG_MarginWidth_r(cache, val) cache->margin_width = val
#  define _XmAssignLabG_MarginLeft_r(cache, val) cache->margin_left = val
#  define _XmAssignLabG_MarginRight_r(cache, val) cache->margin_right = val
#  define _XmAssignLabG_MarginTop_r(cache, val) cache->margin_top = val
#  define _XmAssignLabG_MarginBottom_r(cache, val) cache->margin_bottom = val
