   ...
   Cardinal *num_args) /* unused */
{
   ...
   if (!XmRepTypeValidValue(XmRID_SELECTION_TYPE,
                            ...
                            (Widget)new_w))
   {
      new_w->selection_box.dialog_type = XmIsDialogShell(XtParent(new_w))
                                          ? XmDIALOG_SELECTION
                                          : XmDIALOG_WORK_AREA;
   }
   ...
   if (new_w->selection_box.dialog_type == XmDIALOG_PROMPT || new_w->selection_box.dialog_type == XmDIALOG_WORK_AREA)
   {
   ...
   XmSelectionBoxWidget sel)
{
   ...
   SB_ListLabel(sel) = _XmBB_CreateLabelG((Widget)sel,
                                          sel->selection_box.list_label_string,
                                          "Items",
                                          XmItemsStringLoc);
   return;
}
   ...
   XmSelectionBoxWidget sel)
{
   ...
   SB_OkButton(sel) = _XmBB_CreateButtonG((Widget)sel,
                                          sel->selection_box.ok_label_string,
                                          "OK",
                                          XmOkStringLoc);
   XtAddCallback(SB_OkButton(sel), XmNactivateCallback, SelectionBoxCallback, (XtPointer)XmDIALOG_OK_BUTTON);
   return;
}
   ...
   XmSelectionBoxWidget sel)
{
   ...
   SB_ApplyButton(sel) = _XmBB_CreateButtonG((Widget)sel,
                                             sel->selection_box.apply_label_string,
                                             "Apply",
                                             XmApplyStringLoc);
   ...
   XtAddCallback(SB_ApplyButton(sel), XmNactivateCallback, SelectionBoxCallback, (XtPointer)XmDIALOG_APPLY_BUTTON);
   return;
}
   ...
   XmSelectionBoxWidget sel)
{
   ...
   SB_CancelButton(sel) = _XmBB_CreateButtonG((Widget)sel,
                                              sel->selection_box.cancel_label_string,
                                              "Cancel",
                                              XmCancelStringLoc);
   XtAddCallback(SB_CancelButton(sel), XmNactivateCallback, SelectionBoxCallback, (XtPointer)XmDIALOG_CANCEL_BUTTON);
   return;
}
   ...
   XmSelectionBoxWidget sel)
{
   ...
   SB_HelpButton(sel) = _XmBB_CreateButtonG((Widget)sel,
                                            sel->selection_box.help_label_string,
                                            "Help",
                                            XmHelpStringLoc);
   /* Remove BulletinBoard Unmanage callback from apply and help buttons.
    */
   XtRemoveAllCallbacks(SB_HelpButton(sel), XmNactivateCallback);
   XtAddCallback(SB_HelpButton(sel), XmNactivateCallback, SelectionBoxCallback, (XtPointer)XmDIALOG_HELP_BUTTON);
   return;
}
   ...
   XtPointer call_data)
{
   ...
   success = _XmConvertHandler(w, &PRIMARY, &atoms[XmA_MOTIF_SELECTION_TEXT], &type, &value, &size, &format);
   if (!success)
   {
      _XmConvertHandlerSetLocal();
      success = _XmConvertHandler(w, &PRIMARY, &atoms[XmA_MOTIF_COMPOUND_STRING], &type, &value, &size, &format);
   }
   if (success)
   {
   ...
   Cardinal *num_args) /* unused */
{
   ...
   if (new_w->selection_box.list_visible_item_count != current->selection_box.list_visible_item_count)
   {
 ...
 ****************/
Widget
_XmSelectionBoxGetChild(Widget sb, unsigned char which)
{
   /****************/
   Widget child = NULL;
...
/* Deprecated */
Widget
XmSelectionBoxGetChild(Widget sb, unsigned char which)
{
