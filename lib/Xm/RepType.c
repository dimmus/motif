...
static Boolean ReverseConvertRepType(Display *disp,
                                     XrmValue *args,
                                     Cardinal *n_args,
                                     XrmValue *from,
                                     XrmValue *to,
...
static XmConst char *XmConst AnimationStyleNames[] = {"drag_under_none",
                                                      "drag_under_pixmap",
...
static XmConst char *XmConst ArrowLayoutNames[] = {
    "arrows_end", "arrows_beginning", "arrows_split", "arrows_flat_end", "arrows_flat_beginning"};
static XmConst char *XmConst ArrowOrientationNames[] = {"arrows_vertical", "arrows_horizontal"};
...
static XmConst char *XmConst AttachmentNames[] = {"attach_none",
                                                  "attach_form",
...
static XmConst char *XmConst AutomaticSelectionNames[] = {
    "no_auto_select", "auto_select", XtEoff, XtEfalse, XtEno, "0", XtEon, XtEtrue, XtEyes, "1"};
static XmConst unsigned char AutomaticSelectionMap[] = {XmNO_AUTO_SELECT,
                                                        XmAUTO_SELECT,
                                                        XmNO_AUTO_SELECT,
                                                        XmNO_AUTO_SELECT,
                                                        XmNO_AUTO_SELECT,
...
static XmConst char *XmConst ChildVerticalAlignmentNames[] = {"alignment_baseline_top",
                                                              "alignment_center",
                                                              "alignment_baseline_bottom",
                                                              "alignment_widget_top",
                                                              "alignment_widget_bottom",
                                                              "alignment_child_top",
                                                              "alignment_child_bottom"};
static XmConst unsigned char ChildVerticalAlignmentMap[] = {XmALIGNMENT_BASELINE_TOP,
                                                            XmALIGNMENT_CENTER,
...
static XmConst char *XmConst ComboBoxListActionActionParamNames[] = {
    "up", "down", "listprevpage", "listnextpage", "listbegindata", "listenddata"};
...
static XmConst char *XmConst CommandWindowLocationNames[] = {"command_above_workspace",
...
static XmConst char *XmConst ContainerStartTransferActionParamNames[] = {"link", "move", "copy"};
static XmConst char *XmConst DefaultButtonEmphasisNames[] = {"external_highlight",
                                                             "internal_highlight"};
static XmConst char *XmConst DefaultButtonTypeNames[] = {
    "dialog_none", "dialog_cancel_button", "dialog_ok_button", "dialog_help_button"};
static XmConst unsigned char DefaultButtonTypeMap[] = {
    XmDIALOG_NONE, XmDIALOG_CANCEL_BUTTON, XmDIALOG_OK_BUTTON, XmDIALOG_HELP_BUTTON};
static XmConst char *XmConst DeleteResponseNames[] = {"destroy", "unmap", "do_nothing"};
static XmConst char *XmConst DialogStyleNames[] = {"dialog_modeless",
                                                   "dialog_work_area",
                                                   "dialog_primary_application_modal",
                                                   "dialog_application_modal",
                                                   "dialog_full_application_modal",
                                                   "dialog_system_modal"};
static XmConst unsigned char DialogStyleMap[] = {XmDIALOG_MODELESS,
                                                 XmDIALOG_WORK_AREA,
                                                 XmDIALOG_PRIMARY_APPLICATION_MODAL,
                                                 XmDIALOG_APPLICATION_MODAL,
                                                 XmDIALOG_FULL_APPLICATION_MODAL,
                                                 XmDIALOG_SYSTEM_MODAL};
static XmConst char *XmConst DialogTypeNames[] = {"dialog_template",
                                                  "dialog_error",
                                                  "dialog_information",
                                                  "dialog_message",
                                                  "dialog_question",
                                                  "dialog_warning",
                                                  "dialog_working"};
static XmConst char *XmConst DirectionNames[] = {"left_to_right",
                                                 "right_to_left",
...
static XmConst unsigned char DirectionMap[] = {XmLEFT_TO_RIGHT,
                                               XmRIGHT_TO_LEFT,
...
static XmConst char *XmConst DragInitiatorProtocolStyleNames[] = {"drag_none",
                                                                  "drag_drop_only",
...
static XmConst char *XmConst DragReceiverProtocolStyleNames[] = {"drag_none",
                                                                 "drag_drop_only",
                                                                 "drag_prefer_preregister",
                                                                 "drag_preregister",
                                                                 "drag_prefer_dynamic",
...
static XmConst char *XmConst IconAttachmentNames[] = {"attach_north_west",
                                                      "attach_north",
                                                      "attach_north_east",
                                                      "attach_east",
                                                      "attach_south_east",
                                                      ...
                                                      "attach_center",
                                                      "attach_hot"};
static XmConst char *XmConst IndicatorOnNames[] = {"indicator_none",
                                                   "indicator_fill",
                                                   "indicator_box",
                                                   "indicator_check",
                                                   "indicator_check_box",
                                                   ...
                                                   XtEtrue,
                                                   XtEyes};
static XmConst unsigned char IndicatorOnMap[] = {XmINDICATOR_NONE,
                                                 XmINDICATOR_FILL,
                                                 XmINDICATOR_BOX,
                                                 XmINDICATOR_CHECK,
...
static XmConst char *XmConst LineTypeNames[] = {
    "no_line", "single_line", "double_line", "single_dashed_line", "double_dashed_line", "as_is"};
static XmConst unsigned char LineTypeMap[] = {
    XmNO_LINE, XmSINGLE_LINE, XmDOUBLE_LINE, XmSINGLE_DASHED_LINE, XmDOUBLE_DASHED_LINE, XmAS_IS};
...
static XmConst char *XmConst OutlineButtonPolicyNames[] = {"outline_button_present",
                                                           "outline_button_absent"};
...
static XmConst char *XmConst PanedWindowSashIncrementActionParamNames[] = {"defaultincr",
                                                                           "largeincr"};
static XmConst char *XmConst PathModeNames[] = {"path_mode_full", "path_mode_relative"};
static XmConst char *XmConst PositionModeNames[] = {"zero_based", "one_based"};
static XmConst char *XmConst PositionTypeNames[] = {"position_index", "position_value"};
...
static XmConst char *XmConst ScrolledWindowChildTypeNames[] = {"work_area",
                                                               "menu_bar",
                                                               "hor_scrollbar",
                                                               "vert_scrollbar",
                                                               "command_window",
...
static XmConst char *XmConst SelectionTechniqueNames[] = {
    "marquee", "marquee_extend_start", "marquee_extend_both", "touch_only", "touch_over"};
static XmConst char *XmConst SelectionTypeNames[] = {"dialog_work_area",
                                                     "dialog_prompt",
                                                     "dialog_selection",
                                                     "dialog_command",
                                                     "dialog_file_selection"};
static XmConst char *XmConst SeparatorTypeNames[] = {"no_line",
                                                     "single_line",
                                                     "double_line",
                                                     "single_dashed_line",
                                                     "double_dashed_line",
...
static XmConst char *XmConst SetNames[] = {
    "unset", "set", "indeterminate", XtEoff, XtEfalse, XtEno, "0", XtEon, XtEtrue, XtEyes, "1"};
static XmConst unsigned char SetMap[] = {XmUNSET,
                                         XmSET,
                                         XmINDETERMINATE,
                                         XmUNSET,
                                         XmUNSET,
...
static XmConst char *XmConst ShowArrowsNames[] = {"each_side",
                                                  XtEtrue,
                                                  XtEyes,
                                                  XtEon,
                                                  "1",
...
static XmConst unsigned char ShowArrowsMap[] = {
    1, 1, 1, 1, 1, XmMAX_SIDE, XmMIN_SIDE, 0, 0, 0, 0, 0};
static XmConst char *XmConst ShowValueNames[] = {"near_slider",
                                                 XtEtrue,
                                                 XtEyes,
                                                 XtEon,
                                                 "1",
...
static XmConst char *XmConst StringDirectionNames[] = {"string_direction_l_to_r",
...
static XmConst char *XmConst UnitTypeNames[] = {"pixels",
                                                "100th_millimeters",
                                                "1000th_inches",
                                                "100th_points",
                                                "100th_font_units",
...
static XmConst char *XmConst VerticalAlignmentNames[] = {"alignment_baseline_top",
                                                         "alignment_center",
                                                         "alignment_baseline_bottom",
...
static XmRepTypeEntryRec StandardRepTypes[] = {
    ...
    {XmREnableBtn1Transfer,
     (String *)EnableBtn1Names,
     (unsigned char *)EnableBtn1Map,
     XtNumber(EnableBtn1Names),
     FALSE},
    {
        XmREnableWarp,
...
static String *CopyStringArray(String *StrArray, unsigned char NumEntries, Boolean UppercaseFormat)
{
  unsigned int Index;
  String *TmpStr;
  int PrefixSize = 0;
                              ...
                              unsigned char num_values)
{
  ...
  XtSetTypeConverter(
      XmRString, NewRecord->rep_type_name, ConvertRepType, &convertArg, 1, XtCacheNone, NULL);
...
void XmRepTypeAddReverse(XmRepTypeId rep_type_id)
{
  ...
  if (Record && !Record->reverse_installed) {
    ...
    convertArg.size = sizeof(convertArg.address_id);
    XtSetTypeConverter(Record->rep_type_name,
                       XmRString,
...
XmRepTypeId XmRepTypeGetId(String rep_type_name)
{
  ...
  for (Index = 0; Index < StandardNumRecs; Index++) {
    int compare_name = strcmp(rep_type_name, StandardRepTypes[Index].rep_type_name);
    if (compare_name == 0) {
      _XmProcessUnlock();
      return Index;
    }
  ...
  for (Index = 0; Index < DynamicRepTypeNumRecords; Index++) {
    if (!strcmp(rep_type_name, DynamicRepTypes[Index].rep_type_name)) {
      _XmProcessUnlock();
...
String *XmRepTypeGetNameList(XmRepTypeId rep_type_id, Boolean use_uppercase_format)
{
  XmRepTypeEntry Record;
                              ...
                              XtPointer *converter_data) /* unused */
{
  ...
  while (Index < Record->num_values) {
    if (XmeNamesAreEqual(in_str, Record->value_names[Index])) {
      if ((RepTypeID == XmRID_EDIT_MODE) || (RepTypeID == XmRID_WHICH_BUTTON) ||
...
void _XmRepTypeInstallConverters(void)
{
  ...
  convertArg.size = sizeof(convertArg.address_id);
  XtSetTypeConverter(
      XmRString, REAL_UNIT_TYPE_NAME, ConvertRepType, &convertArg, 1, XtCacheNone, NULL);
  ...
  for (Index = 0; Index < StandardNumRecs; Index++) {
    ...
    if (StandardRepTypes[Index].reverse_installed)
      continue;
 ...
 */
Boolean _XmConvertActionParamToRepTypeId(
    Widget widget, XmRepTypeId rep_type_id, char *parameter, Boolean can_be_numeric, int *result)
{
  int value, i;
...
void _XmCheckStandardNumRecs()
{
  ...
  for (Index = 0; Index < StandardNumRecs; Index++) {
    ...
    if (PrevRecord)
      if (strcmp(Record->rep_type_name, PrevRecord->rep_type_name) <= 0)
