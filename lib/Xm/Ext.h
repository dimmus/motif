...
#define XmNbadActionParametersMsg "Bad parameters passed to an action routine of widget '%s'."
...
#define XmNbadXlfdFontMsg "%s: All Xlfd fonts must contain 14 hyphens\n'%s' is not valid."
...
#define XmNcolorNameTooLongMsg "Color name '%s' is too long, truncated to '%s'."
...
#define XmNconversionFailureMsg "%s: Unable to perform string to %s conversion."
#define XmNcouldNotFindFamilyData "couldNotFindFamilyData"
#define XmNcouldNotFindFamilyDataMsg "Could not find family data for family '%s'."
...
#define XmNinsertBeforeNotSiblingMsg \
  "XmHierarchy: InsertBefore Widget\
...
#define XmNselfOrOutsideOfApplicationDropMsg "Attempt to drop into illegal object."
#define XmNstaticTranslationsMsg "Cannot change translation table after initialization."
#define XmNstaticScrollbarsMsg "Cannot change scrollbars after initialization."
...
#define XmNunparsableColorMsg "Could not parse the color name '%s'."
#define XmNnodeParentIsSelf "nodeParentIsSelf"
#define XmNnodeParentIsSelfMsg "The node parent cannot be self referential."
