...
static XtResource resources[] = {
   { XmNsource,                  XmCSource,                 XmRPointer,             sizeof(XtPointer),        XtOffsetOf(struct _XmTextRec,      text.source),                     XmRPointer,   (XtPointer)&nullsourceptr     },
   { XmNactivateCallback,        XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.activate_callback),          XmRCallback,  NULL                          },
   { XmNfocusCallback,           XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.focus_callback),             XmRCallback,  NULL                          },
   { XmNlosingFocusCallback,     XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.losing_focus_callback),      XmRCallback,  NULL                          },
   { XmNvalueChangedCallback,    XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.value_changed_callback),     XmRCallback,  NULL                          },
   { XmNdestinationCallback,     XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.destination_callback),       XmRCallback,  NULL                          },
   { XmNmodifyVerifyCallback,    XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.modify_verify_callback),     XmRCallback,  NULL                          },
   { XmNmodifyVerifyCallbackWcs, XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.wcs_modify_verify_callback), XmRCallback,  NULL                          },
   { XmNmotionVerifyCallback,    XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.motion_verify_callback),     XmRCallback,  NULL                          },
   { XmNgainPrimaryCallback,     XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.gain_primary_callback),      XmRCallback,  NULL                          },
   { XmNlosePrimaryCallback,     XmCCallback,               XmRCallback,            sizeof(XtCallbackList),   XtOffsetOf(struct _XmTextRec,      text.lose_primary_callback),      XmRCallback,  NULL                          },
   { XmNvalue,                   XmCValue,                  XmRString,              sizeof(String),           XtOffsetOf(struct _XmTextRec,      text.value),                      XmRString,    ""                            },
   { XmNvalueWcs,                XmCValueWcs,               XmRValueWcs,            sizeof(wchar_t *),        XtOffsetOf(struct _XmTextRec,      text.wc_value),                   XmRString,    NULL                          },
   { XmNmaxLength,               XmCMaxLength,              XmRInt,                 sizeof(int),              XtOffsetOf(struct _XmTextRec,      text.max_length),                 XmRImmediate, (XtPointer)INT_MAX            },
   { XmNmarginHeight,            XmCMarginHeight,           XmRVerticalDimension,   sizeof(Dimension),        XtOffsetOf(struct _XmTextRec,      text.margin_height),              XmRImmediate, (XtPointer)5                  },
   { XmNmarginWidth,             XmCMarginWidth,            XmRHorizontalDimension, sizeof(Dimension),        XtOffsetOf(struct _XmTextRec,      text.margin_width),               XmRImmediate, (XtPointer)5                  },
   { XmNoutputCreate,            XmCOutputCreate,           XmRFunction,            sizeof(OutputCreateProc), XtOffsetOf(struct _XmTextRec,      text.output_create),              XmRFunction,  (XtPointer)NULL               },
   { XmNinputCreate,             XmCInputCreate,            XmRFunction,            sizeof(InputCreateProc),  XtOffsetOf(struct _XmTextRec,      text.input_create),               XmRFunction,  (XtPointer)NULL               },
   { XmNtopCharacter,            XmCTopCharacter,           XmRTextPosition,        sizeof(XmTextPosition),   XtOffsetOf(struct _XmTextRec,      text.top_character),              XmRImmediate, (XtPointer)0                  },
   { XmNcursorPosition,          XmCCursorPosition,         XmRTextPosition,        sizeof(XmTextPosition),   XtOffsetOf(struct _XmTextRec,      text.cursor_position),            XmRImmediate, (XtPointer)0                  },
   { XmNeditMode,                XmCEditMode,               XmREditMode,            sizeof(int),              XtOffsetOf(struct _XmTextRec,      text.edit_mode),                  XmRImmediate, (XtPointer)XmSINGLE_LINE_EDIT },
   { XmNautoShowCursorPosition,  XmCAutoShowCursorPosition, XmRBoolean,             sizeof(Boolean),          XtOffsetOf(struct _XmTextRec,      text.auto_show_cursor_position),  XmRImmediate, (XtPointer)True               },
   { XmNeditable,                XmCEditable,               XmRBoolean,             sizeof(Boolean),          XtOffsetOf(struct _XmTextRec,      text.editable),                   XmRImmediate, (XtPointer)True               },
   { XmNverifyBell,              XmCVerifyBell,             XmRBoolean,             sizeof(Boolean),          XtOffsetOf(struct _XmTextRec,      text.verify_bell),                XmRImmediate, (XtPointer)XmDYNAMIC_BOOL     },
   ...
   { XmNtotalLines,              XmCTotalLines,             XmRInt,                 sizeof(int),              XtOffsetOf(struct _XmTextRec,      text.total_lines),                XmRImmediate, (XtPointer)1                  },
};
...
externaldef(xmtextwidgetclass) WidgetClass xmTextWidgetClass = (WidgetClass)&xmTextClassRec;
...
_XmCreateCutBuffers(Widget w)
{
   ...
   if (XFindContext(dpy, (Window)screen, local_context, &tmp))
   {
      ...
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER0, XA_STRING, 8, PropModeAppend, NULL, 0);
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER1, XA_STRING, 8, PropModeAppend, NULL, 0);
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER2, XA_STRING, 8, PropModeAppend, NULL, 0);
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER3, XA_STRING, 8, PropModeAppend, NULL, 0);
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER4, XA_STRING, 8, PropModeAppend, NULL, 0);
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER5, XA_STRING, 8, PropModeAppend, NULL, 0);
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER6, XA_STRING, 8, PropModeAppend, NULL, 0);
      XChangeProperty(dpy, RootWindowOfScreen(screen), XA_CUT_BUFFER7, XA_STRING, 8, PropModeAppend, NULL, 0);
              ...
              XmSecondaryResourceData **secResDataRtn)
{
   ...
   secResDataPtr = (XmSecondaryResourceData *)XtMalloc(sizeof(XmSecondaryResourceData) * 2);
...
ClassPartInitialize(WidgetClass wc)
{
   ...
   event_bindings = (char *)XtMalloc(strlen(_XmTextEventBindings1) + strlen(_XmTextEventBindings2) + strlen(_XmTextEventBindings3) + 1);
...
{
   xmTextClassRec.core_class.actions     = (XtActionList)_XmdefaultTextActionsTable;
   ...
   XmeTraitSet((XtPointer)xmTextWidgetClass, XmQTaccessTextual, (XtPointer)&TextCS);
}
            ...
            XmTextPosition updateTo)
{
   ...
   */
        ...
        i++)
   {
      ...
      (*tw->text.output->Draw)(tw, i, updateFrom, MIN(updateTo, nextstart), l2->mode);
...
RedrawChanges(XmTextWidget tw)
{
   ...
   {
      (*tw->text.output->Draw)(tw, (LineNum)0, tw->text.first_position, tw->text.last_position, XmHIGHLIGHT_NORMAL);
   }
       ...
       int          destcopy)
{
   ...
   LineNum i;
   EraseInsertionPoint(tw);
   if (tw->text.disable_depth == 0 && (*tw->text.output->MoveLines)(tw, (LineNum)startcopy, (LineNum)endcopy, (LineNum)destcopy))
   {
      TextDrawInsertionPoint(tw);
      return;
   }
                  ...
                  int            delta)
{
   ...
   if (line_table[t_index].start_pos < (unsigned int)start)
   {
      ...
      if (t_index <= max_index && (line_table[t_index].start_pos == tw->text.last_position) && (tw->text.number_lines == -delta) && t_index == max_index)
         t_index++;
   }
   else
...
RefigureLines(XmTextWidget tw)
{
   ...
   for (i = 0; i == 0 || !line[i - 1].past_end; i++)
   {
      ...
      if (line[i].start >= tw->text.forget_past || line[i].start != oldline[j].start || oldline[j].changed || oldline[j + 1].changed)
      {
         line[i].past_end  = !(*tw->text.output->MeasureLine)(tw, i, line[i].start, &line[i + 1].start, &line[i].extra);
         line[i + 1].extra = NULL;
         if (!line[i].past_end && (line[i + 1].start == PASTENDPOS) && (line[i].start != PASTENDPOS))
      ...
      else
      {
         ...
         line[i].past_end  = !(*tw->text.output->MeasureLine)(tw, i, line[i].start, NULL, NULL);
         line[i + 1].start = oldline[j + 1].start;
         line[i + 1].extra = oldline[j + 1].extra;
      }
      if (!line[i].past_end)
      {
         if (line[i].start != oldline[j].start || line[i + 1].start != oldline[j + 1].start || line[i].start >= tw->text.forget_past)
         {
            AddRedraw(tw, line[i].start, line[i + 1].start);
         }
         else
         {
            if (i != j && line[i + 1].start >= tw->text.last_position)
               AddRedraw(tw, tw->text.last_position, tw->text.last_position);
      ...
      if (!line[i].past_end)
         ...
         tw->text.bottom_position = MIN(line[i].start, tw->text.last_position);
   }
   if (startcopy >= 0)
   {
      DoMove(tw, startcopy, endcopy, destcopy);
   ...
   if (tw->text.top_character >= tw->text.last_position && tw->text.last_position > tw->text.first_position && tw->text.output->data->number_lines > 1)
   {
   ...
   if (tw->text.force_display >= 0)
   {
      ...
      else if (tw->text.force_display == line[tw->text.number_lines].start)
      {
            ...
            unsigned int cur_index)
{
   ...
   if ((tw->text.table_size > TABLE_INCREMENT && tw->text.total_lines <= tw->text.table_size - TABLE_INCREMENT) || tw->text.total_lines <= tw->text.table_size >> 1)
   {
                        ...
                        register XmTextPosition cur_end)
{
   ...
   cur_index++;
   line_end = (*tw->text.source->Scan)(tw->text.source, cur_start, XmSELECT_LINE, XmsdRight, 1, TRUE);
                       ...
                       Boolean        update)
{
   ...
   if ((start == end && length == 0) || (word_wrap && !XtIsRealized(widget) && XmIsScrolledWindow(XtParent(widget)) && XtIsShell(XtParent(XtParent(widget)))))
   {
      return;
   }
   line_table  = tw->text.line_table;
   ...
   if (end > start)
   {
      ...
      else if (line_table[end_index].start_pos > (unsigned int)start && line_table[end_index].start_pos <= (unsigned int)cur_end)
      {
         lines_avail++;
      }
   }
            ...
            else
            {
               if (temp_index >= temp_table_size)
               {
                  if (!temp_table_size)
                  {
                     ...
                     {
                        temp_table_size = length / (tw->text.output->data->columns / 2);
...
FindHighlightingChanges(XmTextWidget tw)
{
   ...
   {
      if (i1 < n1 - 1)
         next1 = l1[i1 + 1].position;
      else
         next1 = tw->text.last_position;
      if (i2 < n2 - 1)
         next2 = l2[i2 + 1].position;
      else
         next2 = tw->text.last_position;
...
Redisplay(XmTextWidget tw)
{
   ...
   if (tw->text.in_redisplay || tw->core.being_destroyed || tw->text.disable_depth != 0 || !XtIsRealized((Widget)tw)) return;
   EraseInsertionPoint(tw);
...
#define radjust(p) \
  if ((p > position && p != PASTENDPOS) ||		                    \
   ...
   tw->text.first_position = (*tw->text.source->Scan)(tw->text.source, 0, XmSELECT_ALL, XmsdLeft, 1, FALSE);
   tw->text.last_position  = (*tw->text.source->Scan)(tw->text.source, 0, XmSELECT_ALL, XmsdRight, 1, FALSE);
   if (delta == NODELTA)
   {
      ...
      if (tw->text.top_character > position && tw->text.bottom_position < topos)
      {
      ...
      if (tw->text.in_resize && tw->text.line_table != NULL)
      {
         ...
         if (top_index != 0 && tw->text.output->data->number_lines > lines_used)
         {
            ...
            if (index_offset < tw->text.total_lines - lines_used)
               ...
               next_index = 0;
            tw->text.new_top = tw->text.top_character = tw->text.line_table[next_index].start_pos;
         }
      }
      tw->text.forget_past = MIN(tw->text.forget_past, position);
   }
   else
   {
      ...
      for (i = 1; i < tw->text.highlight.number; i++)
      {
         ...
         if (delta > 0 && ((tw->text.highlight.list[i].position > position) || ((tw->text.highlight.list[i].position == position) && (tw->text.highlight.list[i].mode != XmHIGHLIGHT_NORMAL))))
      ...
      for (i = 1; i < tw->text.old_highlight.number; i++)
      {
         ...
         if (delta > 0 && ((tw->text.old_highlight.list[i].position > position) || ((tw->text.old_highlight.list[i].position == position) && (tw->text.old_highlight.list[i].mode != XmHIGHLIGHT_NORMAL))))
      ...
      for (i = 0; i <= tw->text.number_lines && tw->text.line[i].start != PASTENDPOS; i++)
      {
         ...
         {
            if (tw->text.line[i].start > position && tw->text.line[i].start <= topos)
            {
      ...
      if (shift)
      {
         for (i = shift_start; i < tw->text.number_lines; i++)
         {
            ...
            if (tw->text.line[i].start != PASTENDPOS)
               tw->text.line[i].changed_position = tw->text.line[i + 1].start - 1;
            else
      ...
      for (l = _XmTextPosToLine(tw, position), p = position;
           l < tw->text.number_lines && tw->text.line[l].start <= endpos;
           l++, p = tw->text.line[l].start)
      {
         if (l != NOLINE)
         {
            ...
            {
               tw->text.line[l].changed_position = MIN(p, tw->text.line[l].changed_position);
            }
            else
            {
   ...
   else
   {
      ...
      if (tw->text.highlight.number > tw->text.highlight.maximum)
      {
         ...
         l = tw->text.highlight.list = (_XmHighlightRec *)
            XtRealloc((char *)l, tw->text.highlight.maximum * sizeof(_XmHighlightRec));
      }
           ...
           Cardinal *num_args)
{
   ...
   newtw->text.onthespot->start = newtw->text.onthespot->end = newtw->text.onthespot->cursor = newtw->text.onthespot->over_len = newtw->text.onthespot->over_maxlen = 0;
   ...
   else
   {
      ...
      else if (tw->text.value != NULL)
      {
         ...
         for (i = 0; i < num_args; i++)
            if (tw->text.value == (char *)args[i].value && (args[i].name == XmNvalue || strcmp(args[i].name, XmNvalue) == 0))
            {
   ...
   */
   if (!used_source)
   {
      ...
      if (tw->text.char_size == 1)
      {
         ...
         (void)(*tw->text.source->ReadSource)(source, 0, source->data->length, &block);
   }
   else
      (void)(*tw->text.source->ReadSource)(source, 0, source->data->length, &block);
   ...
   (*tw->text.output->PosToXY)(tw, tw->text.cursor_position, &(tw->text.cursor_position_x), &dummy);
}
        ...
        XSetWindowAttributes *attributes)
{
   ...
   */
      ...
      XtSetArg(im_args[n], XmNpreeditStartCallback, &xim_cb[0]);
      n++;
      XtSetArg(im_args[n], XmNpreeditDoneCallback, &xim_cb[1]);
      n++;
      XtSetArg(im_args[n], XmNpreeditDrawCallback, &xim_cb[2]);
      n++;
      XtSetArg(im_args[n], XmNpreeditCaretCallback, &xim_cb[3]);
      n++;
                       ...
                       XmTextPosition top_character)
{
   ...
   */
   else if (tw->text.auto_show_cursor_position && tw->text.edit_mode == XmSINGLE_LINE_EDIT)
          ...
          Cardinal *num_args)
{
  ...
  */
   ...
   */
   ...
   newtw->text.cursor_position = 0;
   if (!XtIsSensitive(new_w) && newtw->text.input->data->has_destination)
   {
      _XmTextSetDestinationSelection(new_w, 0, True, XtLastTimestampProcessed(XtDisplay(new_w)));
   }
   if (!XmRepTypeValidValue(XmRID_EDIT_MODE,
                            newtw->text.edit_mode,
                            new_w))
   ...
   if ((old->text.top_character != newtw->text.top_character) && (newtw->text.top_character != newtw->text.new_top))
   {
      XmTextPosition new_top;
      if (newtw->text.output->data->resizeheight && !(newtw->text.output->data->scrollvertical && XmIsScrolledWindow(XtParent((Widget)newtw))))
         new_top = 0;
      else
   ...
   */
   ...
   if (newtw->text.wc_value != NULL)
   {
      ...
      n_bytes   = wcstombs(tmp_value, newtw->text.wc_value, (num_chars + 1) * (int)newtw->text.char_size);
      if (n_bytes == -1) n_bytes = 0;
      tmp_value[n_bytes]   = 0; /* NULL terminate the string */
      o_redisplay          = newtw->text.needs_redisplay;
   ...
   o_redisplay = (*newtw->text.output->SetValues)(oldw, reqw, new_w, args, num_args);
   ...
   (*newtw->text.output->PosToXY)(newtw, newtw->text.cursor_position, &(newtw->text.cursor_position_x), &dummy);
   ...
   if ((!newtw->text.editable || !XtIsSensitive(new_w)) && _XmTextHasDestination(new_w))
   ...
   if (need_text_redisplay && !newtw->text.needs_redisplay && newtw->text.disable_depth == 0)
   {
      EraseInsertionPoint(newtw);
              ...
              XtWidgetGeometry *reply)
{
   ...
   if ((GMode(intended) != GMode(reply)) || (reply->width != intended->width) || (reply->height != intended->height))
                         ...
                         XmTextPosition position)
{
   ...
   if (position != tw->text.cursor_position)
   {
      ...
      cb.doit       = True;
      XtCallCallbackList(widget, tw->text.motion_verify_callback, (XtPointer)&cb);
   ...
   * the selection.
   */
   if (!tw->text.add_mode && tw->text.pendingoff && _XmStringSourceHasSelection(source))
      (*source->SetSelection)(source, position, position, XtLastTimestampProcessed(XtDisplay(widget)));
   ...
   if (tw->text.needs_redisplay && tw->text.disable_depth == 0)
      Redisplay(tw);
   (*tw->text.output->PosToXY)(tw, position, &(tw->text.cursor_position_x), &dummy);
   ...
   * any changes that have occured while redisplay has been disabled.  */
   if (widget->text.disable_depth == 0)
   {
                           ...
                           XmTOP_TO_BOTTOM_RIGHT_TO_LEFT))
      {
         ...
         if (widget->text.output->data->scrollhorizontal && XmIsScrolledWindow(XtParent(widget)) && !widget->text.hsbar_scrolling)
            _XmChangeHSB(widget);
      }
      else
      {
         if (widget->text.output->data->scrollvertical && XmIsScrolledWindow(XtParent(widget)) && !widget->text.vsbar_scrolling)
            _XmChangeVSB(widget);
                   ...
                   Boolean editable)
{
   ...
   if (!tw->text.editable && editable)
   {
      ...
      (*tw->text.output->PosToXY)(tw, tw->text.cursor_position, &xmim_point.x, &xmim_point.y);
      (void)_XmTextGetDisplayRect((Widget)tw, &xmim_area);
      n = 0;
      XtSetArg(args[n], XmNfontList, o_data->fontlist);
      n++;
      XtSetArg(args[n], XmNbackground, widget->core.background_pixel);
      n++;
      XtSetArg(args[n], XmNforeground, tw->primitive.foreground);
      n++;
      XtSetArg(args[n], XmNbackgroundPixmap, widget->core.background_pixmap);
      n++;
      XtSetArg(args[n], XmNspotLocation, &xmim_point);
      n++;
      XtSetArg(args[n], XmNarea, &xmim_area);
      n++;
      XtSetArg(args[n], XmNlineSpace, o_data->lineheight);
      n++;
      /*
    * 	Register on the spot callbacks.
    */
                    ...
                    XmHighlightMode mode)
{
   ...
   if (!tw->text.highlight_changed)
   {
      ...
      memcpy((void *)tw->text.old_highlight.list,
             ...
             (size_t)tw->text.old_highlight.number * sizeof(_XmHighlightRec));
   }
                    ...
                    XmTextPosition position)
{
   ...
   _XmAppLock(app);
   if (!tw->text.needs_refigure_lines && (position < 0 || (position >= tw->text.top_character && position < tw->text.bottom_position)))
   {
                    ...
                    int   *total_lines)
{
   ...
   *total_lines = tw->text.total_lines;
   ...
   memcpy((void *)line_table, (void *)tw->text.line_table, *total_lines * sizeof(XmTextLineTableRec));
   return line_table;
}
             ...
             int       format)
{
   ...
   {
      case XmFORMAT_XmSTRING:
         str = (char *)_XmStringUngenerate((XmString)s, NULL, XmMULTIBYTE_TEXT, XmMULTIBYTE_TEXT);
             ...
             XPointer call_data)
{
   ...
   if (tw->text.input->data->overstrike)
   {
      ...
      PreOverStr(tw) = _XmStringSourceGetString(tw, PreCursorTW(tw), lastPos, False);
   }
   return (-1);
}
            ...
            XPointer call_data)
{
   ...
   */
   if (PreEndTW(tw) > PreStartTW(tw))
   {
      if (need_verify)
      {
         PreeditVerifyReplace(w, PreStartTW(tw), PreEndTW(tw), NULL, PreStartTW(tw), &end_preedit);
      ...
      else
      {
         ...
         block.length = 0;
         block.format = XmFMT_8_BIT;
         (*tw->text.source->Replace)(tw, NULL, &PreStartTW(tw), &PreEndTW(tw), &block, False);
      }
   }
   if (tw->text.input->data->overstrike && PreOverMaxLen(tw) > 0)
   {
      ...
      if (need_verify)
      {
         PreeditVerifyReplace(w, PreStartTW(tw), PreStartTW(tw), mb, PreStartTW(tw), &end_preedit);
         if (end_preedit) return;
      }
      else
      {
         ...
         block.length = strlen(block.ptr);
         block.format = XmFMT_8_BIT;
         (*tw->text.source->Replace)(tw, NULL, &PreStartTW(tw), &PreStartTW(tw), &block, False);
            ...
            XIMPreeditDrawCallbackStruct *call_data)
{
   ...
   /* turn cursor off */
   (*tw->text.output->DrawInsertionPoint)(tw, tw->text.cursor_position, off);
   XmTextSetHighlight(w, PreStartTW(tw) + call_data->chg_first, PreStartTW(tw) + call_data->chg_first + call_data->chg_length, XmHIGHLIGHT_NORMAL);
   /* preedit deletion */
   if (!data->overstrike && (!call_data->text || !insert_length))
   {
      ...
      else
      {
         ...
         block.length = 0;
         block.format = XmFMT_8_BIT;
         if ((*tw->text.source->Replace)(tw, NULL, &startPos, &endPos, &block, False) != EditDone)
         {
   ...
   {
      startPos = PreStartTW(tw) + call_data->chg_first;
      tmp_end  = (XmTextPosition)(PreEndTW(tw) + insert_length - call_data->chg_length);
      ...
      rest_len = PreEndTW(tw) - PreStartTW(tw) - call_data->chg_first - call_data->chg_length;
      if (rest_len)
      {
         over_mb = _XmStringSourceGetString(tw, (XmTextPosition)(PreStartTW(tw) + call_data->chg_first + call_data->chg_length), PreEndTW(tw), False);
   ...
   if (need_verify)
   {
      PreeditVerifyReplace(w, startPos, endPos, mb, PreCursorTW(tw), &end_preedit);
      if (end_preedit)
      {
         (*tw->text.output->DrawInsertionPoint)(tw, tw->text.cursor_position, on);
         return;
                          ...
                          XmTextPosition position)
{
   ...
   if (tw != NULL && tw->text.onthespot)
   {
      ...
      {
         PreStartTW(tw) = PreEndTW(tw) = PreCursorTW(tw) = cursorPos;
      }
   }
   return cursorPos;
}
                   ...
                   wchar_t *wc_value)
{
   ...
   else
   {
      ...
      if (result == (size_t)-1)
      {               /* if wcstombs fails, it returns (size_t) -1 */
                      ...
                      XmTextPosition top_character)
{
   ...
   _XmWidgetToAppContext(widget);
   _XmAppLock(app);
   if (tw->text.output->data->resizeheight && !(tw->text.output->data->scrollvertical && XmIsScrolledWindow(XtParent(widget))))
   {
                ...
                XmTextPosition cursor_position)
{
   ...
   if (tw->text.edit_mode == XmMULTI_LINE_EDIT)
      top_character = (*tw->text.source->Scan)(tw->text.source, top_character, XmSELECT_LINE, XmsdLeft, 1, FALSE);
   tw->text.new_top       = top_character;
   tw->text.top_character = 0;
   ...
   (*tw->text.output->PosToXY)(tw, cursor_position, &xmim_point.x, &xmim_point.y);
   (void)_XmTextGetDisplayRect((Widget)tw, &xmim_area);
   n = 0;
   XtSetArg(args[n], XmNspotLocation, &xmim_point);
   n++;
                     ...
                     Cardinal argcount)
{
   ...
   */
   ...
   XtSetArg(merged_args[n], XmNscrollingPolicy, (XtArgVal)XmAPPLICATION_DEFINED);
   n++;
   XtSetArg(merged_args[n], XmNvisualPolicy, (XtArgVal)XmVARIABLE);
   n++;
   XtSetArg(merged_args[n], XmNscrollBarDisplayPolicy, (XtArgVal)XmSTATIC);
   n++;
   XtSetArg(merged_args[n], XmNshadowThickness, (XtArgVal)0);
   n++;
   swindow = XtCreateManagedWidget(s, xmScrolledWindowWidgetClass, parent, merged_args, n);
