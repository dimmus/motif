...
externaldef(uil_sym_glbl) int uil_max_object = 96;
...
externaldef(uil_sym_glbl) int uil_max_arg = 726;
...
externaldef(uil_sym_glbl) int uil_max_reason = 82;
...
externaldef(uil_sym_glbl) int uil_max_enumset = 118;
externaldef(uil_sym_glbl) int uil_max_enumval = 405;
...
externaldef(uil_sym_glbl) int uil_max_charset = 27;
