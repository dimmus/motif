...
FunctionTableEntry functionTable[] = {
    ...
    {"f.action",	0,
			...
			0,
			F_Action,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncActionArg},
#else /* PANELIST */
    {"f.action",	0,
			CRS_ANY,
			0,
			F_Action,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncStrArg},
#endif  /* PANELIST */
#endif /* WSM */
    {"f.beep",		0,
			CRS_ANY,
			0,
			F_Beep,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncNoArg},
#if ((!defined(WSM)) || defined(MWM_QATS_PROTOCOL))
    {"f.cci",		0,
	        	CRS_ANY,
			0,
			F_Nop,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncCCIArgs},
#endif /* !defined(WSM) || defined(MWM_QATS_PROTOCOL) */
    {"f.circle_down",	F_SUBCONTEXT_IB_IICON|F_SUBCONTEXT_IB_WICON,
			CRS_ANY,
			0,
			F_Circle_Down,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncGrpArg},
    ...
    {"f.help",          0,
			...
			0,
			F_Help,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncStrArg},  /* [helpvolume && helptopic] */
    {"f.help_mode",     0,
			CRS_ANY,
			0,
			F_Help_Mode,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncNoArg},  /* for now */
#endif /* WSM */
#if ((!defined(WSM)) || defined(MWM_QATS_PROTOCOL))
    {"f.invoke_command",
	        	0, CRS_ANY,
    ...
    {"f.normalize_and_raise",
			...
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncMaybeStrArg},
#else /* PANELIST */
    {"f.normalize_and_raise",
	                F_CONTEXT_ROOT|F_CONTEXT_NORMAL,
			CRS_ANY,
    ...
    {"f.send_msg",	F_CONTEXT_ROOT,
			...
			0,
			F_Send_Msg,
			(Boolean (*)(unsigned char **, WmFunction, String *))ParseWmFuncNbrArg},
    {"f.separator",	0,
			CRS_MENU,
			0,
			F_Separator,
